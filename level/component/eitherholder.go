...
//
// Deprecated: Minecraft 26.1 removed EitherHolder<T>; the components that used it
// (damage_type, chicken/variant, zombie_nautilus/variant, provides_trim_material, ...)
// are plain registry holders (pk.VarInt or holder_data) since protocol 775.
// Kept for code targeting 1.21.x.
//
