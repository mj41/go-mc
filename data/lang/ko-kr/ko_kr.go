// Code generated by tools/gen_lang.go from 1.21.11/ko_kr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"attribute.name.explosion_knockback_resistance": "폭발 밀치기 저항",
	...
	"attribute.name.generic.explosion_knockback_resistance": "폭발 밀치기 저항",
	...
	"attribute.name.knockback_resistance": "밀치기 저항",
	...
	"commands.attribute.base_value.get.success": "%s 개체의 %s 특성 기초 값은 %s입니다",
	"commands.attribute.base_value.reset.success": "%s 개체의 %s 특성 기초 값을 기본값 %s(으)로 초기화했습니다",
	"commands.attribute.base_value.set.success": "%s 개체의 %s 특성 기초 값을 %s(으)로 설정했습니다",
	...
	"commands.attribute.modifier.value.get.success": "%s 개체의 %s 특성의 %s 변경자 값은 %s입니다",
	"commands.attribute.value.get.success": "%s 개체의 %s 특성 값은 %s입니다",
	...
	"commands.swing.success.multiple": "개체 %s개가 팔을 휘둘렀습니다",
	"commands.swing.success.single": "%s이(가) 팔을 휘둘렀습니다",
	...
	"commands.time.pause": "시계 %s을(를) 일시 정지했습니다",
	"commands.time.query": "현재 시간은 %s입니다",
	"commands.time.query.absolute": "시계 %s은(는) %s 틱에 있습니다",
	"commands.time.query.gametime": "게임 시간은 %s틱입니다",
	"commands.time.query.timeline": "시간선 %s은(는) %s틱에 있습니다",
	"commands.time.query.timeline.repetitions": "시간선 %s이(가) %s회의 반복을 완료했습니다",
	"commands.time.resume": "시계 %s을(를) 다시 시작했습니다",
	...
	"gamerule.minecraft.universal_anger.description": "중립 몹이 화나면 화나게 한 플레이어뿐만 아니라 근처에 있는 모든 플레이어를 공격합니다. forgive_dead_players가 꺼져 있을 때 가장 잘 작동합니다.",
	...
	"inventory.hotbarInfo": "%[1]s + %[2]s을(를) 눌러 단축바를 저장할 수 있습니다",
	...
	"known_server_link.report_bug": "서버 버그 신고하기",
	...
	"options.textureFiltering.rgss.tooltip": "(회전 격자 슈퍼 샘플링)\n적당한 성능 영향으로 텍스처 품질을 개선하는 셰이더 기반 필터링 기법입니다.",
	"options.title": "설정",
	...
	"selectWorld.backupQuestion.file_fixing_required": "세계를 변환하기 전에 백업을 만드시겠습니까?",
	...
	"selectWorld.backupWarning.file_fixing_required": "이 세계는 플레이하기 전에 상위 버전으로 변환해야 합니다. 세계가 손상될 수 있으니 진행하기 전 백업을 만드는 것을 강력히 권장합니다.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "이 세계는 세계 형식의 내부적인 변경 사항으로 인해 편집하기 전에 최신 버전으로 변환해야 합니다.",
	"selectWorld.requiresFileFixingTooltip.play": "이 세계는 세계 형식의 내부적인 변경 사항으로 인해 플레이하기 전에 최신 버전으로 변환해야 합니다.",
	"selectWorld.requiresFileFixingTooltip.recreate": "이 세계는 세계 형식의 내부적인 변경 사항으로 인해 다시 만들기 전에 최신 버전으로 변환해야 합니다.",
	...
	"selectWorld.upgrade_and_play": "변환 및 플레이",
	...
	"selectWorld.waitingForBackup.message": "세계의 크기에 따라, 시간이 다소 걸릴 수 있습니다. 게임을 종료하거나 기기를 끄지 말아 주세요.",
	...
	"selectWorld.world_gen_settings_access": "세계 생성 설정 파일을 읽거나 접근할 수 없습니다! %s",
	"selecteWorld.backupRequiredTooltip": "세계를 불러오려면 먼저 백업을 진행해야 합니다",
	"sign.edit": "표지판 문구 편집",
	...
	"subtitles.block.creaking_heart.idle": "으스스한 소리",
	...
	"subtitles.block.pale_hanging_moss.idle": "으스스한 소리",
	...
	"subtitles.item.brush.brushing.gravel.complete": "자갈 솔질 완료",
	"subtitles.item.brush.brushing.sand": "모래 솔질",
	"subtitles.item.brush.brushing.sand.complete": "모래 솔질 완료",
	...
	"subtitles.item.golden_dandelion.unuse": "황금 민들레로 성장을 시작함",
	...
	"test.error.entity_property": "개체 %s이(가) 테스트에 실패했습니다: %s",
	"test.error.entity_property_details": "개체 %s이(가) 테스트에 실패했습니다: %s. %s이(가) 필요한데, %s(이)었습니다",
	...
	"upgradeWorld.done": "세계 변환 완료",
	"upgradeWorld.info.converted": "변환됨: %s개",
	"upgradeWorld.info.file_fix_stage": "단계: %s/%s",
	"upgradeWorld.info.scanning": "파일 찾는 중...",
	...
	"upgradeWorld.progress.type.legacy_structures": "기존 구조물 변환 중",
	"upgradeWorld.progress.type.region": "지역 변환 중",
	"upgradeWorld.symlink.message": "선택된 세계에 심볼릭 링크가 있습니다.\n세계를 현재 버전으로 변환하는 데 필요한 절차에서는 심볼릭 링크를 지원하지 않습니다. 세계를 변환하려면, 먼저 링크 문제를 해결해야 합니다.",
	"upgradeWorld.symlink.title": "세계를 변환할 수 없습니다",
	"upgradeWorld.title": "세계 파일 변환 중",
}
