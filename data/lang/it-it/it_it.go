// Code generated by tools/gen_lang.go from 26.2/it_it.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.play_jukebox_in_meadows.description": "Fa' andare la musica per le valli in fiore con un giradischi",
	...
	"advancements.adventure.trim_with_any_armor_pattern.description": "Crea un'armatura ornata usando un banco da forgiatura",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fa' in modo che un alleviante porti una torta presso un blocco sonoro",
	...
	"advancements.husbandry.breed_all_animals.description": "Fa' accoppiare due animali di ciascuna specie!",
	"advancements.husbandry.breed_all_animals.title": "A due a due",
	"advancements.husbandry.breed_an_animal.description": "Fa' accoppiare due animali della stessa specie",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Fa' brillare il testo di un cartello o di un'insegna",
	...
	"advancements.husbandry.uh_oh.description": "Fa' assorbire un blocco di TNT a un cubo di zolfo",
	...
	"advancements.husbandry.wax_on.title": "Da' la cera",
	...
	"advancements.nether.ride_strider_in_overworld_lava.description": "Fa' un luuuungo giro su uno strider in un lago di lava nell'Overworld",
	...
	"argument.block.tag.disallowed": "Qui non sono consentiti insiemi, ma solo blocchi concreti",
	...
	"argument.entity.notfound.entity": "Nessun'entità trovata",
	...
	"argument.entity.options.tag.description": "Entità con un determinato marcatore",
	...
	"argument.float.big": "Il numero reale non deve essere maggiore di %s (ricevuto: %s)",
	"argument.float.low": "Il numero reale non deve essere minore di %s (ricevuto: %s)",
	...
	"argument.item.tag.disallowed": "Qui non sono consentiti insiemi, ma solo oggetti concreti",
	...
	"argument.nbt.expected.compound": "Previsto un valore composto",
	...
	"argument.resource.invalid_type": "L'elemento «%s» è di tipo errato: %s (previsto: %s)",
	...
	"argument.resource_or_id.invalid": "Marcatore o ID non validi",
	...
	"argument.resource_tag.invalid_type": "Il marcatore «%s» è di tipo errato: %s (previsto: %s)",
	"argument.resource_tag.not_found": "Impossibile trovare il marcatore «%s» di tipo «%s»",
	"argument.rotation.incomplete": "Incompleto (previsti 2 argomenti della rotazione)",
	"argument.scoreHolder.empty": "Nessun possessore di punteggio pertinente trovato",
	"argument.scoreboardDisplaySlot.invalid": "Posizione sconosciuta: %s",
	"argument.style.invalid": "Stile non valido: %s",
	"argument.swing_animation.invalid": "Animazione del braccio sconosciuta: %s",
	...
	"arguments.block.tag.unknown": "Insieme di blocchi sconosciuto: %s",
	"arguments.function.tag.unknown": "Insieme di funzioni sconosciuto: %s",
	...
	"arguments.item.tag.unknown": "Insieme di oggetti sconosciuto: %s",
	"arguments.nbtpath.node.invalid": "Elemento non valido nel percorso NBT",
	"arguments.nbtpath.nothing_found": "Nessun elemento corrispondente a %s trovato",
	...
	"biome.minecraft.dappled_forest": "Foresta ambrata",
	...
	"block.minecraft.attached_melon_stem": "Tralcio di anguria maturo",
	"block.minecraft.attached_pumpkin_stem": "Tralcio di zucca maturo",
	...
	"block.minecraft.black_concrete_slab": "Lastra di calcestruzzo nero",
	"block.minecraft.black_concrete_stairs": "Scalini di calcestruzzo nero",
	...
	"block.minecraft.black_wool_slab": "Lastra di lana nera",
	"block.minecraft.black_wool_stairs": "Scalini di lana nera",
	...
	"block.minecraft.blue_concrete_slab": "Lastra di calcestruzzo blu",
	"block.minecraft.blue_concrete_stairs": "Scalini di calcestruzzo blu",
	...
	"block.minecraft.blue_wool_slab": "Lastra di lana blu",
	"block.minecraft.blue_wool_stairs": "Scalini di lana blu",
	"block.minecraft.bone_block": "Blocco d'ossa",
	...
	"block.minecraft.brown_concrete_slab": "Lastra di calcestruzzo marrone",
	"block.minecraft.brown_concrete_stairs": "Scalini di calcestruzzo marrone",
	...
	"block.minecraft.brown_wool_slab": "Lastra di lana marrone",
	"block.minecraft.brown_wool_stairs": "Scalini di lana marrone",
	...
	"block.minecraft.chorus_flower": "Fiore di coro",
	"block.minecraft.chorus_plant": "Ramo di coro",
	...
	"block.minecraft.cyan_concrete_slab": "Lastra di calcestruzzo ciano",
	"block.minecraft.cyan_concrete_stairs": "Scalini di calcestruzzo ciano",
	...
	"block.minecraft.cyan_wool_slab": "Lastra di lana ciano",
	"block.minecraft.cyan_wool_stairs": "Scalini di lana ciano",
	...
	"block.minecraft.flowering_azalea_leaves": "Foglie di azalea fiorita",
	...
	"block.minecraft.gray_concrete_slab": "Lastra di calcestruzzo grigio",
	"block.minecraft.gray_concrete_stairs": "Scalini di calcestruzzo grigio",
	...
	"block.minecraft.gray_wool_slab": "Lastra di lana grigia",
	"block.minecraft.gray_wool_stairs": "Scalini di lana grigia",
	...
	"block.minecraft.green_concrete_slab": "Lastra di calcestruzzo verde",
	"block.minecraft.green_concrete_stairs": "Scalini di calcestruzzo verde",
	...
	"block.minecraft.green_wool_slab": "Lastra di lana verde",
	"block.minecraft.green_wool_stairs": "Scalini di lana verde",
	...
	"block.minecraft.jigsaw": "Blocco incastri",
	...
	"block.minecraft.light_blue_concrete_slab": "Lastra di calcestruzzo azzurro",
	"block.minecraft.light_blue_concrete_stairs": "Scalini di calcestruzzo azzurro",
	...
	"block.minecraft.light_blue_wool_slab": "Lastra di lana azzurra",
	"block.minecraft.light_blue_wool_stairs": "Scalini di lana azzurra",
	...
	"block.minecraft.light_gray_concrete_slab": "Lastra di calcestruzzo grigio chiaro",
	"block.minecraft.light_gray_concrete_stairs": "Scalini di calcestruzzo grigio chiaro",
	...
	"block.minecraft.light_gray_wool_slab": "Lastra di lana grigio chiaro",
	"block.minecraft.light_gray_wool_stairs": "Scalini di lana grigio chiaro",
	...
	"block.minecraft.lime_concrete_slab": "Lastra di calcestruzzo lime",
	"block.minecraft.lime_concrete_stairs": "Scalini di calcestruzzo lime",
	...
	"block.minecraft.lime_wool_slab": "Lastra di lana lime",
	"block.minecraft.lime_wool_stairs": "Scalini di lana lime",
	...
	"block.minecraft.magenta_concrete_slab": "Lastra di calcestruzzo magenta",
	"block.minecraft.magenta_concrete_stairs": "Scalini di calcestruzzo magenta",
	...
	"block.minecraft.magenta_wool_slab": "Lastra di lana magenta",
	"block.minecraft.magenta_wool_stairs": "Scalini di lana magenta",
	...
	"block.minecraft.melon_stem": "Tralcio di anguria",
	...
	"block.minecraft.oak_wall_hanging_sign": "Insegna di quercia a parete",
	...
	"block.minecraft.orange_concrete_slab": "Lastra di calcestruzzo arancione",
	"block.minecraft.orange_concrete_stairs": "Scalini di calcestruzzo arancione",
	"block.minecraft.orange_glazed_terracotta": "Terracotta smaltata arancione",
	"block.minecraft.orange_poplar_leaves": "Foglie di pioppo arancioni",
	...
	"block.minecraft.orange_wool_slab": "Lastra di lana arancione",
	"block.minecraft.orange_wool_stairs": "Scalini di lana arancione",
	...
	"block.minecraft.pale_hanging_moss": "Muschio pallido pendente",
	...
	"block.minecraft.pink_concrete_slab": "Lastra di calcestruzzo rosa",
	"block.minecraft.pink_concrete_stairs": "Scalini di calcestruzzo rosa",
	...
	"block.minecraft.pink_wool_slab": "Lastra di lana rosa",
	"block.minecraft.pink_wool_stairs": "Scalini di lana rosa",
	...
	"block.minecraft.poplar_button": "Pulsante di pioppo",
	"block.minecraft.poplar_door": "Porta di pioppo",
	"block.minecraft.poplar_fence": "Staccionata di pioppo",
	"block.minecraft.poplar_fence_gate": "Cancelletto di pioppo",
	"block.minecraft.poplar_hanging_sign": "Insegna di pioppo",
	"block.minecraft.poplar_leaves": "Foglie di pioppo",
	"block.minecraft.poplar_log": "Tronco di pioppo",
	"block.minecraft.poplar_planks": "Assi di pioppo",
	"block.minecraft.poplar_pressure_plate": "Pedana a pressione di pioppo",
	"block.minecraft.poplar_sapling": "Arboscello di pioppo",
	"block.minecraft.poplar_shelf": "Scaffale di pioppo",
	"block.minecraft.poplar_sign": "Cartello di pioppo",
	"block.minecraft.poplar_slab": "Lastra di pioppo",
	"block.minecraft.poplar_stairs": "Scalini di pioppo",
	"block.minecraft.poplar_trapdoor": "Botola di pioppo",
	"block.minecraft.poplar_wall_hanging_sign": "Insegna di pioppo a parete",
	"block.minecraft.poplar_wall_sign": "Cartello di pioppo a parete",
	"block.minecraft.poplar_wood": "Legno di pioppo",
	...
	"block.minecraft.potted_poplar_sapling": "Vaso con arboscello di pioppo",
	...
	"block.minecraft.pumpkin_stem": "Tralcio di zucca",
	...
	"block.minecraft.purple_concrete_slab": "Lastra di calcestruzzo viola",
	"block.minecraft.purple_concrete_stairs": "Scalini di calcestruzzo viola",
	...
	"block.minecraft.purple_wool_slab": "Lastra di lana viola",
	"block.minecraft.purple_wool_stairs": "Scalini di lana viola",
	"block.minecraft.purpur_block": "Blocco di purpura",
	"block.minecraft.purpur_pillar": "Pilastro di purpura",
	"block.minecraft.purpur_slab": "Lastra di purpura",
	"block.minecraft.purpur_stairs": "Scalini di purpura",
	...
	"block.minecraft.red_concrete_slab": "Lastra di calcestruzzo rosso",
	"block.minecraft.red_concrete_stairs": "Scalini di calcestruzzo rosso",
	...
	"block.minecraft.red_poplar_leaves": "Foglie di pioppo rosse",
	...
	"block.minecraft.red_shrub": "Arbusto rosso",
	...
	"block.minecraft.red_wool_slab": "Lastra di lana rossa",
	"block.minecraft.red_wool_stairs": "Scalini di lana rossa",
	...
	"block.minecraft.set_spawn": "Impostato il punto di rinascita",
	"block.minecraft.shelf_mushroom": "Fungo a mensola",
	...
	"block.minecraft.straw_bed": "Pagliericcio",
	...
	"block.minecraft.stripped_poplar_log": "Tronco di pioppo scortecciato",
	"block.minecraft.stripped_poplar_wood": "Legno di pioppo scortecciato",
	...
	"block.minecraft.structure_void": "Vuoto strutturale",
	...
	"block.minecraft.test_block": "Blocco di collaudo",
	"block.minecraft.test_instance_block": "Blocco istanza di collaudo",
	...
	"block.minecraft.torchflower_crop": "Coltura di fiortorcia",
	...
	"block.minecraft.white_concrete_slab": "Lastra di calcestruzzo bianco",
	"block.minecraft.white_concrete_stairs": "Scalini di calcestruzzo bianco",
	...
	"block.minecraft.white_wool_slab": "Lastra di lana bianca",
	"block.minecraft.white_wool_stairs": "Scalini di lana bianca",
	...
	"block.minecraft.yellow_concrete_slab": "Lastra di calcestruzzo giallo",
	"block.minecraft.yellow_concrete_stairs": "Scalini di calcestruzzo giallo",
	"block.minecraft.yellow_glazed_terracotta": "Terracotta smaltata gialla",
	"block.minecraft.yellow_poplar_leaves": "Foglie di pioppo gialle",
	...
	"block.minecraft.yellow_wool_slab": "Lastra di lana gialla",
	"block.minecraft.yellow_wool_stairs": "Scalini di lana gialla",
	...
	"book.invalid.tag": "*Dati non validi*",
	...
	"chat.link.open": "Apri collegamento",
	...
	"clear.failed.multiple": "Nessun oggetto trovato in %s giocatori",
	"clear.failed.single": "Nessun oggetto trovato in %s",
	...
	"command.compute.result.named.exact": "Valore di %s: %s",
	"command.compute.result.named.rounded": "Valore di %s: %s (arrotondato: %s)",
	"command.compute.result.unnamed.exact": "Valore del numero fornito: %s",
	"command.compute.result.unnamed.rounded": "Valore del numero fornito: %s (arrotondato: %s)",
	...
	"commands.advancement.grant.criterion.to.many.success": "Assegnato il criterio «%s» del progresso %s a %s giocatori",
	...
	"commands.advancement.grant.criterion.to.one.success": "Assegnato il criterio «%s» del progresso %s a %s",
	"commands.advancement.grant.many.to.many.failure": "Impossibile assegnare %s progressi a %s giocatori perché li possiedono già",
	"commands.advancement.grant.many.to.many.success": "Assegnato %s progressi a %s giocatori",
	"commands.advancement.grant.many.to.one.failure": "Impossibile assegnare %s progressi a %s perché li possiede già",
	"commands.advancement.grant.many.to.one.success": "Assegnato %s progressi a %s",
	...
	"commands.advancement.grant.one.to.many.success": "Assegnato %s a %s giocatori",
	"commands.advancement.grant.one.to.one.failure": "Impossibile assegnare il progresso %s a %s perché lo possiede già",
	"commands.advancement.grant.one.to.one.success": "Assegnato il progresso %s a %s",
	...
	"commands.advancement.revoke.criterion.to.many.success": "Rimosso il criterio «%s» del progresso %s da %s giocatori",
	...
	"commands.advancement.revoke.criterion.to.one.success": "Rimosso il criterio «%s» del progresso %s da %s",
	...
	"commands.advancement.revoke.many.to.many.success": "Rimosso %s progressi da %s giocatori",
	"commands.advancement.revoke.many.to.one.failure": "Impossibile rimuovere %s progressi da %s perché non li possiede",
	"commands.advancement.revoke.many.to.one.success": "Rimosso %s progressi da %s",
	...
	"commands.advancement.revoke.one.to.many.success": "Rimosso il progresso %s da %s giocatori",
	"commands.advancement.revoke.one.to.one.failure": "Impossibile rimuovere il progresso %s da %s perché non lo possiede",
	"commands.advancement.revoke.one.to.one.success": "Rimosso il progresso %s da %s",
	"commands.attribute.base_value.get.success": "Valore base dell'attributo %s dell'entità %s: %s",
	"commands.attribute.base_value.reset.success": "Impostato il valore base dell'attributo %s dell'entità %s al valore predefinito %s",
	"commands.attribute.base_value.set.success": "Impostato il valore base dell'attributo %s dell'entità %s a %s",
	...
	"commands.attribute.modifier.remove.success": "Rimosso il modificatore %s dall'attributo %s dell'entità %s",
	"commands.attribute.modifier.value.get.success": "Valore del modificatore %s dell'attributo %s dell'entità %s: %s",
	"commands.attribute.value.get.success": "Valore dell'attributo %s dell'entità %s: %s",
	"commands.ban.failed": "Nessun cambiamento: questo giocatore è già bannato",
	"commands.ban.success": "Bannato %s: %s",
	"commands.banip.failed": "Nessun cambiamento: quest'indirizzo IP è già bannato",
	...
	"commands.banip.success": "Bannato l'indirizzo IP %s: %s",
	"commands.banlist.entry": "%[2]s ha bannato %[1]s: %[3]s",
	"commands.banlist.entry.unknown": "(Sconosciuto)",
	"commands.banlist.list": "%s ban:",
	"commands.banlist.none": "Non ci sono ban",
	"commands.bossbar.create.failed": "Esiste già una barra superiore con l'ID «%s»",
	"commands.bossbar.create.success": "Barra superiore creata: %s",
	"commands.bossbar.get.max": "Valore massimo della barra superiore %s: %s",
	"commands.bossbar.get.players.none": "Nessun giocatore assegnato alla barra superiore %s è in linea",
	"commands.bossbar.get.players.some": "La barra superiore %s ha al momento %s giocatore/i in linea: %[3]s",
	"commands.bossbar.get.value": "Valore attuale della barra superiore %s: %s",
	"commands.bossbar.get.visible.hidden": "La barra superiore %s è attualmente nascosta",
	"commands.bossbar.get.visible.visible": "La barra superiore %s è attualmente visibile",
	"commands.bossbar.list.bars.none": "Non ci sono barre superiori attive",
	"commands.bossbar.list.bars.some": "%s barra/e superiore/i attive: %s",
	"commands.bossbar.remove.success": "Rimosso la barra superiore %s",
	"commands.bossbar.set.color.success": "Cambiato il colore della barra superiore %s",
	"commands.bossbar.set.color.unchanged": "Nessun cambiamento: è già il colore di questa barra superiore",
	"commands.bossbar.set.max.success": "Cambiato il valore massimo della barra superiore %s in %s",
	"commands.bossbar.set.max.unchanged": "Nessun cambiamento: è già il valore massimo di questa barra superiore",
	"commands.bossbar.set.name.success": "Rinominato la barra superiore %s",
	"commands.bossbar.set.name.unchanged": "Nessun cambiamento: è già il nome di questa barra superiore",
	"commands.bossbar.set.players.success.none": "La barra superiore %s non è più assegnata ad alcun giocatore",
	"commands.bossbar.set.players.success.some": "La barra superiore %s è ora assegnata a %s giocatore/i: %s",
	"commands.bossbar.set.players.unchanged": "Nessun cambiamento: questi giocatori sono già assegnati alla barra superiore e nessuno va aggiunto o rimosso",
	"commands.bossbar.set.style.success": "Cambiato lo stile della barra superiore %s",
	"commands.bossbar.set.style.unchanged": "Nessun cambiamento: è già lo stile di questa barra superiore",
	"commands.bossbar.set.value.success": "Cambiato il valore attuale della barra superiore %s in %s",
	"commands.bossbar.set.value.unchanged": "Nessun cambiamento: è già il valore di questa barra superiore",
	"commands.bossbar.set.visibility.unchanged.hidden": "Nessun cambiamento: questa barra superiore è già nascosta",
	"commands.bossbar.set.visibility.unchanged.visible": "Nessun cambiamento: questa barra superiore è già visibile",
	"commands.bossbar.set.visible.success.hidden": "La barra superiore %s è stata resa nascosta",
	"commands.bossbar.set.visible.success.visible": "La barra superiore %s è stata resa visibile",
	"commands.bossbar.unknown": "Non esiste alcuna barra superiore con l'ID «%s»",
	"commands.clear.success.multiple": "Rimosso %s oggetto/i da %s giocatori",
	"commands.clear.success.single": "Rimosso %s oggetto/i da %s",
	"commands.clear.test.multiple": "Trovato una corrispondenza di %s oggetto/i su %s giocatori",
	"commands.clear.test.single": "Trovato una corrispondenza di %s oggetto/i su %s",
	...
	"commands.data.block.get": "Proprietà %s del blocco in %s, %s, %s con fattore di scala di %s: %s",
	"commands.data.block.invalid": "Il blocco di destinazione non è un blocco complesso",
	"commands.data.block.modified": "Modificato i dati blocco in %s, %s, %s",
	"commands.data.block.query": "Dati del blocco in %s, %s, %s: %s",
	"commands.data.entity.get": "Proprietà %s di %s con fattore di scala di %s: %s",
	"commands.data.entity.invalid": "Impossibile modificare i dati del giocatore",
	"commands.data.entity.modified": "Modificato i dati entità di %s",
	"commands.data.entity.query": "%s ha i seguenti dati entità: %s",
	"commands.data.get.invalid": "Impossibile recuperare %s: sono consentiti solo valori numerici",
	"commands.data.get.multiple": "Quest'argomento accetta un solo valore NBT",
	"commands.data.get.unknown": "Impossibile recuperare %s: il valore non esiste",
	...
	"commands.data.storage.get": "Proprietà %s nel contenitore %s con fattore di scala di %s: %s",
	"commands.data.storage.modified": "Modificato i dati nel contenitore %s",
	...
	"commands.datapack.disable.failed": "Pacchetto di dati %s non attivo",
	"commands.datapack.disable.failed.feature": "Pacchetto «%s» non disattivabile perché fa parte di una variabile attiva",
	"commands.datapack.enable.failed": "Pacchetto di dati «%s» già attivo",
	...
	"commands.defaultgamemode.success": "Impostato la modalità di gioco predefinita: %s",
	...
	"commands.dialog.clear.multiple": "Cancellato le finestre di dialogo per %s giocatori",
	"commands.dialog.clear.single": "Cancellato le finestre di dialogo per %s",
	"commands.dialog.show.multiple": "Mostrato finestra di dialogo a %s giocatori",
	"commands.dialog.show.single": "Mostrato finestra di dialogo a %s",
	"commands.difficulty.failure": "Nessun cambiamento: la difficoltà è già impostata su «%s»",
	"commands.difficulty.query": "Difficoltà attuale: %s",
	"commands.difficulty.success": "Impostato la difficoltà: %s",
	...
	"commands.effect.clear.everything.success.multiple": "Rimosso tutti gli effetti da %s destinatari",
	"commands.effect.clear.everything.success.single": "Rimosso tutti gli effetti da %s",
	"commands.effect.clear.specific.failed": "Il destinatario non ha l'effetto richiesto",
	"commands.effect.clear.specific.success.multiple": "Rimosso l'effetto %s da %s destinatari",
	"commands.effect.clear.specific.success.single": "Rimosso l'effetto %s da %s",
	...
	"commands.execute.conditional.fail": "Il collaudo non è stato superato",
	"commands.execute.conditional.fail_count": "Il collaudo non è stato superato (quantità: %s)",
	"commands.execute.conditional.pass": "Il collaudo è stato superato",
	"commands.execute.conditional.pass_count": "Il collaudo è stato superato (quantità: %s)",
	"commands.execute.function.instantiationFailure": "Creazione di un'istanza della funzione %s non riuscita: %s",
	"commands.experience.add.levels.success.multiple": "Assegnato %s livelli di esperienza a %s giocatori",
	"commands.experience.add.levels.success.single": "Assegnato %s livelli di esperienza a %s",
	"commands.experience.add.points.success.multiple": "Assegnato %s punti esperienza a %s giocatori",
	"commands.experience.add.points.success.single": "Assegnato %s punti esperienza a %s",
	"commands.experience.query.levels": "%s ha %s livelli di esperienza",
	"commands.experience.query.points": "%s ha %s punti esperienza",
	"commands.experience.set.levels.success.multiple": "Impostato i livelli di esperienza di %[2]s giocatori a %[1]s",
	"commands.experience.set.levels.success.single": "Impostato i livelli di esperienza di %[2]s a %[1]s",
	...
	"commands.experience.set.points.success.multiple": "Impostato i punti esperienza di %[2]s giocatori a %[1]s",
	"commands.experience.set.points.success.single": "Impostato i punti esperienza di %[2]s a %[1]s",
	...
	"commands.fillbiome.no_changes": "Nessun bioma modificato",
	"commands.fillbiome.success": "Impostato biomi tra %s, %s, %s e %s, %s, %s",
	...
	"commands.forceload.added.multiple": "Segnalato %[1]s chunk da %[3]s a %[4]s nella dimensione %[2]s per il caricamento forzato",
	"commands.forceload.added.none": "Nessun chunk con caricamento forzato trovato nella dimensione %s",
	"commands.forceload.added.single": "Segnalato il chunk %s nella dimensione %s per il caricamento forzato",
	"commands.forceload.list.multiple": "Trovato %s chunk con caricamento forzato nella dimensione %s: %s",
	"commands.forceload.list.single": "Trovato un chunk con caricamento forzato nella dimensione %s: %s",
	...
	"commands.function.scheduled.no_functions": "Nessuna funzione con il nome «%s» trovata",
	...
	"commands.gamemode.success.other": "Impostato la modalità di gioco di %s: %s",
	"commands.gamemode.success.self": "Impostato la tua modalità di gioco: %s",
	"commands.gamerule.not_set": "Regola di gioco «%s» già impostata su «%s»",
	"commands.gamerule.query": "La regola di gioco %s è attualmente impostata su «%s»",
	"commands.gamerule.set": "Impostato la regola di gioco «%s»: %s",
	...
	"commands.help.failed": "Comando sconosciuto o autorizzazioni insufficienti",
	"commands.item.block.modify.success": "Modificato %s casella/e in %s, %s, %s",
	"commands.item.block.replace.success": "Sostituito %s casella/e in %s, %s, %s",
	"commands.item.block.replace.success.known_item": "Sostituito %s casella/e in %s, %s, %s con %s",
	"commands.item.block.set.success": "Sostituito una casella in %s, %s, %s con %s",
	"commands.item.entity.modify.success.multiple": "Modificato casella/e di %s entità",
	"commands.item.entity.modify.success.single": "Modificato casella/e di %s",
	"commands.item.entity.replace.success.multiple": "Sostituito casella/e di %s entità",
	"commands.item.entity.replace.success.multiple.known_item": "Sostituito casella/e di %s entità con %s",
	"commands.item.entity.replace.success.single": "Sostituito %s casella/e di %s",
	"commands.item.entity.replace.success.single.known_item": "Sostituito %s casella/e di %s con %s",
	"commands.item.entity.set.success.multiple": "Sostituito una casella di %s entità con %s",
	"commands.item.entity.set.success.single": "Sostituito una casella di %s con %s",
	"commands.item.source.no_such_slot": "L'origine non possiede la casella %s",
	"commands.item.source.no_such_slot.unnamed": "L'origine non possiede le caselle specificate",
	"commands.item.source.not_a_container": "La posizione di origine in %s, %s, %s non è un contenitore",
	"commands.item.target.failed": "Nessun destinatario ha accettato gli oggetti nelle caselle specificate",
	"commands.item.target.failed.known_item": "Nessun destinatario ha accettato l'oggetto %s nelle caselle specificate",
	"commands.item.target.no_changed.known_item": "Nessun destinatario ha accettato l'oggetto %s nella casella %s",
	"commands.item.target.no_changes": "Nessun destinatario ha accettato l'oggetto nella casella %s",
	"commands.item.target.no_such_slot": "Il destinatario non possiede la casella %s",
	"commands.item.target.no_such_slot.unnamed": "Il destinatario non possiede le caselle specificate",
	...
	"commands.kick.owner.failed": "Impossibile espellere il proprietario del server in una sessione in rete locale",
	"commands.kick.singleplayer.failed": "Impossibile espellere in un mondo in giocatore singolo",
	"commands.kick.success": "Espulso %s: %s",
	"commands.kill.success.multiple": "Ucciso %s entità",
	...
	"commands.locate.biome.success": "Il bioma %s più vicino è in %s (blocchi di distanza: %s)",
	"commands.locate.poi.not_found": "Punto d'interesse di tipo «%s» entro una distanza ragionevole non trovato",
	"commands.locate.poi.success": "Il punto «%s» più vicino è in %s (blocchi di distanza: %s)",
	...
	"commands.locate.structure.success": "La struttura di tipo %s più vicina è in %s (blocchi di distanza: %s)",
	...
	"commands.pardonip.failed": "Nessun cambiamento: l'indirizzo IP non è bannato",
	...
	"commands.perf.reportFailed": "Creazione del rapporto diagnostico non riuscita",
	"commands.perf.reportSaved": "Creato il rapporto diagnostico in %s",
	...
	"commands.place.feature.failed": "Piazzamento dell'elemento non riuscito",
	"commands.place.feature.invalid": "Non esiste un elemento di tipo «%s»",
	"commands.place.feature.success": "Elemento «%s» piazzato in %s, %s, %s",
	"commands.place.feature.success.inline": "Elemento piazzato in %s, %s, %s",
	"commands.place.jigsaw.failed": "Generazione dell'incastro non riuscita",
	"commands.place.jigsaw.invalid": "Non esiste un insieme di modelli di tipo «%s»",
	"commands.place.jigsaw.success": "Incastro generato in %s, %s, %s",
	...
	"commands.playsound.success.multiple": "Riprodotto il suono %s a %s giocatori",
	"commands.playsound.success.single": "Riprodotto il suono %s a %s",
	"commands.posteffect.add.failed": "Il giocatore ha già l'effetto visivo specificato",
	"commands.posteffect.add.success.multiple": "Aggiunto l'effetto visivo %s a %s giocatori",
	"commands.posteffect.add.success.single": "Aggiunto l'effetto visivo %s a %s",
	"commands.posteffect.clear.failed": "Nessun effetto visivo rimovibile dal giocatore",
	"commands.posteffect.clear.success.multiple": "Rimosso tutti gli effetti visivi da %s giocatori",
	"commands.posteffect.clear.success.single": "Rimosso tutti gli effetti visivi da %s",
	"commands.posteffect.list.empty": "Il giocatore %s non ha effetti visivi",
	"commands.posteffect.list.success": "Il giocatore %s ha %s effetti visivi: %s",
	"commands.posteffect.remove.failed": "Il giocatore non ha l'effetto visivo specificato",
	"commands.posteffect.remove.success.multiple": "Rimosso l'effetto visivo %s da %s giocatori",
	"commands.posteffect.remove.success.single": "Rimosso l'effetto visivo %s da %s",
	...
	"commands.publish.alreadyPublished": "Partita multigiocatore già ospitata sulla porta %s",
	"commands.publish.alreadyPublished.lan": "Partita locale già ospitata sulla porta %s",
	"commands.publish.alreadyPublished.online": "Partita in rete già ospitata",
	"commands.publish.failed": "Impossibile ospitare la partita locale",
	"commands.publish.started": "Partita locale ospitata sulla porta %s",
	"commands.publish.started.lan": "Partita locale ospitata sulla porta %s",
	"commands.publish.started.online": "Partita in rete ospitata",
	"commands.publish.success": "Partita multigiocatore ospitata sulla porta %s",
	"commands.random.error.range_too_large": "L'intervallo del valore casuale dev'essere al massimo 2147483646",
	"commands.random.error.range_too_small": "L'intervallo del valore casuale dev'essere almeno 1",
	"commands.random.reset.all.success": "Sequenze casuali ripristinate: %s",
	"commands.random.reset.success": "Ripristinato la sequenza casuale %s",
	"commands.random.roll": "%s ha estratto %s (tra %s e %s)",
	"commands.random.sample.success": "Valore casuale: %s",
	"commands.recipe.give.failed": "Nessuna nuova ricetta sbloccata",
	"commands.recipe.give.success.multiple": "Ricette sbloccate per %[2]s giocatori: %[1]s",
	"commands.recipe.give.success.single": "Ricette sbloccate per %[2]s: %[1]s",
	"commands.recipe.take.failed": "Nessuna ricetta può essere rimossa",
	"commands.recipe.take.success.multiple": "Ricette rimosse da %[2]s giocatori: %[1]s",
	"commands.recipe.take.success.single": "Ricette rimosse da %[2]s: %[1]s",
	...
	"commands.save.alreadyOff": "Salvataggio già disattivato",
	"commands.save.alreadyOn": "Salvataggio già attivo",
	"commands.save.disabled": "Disattivato il salvataggio automatico",
	"commands.save.enabled": "Attivato il salvataggio automatico",
	...
	"commands.save.success": "Partita salvata",
	"commands.schedule.cleared.failure": "Nessun programma con l'ID %s",
	"commands.schedule.cleared.success": "Programmi rimossi con l'ID %[2]s: %[1]s",
	"commands.schedule.created.function": "La funzione «%s» verrà eseguita tra %s tick (tempo di gioco: %s)",
	"commands.schedule.created.tag": "Il marcatore «%s» verrà eseguito tra %s tick (tempo di gioco: %s)",
	...
	"commands.scoreboard.objectives.add.success": "Creato l'obiettivo %s",
	...
	"commands.scoreboard.objectives.display.cleared": "Rimosso tutti gli obiettivi dalla posizione %s",
	"commands.scoreboard.objectives.display.set": "Impostato la visualizzazione dell'obiettivo %[2]s nella posizione «%[1]s»",
	...
	"commands.scoreboard.objectives.modify.displayname": "Cambiato il nome da visualizzare dell'obiettivo %s in %s",
	...
	"commands.scoreboard.objectives.modify.rendertype": "Cambiato il tipo di elaborazione grafica dell'obiettivo %s",
	"commands.scoreboard.objectives.remove.success": "Rimosso l'obiettivo %s",
	"commands.scoreboard.players.add.success.multiple": "Aggiunto %s punti all'obiettivo %s per %s entità",
	"commands.scoreboard.players.add.success.single": "Aggiunto %s punti all'obiettivo %s per %s (attuali: %s)",
	...
	"commands.scoreboard.players.enable.failed": "Nessun cambiamento: l'innesco è già attivato",
	"commands.scoreboard.players.enable.invalid": "Solo gli obiettivi di tipo «trigger» supportano la funzione «enable»",
	"commands.scoreboard.players.enable.success.multiple": "Attivato l'innesco %s per %s entità",
	"commands.scoreboard.players.enable.success.single": "Attivato l'innesco %s per %s",
	...
	"commands.scoreboard.players.operation.success.multiple": "Aggiornato il punteggio dell'obiettivo %s per %s entità",
	"commands.scoreboard.players.operation.success.single": "Impostato il punteggio dell'obiettivo %s per %s a %s",
	"commands.scoreboard.players.remove.success.multiple": "Rimosso %s punti dall'obiettivo %s per %s entità",
	"commands.scoreboard.players.remove.success.single": "Rimosso %s punti dall'obiettivo %s per %s (attuali: %s)",
	"commands.scoreboard.players.reset.all.multiple": "Azzerato tutti i punteggi per %s entità",
	"commands.scoreboard.players.reset.all.single": "Azzerato tutti i punteggi per %s",
	"commands.scoreboard.players.reset.specific.multiple": "Azzerato il punteggio dell'obiettivo %s per %s entità",
	"commands.scoreboard.players.reset.specific.single": "Azzerato il punteggio dell'obiettivo %s per %s",
	"commands.scoreboard.players.set.success.multiple": "Impostato il punteggio dell'obiettivo %s per %s entità a %s",
	"commands.scoreboard.players.set.success.single": "Impostato il punteggio dell'obiettivo %s per %s a %s",
	"commands.seed.success": "Seme: %s",
	"commands.setblock.failed": "Impossibile piazzare il blocco",
	"commands.setblock.success": "Cambiato il blocco in %s, %s, %s",
	"commands.setidletimeout.success": "Impostato il tempo d'inattività massimo dei giocatori a %s minuto/i",
	"commands.setidletimeout.success.disabled": "Disattivato il tempo d'inattività massimo dei giocatori",
	"commands.setworldspawn.failure.not_overworld": "Impossibile impostare il punto di generazione globale fuori dall'Overworld",
	"commands.setworldspawn.success": "Impostato il punto di generazione globale in %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Impostato il punto di generazione globale in %s, %s, %s [%s, %s] nella dimensione %s",
	"commands.spawnpoint.success.multiple": "Impostato il punto di generazione di %[6]s giocatori in %[1]s, %[2]s, %[3]s [%[4]s] nella dimensione %[5]s",
	"commands.spawnpoint.success.multiple.new": "Impostato il punto di generazione di %[7]s giocatori in %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] nella dimensione %[6]s",
	"commands.spawnpoint.success.single": "Impostato il punto di generazione di %[6]s in %[1]s, %[2]s, %[3]s [%[4]s] nella dimensione %[5]s",
	"commands.spawnpoint.success.single.new": "Impostato il punto di generazione di %[7]s in %[1]s, %[2]s, %[3]s [%[4]s, %[5]s] nella dimensione %[6]s",
	...
	"commands.spreadplayers.success.entities": "Distribuito %s entità intorno a %s, %s con una separazione in blocchi media di %s",
	"commands.spreadplayers.success.teams": "Distribuito %s squadra/e intorno a %s, %s con una separazione in blocchi media di %s",
	"commands.stop.stopping": "Arresto del server...",
	"commands.stopsound.success.source.any": "Interrotto tutti i suoni con fonte %s",
	"commands.stopsound.success.source.sound": "Interrotto il suono %s con fonte %s",
	"commands.stopsound.success.sourceless.any": "Interrotto tutti i suoni",
	"commands.stopsound.success.sourceless.sound": "Interrotto il suono %s",
	"commands.stopwatch.already_exists": "Il cronometro «%s» esiste già",
	"commands.stopwatch.create.success": "Cronometro «%s» creato",
	"commands.stopwatch.does_not_exist": "Il cronometro «%s» non esiste",
	"commands.stopwatch.query": "Tempo d'esecuzione del cronometro «%s»: %s s",
	"commands.stopwatch.remove.success": "Cronometro «%s» rimosso",
	"commands.stopwatch.restart.success": "Cronometro «%s» riavviato",
	...
	"commands.summon.success": "Evocato l'entità %s",
	"commands.swing.failed.notliving": "Nessun'entità vivente compatibile trovata",
	"commands.swing.success.multiple": "%s entità hanno agitato un braccio",
	"commands.swing.success.single": "%s ha agitato un braccio",
	"commands.tag.add.failed": "Il destinatario ha già il marcatore o ne possiede troppi",
	"commands.tag.add.success.multiple": "Aggiunto il marcatore «%s» a %s entità",
	"commands.tag.add.success.single": "Aggiunto il marcatore «%s» a %s",
	"commands.tag.list.multiple.empty": "Le %s entità non hanno marcatori",
	"commands.tag.list.multiple.success": "Le %s entità hanno in totale %s marcatore/i: %s",
	"commands.tag.list.single.empty": "%s non ha marcatori",
	"commands.tag.list.single.success": "%s ha %s marcatore/i: %s",
	"commands.tag.remove.failed": "Il destinatario non ha questo marcatore",
	"commands.tag.remove.success.multiple": "Rimosso il marcatore «%s» da %s entità",
	"commands.tag.remove.success.single": "Rimosso il marcatore «%s» da %s",
	"commands.team.add.duplicate": "Esiste già una squadra con questo nome",
	"commands.team.add.success": "Creato la squadra %s",
	...
	"commands.team.join.success.multiple": "Aggiunto %s membri alla squadra %s",
	"commands.team.join.success.single": "Aggiunto %s alla squadra %s",
	"commands.team.leave.success.multiple": "Rimosso %s membri dalle loro squadre",
	...
	"commands.team.option.collisionRule.success": "Impostato la regola di collisione per la squadra %s su «%s»",
	"commands.team.option.collisionRule.unchanged": "Nessun cambiamento: la regola di collisione è già impostata su questo valore",
	"commands.team.option.color.clear.success": "Cancellato il colore della squadra %s",
	"commands.team.option.color.success": "Cambiato il colore della squadra %s in %s",
	"commands.team.option.color.unchanged": "Nessun cambiamento: è già il colore di questa squadra",
	"commands.team.option.deathMessageVisibility.success": "Impostato la visibilità dei messaggi di morte per la squadra %s su «%s»",
	...
	"commands.team.option.name.success": "Aggiornato il nome della squadra %s",
	"commands.team.option.name.unchanged": "Nessun cambiamento: è già il nome di questa squadra",
	"commands.team.option.nametagVisibility.success": "Impostato la visibilità dei nomi dei giocatori per la squadra %s su «%s»",
	...
	"commands.team.option.prefix.success": "Cambiato il prefisso della squadra in «%s»",
	...
	"commands.team.option.suffix.success": "Cambiato il suffisso della squadra in «%s»",
	"commands.team.remove.success": "Rimosso la squadra %s",
	...
	"commands.teleport.success.entity.multiple": "Teletrasportato %s entità presso %s",
	"commands.teleport.success.entity.single": "Teletrasportato %s presso %s",
	"commands.teleport.success.location.multiple": "Teletrasportato %s entità presso %s, %s, %s",
	...
	"commands.test.clear.error.no_tests": "Impossibile trovare un collaudo da cancellare",
	"commands.test.clear.success": "Strutture cancellate: %s",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Clicca per copiare negli appunti",
	"commands.test.create.success": "Creato l'impostazione per il collaudo %s",
	"commands.test.error.no_test_containing_pos": "Impossibile trovare un'istanza di collaudo che contenga %s, %s, %s",
	"commands.test.error.no_test_instances": "Nessun'istanza di collaudo trovata",
	"commands.test.error.non_existant_test": "Collaudo %s non trovato",
	"commands.test.error.structure_not_found": "Struttura di collaudo %s non trovata",
	"commands.test.error.test_instance_not_found": "Impossibile trovare il blocco istanza di collaudo",
	...
	"commands.test.locate.started": "Avviata la localizzazione delle strutture di collaudo. Potrebbe volerci un po' di tempo...",
	"commands.test.no_tests": "Nessun collaudo da eseguire",
	"commands.test.relative_position": "Posizione relativa a %s: %s",
	"commands.test.reset.error.no_tests": "Impossibile trovare un collaudo da ripristinare",
	"commands.test.reset.success": "Strutture ripristinate: %s",
	"commands.test.run.no_tests": "Nessun collaudo trovato",
	"commands.test.run.running": "Esecuzione di %s collaudo/i...",
	"commands.test.summary": "Collaudo di gioco completato! Eseguito %s collaudo/i",
	"commands.test.summary.all_required_passed": "Superato tutti i collaudi necessari :)",
	"commands.test.summary.failed": "Collaudi necessari non riusciti: %s :(",
	"commands.test.summary.optional_failed": "Collaudi facoltativi non riusciti: %s",
	"commands.tick.query.percentiles": "Percentili: P50: %s ms, P95: %s ms, P99: %s ms. Campione: %s",
	"commands.tick.query.rate.running": "Frequenza dei tick indicata: %s al secondo.\nTempo medio per tick: %s ms (indicato: %s ms)",
	"commands.tick.query.rate.sprinting": "Frequenza dei tick indicata: %s al secondo (ignorata, solo per riferimento).\nTempo medio per tick: %s ms",
	"commands.tick.rate.success": "Impostato la frequenza indicata a %s tick al secondo",
	"commands.tick.sprint.report": "Accelerazione completata con %s tick al secondo, o %s ms per tick",
	"commands.tick.sprint.stop.fail": "Nessun'accelerazione di tick in corso",
	"commands.tick.sprint.stop.success": "Accelerazione dei tick interrotta",
	"commands.tick.status.frozen": "Gioco fermo",
	"commands.tick.status.lagging": "Gioco in esecuzione, ma con frequenza dei tick indicata non sostenibile",
	"commands.tick.status.running": "Gioco a velocità normale",
	"commands.tick.status.sprinting": "Gioco accelerato",
	...
	"commands.tick.step.stop.success": "Avanzamento dei tick interrotto",
	...
	"commands.time.pause.already_paused": "Orologio %s già in pausa",
	"commands.time.pause.already_running": "Orologio %s già attivo",
	...
	"commands.time.rate.already_same": "L'orologio %s sta già scorrendo a velocità %s×",
	"commands.time.resume": "Orologio riattivato: %s",
	"commands.time.set": "Impostato il tempo a %s tick",
	"commands.time.set.absolute": "Impostato l'orologio %s a %s tick",
	"commands.time.set.already_at_time": "Orologio %s già impostato a %s tick",
	"commands.time.set.already_at_time_marker": "Orologio %s già impostato al marcatore temporale %s",
	"commands.time.set.time_marker": "Impostato l'orologio %s al marcatore temporale %s",
	"commands.time.wrong_timeline_for_clock": "La sequenza temporale %s non è valida per l'orologio %s",
	"commands.title.cleared.multiple": "Cancellato i titoli per %s giocatori",
	"commands.title.cleared.single": "Cancellato i titoli per %s",
	"commands.title.reset.multiple": "Ripristinato le opzioni dei titoli per %s giocatori",
	"commands.title.reset.single": "Ripristinato le opzioni dei titoli per %s",
	...
	"commands.title.times.multiple": "Cambiato i tempi di visualizzazione dei titoli per %s giocatori",
	"commands.title.times.single": "Cambiato i tempi di visualizzazione dei titoli per %s",
	...
	"commands.trigger.add.success": "Attivato %s (incrementato di %s)",
	...
	"commands.trigger.set.success": "Attivato %s (valore impostato a %s)",
	"commands.trigger.simple.success": "Attivato %s",
	"commands.unpublish.notPublished": "Nessuna partita multigiocatore pubblicata",
	"commands.unpublish.success": "Partita multigiocatore non più pubblicata",
	...
	"commands.waypoint.modify.color": "Impostato il colore del punto di riferimento su %s",
	"commands.waypoint.modify.color.reset": "Ripristinato il colore del punto di riferimento",
	"commands.waypoint.modify.style": "Cambiato lo stile del punto di riferimento",
	"commands.weather.set.clear": "Cambiato il tempo atmosferico in sereno",
	"commands.weather.set.rain": "Cambiato il tempo atmosferico in precipitativo",
	"commands.weather.set.thunder": "Cambiato il tempo atmosferico in temporalesco",
	"commands.whitelist.add.failed": "Giocatore già in lista bianca",
	"commands.whitelist.add.success": "Aggiunto %s alla lista bianca",
	"commands.whitelist.alreadyOff": "Lista bianca già disattivata",
	"commands.whitelist.alreadyOn": "Lista bianca già attiva",
	"commands.whitelist.disabled": "Lista bianca disattivata",
	"commands.whitelist.enabled": "Lista bianca attivata",
	"commands.whitelist.list": "%s giocatore/i nella lista bianca: %s",
	"commands.whitelist.none": "Nessun giocatore nella lista bianca",
	"commands.whitelist.reloaded": "Lista bianca ricaricata",
	"commands.whitelist.remove.failed": "Giocatore non nella lista bianca",
	"commands.whitelist.remove.success": "Rimosso %s dalla lista bianca",
	...
	"commands.worldborder.center.success": "Impostato il centro del confine del mondo in %s, %s",
	"commands.worldborder.damage.amount.failed": "Nessun cambiamento: il confine del mondo infligge già questa quantità di danni",
	"commands.worldborder.damage.amount.success": "Impostato la quantità di danni fuori dal confine del mondo a %s per blocco ogni secondo",
	...
	"commands.worldborder.damage.buffer.success": "Impostato la zona sicura in blocchi fuori dal confine del mondo a %s",
	"commands.worldborder.get": "Larghezza in blocchi attuale del confine del mondo: %s",
	...
	"commands.worldborder.set.grow": "Il confine del mondo si sta espandendo per raggiungere una larghezza in blocchi di %s in %s s",
	"commands.worldborder.set.immediate": "Impostato la larghezza in blocchi del confine del mondo a %s",
	"commands.worldborder.set.shrink": "Restrizione della larghezza in blocchi del confine del mondo a %s in %s secondo/i",
	...
	"commands.worldborder.warning.distance.success": "Impostato la distanza di avvertimento in blocchi del confine del mondo a %s",
	...
	"commands.worldborder.warning.time.success": "Impostato il tempo di avvertimento del confine del mondo a %s secondo/i",
	"compliance.playtime.greaterThan24Hours": "Ore di gioco: 24+",
	"compliance.playtime.hours": "Ore di gioco: %s",
	"compliance.playtime.message": "Giocare troppo interferisce con la vita quotidiana",
	...
	"container.isLocked": "%s non si apre!",
	...
	"dataPack.trade_rebalance.description": "Scambi con villici aggiornati",
	...
	"death.attack.cactus": "Un cactus ha punzecchiato %[1]s a morte",
	"death.attack.cactus.player": "Un cactus ha punzecchiato %[1]s a morte mentre fuggiva da %[2]s",
	"death.attack.cramming": "Un'orda ha schiacciato %[1]s con troppa pressione",
	"death.attack.cramming.player": "Un'orda ha schiacciato %[1]s con troppa pressione a causa di %[2]s",
	"death.attack.dragonBreath": "Il soffio di drago ha arrostito %[1]s",
	"death.attack.dragonBreath.player": "Il soffio di drago ha arrostito %[1]s a causa di %[2]s",
	"death.attack.drown": "L'acqua ha fatto annegare %[1]s",
	"death.attack.drown.player": "L'acqua ha fatto annegare %[1]s mentre fuggiva da %[2]s",
	"death.attack.dryout": "La disidratazione ha stroncato %[1]s",
	"death.attack.dryout.player": "La disidratazione ha stroncato %[1]s mentre fuggiva da %[2]s",
	"death.attack.even_more_magic": "Ancora più magia ha eliminato %[1]s",
	"death.attack.explosion": "Un'esplosione ha fatto saltare in aria %[1]s",
	"death.attack.explosion.player": "%[2]s ha fatto saltare in aria %[1]s",
	"death.attack.explosion.player.item": "%[2]s ha fatto saltare in aria %[1]s con %[3]s",
	"death.attack.fall": "L'impatto ha sfracellato %[1]s",
	"death.attack.fall.player": "L'impatto ha sfracellato %[1]s mentre fuggiva da %[2]s",
	...
	"death.attack.fireball.item": "%[2]s ha preso %[1]s a palle di fuoco con %[3]s",
	"death.attack.fireworks": "Un gran botto ha congedato %[1]s",
	"death.attack.fireworks.item": "Un gran botto ha congedato %[1]s a causa di un razzo pirotecnico sparato con %[3]s da %[2]s",
	"death.attack.fireworks.player": "Un gran botto ha congedato %[1]s mentre lottava con %[2]s",
	"death.attack.flyIntoWall": "%[1]s non ha temuto l'energia cinetica",
	"death.attack.flyIntoWall.player": "%[1]s non ha temuto l'energia cinetica mentre fuggiva da %[2]s",
	"death.attack.freeze": "Il gelo ha assiderato %[1]s",
	"death.attack.freeze.player": "Il gelo ha assiderato %[1]s a causa di %[2]s",
	"death.attack.generic": "La morte ha colto %[1]s",
	"death.attack.generic.player": "La morte ha colto %[1]s a causa di %[2]s",
	"death.attack.genericKill": "Qualcosa ha ucciso %[1]s",
	"death.attack.genericKill.player": "Qualcosa ha ucciso %[1]s mentre lottava con %[2]s",
	"death.attack.hotFloor": "%[1]s ha scoperto che il pavimento era lava",
	"death.attack.hotFloor.player": "%[2]s ha spinto %[1]s in una zona pericolosa",
	"death.attack.inFire": "Le fiamme hanno avvolto %[1]s",
	"death.attack.inFire.player": "Le fiamme hanno avvolto %[1]s mentre lottava con %[2]s",
	"death.attack.inWall": "Un muro ha tolto il respiro a %[1]s",
	"death.attack.inWall.player": "Un muro ha tolto il respiro a %[1]s mentre lottava con %[2]s",
	...
	"death.attack.lava.player": "%[1]s ha provato a nuotare nella lava mentre fuggiva da %[2]s",
	...
	"death.attack.mace_smash": "%[2]s ha fracassato %[1]s",
	"death.attack.mace_smash.item": "%[2]s ha fracassato %[1]s con %[3]s",
	"death.attack.magic": "La magia ha eliminato %[1]s",
	"death.attack.magic.player": "La magia ha eliminato %[1]s mentre fuggiva da %[2]s",
	...
	"death.attack.mob.item": "%[2]s ha ucciso %[1]s con %[3]s",
	"death.attack.onFire": "Il fuoco ha ridotto in cenere %[1]s",
	"death.attack.onFire.item": "Il fuoco ha ridotto in cenere %[1]s mentre lottava con %[2]s che impugnava %[3]s",
	"death.attack.onFire.player": "Il fuoco ha ridotto in cenere %[1]s mentre lottava con %[2]s",
	"death.attack.outOfWorld": "Il vuoto ha inghiottito %[1]s",
	...
	"death.attack.outsideBorder.player": "%[1]s ha oltrepassato i confini del mondo mentre lottava con %[2]s",
	"death.attack.player": "%[2]s ha ucciso %[1]s",
	"death.attack.player.item": "%[2]s ha ucciso %[1]s con %[3]s",
	"death.attack.sonic_boom": "Un urlo caricato sonicamente ha obliterato %[1]s",
	"death.attack.sonic_boom.item": "Un urlo caricato sonicamente ha obliterato %[1]s mentre fuggiva da %[2]s che impugnava %[3]s",
	"death.attack.sonic_boom.player": "Un urlo caricato sonicamente ha obliterato %[1]s mentre fuggiva da %[2]s",
	"death.attack.spear": "%[2]s ha infilzato %[1]s",
	"death.attack.spear.item": "%[2]s ha infilzato %[1]s con %[3]s",
	...
	"death.attack.starve": "La fame ha divorato %[1]s",
	"death.attack.starve.player": "La fame ha divorato %[1]s mentre lottava con %[2]s",
	"death.attack.sting": "Un'ape ha punto a morte %[1]s",
	"death.attack.sting.item": "%[2]s ha punto a morte %[1]s con %[3]s",
	"death.attack.sting.player": "%[2]s ha punto a morte %[1]s",
	"death.attack.sulfurCubeHot": "%[1]s ha scoperto che qualcos'altro oltre al pavimento era lava",
	"death.attack.sulfurCubeHot.item": "%[2]s ha mostrato a %[1]s che qualcos'altro oltre al pavimento era lava con %[3]s",
	"death.attack.sulfurCubeHot.player": "%[2]s ha mostrato a %[1]s che qualcos'altro oltre al pavimento era lava",
	"death.attack.sweetBerryBush": "Un cespuglio di bacche dolci ha punzecchiato a morte %[1]s",
	"death.attack.sweetBerryBush.player": "Un cespuglio di bacche dolci ha punzecchiato a morte %[1]s mentre fuggiva da %[2]s",
	"death.attack.thorns": "Il contrappasso ha punito %[1]s mentre colpiva %[2]s",
	"death.attack.thorns.item": "%[3]s ha punito %[1]s mentre colpiva %[2]s",
	...
	"death.attack.trident.item": "%[2]s ha impalato %[1]s con %[3]s",
	"death.attack.wither": "L'avvizzimento ha consumato %[1]s",
	"death.attack.wither.player": "L'avvizzimento ha consumato %[1]s mentre lottava con %[2]s",
	"death.attack.witherSkull": "Un teschio di %[2]s ha colpito %[1]s",
	"death.attack.witherSkull.item": "Un teschio di %[2]s ha colpito %[1]s con %[3]s",
	"death.fell.accident.generic": "%[1]s ha sfidato la gravità e ha perso",
	"death.fell.accident.ladder": "Una scala ha tradito la presa di %[1]s",
	"death.fell.accident.other_climbable": "%[1]s ha perso l'equilibrio mentre si arrampicava",
	"death.fell.accident.scaffolding": "La precarietà di un'impalcatura ha liquidato %[1]s",
	"death.fell.accident.twisting_vines": "I viticci dei rampicanti attorcigliati ha respinto %[1]s",
	"death.fell.accident.vines": "I rampicanti hanno negato l'appiglio a %[1]s",
	"death.fell.accident.weeping_vines": "L'abbraccio dei rampicanti piangenti ha respinto %[1]s",
	"death.fell.assist": "%[2]s ha fatto cadere %[1]s",
	"death.fell.assist.item": "%[2]s ha fatto cadere %[1]s con %[3]s",
	"death.fell.finish": "%[2]s ha interrotto la rovinosa caduta di %[1]s",
	"death.fell.finish.item": "%[2]s ha interrotto la rovinosa caduta di %[1]s con %[3]s",
	"death.fell.killer": "Il destino ha fatto cadere %[1]s",
	...
	"debug.crash.message.rebindable": "Stai tenendo premuti %s + %s. Se non li rilasci, il gioco verrà arrestato.",
	"debug.crash.warning": "Arresto del gioco tra %s...",
	"debug.creative_spectator.error": "Non hai l'autorizzazione a cambiare modalità di gioco",
	...
	"debug.entry.currently.inOverlay": "%s (attualmente visibile nel cruscotto)",
	"debug.entry.currently.never": "%s (attualmente nascosta)",
	"debug.entry.f3": "Con F3",
	"debug.entry.overlay": "Cruscotto",
	"debug.gamemodes.error": "Non hai l'autorizzazione a cambiare modalità di gioco",
	...
	"debug.improvedTransparency.off": "Trasparenza migliorata disattivata",
	"debug.improvedTransparency.on": "Trasparenza migliorata attivata",
	...
	"debug.options.category.renderer": "Visualizzazioni diagnostiche",
	"debug.options.category.text": "Informazioni diagnostiche",
	"debug.options.help": "F3 + F6 = Modifica le opzioni diagnostiche",
	"debug.options.notAllowed.tooltip": "Non visibile quando le informazioni diagnostiche sono ridotte.",
	...
	"debug.options.title": "Opzioni diagnostiche",
	"debug.options.warning": "Queste opzioni sono disponibili a scopo di collaudo. Potrebbero rallentare il tuo computer, far arrestare il gioco o rubarti la merenda appena ti distrai.",
	...
	"demo.day.1": "Questo mondo di prova durerà cinque giorni di gioco. Fa' del tuo meglio!",
	"demo.day.2": "Secondo giorno",
	"demo.day.3": "Terzo giorno",
	"demo.day.4": "Quarto giorno",
	"demo.day.5": "Ultimo giorno!",
	"demo.day.6": "Hai superato il quinto giorno. Premi %s per salvare una schermata delle tue creazioni.",
	...
	"demo.help.fullWrapped": "Questo mondo di prova durerà cinque giorni di gioco (circa 1 ora e 40 minuti di tempo reale). Da' un'occhiata ai progressi per avere dei suggerimenti! Buon divertimento!",
	...
	"difficulty.lock.question": "Vuoi davvero bloccare la difficoltà del mondo? Verrà bloccata per sempre su «%[1]s» e non potrai mai più cambiarla.",
	"difficulty.lock.title": "Blocco della difficoltà del mondo",
	"disconnect.endOfStream": "Fine del flusso dati",
	"disconnect.exceeded_packet_rate": "Espulsione per superamento del limite di pacchetti",
	...
	"disconnect.loginFailedInfo.userBanned": "Gioco in rete proibito",
	"disconnect.lost": "Connessione persa",
	"disconnect.packetError": "Errore del protocollo di rete",
	"disconnect.spam": "Espulsione per azioni ripetute",
	...
	"editGamerule.inGame.disabled.hardcore.tooltip": "Le regole di gioco sono bloccate nei mondi in modalità estrema.",
	...
	"entity.minecraft.cushion": "Cuscino",
	...
	"entity.minecraft.poplar_boat": "Barca di pioppo",
	"entity.minecraft.poplar_chest_boat": "Barca di pioppo con baule",
	...
	"filled_map.bamboo_camp_map": "Mappa per giungla di bambù",
	"filled_map.bamboo_jungle_abandoned_camp": "Mappa per giungla di bambù",
	"filled_map.birch_forest_abandoned_camp": "Mappa per foresta di betulle",
	"filled_map.birch_forest_camp_map": "Mappa per foresta di betulle",
	"filled_map.buried_treasure": "Mappa del tesoro",
	"filled_map.cherry_grove_abandoned_camp": "Mappa per boschetto di ciliegi",
	"filled_map.cherry_grove_camp_map": "Mappa per boschetto di ciliegi",
	"filled_map.dappled_forest_abandoned_camp": "Mappa per foresta ambrata",
	"filled_map.dappled_forest_camp_map": "Mappa per foresta ambrata",
	"filled_map.explorer_jungle": "Mappa per piramide della giungla",
	"filled_map.explorer_swamp": "Mappa per capanna della palude",
	"filled_map.flower_forest_abandoned_camp": "Mappa per foresta floreale",
	"filled_map.flower_forest_camp_map": "Mappa per foresta floreale",
	"filled_map.id": "ID: %s",
	"filled_map.jungle_temple": "Mappa per piramide della giungla",
	"filled_map.level": "(Livello %s/%s)",
	"filled_map.locked": "Bloccata",
	"filled_map.mansion": "Mappa per magione della foresta",
	"filled_map.monument": "Mappa per monumento oceanico",
	"filled_map.pale_garden_abandoned_camp": "Mappa per giardino pallido",
	"filled_map.pale_garden_camp_map": "Mappa per giardino pallido",
	"filled_map.scale": "Scala 1:%s",
	"filled_map.swamp_abandoned_camp": "Mappa per palude",
	"filled_map.swamp_camp_map": "Mappa per palude",
	"filled_map.trial_chambers": "Mappa per camera della sfida",
	"filled_map.unknown": "Mappa sconosciuta",
	"filled_map.village_desert": "Mappa per villaggio del deserto",
	"filled_map.village_plains": "Mappa per villaggio della pianura",
	"filled_map.village_savanna": "Mappa per villaggio della savana",
	"filled_map.village_snowy": "Mappa per villaggio innevato",
	"filled_map.village_taiga": "Mappa per villaggio della taiga",
	"filled_map.windswept_forest_abandoned_camp": "Mappa per foresta ventosa",
	"filled_map.windswept_forest_camp_map": "Mappa per foresta ventosa",
	...
	"gameMode.changed": "Cambiato la tua modalità di gioco in %s",
	...
	"gamerule.doLimitedCrafting.description": "Se attivata, i giocatori possono fabbricare oggetti solo seguendo le ricette sbloccate.",
	...
	"gamerule.forgiveDeadPlayers.description": "Le creature neutrali che sono state provocate smettono di essere arrabbiate quando il giocatore puntato muore nelle vicinanze.",
	...
	"gamerule.reducedDebugInfo": "Informazioni diagnostiche ridotte",
	"gamerule.reducedDebugInfo.description": "Limita il contenuto del cruscotto diagnostico.",
	...
	"generator.minecraft.debug_all_block_states": "Diagnostico",
	"generator.minecraft.flat": "Piatto",
	"generator.minecraft.flat_all_dimensions": "Dimensioni piatte",
	...
	"gui.banned.description.permanent": "Il tuo account è permanentemente bannato, quindi non puoi giocare in rete o entrare nei Realm.",
	"gui.banned.description.reason": "Abbiamo ricevuto una segnalazione per comportamento scorretto da parte del tuo account. I nostri moderatori hanno revisionato il tuo caso e l'hanno identificato come %s, che viola le norme della collettività di Minecraft.",
	...
	"gui.banned.description.unknownreason": "Abbiamo ricevuto una segnalazione per comportamento scorretto da parte del tuo account. I nostri moderatori hanno revisionato il tuo caso e hanno stabilito che viola le norme della collettività di Minecraft.",
	"gui.banned.name.description": "Il tuo nome attuale («%s») viola le norme della collettività. Puoi giocare in giocatore singolo, ma devi cambiare il nome per giocare in rete.\n\nScopri di più o richiedi una revisione del caso al collegamento seguente: %s",
	...
	"gui.banned.reason.generic_violation": "Violazione delle norme della collettività",
	...
	"gui.banned.reason.spam_or_advertising": "Pubblicità indesiderata",
	"gui.banned.skin.description": "La tua skin attuale viola le norme della collettività. Puoi continuare a giocare con una skin predefinita oppure sceglierne una nuova.\n\nScopri di più o richiedi una revisione del caso al collegamento seguente: %s",
	...
	"gui.friends.error.generic": "Qualcosa non va... con questa funzionalità, mica coi tuoi amici!\n\nRiprova più tardi",
	...
	"gui.friends.error.unauthorized": "Gettone d'autenticazione non valido. Riavvia il gioco e il launcher prima di riprovare",
	...
	"gui.friends.presence.status.playing_hosted_server": "In linea (rete locale)",
	...
	"gui.friends.validation.already_friend": "%s è già nella tua lista amici",
	"gui.friends.validation.already_incoming": "%s ti ha già inviato una richiesta d'amicizia",
	"gui.friends.validation.already_outgoing": "Hai già inviato una richiesta d'amicizia a %s",
	"gui.friends.validation.cannot_add_self": "Non puoi inviarti una richiesta d'amicizia",
	...
	"gui.togglable_slot": "Clicca per disattivare la casella",
	"gui.up": "Su",
	...
	"item.minecraft.abandoned_camp_map": "Mappa per accampamento",
	"item.minecraft.abandoned_campsite_map": "Mappa per accampamento",
	...
	"item.minecraft.ancient_city_map": "Mappa per città antica",
	...
	"item.minecraft.black_cushion": "Cuscino nero",
	...
	"item.minecraft.blue_cushion": "Cuscino blu",
	...
	"item.minecraft.bone_meal": "Farina d'ossa",
	...
	"item.minecraft.brown_cushion": "Cuscino marrone",
	...
	"item.minecraft.buried_ancient_city_map": "Mappa per città antica",
	"item.minecraft.buried_mineshaft_map": "Mappa per miniera",
	"item.minecraft.buried_treasure_map": "Mappa del tesoro",
	"item.minecraft.buried_trial_chambers_map": "Mappa per camera della sfida",
	...
	"item.minecraft.chorus_fruit": "Coro",
	...
	"item.minecraft.cyan_cushion": "Cuscino ciano",
	...
	"item.minecraft.debug_stick": "Bastone di collaudo",
	"item.minecraft.debug_stick.empty": "%s non ha proprietà",
	"item.minecraft.debug_stick.select": "%s = %s",
	"item.minecraft.debug_stick.update": "%s → %s",
	"item.minecraft.desert_pyramid_map": "Mappa per piramide del deserto",
	"item.minecraft.desert_village_map": "Mappa per villaggio del deserto",
	...
	"item.minecraft.firework_rocket.flight_duration": "Durata del volo: %s",
	...
	"item.minecraft.gray_cushion": "Cuscino grigio",
	...
	"item.minecraft.green_cushion": "Cuscino verde",
	...
	"item.minecraft.jungle_explorer_map": "Mappa per piramide della giungla",
	"item.minecraft.jungle_pyramid_map": "Mappa per piramide della giungla",
	...
	"item.minecraft.light_blue_cushion": "Cuscino azzurro",
	...
	"item.minecraft.light_gray_cushion": "Cuscino grigio chiaro",
	...
	"item.minecraft.lime_cushion": "Cuscino lime",
	...
	"item.minecraft.magenta_cushion": "Cuscino magenta",
	...
	"item.minecraft.mineshaft_map": "Mappa per miniera",
	...
	"item.minecraft.ocean_explorer_map": "Mappa per monumento oceanico",
	"item.minecraft.ocean_monument_map": "Mappa per monumento oceanico",
	...
	"item.minecraft.orange_cushion": "Cuscino arancione",
	...
	"item.minecraft.pink_cushion": "Cuscino rosa",
	...
	"item.minecraft.plains_village_map": "Mappa per villaggio della pianura",
	...
	"item.minecraft.poplar_boat": "Barca di pioppo",
	"item.minecraft.poplar_chest_boat": "Barca di pioppo con baule",
	"item.minecraft.popped_chorus_fruit": "Coro scoppiato",
	...
	"item.minecraft.purple_cushion": "Cuscino viola",
	...
	"item.minecraft.red_cushion": "Cuscino rosso",
	...
	"item.minecraft.savanna_village_map": "Mappa per villaggio della savana",
	...
	"item.minecraft.snowy_village_map": "Mappa per villaggio innevato",
	...
	"item.minecraft.straw_bed": "Pagliericcio",
	...
	"item.minecraft.swamp_explorer_map": "Mappa per capanna della palude",
	"item.minecraft.swamp_hut_map": "Mappa per capanna della palude",
	...
	"item.minecraft.taiga_village_map": "Mappa per villaggio della taiga",
	...
	"item.minecraft.trial_explorer_map": "Mappa per camera della sfida",
	...
	"item.minecraft.warm_ocean_ruins_map": "Mappa per rovine oceaniche calde",
	...
	"item.minecraft.white_cushion": "Cuscino bianco",
	...
	"item.minecraft.woodland_explorer_map": "Mappa per magione della foresta",
	"item.minecraft.woodland_mansion_map": "Mappa per magione della foresta",
	...
	"item.minecraft.yellow_cushion": "Cuscino giallo",
	...
	"item.nbt_tags": "NBT: %s marcatore/i",
	...
	"jigsaw_block.keep_jigsaws": "Mantenimento",
	"jigsaw_block.levels": "Livelli: %s",
	"jigsaw_block.name": "Nome",
	"jigsaw_block.placement_priority": " ",
	"jigsaw_block.placement_priority.tooltip": "Quando questo blocco incastri si connette a un pezzo, questo sarà l'ordine in cui il pezzo viene elaborato per le connessioni nella struttura complessiva.\n\nI pezzi verranno elaborati in ordine di priorità decrescente o, in caso di parità, seguendo l'ordine d'inserimento.",
	"jigsaw_block.pool": "Insieme di destinazione",
	"jigsaw_block.selection_priority": "Priorità di selezione e di piazzamento",
	"jigsaw_block.selection_priority.tooltip": "Quando il pezzo associato viene elaborato per le connessioni, questo sarà l'ordine in cui questo blocco incastri tenterà di connettersi al suo pezzo di destinazione.\n\nI pezzi verranno elaborati in ordine di priorità decrescente o, in caso di parità, casualmente.",
	...
	"key.category.minecraft.debug": "Diagnostica",
	...
	"key.debug.debugOptions": "Opzioni diagnostiche",
	...
	"key.debug.improvedTransparency": "Attiva la trasparenza migliorata",
	"key.debug.lightmapTexture": "Mappa d'illuminazione",
	"key.debug.modifier": "Tasto modificatore diagnostico",
	...
	"key.jump": "Salta",
	"key.keyboard.ac.back": "Indietro CA",
	"key.keyboard.ac.bookmarks": "Preferiti CA",
	"key.keyboard.ac.close": "Chiudi CA",
	"key.keyboard.ac.exit": "Esci CA",
	"key.keyboard.ac.forward": "Avanti CA",
	"key.keyboard.ac.home": "Inizio CA",
	"key.keyboard.ac.new": "Nuovo CA",
	"key.keyboard.ac.open": "Apri CA",
	"key.keyboard.ac.print": "Stampa CA",
	"key.keyboard.ac.properties": "Proprietà CA",
	"key.keyboard.ac.refresh": "Aggiorna CA",
	"key.keyboard.ac.save": "Salva CA",
	"key.keyboard.ac.search": "Cerca CA",
	"key.keyboard.ac.stop": "Arresta CA",
	"key.keyboard.again": "Ripeti",
	"key.keyboard.alternate.erase": "Cancella alt",
	"key.keyboard.apostrophe": "'",
	"key.keyboard.application": "Applicazione",
	"key.keyboard.backslash": "\\",
	"key.keyboard.backspace": "Indietro",
	"key.keyboard.call": "Chiama",
	"key.keyboard.cancel": "Annulla",
	"key.keyboard.caps.lock": "Bloc maiusc",
	"key.keyboard.channel.down": "Canale -",
	"key.keyboard.channel.up": "Canale +",
	"key.keyboard.clear": "Azzera",
	"key.keyboard.clear.again": "Riazzera",
	"key.keyboard.comma": ",",
	"key.keyboard.copy": "Copia",
	"key.keyboard.crsel": "Sel curs",
	"key.keyboard.currency.subunit": "Cent valuta",
	"key.keyboard.currency.unit": "Unità valuta",
	"key.keyboard.cut": "Taglia",
	"key.keyboard.decimal.separator": "Sep decimale",
	"key.keyboard.delete": "Canc",
	"key.keyboard.down": "↓",
	"key.keyboard.end": "Fine",
	"key.keyboard.end.call": "Termina",
	"key.keyboard.enter": "Invio",
	"key.keyboard.enter2": "Invio 2",
	"key.keyboard.equal": "=",
	"key.keyboard.escape": "Esc",
	"key.keyboard.execute": "Esegui",
	"key.keyboard.exsel": "Est sel",
	"key.keyboard.f1": "F1",
	...
	"key.keyboard.f8": "F8",
	"key.keyboard.f9": "F9",
	"key.keyboard.find": "Trova",
	"key.keyboard.grave.accent": "`",
	"key.keyboard.help": "Aiuto",
	"key.keyboard.home": "Inizio",
	"key.keyboard.insert": "Ins",
	"key.keyboard.international1": "Internaz 1",
	"key.keyboard.international2": "Internaz 2",
	"key.keyboard.international3": "Internaz 3",
	"key.keyboard.international4": "Internaz 4",
	"key.keyboard.international5": "Internaz 5",
	"key.keyboard.international6": "Internaz 6",
	"key.keyboard.international7": "Internaz 7",
	"key.keyboard.international8": "Internaz 8",
	"key.keyboard.international9": "Internaz 9",
	"key.keyboard.keypad.0": "0 Tn",
	"key.keyboard.keypad.00": "00 Tn",
	"key.keyboard.keypad.000": "000 Tn",
	...
	"key.keyboard.keypad.a": "A Tn",
	"key.keyboard.keypad.add": "+ Tn",
	"key.keyboard.keypad.ampersand": "& Tn",
	"key.keyboard.keypad.at": "@ Tn",
	"key.keyboard.keypad.b": "B Tn",
	"key.keyboard.keypad.backspace": "Indietro Tn",
	"key.keyboard.keypad.binary": "Binario Tn",
	"key.keyboard.keypad.c": "C Tn",
	"key.keyboard.keypad.clear": "Azzera Tn",
	"key.keyboard.keypad.clear.entry": "Azz immiss Tn",
	"key.keyboard.keypad.colon": ": Tn",
	"key.keyboard.keypad.comma": ", Tn",
	"key.keyboard.keypad.d": "D Tn",
	"key.keyboard.keypad.decimal": "Decimale Tn",
	"key.keyboard.keypad.divide": "/ Tn",
	"key.keyboard.keypad.double.ampersand": "&& Tn",
	"key.keyboard.keypad.double.vertical.bar": "|| Tn",
	"key.keyboard.keypad.e": "E Tn",
	"key.keyboard.keypad.enter": "Invio Tn",
	"key.keyboard.keypad.equal": "= Tn",
	"key.keyboard.keypad.equals.as400": "= Tn AS/400",
	"key.keyboard.keypad.exclamation": "! Tn",
	"key.keyboard.keypad.f": "F Tn",
	"key.keyboard.keypad.greater": "> Tn",
	"key.keyboard.keypad.hash": "# Tn",
	"key.keyboard.keypad.hexadecimal": "Esadec Tn",
	"key.keyboard.keypad.left.brace": "{ Tn",
	"key.keyboard.keypad.left.parenthesis": "( Tn",
	"key.keyboard.keypad.less": "< Tn",
	"key.keyboard.keypad.memory.add": "M+ Tn",
	"key.keyboard.keypad.memory.clear": "MC Tn",
	"key.keyboard.keypad.memory.divide": "M/ Tn",
	"key.keyboard.keypad.memory.multiply": "M* Tn",
	"key.keyboard.keypad.memory.recall": "MR Tn",
	"key.keyboard.keypad.memory.store": "MS Tn",
	"key.keyboard.keypad.memory.subtract": "M- Tn",
	"key.keyboard.keypad.multiply": "* Tn",
	"key.keyboard.keypad.octal": "Ottale Tn",
	"key.keyboard.keypad.percent": "%% Tn",
	"key.keyboard.keypad.period": ". Tn",
	"key.keyboard.keypad.plus.minus": "± Tn",
	"key.keyboard.keypad.power": "^ Tn",
	"key.keyboard.keypad.right.brace": "} Tn",
	"key.keyboard.keypad.right.parenthesis": ") Tn",
	"key.keyboard.keypad.space": "Spazio Tn",
	"key.keyboard.keypad.subtract": "- Tn",
	"key.keyboard.keypad.tab": "Tab Tn",
	"key.keyboard.keypad.vertical.bar": "| Tn",
	"key.keyboard.keypad.xor": "⊻ Tn",
	"key.keyboard.lang1": "Lingua 1",
	"key.keyboard.lang2": "Lingua 2",
	"key.keyboard.lang3": "Lingua 3",
	"key.keyboard.lang4": "Lingua 4",
	"key.keyboard.lang5": "Lingua 5",
	"key.keyboard.lang6": "Lingua 6",
	"key.keyboard.lang7": "Lingua 7",
	"key.keyboard.lang8": "Lingua 8",
	"key.keyboard.lang9": "Lingua 9",
	"key.keyboard.left": "←",
	"key.keyboard.left.alt": "Alt",
	"key.keyboard.left.bracket": "[",
	"key.keyboard.left.command": "Cmd sinistro",
	"key.keyboard.left.control": "Ctrl sinistro",
	"key.keyboard.left.meta": "Meta sinistro",
	"key.keyboard.left.option": "Opz sinistro",
	"key.keyboard.left.shift": "Maiusc sin.",
	"key.keyboard.left.win": "Meta sinistro",
	"key.keyboard.left.windows": "Win sinistro",
	...
	"key.keyboard.minus": "-",
	"key.keyboard.mode": "Modalità",
	"key.keyboard.mute": "Muto",
	"key.keyboard.new": "Nuovo",
	"key.keyboard.num.lock": "Bloc num",
	"key.keyboard.oper": "Oper",
	"key.keyboard.out": "Uscita",
	"key.keyboard.page.down": "Pag ↓",
	"key.keyboard.page.up": "Pag ↑",
	"key.keyboard.paste": "Incolla",
	"key.keyboard.pause": "Pausa",
	"key.keyboard.period": ".",
	"key.keyboard.power": "Accensione",
	"key.keyboard.print.screen": "Stamp",
	"key.keyboard.prior": "Precedente",
	"key.keyboard.right": "→",
	"key.keyboard.right.alt": "Alt gr",
	"key.keyboard.right.bracket": "]",
	"key.keyboard.right.command": "Cmd destro",
	"key.keyboard.right.control": "Ctrl destro",
	"key.keyboard.right.meta": "Meta destro",
	"key.keyboard.right.option": "Opz destro",
	"key.keyboard.right.shift": "Maiusc destro",
	"key.keyboard.right.win": "Meta destro",
	"key.keyboard.right.windows": "Win destro",
	"key.keyboard.save": "Salva",
	"key.keyboard.scroll.lock": "Bloc scorr",
	"key.keyboard.select": "Seleziona",
	"key.keyboard.semicolon": ";",
	"key.keyboard.separator": "Sep",
	"key.keyboard.slash": "/",
	"key.keyboard.sleep": "Sospensione",
	"key.keyboard.soft.left": "Prog sinistro",
	"key.keyboard.soft.right": "Prog destro",
	"key.keyboard.space": "Spazio",
	"key.keyboard.stop": "Arresta",
	"key.keyboard.sys.req": "R sist",
	"key.keyboard.tab": "Tab",
	"key.keyboard.thousands.separator": "Sep migliaia",
	"key.keyboard.undo": "Annulla",
	"key.keyboard.unknown": "Nessuno",
	"key.keyboard.up": "↑",
	"key.keyboard.volume.down": "Volume -",
	"key.keyboard.volume.up": "Volume +",
	"key.keyboard.wake": "Riattiva",
	...
	"key.screenshot": "Scatta una schermata",
	...
	"known_server_link.community": "Collettività",
	"known_server_link.community_guidelines": "Linee guida della collettività",
	...
	"known_server_link.support": "Assistenza",
	...
	"lanServer.start": "Apri il mondo in rete locale",
	"lanServer.title": "Avvia la partita in rete locale",
	...
	"manageServer.resourcePack": "Risorse del server",
	...
	"mco.activity.noactivity": "Nessun'attività da %s giorno/i",
	...
	"mco.backup.entry.worldType": "Tipo",
	...
	"mco.brokenworld.nonowner.title": "Mondo non aggiornato",
	...
	"mco.client.incompatible.msg.line2": "Devi usare la versione di Minecraft più recente.",
	...
	"mco.configure.world.buttons.invite_codes": "Codici d'invito",
	...
	"mco.configure.world.close.question.line1": "Puoi chiudere temporaneamente il tuo Realm, impedendo l'accesso al gioco mentre apporti delle modifiche. Riaprilo quando desideri. \n\nIl tuo abbonamento a Realms non verrà disdetto.",
	...
	"mco.configure.world.invite_codes.copy": "Copia",
	"mco.configure.world.invite_codes.create": "Crea un codice d'invito",
	"mco.configure.world.invite_codes.delete": "Elimina",
	"mco.configure.world.invite_codes.edit": "Modifica",
	"mco.configure.world.invite_codes.edit.active": "Attivo",
	"mco.configure.world.invite_codes.edit.expiration_date": "Scadenza",
	"mco.configure.world.invite_codes.edit.expires": "Scadenza: %s",
	"mco.configure.world.invite_codes.edit.title": "Modifica il codice d'invito",
	"mco.configure.world.invite_codes.expiration.12_hours": "12 ore",
	"mco.configure.world.invite_codes.expiration.1_day": "1 giorno",
	"mco.configure.world.invite_codes.expiration.1_hour": "1 ora",
	"mco.configure.world.invite_codes.expiration.30_minutes": "30 minuti",
	"mco.configure.world.invite_codes.expiration.6_hours": "6 ore",
	"mco.configure.world.invite_codes.expiration.7_days": "7 giorni",
	"mco.configure.world.invite_codes.expiration.never": "No",
	"mco.configure.world.invite_codes.loading": "Caricamento dei codici d'invito...",
	"mco.configure.world.invite_codes.subtitle": "Puoi creare e condividere fino a %s codici d'invito per far entrare i giocatori nel tuo Realm",
	"mco.configure.world.invite_codes.title": "Codici d'invito (%s/%s)",
	...
	"mco.configure.world.players.invite.duplicate": "Giocatore con questo nome già invitato al Realm",
	...
	"mco.configure.world.region_preference": "Regione preferenziale",
	"mco.configure.world.region_preference.title": "Seleziona la regione preferenziale",
	"mco.configure.world.renderDistance": "Limite di visibilità",
	"mco.configure.world.renderDistance.tooltip": "La distanza massima visibile dai membri del Realm. Valori maggiori possono influire sulle prestazioni.",
	...
	"mco.configure.world.simulationDistance": "Limite di simulazione",
	"mco.configure.world.simulationDistance.tooltip": "Il raggio intorno ai giocatori entro cui il gioco carica e applica i cambiamenti.",
	...
	"mco.errorMessage.6003": "Limite di download raggiunto",
	...
	"mco.errorMessage.noDetails": "Nessun dettaglio sull'errore",
	...
	"mco.pdp.friends.description": "Fino a dieci amici alla volta possono giocare gratuitamente nel tuo Realm in qualsiasi momento, anche quando non sei disponibile!",
	"mco.pdp.friends.title": "Gioca al meglio con gli amici",
	"mco.pdp.minigames.description": "Esplora una variegata raccolta di minigiochi, avventure e contenuti esclusivi tutti da scoprire.",
	"mco.pdp.minigames.title": "Minigiochi gratuiti dei creatori",
	"mco.pdp.private.backups": "• Backup automatici",
	"mco.pdp.private.easyToManage": "• Facilissimo da configurare",
	"mco.pdp.private.secure": "• Privato e sicuro",
	"mco.pdp.private.title": "Un server personale",
	"mco.pdp.private.worldSlots": "• Fino a tre mondi salvati",
	"mco.pdp.trial.description": "Prova gratuita di 30 giorni!",
	"mco.pdp.trial.title": "Il tuo server sempre disponibile",
	"mco.pdp.tryForFree": "Provalo gratuitamente",
	...
	"mco.selectServer.freeTrial": "Prova gratuita",
	"mco.selectServer.joinCode": "Codice d'invito",
	"mco.selectServer.joinCode.hint": "Inserisci il codice d'invito",
	"mco.selectServer.joinCode.invalid": "Il codice inserito non è valido.",
	"mco.selectServer.joinCode.title": "Entra con un codice d'invito",
	"mco.selectServer.joinCode.validating": "Convalida del codice...",
	"mco.selectServer.joinRealm": "Entra",
	...
	"mco.upload.select.world.none": "Mondi in giocatore singolo non trovati!",
	...
	"mco.upload.size.failure.line2": "Occupa %s. Dimensione massima consentita: %s",
	...
	"menu.multiplayerOptions.button": "Rete locale...",
	"menu.multiplayerOptions.lan": "Partita in rete locale",
	"menu.multiplayerOptions.network": "Multigiocatore",
	"menu.multiplayerOptions.network.header": "Rete",
	"menu.multiplayerOptions.network.lan": "Rete locale",
	"menu.multiplayerOptions.network.lan.tooltip": "I giocatori sulla tua stessa rete possono entrare nel mondo.",
	...
	"menu.multiplayerOptions.otherPlayers.header": "Impostazioni per gli altri giocatori",
	"menu.multiplayerOptions.publish.started.lan": "Mondo aperto in rete locale con numero di porta %s",
	"menu.multiplayerOptions.publish.started.online": "Mondo aperto al multigiocatore in rete",
	"menu.multiplayerOptions.publish.stopped": "Mondo non più aperto al multigiocatore",
	"menu.multiplayerOptions.title": "Opzioni della partita in rete locale",
	...
	"mount.sit": "Premi %[1]s per alzarti",
	...
	"multiplayer.confirm_command.permissions_required": "Stai cercando di eseguire un comando che richiede autorizzazioni elevate.\nCiò potrebbe influire negativamente sulla tua esperienza di gioco.\nVuoi davvero continuare?\nComando: %s",
	...
	"multiplayer.disconnect.banned": "Un operatore ti ha bannato dal server",
	"multiplayer.disconnect.banned.expiration": "\nRimozione del ban: %s",
	"multiplayer.disconnect.banned.reason": "Un operatore ti ha bannato dal server\n\nMotivo: %s",
	"multiplayer.disconnect.banned.reason.default": "Ban da un operatore",
	"multiplayer.disconnect.banned_ip.expiration": "\nRimozione del ban: %s",
	"multiplayer.disconnect.banned_ip.reason": "Un operatore ha bannato il tuo IP da questo server\n\nMotivo: %s",
	...
	"multiplayer.disconnect.flying": "Il volo non è consentito in questo server",
	"multiplayer.disconnect.generic": "Connessione interrotta",
	...
	"multiplayer.disconnect.ip_banned": "Un operatore ha bannato il tuo IP da questo server",
	"multiplayer.disconnect.kicked": "Espulsione da un operatore",
	"multiplayer.disconnect.missing_tags": "Ricevuta dal server una serie di dati non completa.\nContatta un operatore del server.",
	"multiplayer.disconnect.name_taken": "Il tuo nome è già in uso",
	"multiplayer.disconnect.not_whitelisted": "Non sei nella lista bianca di questo server!",
	"multiplayer.disconnect.out_of_order_chat": "Ricevuto un pacchetto chat non funzionante. L'orario del tuo computer è stato modificato?",
	...
	"multiplayer.player.joined": "%s è ora nella partita",
	"multiplayer.player.joined.renamed": "%s (in precedenza %s) è ora nella partita",
	...
	"multiplayer.status.ping.narration": "Latenza di %s millisecondi",
	"multiplayer.status.pinging": "Verifica della latenza...",
	...
	"narrator.controls.bound": "L'azione %s è assegnata a %s",
	"narrator.controls.reset": "Ripristina il tasto per l'azione %s",
	"narrator.controls.unbound": "L'azione %s non è assegnata",
	...
	"options.chunkFade.tooltip": "Durata in secondi dell'eventuale dissolvenza dei chunk alla prima elaborazione.",
	...
	"options.ctrlClickEmulatesRightClick": "Tasto destro emulato",
	"options.ctrlClickEmulatesRightClick.tooltip": "Tasto destro verrà emulato dalla combinazione Ctrl + Tasto sinistro (solo su macOS) attivando quest'opzione.",
	...
	"options.debugGuiScale.tooltip": "Imposta una scala dell'interfaccia per il cruscotto di debug diversa da quella del resto del gioco",
	"options.debugGuiScale.unchanged": "Inalterata",
	...
	"options.directionalAudio.on.tooltip": "Usa l'audio direzionale basato su funzioni di trasferimento correlate alla testa (FTCT, in inglese HRTF) per migliorare la simulazione del suono tridimensionale. Richiede una periferica audio compatibile ed è consigliabile usare le cuffie.",
	...
	"options.exclusiveFullscreen.off.tooltip": "Tutti i metodi d'ingresso dovrebbero funzionare in questa modalità a schermo intero, ma il sincronismo adattivo (Nvidia G-Sync, AMD FreeSync) non funzionerà.",
	"options.exclusiveFullscreen.on.tooltip": "Questa modalità a schermo intero potrebbe impedire il funzionamento di alcuni metodi d'ingresso, ma il sincronismo adattivo (Nvidia G-Sync, AMD FreeSync) dovrebbe funzionare.",
	...
	"options.fullscreen.exclusive.mode": "Schermo intero esclusivo",
	"options.fullscreen.exclusive.mode.tooltip": "Questa impostazione ha effetto solo quando lo schermo intero esclusivo è attivo.",
	...
	"options.graphics.fabulous.tooltip": "La grafica «%s» fa uso di algoritmi di ombreggiatura per disegnare tempo atmosferico, nuvole e particelle attraverso l'acqua e i blocchi semitrasparenti.\nPotrebbe influire negativamente sulle prestazioni dei dispositivi portatili e degli schermi ad altissima risoluzione.",
	...
	"options.graphics.warning.renderer": "Elaboratore grafico rilevato: [%s]",
	...
	"options.graphicsApi.tooltip.vulkan": "Funzionalità sperimentale: potrebbe influire negativamente sulle prestazioni o causare instabilità.",
	"options.graphicsApi.vulkan": "Vulkan (instabile)",
	"options.guiScale": "Scala",
	...
	"options.hideSplashTexts": "Testi iniziali nascosti",
	...
	"options.improvedTransparency.oit.tooltip": "Un approccio sperimentale che utilizza un algoritmo di trasparenza indipendente dall'ordine per evitare problemi grafici normalmente presenti quando si guarda attraverso più strati di oggetti semitrasparenti.\nInfluirà negativamente sulle prestazioni.",
	"options.improvedTransparency.tooltip": "Un approccio sperimentale che utilizza algoritmi di ombreggiatura per disegnare tempo atmosferico, nuvole e particelle attraverso l'acqua e i blocchi semitrasparenti.\nInfluirà negativamente sulle prestazioni della scheda grafica.",
	...
	"options.japaneseGlyphVariants.tooltip": "Applica le varianti giapponesi dei caratteri dell'Asia orientale al tipo di carattere predefinito.",
	"options.key.hold": "Tieni",
	"options.key.toggle": "Alterna",
	"options.language": "Lingua...",
	"options.language.empty_or_missing_translation": "Il documento di localizzazione «%s» è vuoto o mancante. Riavvia il gioco e il launcher e riprova.",
	"options.language.load_translations_failed": "Caricamento delle traduzioni non riuscito",
	"options.language.narration": "Lingua",
	"options.language.title": "Lingua",
	"options.language.tooltip": "Lingua",
	"options.languageAccuracyWarning": "Alcune traduzioni potrebbero contenere imprecisioni.",
	"options.languageWarning": "Alcune traduzioni potrebbero contenere imprecisioni.",
	...
	"options.maxAnisotropy.tooltip": "Ogni livello rende le grafiche molto più armoniose, ma influisce sulle prestazioni e aumenta notevolmente l'uso della memoria grafica. Richiede l'attivazione del filtro anisotropico.",
	...
	"options.multiplayer.title": "Avvia la partita in rete locale",
	...
	"options.prioritizeChunkUpdates.nearby.tooltip": "I chunk vicini vengono sempre compilati immediatamente. Ciò potrebbe influire sulle prestazioni del gioco quando si piazzano o distruggono blocchi.",
	...
	"options.quitShortcuts": "Esci con scorciatoia",
	"options.quitShortcuts.tooltip": "Determina se le scorciatoie da tastiera possono chiudere il gioco. Disattiva quest'opzione per impedire alle scorciatoie Alt + F4 (su Windows e Linux) e Cmd + Q (su macOS) di arrestare il gioco.",
	...
	"options.reducedDebugInfo": "Info diagnostiche ridotte",
	...
	"options.sharePresence": "Visibilità",
	"options.sharePresence.all": "Sì",
	"options.sharePresence.all.tooltip": "Gli amici possono vedere la tua attività.",
	"options.sharePresence.limited": "Parziale",
	"options.sharePresence.limited.tooltip": "Gli amici possono vedere quando sei in linea, ma non la tua attività.",
	"options.sharePresence.none": "No",
	"options.sharePresence.none.tooltip": "Gli amici non possono vedere quando sei in linea.",
	...
	"options.textureFiltering.anisotropic.tooltip": "Un filtraggio basato sull'hardware che influisce sulle prestazioni e aumenta notevolmente l'uso della memoria grafica. Potrebbe non essere compatibile con tutti i dispositivi.",
	...
	"options.textureFiltering.rgss.tooltip": "Supercampionamento a griglia ruotata (SCGR, in inglese RGSS), un filtraggio basato su algoritmi di ombreggiatura che migliora la qualità grafica con un impatto moderato sulle prestazioni.",
	...
	"options.weatherRadius.tooltip": "Raggio entro il quale gli effetti di pioggia e neve sono visibili. Influisce trascurabilmente sulle prestazioni.",
	"options.worldOptions.allow_commands.disabled.demo.tooltip": "I comandi sono bloccati nei mondi di prova.",
	"options.worldOptions.allow_commands.disabled.tooltip": "I comandi sono bloccati nei mondi in modalità estrema.",
	"options.worldOptions.allow_commands.tooltip": "Determina se i giocatori possono usare i comandi.",
	"options.worldOptions.button": "Mondo...",
	"options.worldOptions.difficulty.disabled.hardcore.tooltip": "La difficoltà è bloccata nei mondi in modalità estrema.",
	"options.worldOptions.difficulty.disabled.locked.tooltip": "La difficoltà è bloccata.",
	"options.worldOptions.difficulty.disabled.operator.tooltip": "La difficoltà può essere cambiata solo dagli operatori.",
	"options.worldOptions.game_mode": "Modalità di gioco predefinita",
	"options.worldOptions.game_mode.disabled.operator.tooltip": "La modalità di gioco può essere cambiata solo dagli operatori.",
	"options.worldOptions.game_mode.disabled.tooltip": "La modalità di gioco è bloccata nei mondi in modalità estrema.",
	"options.worldOptions.game_mode.tooltip": "Cambia la modalità di gioco predefinita del mondo.",
	"options.worldOptions.general.title": "Generale",
	"options.worldOptions.guest.command_access": "Accesso ai comandi",
	"options.worldOptions.guest.command_access.disabled.commands.tooltip": "L'accesso ai comandi per i giocatori che entrano nel mondo è bloccato: i comandi non sono consentiti.",
	"options.worldOptions.guest.command_access.disabled.scope.tooltip": "L'accesso ai comandi per i giocatori che entrano nel mondo è bloccato: la partita non è in multigiocatore.",
	"options.worldOptions.guest.command_access.tooltip": "Determina se i giocatori che entrano nel tuo mondo possono eseguire comandi.",
	"options.worldOptions.guest.force_game_mode": "Modalità di gioco forzata",
	"options.worldOptions.guest.force_game_mode.off.commands.tooltip": "Gli altri giocatori possono cambiare la loro modalità di gioco con i comandi.",
	"options.worldOptions.guest.force_game_mode.off.hardcore.tooltip": "Quest'impostazione è bloccata nei mondi in modalità estrema.",
	"options.worldOptions.guest.force_game_mode.off.scope.tooltip": "Quest'impostazione è bloccata: la partita non è in multigiocatore.",
	"options.worldOptions.guest.force_game_mode.off.tooltip": "Gli altri giocatori mantengono la loro modalità di gioco attuale indipendentemente da quella predefinita.",
	"options.worldOptions.guest.force_game_mode.on.tooltip": "Gli altri giocatori possono giocare soltanto nella modalità di gioco predefinita.",
	"options.worldOptions.multiplayer.title": "Multigiocatore",
	"options.worldOptions.personal_game_mode": "Modalità di gioco personale",
	"options.worldOptions.personal_game_mode.tooltip": "Cambia la tua modalità di gioco in questo mondo.",
	...
	"parsing.float.expected": "Previsto un numero reale",
	"parsing.float.invalid": "Numero reale non valido: %s",
	...
	"quickplay.error.realm_permission": "Non hai l'autorizzazione a connetterti a questo Realm",
	...
	"realms.configuration.region.east_us_2": "Stati Uniti d'America (Carolina Nord)",
	...
	"realms.configuration.region.mexico_central": "Messico",
	...
	"realms.configuration.region.south_africa_north": "Sudafrica",
	...
	"realms.configuration.region.west_us_3": "Stati Uniti d'America (Arizona)",
	"realms.configuration.region_preference.automatic_owner": "Automatico (vicino al proprietario)",
	"realms.configuration.region_preference.automatic_player": "Automatico (primo a unirsi)",
	...
	"recover_world.issue.missing_file": "Documento mancante",
	...
	"recover_world.no_fallback": "Nessuno stato recuperabile disponibile",
	...
	"recover_world.warning": "Caricamento del riepilogo non riuscito",
	...
	"screenshot.success": "Schermata salvata: %s",
	...
	"selectWorld.backupJoinConfirmButton": "Effettua backup e carica",
	...
	"selectWorld.targetFolder": "Cartella di salvataggio:\n%s",
	...
	"sign.back_text": "Messaggio posteriore:",
	"sign.click_actions_disabled": "Non puoi interagire con questo cartello",
	"sign.edit": "Messaggio del cartello:",
	"sign.front_text": "Messaggio anteriore:",
	...
	"slot.only_single_allowed": "Sono consentite solo caselle singole (ricevuto: %s)",
	"slot.unknown": "Casella sconosciuta: %s",
	...
	"snbt.parser.no_such_operation": "Nessun'operazione: %s",
	...
	"spectator.cannot_teleport": "Impossibile teletrasportarsi: la destinazione non è ancora stata generata",
	...
	"stat.minecraft.damage_blocked_by_shield": "Danno bloccato da scudo",
	...
	"stat.minecraft.interact_with_anvil": "Interazioni con incudini",
	"stat.minecraft.interact_with_beacon": "Interazioni con fari",
	"stat.minecraft.interact_with_blast_furnace": "Interazioni con forni fusori",
	"stat.minecraft.interact_with_brewingstand": "Interazioni con alambicchi",
	"stat.minecraft.interact_with_campfire": "Interazioni con fuochi da campo",
	"stat.minecraft.interact_with_cartography_table": "Interazioni con banchi da cartografia",
	"stat.minecraft.interact_with_crafting_table": "Interazioni con banchi da lavoro",
	"stat.minecraft.interact_with_furnace": "Interazioni con fornaci",
	"stat.minecraft.interact_with_grindstone": "Interazioni con mole",
	"stat.minecraft.interact_with_lectern": "Interazioni con leggii",
	"stat.minecraft.interact_with_loom": "Interazioni con telai",
	"stat.minecraft.interact_with_smithing_table": "Interazioni con banchi da forgiatura",
	"stat.minecraft.interact_with_smoker": "Interazioni con affumicatori",
	"stat.minecraft.interact_with_stonecutter": "Interazioni con tagliapietre",
	...
	"stat.minecraft.sleep_in_straw_bed": "Notti passate in un pagliericcio",
	...
	"stat.minecraft.talked_to_villager": "Conversazioni con villici",
	...
	"stat_type.minecraft.killed": "Uccisi: %[1]s",
	"stat_type.minecraft.killed.none": "Uccisi: 0",
	"stat_type.minecraft.killed_by": "Morti causate: %[2]s",
	"stat_type.minecraft.killed_by.none": "Morti causate: 0",
	...
	"structure_block.custom_data": "Nome del marcatore personalizzato",
	...
	"structure_block.load_prepare": "Preparato la posizione della struttura %s",
	"structure_block.load_success": "Caricato la struttura da «%s»",
	...
	"structure_block.save_success": "Salvato la struttura come «%s»",
	...
	"structure_block.size_success": "Rilevato la dimensione della struttura %s",
	...
	"subtitles.block.beacon.ambient": "Faro risuona",
	...
	"subtitles.block.chorus_flower.death": "Fiore di coro appassisce",
	"subtitles.block.chorus_flower.grow": "Fiore di coro cresce",
	...
	"subtitles.block.poplar_leaves.ambient": "Fruscio di foglie",
	"subtitles.block.portal.ambient": "Bruito di portale",
	"subtitles.block.portal.travel": "Frastuono di portale",
	"subtitles.block.portal.trigger": "Vortice di portale",
	...
	"subtitles.block.respawn_anchor.ambient": "Bruito di ancora della rinascita",
	...
	"subtitles.block.shelf_mushroom.bounce": "Rimbalzo su fungo",
	...
	"subtitles.block.straw_bed.break_leave": "Pagliericcio distrutto",
	...
	"subtitles.block.trial_spawner.about_to_spawn_item": "Oggetto infausto pronto",
	...
	"subtitles.entity.breeze.idle_ground": "Brezza aleggia",
	...
	"subtitles.entity.cushion.break": "Cuscino rimosso",
	"subtitles.entity.cushion.get_up": "Cuscino liberato",
	"subtitles.entity.cushion.place": "Cuscino piazzato",
	"subtitles.entity.cushion.sit": "Cuscino occupato",
	...
	"subtitles.entity.generic.small_fall": "Caduta lieve",
	...
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast allegro pronto",
	...
	"subtitles.entity.happy_ghast.riding": "Folata di vento",
	...
	"subtitles.entity.iron_golem.damage": "Golem di ferro incrinato",
	...
	"subtitles.entity.minecart.riding": "Vagonetto sferraglia",
	...
	"subtitles.entity.nautilus.riding": "Nautilo gorgoglia",
	...
	"subtitles.entity.small_sulfur_cube.death": "Cubetto di zolfo muore",
	"subtitles.entity.small_sulfur_cube.eat": "Cubetto di zolfo cresce",
	"subtitles.entity.small_sulfur_cube.hurt": "Cubetto di zolfo ferito",
	"subtitles.entity.small_sulfur_cube.jump": "Cubetto di zolfo saltella",
	...
	"subtitles.entity.sulfur_cube.absorb": "Cubo di zolfo riempito",
	...
	"subtitles.entity.sulfur_cube.jump": "Cubo di zolfo saltella",
	...
	"subtitles.entity.turtle.egg_break": "Uovo di tartaruga rotto",
	...
	"subtitles.item.armor.equip": "Armatura indossata",
	...
	"subtitles.item.armor.equip_nautilus": "Armatura per nautili assestata",
	"subtitles.item.armor.equip_netherite": "Armatura di netherite sferraglia",
	"subtitles.item.armor.equip_turtle": "Carapace di tartaruga calzato",
	...
	"subtitles.item.bone_meal.use": "Farina d'ossa fruscia",
	...
	"subtitles.item.nether_wart.plant": "Verruca seminata",
	...
	"subtitles.item.wolf_armor.break": "Armatura per lupi distrutta",
	...
	"telemetry.property.advancement_game_time.title": "Tempo di gioco [t]",
	...
	"telemetry.property.client_modded.title": "Modifiche del client",
	...
	"telemetry.property.load_time_bootstrap_ms.title": "Tempo di avvio [ms]",
	"telemetry.property.load_time_loading_overlay_ms.title": "Tempo nella schermata di caricamento [ms]",
	"telemetry.property.load_time_pre_window_ms.title": "Tempo prima dell'apertura della finestra [ms]",
	"telemetry.property.load_time_total_time_ms.title": "Tempo totale di caricamento [ms]",
	...
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Tempo di connessione dello SCI [ms]",
	...
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Tempo di connessione di segnalamento [ms]",
	"telemetry.property.p2p_connection_successful.title": "Esito della connessione positivo",
	"telemetry.property.p2p_connection_total_time_ms.title": "Tempo totale di connessione [ms]",
	"telemetry.property.platform.title": "Piattaforma",
	"telemetry.property.realms_map_content.title": "Nome del minigioco o contenuto di Realms",
	"telemetry.property.render_distance.title": "Visibilità",
	"telemetry.property.render_time_samples.title": "Campioni del tempo di elaborazione grafica",
	"telemetry.property.seconds_since_load.title": "Tempo dal caricamento del mondo [s]",
	"telemetry.property.server_modded.title": "Modifiche del server",
	"telemetry.property.server_session_id.title": "ID della sessione del server",
	"telemetry.property.server_type.title": "Tipo di server",
	"telemetry.property.ticks_since_load.title": "Tempo dal caricamento del mondo [t]",
	"telemetry.property.used_memory_samples.title": "Utilizzo della memoria (RAM)",
	"telemetry.property.user_id.title": "ID dell'utente",
	"telemetry.property.world_load_time_ms.title": "Tempo di caricamento del mondo [ms]",
	"telemetry.property.world_session_id.title": "ID della sessione del mondo",
	"telemetry_info.button.give_feedback": "Invia riscontro",
	"telemetry_info.button.privacy_statement": "Info sulla riservatezza",
	...
	"test.error.entity_property": "L'entità %s ha fallito il collaudo: %s",
	"test.error.entity_property_details": "L'entità %s ha fallito il collaudo: %s (previsto: %s, ricevuto: %s)",
	...
	"test.error.expected_block_tag": "Previsto blocco nell'insieme #%s (ricevuto: %s)",
	...
	"test.error.expected_entity_in_test": "Prevista l'esistenza di %s nel collaudo",
	...
	"test.error.sequence.condition_already_triggered": "Condizione già attivata nel tick %s",
	...
	"test.error.sequence.not_completed": "Il collaudo è scaduto prima del completamento della sequenza",
	...
	"test.error.structure.failure": "Piazzamento della struttura di collaudo per %s non riuscita",
	"test.error.tick": "%s al tick %s",
	"test.error.ticking_without_structure": "Collaudo in corso prima di piazzare la struttura",
	"test.error.timeout.no_result": "Non riuscito né fallito entro %s tick",
	...
	"test.error.wrong_block_entity": "Tipo di blocco complesso errato: %s",
	"test.player.coordinates": "Coordinate del giocatore: [%s, %s, %s] nella dimensione %s",
	"test.run.coordinates": "Coordinate di collaudo: [%s, %s, %s] nella dimensione %s",
	"test_block.error.missing": "Blocco %s mancante dalla struttura di collaudo",
	...
	"test_block.mode_info.accept": "Accettazione: accetta la riuscita di (una parte di) un collaudo",
	"test_block.mode_info.fail": "Fallimento: fa' fallire il collaudo",
	"test_block.mode_info.log": "Registrazione: registra un messaggio",
	"test_block.mode_info.start": "Avvio: il punto di partenza di un collaudo",
	...
	"test_instance.description.dimension": "Dimensione: %s",
	"test_instance.description.failed": "Non riuscito: %s",
	"test_instance.description.function": "Funzione: %s",
	"test_instance.description.invalid_id": "ID di collaudo non valido",
	"test_instance.description.no_test": "Nessun collaudo trovato",
	"test_instance.description.structure": "Struttura: %s",
	"test_instance.description.type": "Tipo: %s",
	"test_instance.type.block_based": "Collaudo basato su blocchi",
	"test_instance.type.function": "Collaudo di funzione integrata",
	"test_instance_block.entities": "Entità",
	"test_instance_block.error.no_test": "Impossibile eseguire l'istanza di collaudo presso %s, %s, %s perché non è stato definito alcun collaudo",
	"test_instance_block.error.no_test_structure": "Impossibile eseguire l'istanza di collaudo presso %s, %s, %s perché non ha una struttura di collaudo",
	"test_instance_block.error.unable_to_save": "Impossibile salvare il modello di struttura per l'istanza di collaudo presso %s, %s, %s",
	"test_instance_block.invalid": "[non valido]",
	"test_instance_block.reset_success": "Ripristino riuscito per il collaudo: %s",
	"test_instance_block.rotation": "Rotazione",
	"test_instance_block.size": "Dimensione della struttura di collaudo",
	"test_instance_block.starting": "Avvio del collaudo %s...",
	"test_instance_block.test_id": "ID dell'istanza di collaudo",
	...
	"title.multiplayer.lan": "Multigiocatore (rete locale)",
	...
	"upgradeWorld.aborted.file_already_exists": "Sembra che la cartella del mondo contenga alcuni documenti già aggiornati, dunque non è stato possibile aggiornare correttamente il mondo.",
