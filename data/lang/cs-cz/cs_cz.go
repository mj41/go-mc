// Code generated by tools/gen_lang.go from 1.21.11/cs_cz.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.swing.failed.notliving": "Nebyly nalezeny žádné entity, které by mohly mávnout rukou",
	"commands.swing.success.multiple": "Donuceno %s entit mávnout rukama",
	"commands.swing.success.single": "Donuceno entitu %s mávnout rukou",
	...
	"commands.time.no_time_marker_found": "U hodin %s neexistuje časová značka %s",
	"commands.time.pause": "Hodiny pozastaveny %s",
	...
	"commands.time.query.timeline.repetitions": "Časová osa %s už se %skrát opakovala",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Z důvodu zásadních změn ve formátu světa je třeba tento svět aktualizovat na nejnovější verzi, než jej budeš moci upravovat.",
	"selectWorld.requiresFileFixingTooltip.play": "Z důvodu zásadních změn ve formátu světa je třeba tento svět aktualizovat na nejnovější verzi, než jej budeš moci hrát.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Z důvodu zásadních změn ve formátu světa je třeba tento svět aktualizovat na nejnovější verzi, než jej budeš moci znovu vytvořit.",
	...
	"upgradeWorld.info.file_fix_stage": "Fáze: %s/%s",
	"upgradeWorld.info.scanning": "Zkoumání souborů…",
	...
	"upgradeWorld.symlink.message": "Vybraný svět obsahuje symbolické odkazy.\nKroky potřebné k aktualizaci světa na současnou verzi nepodporují používání symbolických odkazů. K aktualizaci světa je třeba nejprve vyřešit odkazy.",
