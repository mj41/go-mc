// Code generated by tools/gen_lang.go from 26.2/fr_fr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"argument.pos.mixed": "Impossible de mélanger des coordonnées locales et de monde (vous devez utiliser ^ partout ou nul part)",
	...
	"commands.setworldspawn.failure.not_overworld": "Le point d'apparition du monde ne peut être défini qu'à la Surface",
	...
	"commands.tag.list.multiple.success": "Les %s entités ont %s tags au total : %s",
	...
	"commands.worldborder.set.grow": "Augmentation des limites du monde à %s blocs de large sur %s secondes",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Certaines actions à l'intérieur d'un tronçon le feront recompiler immédiatement. Cela comprend le placement et la destruction des blocs.",
	...
	"options.worldOptions.game_mode.disabled.tooltip": "Impossible de modifier le mode de jeu dans un monde Hardcore.",
	...
	"subtitles.block.shelf_mushroom.bounce": "Quelque chose rebondit sur une pholiote du peuplier",
