// Code generated by tools/gen_lang.go from 1.21.11/fr_fr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"selectWorld.backupWarning.file_fixing_required": "Ce monde doit être mis à niveau avant de pouvoir y jouer. Nous vous recommandons fortement de créer une sauvegarde avant de continuer, au cas où votre monde serait corrompu.",
	...
	"subtitles.item.golden_dandelion.unuse": "Croissance reprise",
	...
	"test.error.sequence.minimum_tick": "Réussite avant le tick prévu : attente de %s prévue",
	...
	"test.error.state_not_equal": "État incorrect. %s attendu (état reçu : %s)",
	...
	"test.error.value_not_equal": "%s attendu : %s (valeur reçue : %s)",
	...
	"upgradeWorld.symlink.title": "Impossible de mettre à niveau ce monde",
