// Code generated by tools/gen_lang.go from 1.21.11/zh_cn.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"mco.selectServer.popup": "Realms最多可以同时支持十位好友安全且简单地在线享受Minecraft世界。它也支持多种小游戏与海量自定义世界！只有Realm的所有者需要付款。",
	...
	"narration.selection.usage": "按下上键或下键移动到另一项",
	...
	"selectWorld.backupWarning.file_fixing_required": "此世界需要升级后才能进入游戏。我们强烈建议在继续前创建备份，以防世界损坏。",
	...
	"selectWorld.upgrade_and_play": "升级并进入游戏",
	...
	"stat_type.minecraft.killed": "你杀死了%s个%s",
	...
	"subtitles.entity.copper_golem_become_statue": "铜傀儡：锈化",
	...
	"test.error.position": "%s，位于%s, %s, %s（相对位置：%s, %s, %s），%s刻",
	...
	"upgradeWorld.symlink.title": "无法升级世界",
