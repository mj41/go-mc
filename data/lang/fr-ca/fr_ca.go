// Code generated by tools/gen_lang.go from 1.21.11/fr_ca.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.swing.success.multiple": "%s entités agitent leur bras",
	"commands.swing.success.single": "%s agite son bras",
	...
	"gamerule.minecraft.universal_anger.description": "Les mobs neutres enragés attaquent n'importe quels joueurs à proximité, pas seulement le joueur qui les a enragé. Fonctionne mieux si la règle \"forgive_dead_players\" est désactivée.",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Délai des portails du Nether en mode Créatif",
	"gamerule.playersNetherPortalCreativeDelay.description": "Durée (en ticks) que les joueurs en mode Créatif doivent attendre en se tenant dans un portail du Nether avant de changer de dimension.",
	"gamerule.playersNetherPortalDefaultDelay": "Délai des portails du Nether",
	"gamerule.playersNetherPortalDefaultDelay.description": "Durée (en ticks) que les joueurs qui ne sont pas en mode Créatif doivent attendre en se tenant dans un portail du Nether avant de changer de dimension.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Ce monde a besoin d'être mis à niveau à la dernière version avant de pouvoir être modifié en raison de changements sous-jacents au format du monde.",
	"selectWorld.requiresFileFixingTooltip.play": "Ce monde a besoin d'être mis à niveau à la dernière version avant de pouvoir y jouer en raison de changements sous-jacents au format du monde.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Ce monde a besoin d'être mis à niveau à la dernière version avant de pouvoir être recréé en raison de changements sous-jacents au format du monde.",
	...
	"test.error.sequence.invalid_tick": "Réussite dans le tick invalide : %s attendu",
	...
	"upgradeWorld.joinNow": "Voulez-vous entrer dans le monde maintenant?",
	...
	"upgradeWorld.symlink.message": "Le monde sélectionné contient des liens symboliques. Les étapes nécessaires pour mettre ce monde à niveau à la version actuelle ne prend pas en charge l'utilisation de liens symboliques. Pour mettre ce monde à niveau, ces liens doivent d'abord être résolus.",
	"upgradeWorld.symlink.title": "Impossible de mettre ce monde à niveau",
