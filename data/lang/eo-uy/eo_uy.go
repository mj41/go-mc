// Code generated by tools/gen_lang.go from 1.21.11/eo_uy.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.experience.set.points.invalid": "Spertaj poentoj ne agordeblas al valoro, superanta la maksimuman punktaron por la nuna nivelo de la ludanto",
	...
	"commands.kill.success.single": "%s estis mortigitaj",
	...
	"commands.schedule.cleared.failure": "Mankas horaroj kun la ID: %s",
	...
	"selectWorld.backupWarning.file_fixing_required": "Ĉi tiu mondo estas ĝisdatigenda, por ke vi povu ludi ĝin. Ni instigas sekurkopii la mondon antaŭ ol daŭrigi por protekti ĝin kontraŭ difektoj.",
	"selectWorld.backupWarning.snapshot": "Ĉi tiun mondon lastafoje oni ludis en la versio %s; vi uzas la version %s. Bonvolu sekurkopii la mondon por protekti ĝin kontraŭ difektoj.",
	...
	"test_instance_block.reset_success": "Testo «%s» sukcese defaŭltiĝis",
