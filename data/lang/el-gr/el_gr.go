// Code generated by tools/gen_lang.go from 1.21.11/el_gr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.end.kill_dragon.title": "Ελευθέρωσε το Εντ",
	...
	"chat.disabled.chain_broken": "Η συνομιλία έχει απενεργοποιηθεί λόγω σπασμένης αλυσίδας. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.expiredProfileKey": "Η συνομιλία έχει απενεργοποιηθεί λόγω ληγμένου δημοσίου κλειδιού προφίλ. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	...
	"chat.disabled.missingProfileKey": "Η συνομιλία έχει απενεργοποιηθεί λόγω απουσίας δημοσίου κλειδιού προφίλ. Παρακαλώ δοκίμασε να επανασυνδεθείς.",
	"chat.disabled.options": "Η συνομιλία έχει απενεργοποιηθεί στις επιλογές του προγράμματος πελάτη.",
	...
	"commands.dialog.clear.multiple": "Εκκαθαρίστηκε ο διάλογος για %s παίκτες",
	"commands.dialog.clear.single": "Εκκαθαρίστηκε ο διάλογος για τον παίκτη %s",
	"commands.dialog.show.multiple": "Εμφανίστηκε ο διάλογος σε %s παίκτες",
	"commands.dialog.show.single": "Εμφανίστηκε ο διάλογος στον παίκτη %s",
	...
	"commands.enchant.failed": "Τίποτα δεν άλλαξε. Οι στόχοι είτε δεν κρατούν κανένα αντικείμενο στα χέρια τους είτε το μάγεμα δεν μπόρεσε να εφαρμοστεί",
	...
	"commands.test.error.test_instance_not_found": "Δε βρέθηκε ο κύβος οντότητα της παρουσίας δοκιμής",
	"commands.test.error.test_instance_not_found.position": "Δε βρέθηκε ο κύβος οντότητα της παρουσίας δοκιμής για τη δοκιμή στη θέση %s, %s, %s",
	...
	"createWorld.customize.presets.share": "Θέλεις να μοιραστείς την προκαθορισμένη σου ρύθμισή με κάποιον; Χρησιμοποίησε το παρακάτω πλαίσιο!",
	...
	"datapackFailure.title": "Σφάλματα σε επιλεγμένα πακέτα δεδομένων απέτρεψαν τη φόρτωση του κόσμου.\nΜπορείς είτε να προσπαθήσεις να τον φορτώσεις μόνο με το προεπιλεγμένο πακέτο δεδομένων («λειτουργία ασφαλείας»), είτε να πας πίσω στην οθόνη τίτλου και να διορθώσεις το πρόβλημα εσύ.",
	...
	"demo.help.fullWrapped": "Αυτή η επίδειξη θα διαρκέσει 5 ημέρες εντός παιχνιδιού (περίπου 1 ώρα και 40 λεπτά πραγματικού χρόνου). Δες τις εξελίξεις για καθοδήγηση! Καλή διασκέδαση!",
	...
	"disconnect.loginFailedInfo.invalidSession": "Μη έγκυρη συνεδρία (Δοκίμασε να επανεκκινήσεις το παιχνίδι και τον εκκινητή)",
	...
	"mco.configure.world.close.question.title": "Χρειάζεται να κάνεις αλλαγές χωρίς αναστάτωση;",
	...
	"mco.configure.world.uninvite.player": "Είσαι βέβαιος/βέβαιη ότι θέλεις να αναιρέσεις την πρόσκληση του παίκτη «%s»;",
	"mco.configure.world.uninvite.question": "Είσαι βέβαιος/βέβαιη ότι θέλεις να αναιρέσεις την πρόσκληση του παίκτη",
	...
	"mco.errorMessage.retry": "Δοκιμή ξανά διαδικασίας",
	...
	"mco.selectServer.popup": "Τα Realms είναι ένας ασφαλής, απλός τρόπος να απολαύσεις έναν διαδικτυακό κόσμο Minecraft με έως και δέκα φίλους τη φορά. Υποστηρίζουν πολλά μίνι-παιχνίδια και αρκετούς προσαρμοσμένους κόσμους! Μόνο ο ιδιοκτήτης του realm χρειάζεται να πληρώσει.",
	...
	"options.inactivityFpsLimit.afk.tooltip": "Περιορίζει τον ρυθμό καρέ σε 30 όταν το παιχνίδι δε λαμβάνει καμία είσοδο από τον παίκτη για περισσότερο από ένα λεπτό. Τον περιορίζει περαιτέρω σε 10 μετά από 9 παραπάνω λεπτά.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Αυτός ο κόσμος χρειάζεται να αναβαθμιστεί πριν μπορείς να τον παίξεις. Προτείνουμε ανεπιφύλακτα τη δημιουργία ενός αντιγράφου ασφαλείας πριν συνεχίσεις σε περίπτωση που αντιμετωπίσεις αλλοιώσεις κόσμου.",
	"selectWorld.backupWarning.snapshot": "Αυτός ο κόσμος παίχτηκε τελευταία φορά στην έκδοση %s· είσαι στην έκδοση %s. Παρακαλώ δημιούργησε ένα αντίγραφο ασφαλείας σε περίπτωση αλλοίωσης κόσμου.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Αυτός ο κόσμος χρειάζεται να αναβαθμιστεί στην τελευταία έκδοση πριν μπορείς να τον επεξεργαστείς λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	"selectWorld.requiresFileFixingTooltip.play": "Αυτός ο κόσμος χρειάζεται να αναβαθμιστεί στην τελευταία έκδοση πριν μπορείς να τον παίξεις λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Αυτός ο κόσμος χρειάζεται να αναβαθμιστεί στην τελευταία έκδοση πριν μπορείς να τον αναδημιουργήσεις λόγω υποκείμενων αλλαγών στη μορφή του κόσμου.",
	...
	"symlink_warning.title": "Ο φάκελος κόσμων περιέχει συμβολικές συνδέσεις",
	"symlink_warning.title.pack": "Το πακέτο που προστέθηκε περιέχει/Τα πακέτα που προστέθηκαν περιέχουν συμβολικές συνδέσεις",
	"symlink_warning.title.world": "Ο φάκελος κόσμων περιέχει συμβολικές συνδέσεις",
	...
	"telemetry.property.launcher_name.title": "Όνομα Εκκινητή",
	...
	"test.error.missing_block_entity": "Λείπει ο κύβος οντότητας",
	...
	"test.error.wrong_block_entity": "Λάθος τύπος κύβου οντότητας: %s",
	...
	"upgradeWorld.symlink.message": "Ο επιλεγμένος κόσμος περιέχει συμβολικές συνδέσεις.\nΤα απαιτούμενα βήματα για την αναβάθμιση του κόσμου στην τρέχουσα έκδοση δεν υποστηρίζουν τη χρήση συμβολικών συνδέσεων. Για να αναβαθμίσεις τον κόσμο, οι σύνδεσμοι χρειάζεται να επιλυθούν πρώτα.",
