// Code generated by tools/gen_lang.go from 26.2/el_gr.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.trackOutput": "Παρακολούθηση Εξόδου",
	...
	"advancements.adventure.arbalistic.title": "Βαλλιστροφορικό",
	...
	"advancements.adventure.avoid_vibration.title": "Στα Μουλωχτά",
	...
	"advancements.adventure.brush_armadillo.description": "Απόκτησε Φολίδες Αρμαντίλλο από ένα Αρμαντίλλο χρησιμοποιώντας ένα Ξεσκονιστήρι",
	"advancements.adventure.brush_armadillo.title": "Αρμαντίλλο για Φίλο",
	...
	"advancements.adventure.shoot_arrow.title": "Θέτοντας Στόχους",
	...
	"advancements.husbandry.plant_any_sniffer_seed.description": "Φύτεψε οποιονδήποτε σπόρο Οσφρητή",
	...
	"advancements.husbandry.repair_wolf_armor.description": "Επισκεύασε πλήρως κατεστραμμένη Πανοπλία Λύκου χρησιμοποιώντας Φολίδες Αρμαντίλλο",
	...
	"advancements.husbandry.ride_a_boat_with_a_goat.title": "Κατσίκι στο Καΐκι!",
	...
	"advancements.husbandry.uh_oh.description": "Βάλε μια Γλίτσα Θείου να απορροφήσει έναν κύβο TNT",
	...
	"advancements.nether.create_beacon.title": "Φαροποιός",
	"advancements.nether.create_full_beacon.description": "Φέρε έναν Φάρο σε πλήρη δύναμη",
	"advancements.nether.create_full_beacon.title": "Φαροκράτορας",
	...
	"advancements.nether.loot_bastion.title": "Λεηλατώντας σαν Γουρούνια",
	...
	"advancements.nether.obtain_blaze_rod.title": "Οι Δρόμοι της Φωτιάς",
	...
	"advancements.story.enchant_item.title": "Μαγευτής",
	...
	"advancements.story.obtain_armor.title": "Σιδερωμένη Στολή",
	...
	"argument.swing_animation.invalid": "Άγνωστος τύπος απεικόνισης κουνήματος: %s",
	...
	"arguments.item.overstacked": "Το αντικείμενο %s μπορεί να τοποθετηθεί μέχρι %s φορές ανά υποδοχή",
	...
	"arguments.nbtpath.too_deep": "Η διαδρομή NBT που προκύπτει είναι ένθετη σε πολύ μεγάλο βάθος",
	"arguments.nbtpath.too_large": "Η διαδρομή NBT που προκύπτει είναι πολύ μεγάλη",
	...
	"biome.minecraft.dappled_forest": "Πολύχρωμο Δάσος",
	...
	"block.minecraft.bamboo_sapling": "Βλαστάρι Μπαμπού",
	...
	"block.minecraft.black_concrete_slab": "Μαύρη Πλάκα Σκυροδέματος",
	"block.minecraft.black_concrete_stairs": "Μαύρες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.black_wool_slab": "Πλάκα Μαύρου Μαλλιού",
	"block.minecraft.black_wool_stairs": "Σκάλες Μαύρου Μαλλιού",
	...
	"block.minecraft.blue_concrete_slab": "Μπλε Πλάκα Σκυροδέματος",
	"block.minecraft.blue_concrete_stairs": "Μπλε Σκάλες Σκυροδέματος",
	...
	"block.minecraft.blue_wool_slab": "Πλάκα Μπλε Μαλλιού",
	"block.minecraft.blue_wool_stairs": "Σκάλες Μπλε Μαλλιού",
	...
	"block.minecraft.brown_concrete_slab": "Καφέ Πλάκα Σκυροδέματος",
	"block.minecraft.brown_concrete_stairs": "Καφέ Σκάλες Σκυροδέματος",
	...
	"block.minecraft.brown_wool_slab": "Πλάκα Καφέ Μαλλιού",
	"block.minecraft.brown_wool_stairs": "Σκάλες Καφέ Μαλλιού",
	...
	"block.minecraft.cyan_concrete_slab": "Κυανή Πλάκα Σκυροδέματος",
	"block.minecraft.cyan_concrete_stairs": "Κυανές Σκάλες Σκυροδέματος",
	...
	"block.minecraft.cyan_wool_slab": "Πλάκα Κυανού Μαλλιού",
	"block.minecraft.cyan_wool_stairs": "Σκάλες Κυανού Μαλλιού",
	...
	"block.minecraft.gray_concrete_slab": "Γκρίζα Πλάκα Σκυροδέματος",
	"block.minecraft.gray_concrete_stairs": "Γκρίζες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.gray_wool_slab": "Πλάκα Γκρίζου Μαλλιού",
	"block.minecraft.gray_wool_stairs": "Σκάλες Γκρίζου Μαλλιού",
	...
	"block.minecraft.green_concrete_slab": "Πράσινη Πλάκα Σκυροδέματος",
	"block.minecraft.green_concrete_stairs": "Πράσινες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.green_wool_slab": "Πλάκα Πράσινου Μαλλιού",
	"block.minecraft.green_wool_stairs": "Σκάλες Πράσινου Μαλλιού",
	...
	"block.minecraft.light_blue_concrete_slab": "Γαλάζια Πλάκα Σκυροδέματος",
	"block.minecraft.light_blue_concrete_stairs": "Γαλάζιες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.light_blue_wool_slab": "Πλάκα Γαλάζιου Μαλλιού",
	"block.minecraft.light_blue_wool_stairs": "Σκάλες Γαλάζιου Μαλλιού",
	...
	"block.minecraft.light_gray_concrete_slab": "Ανοιχτή Γκρίζα Πλάκα Σκυροδέματος",
	"block.minecraft.light_gray_concrete_stairs": "Ανοιχτές Γκρίζες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.light_gray_wool_slab": "Πλάκα Ανοιχτού Γκρίζου Μαλλιού",
	"block.minecraft.light_gray_wool_stairs": "Σκάλες Ανοιχτού Γκρίζου Μαλλιού",
	...
	"block.minecraft.lime_concrete_slab": "Λαχανί Πλάκα Σκυροδέματος",
	"block.minecraft.lime_concrete_stairs": "Λαχανί Σκάλες Σκυροδέματος",
	...
	"block.minecraft.lime_wool_slab": "Πλάκα Λαχανί Μαλλιού",
	"block.minecraft.lime_wool_stairs": "Σκάλες Λαχανί Μαλλιού",
	...
	"block.minecraft.magenta_concrete_slab": "Φούξια Πλάκα Σκυροδέματος",
	"block.minecraft.magenta_concrete_stairs": "Φούξια Σκάλες Σκυροδέματος",
	...
	"block.minecraft.magenta_wool_slab": "Πλάκα Φούξια Μαλλιού",
	"block.minecraft.magenta_wool_stairs": "Σκάλες Φούξια Μαλλιού",
	...
	"block.minecraft.orange_concrete_slab": "Πορτοκαλί Πλάκα Σκυροδέματος",
	"block.minecraft.orange_concrete_stairs": "Πορτοκαλί Σκάλες Σκυροδέματος",
	"block.minecraft.orange_glazed_terracotta": "Πορτοκαλί Γυαλισμένη Τερακότα",
	"block.minecraft.orange_poplar_leaves": "Πορτοκαλί Φύλλα Λεύκας",
	...
	"block.minecraft.orange_wool_slab": "Πλάκα Πορτοκαλί Μαλλιού",
	"block.minecraft.orange_wool_stairs": "Σκάλες Πορτοκαλί Μαλλιού",
	...
	"block.minecraft.pink_concrete_slab": "Ροζ Πλάκα Σκυροδέματος",
	"block.minecraft.pink_concrete_stairs": "Ροζ Σκάλες Σκυροδέματος",
	...
	"block.minecraft.pink_wool_slab": "Πλάκα Ροζ Μαλλιού",
	"block.minecraft.pink_wool_stairs": "Σκάλες Ροζ Μαλλιού",
	...
	"block.minecraft.poplar_button": "Κουμπί Λεύκας",
	"block.minecraft.poplar_door": "Πόρτα Λεύκας",
	"block.minecraft.poplar_fence": "Φράχτης Λεύκας",
	"block.minecraft.poplar_fence_gate": "Πύλη Φράχτη Λεύκας",
	"block.minecraft.poplar_hanging_sign": "Κρεμαστή Πινακίδα Λεύκας",
	"block.minecraft.poplar_leaves": "Φύλλα Λεύκας",
	"block.minecraft.poplar_log": "Κορμός Λεύκας",
	"block.minecraft.poplar_planks": "Σανίδες Λεύκας",
	"block.minecraft.poplar_pressure_plate": "Πλάκα Πίεσης Λεύκας",
	"block.minecraft.poplar_sapling": "Βλαστάρι Λεύκας",
	"block.minecraft.poplar_shelf": "Ράφι Λεύκας",
	"block.minecraft.poplar_sign": "Πινακίδα Λεύκας",
	"block.minecraft.poplar_slab": "Πλάκα Λεύκας",
	"block.minecraft.poplar_stairs": "Σκάλες Λεύκας",
	"block.minecraft.poplar_trapdoor": "Καταπακτή Λεύκας",
	"block.minecraft.poplar_wall_hanging_sign": "Κρεμαστή Πινακίδα Τοίχου Λεύκας",
	"block.minecraft.poplar_wall_sign": "Πινακίδα Τοίχου Λεύκας",
	"block.minecraft.poplar_wood": "Ξύλο Λεύκας",
	...
	"block.minecraft.potted_poplar_sapling": "Βλαστάρι Λεύκας σε Γλάστρα",
	...
	"block.minecraft.purple_concrete_slab": "Μοβ Πλάκα Σκυροδέματος",
	"block.minecraft.purple_concrete_stairs": "Μοβ Σκάλες Σκυροδέματος",
	...
	"block.minecraft.purple_wool_slab": "Πλάκα Μοβ Μαλλιού",
	"block.minecraft.purple_wool_stairs": "Σκάλες Μοβ Μαλλιού",
	...
	"block.minecraft.red_concrete_slab": "Κόκκινη Πλάκα Σκυροδέματος",
	"block.minecraft.red_concrete_stairs": "Κόκκινες Σκάλες Σκυροδέματος",
	...
	"block.minecraft.red_poplar_leaves": "Κόκκινα Φύλλα Λεύκας",
	...
	"block.minecraft.red_shrub": "Κόκκινος Θάμνος",
	...
	"block.minecraft.red_wool_slab": "Πλάκα Κόκκινου Μαλλιού",
	"block.minecraft.red_wool_stairs": "Σκάλες Κόκκινου Μαλλιού",
	...
	"block.minecraft.shelf_mushroom": "Πολύπορος",
	...
	"block.minecraft.straw_bed": "Κρεβάτι Αχύρου",
	...
	"block.minecraft.stripped_poplar_log": "Αποφλοιωμένος Κορμός Λεύκας",
	"block.minecraft.stripped_poplar_wood": "Αποφλοιωμένο Ξύλο Λεύκας",
	...
	"block.minecraft.white_concrete_slab": "Λευκή Πλάκα Σκυροδέματος",
	"block.minecraft.white_concrete_stairs": "Λευκές Σκάλες Σκυροδέματος",
	...
	"block.minecraft.white_wool_slab": "Πλάκα Λευκού Μαλλιού",
	"block.minecraft.white_wool_stairs": "Σκάλες Λευκού Μαλλιού",
	...
	"block.minecraft.yellow_concrete_slab": "Κίτρινη Πλάκα Σκυροδέματος",
	"block.minecraft.yellow_concrete_stairs": "Κίτρινες Σκάλες Σκυροδέματος",
	"block.minecraft.yellow_glazed_terracotta": "Κίτρινη Γυαλισμένη Τερακότα",
	"block.minecraft.yellow_poplar_leaves": "Κίτρινα Φύλλα Λεύκας",
	...
	"block.minecraft.yellow_wool_slab": "Πλάκα Κίτρινου Μαλλιού",
	"block.minecraft.yellow_wool_stairs": "Σκάλες Κίτρινου Μαλλιού",
	...
	"chat.filtered_full": "Ο διακομιστής έχει κρύψει το μήνυμά σου για μερικούς παίκτες.",
	...
	"commands.attribute.failed.modifier_already_present": "Η τροποποίηση %s είναι ήδη παρούσα στο χαρακτηριστικό %s για την οντότητα %s",
	...
	"commands.bossbar.get.players.none": "Η προσαρμοσμένη μπάρα %s δεν έχει τώρα παίκτες σε σύνδεση",
	"commands.bossbar.get.players.some": "Η προσαρμοσμένη μπάρα %s έχει τώρα %s παίκτη/παίκτες σε σύνδεση: %s",
	...
	"commands.data.modify.invalid_substring": "Μη έγκυρα ευρετήρια υποσυμβολοσειράς: %s μέχρι %s",
	...
	"commands.fillbiome.no_changes": "Δεν άλλαξαν καταχωρίσεις τοπίων",
	...
	"commands.forceload.added.multiple": "Επισημάνθηκαν %s τμήματα στη διάσταση %s από %s μέχρι %s για εξαναγκασμένη φόρτωση",
	...
	"commands.forceload.removed.multiple": "Ανεπισημάνθηκαν %s τμήματα στη διάσταση %s από %s μέχρι %s για εξαναγκασμένη φόρτωση",
	...
	"commands.gamerule.not_set": "Ο κανόνας παιχνιδιού %s έχει ήδη τεθεί σε %s",
	...
	"commands.item.block.modify.success": "Τροποποιήθηκε/Τροποποιήθηκαν %s υποδοχή/υποδοχές στη θέση %s, %s, %s",
	"commands.item.block.replace.success": "Αντικαταστήθηκε/Αντικαταστήθηκαν %s υποδοχή/υποδοχές στη θέση %s, %s, %s",
	"commands.item.block.replace.success.known_item": "Αντικαταστήθηκε/Αντικαταστήθηκαν %s υποδοχή/υποδοχές στη θέση %s, %s, %s με το αντικείμενο %s",
	"commands.item.block.set.success": "Αντικαταστάθηκε μια υποδοχή στον κύβο %s, %s, %s με το αντικείμενο %s",
	"commands.item.entity.modify.success.multiple": "Τροποποιήθηκε υποδοχή/Τροποποιήθηκαν υποδοχές σε %s οντότητες",
	"commands.item.entity.modify.success.single": "Τροποποιήθηκε/Τροποποιήθηκαν %s υποδοχή/υποδοχές στην οντότητα %s",
	"commands.item.entity.replace.success.multiple": "Αντικαταστήθηκε υποδοχή/Αντικαταστήθηκαν υποδοχές σε %s οντότητες",
	"commands.item.entity.replace.success.multiple.known_item": "Αντικαταστήθηκε υποδοχή/Αντικαταστήθηκαν υποδοχές σε %s οντότητες με το αντικείμενο %s",
	"commands.item.entity.replace.success.single": "Αντικαταστήθηκε/Αντικαταστήθηκαν %s υποδοχή/υποδοχές στην οντότητα %s",
	"commands.item.entity.replace.success.single.known_item": "Αντικαταστήθηκε/Αντικαταστήθηκαν %s υποδοχή/υποδοχές στην οντότητα %s με το αντικείμενο %s",
	...
	"commands.item.source.no_such_slot.unnamed": "Η πηγή δεν έχει τις επιλεγμένες υποδοχές",
	"commands.item.source.not_a_container": "Η θέση πηγή %s, %s, %s δεν είναι δοχείο",
	"commands.item.target.failed": "Κανένας στόχος δε δέχτηκε αντικείμενα στις επιλεγμένες υποδοχές",
	"commands.item.target.failed.known_item": "Κανένας στόχος δε δέχτηκε το αντικείμενο %s στις επιλεγμένες υποδοχές",
	...
	"commands.item.target.no_such_slot.unnamed": "Ο στόχος δεν έχει τις επιλεγμένες υποδοχές",
	...
	"commands.kick.owner.failed": "Δεν μπορεί να αποβληθεί ο ιδιοκτήτης του διακομιστή σε ένα παιχνίδι LAN",
	...
	"commands.list.players": "Υπάρχουν %s από τους %s το μέγιστο παίκτες σε σύνδεση: %s",
	...
	"commands.perf.started": "Ξεκίνησε μια εκτέλεση καταγραφής απόδοσης 10 δευτερολέπτων (χρησιμοποίησε «/perf stop» για να σταματήσεις νωρίς)",
	...
	"commands.place.feature.success.inline": "Τοποθετήθηκε το χαρακτηριστικό στη θέση %s, %s, %s",
	...
	"commands.posteffect.add.failed": "Ο παίκτης έχει ήδη την επιλεγμένη μετεπίδραση",
	"commands.posteffect.add.success.multiple": "Προστέθηκε η μετεπίδραση %s σε %s παίκτες",
	"commands.posteffect.add.success.single": "Προστέθηκε η μετεπίδραση %s στον παίκτη %s",
	"commands.posteffect.clear.failed": "Ο παίκτης δεν έχει καμία μετεπίδραση για κατάργηση",
	"commands.posteffect.clear.success.multiple": "Καταργήθηκαν όλες οι μετεπιδράσεις από %s παίκτες",
	"commands.posteffect.clear.success.single": "Καταργήθηκαν όλες οι μετεπιδράσεις από τον παίκτη %s",
	"commands.posteffect.list.empty": "Ο παίκτης %s δεν έχει καμία μετεπίδραση",
	"commands.posteffect.list.success": "Ο παίκτης %s έχει %s μετεπιδράσεις: %s",
	"commands.posteffect.remove.failed": "Ο παίκτης δεν έχει την επιλεγμένη μετεπίδραση",
	"commands.posteffect.remove.success.multiple": "Καταργήθηκε η μετεπίδραση %s από %s παίκτες",
	"commands.posteffect.remove.success.single": "Καταργήθηκε η μετεπίδραση %s από τον παίκτη %s",
	...
	"commands.publish.alreadyPublished.lan": "Το τοπικό παιχνίδι εξυπηρετείται ήδη στη θύρα %s",
	"commands.publish.alreadyPublished.online": "Το διαδικτυακό παιχνίδι εξυπηρετείται ήδη",
	...
	"commands.publish.started.lan": "Το τοπικό παιχνίδι εξυπηρετείται στη θύρα %s",
	"commands.publish.started.online": "Το διαδικτυακό παιχνίδι εξυπηρετείται",
	"commands.publish.success": "Το παιχνίδι πολλαπλών παικτών εξυπηρετείται τώρα στη θύρα %s",
	"commands.random.error.range_too_large": "Το εύρος της τυχαίας τιμής πρέπει να είναι το πολύ 2147483647",
	"commands.random.error.range_too_small": "Το εύρος της τυχαίας τιμής πρέπει να είναι τουλάχιστον 1",
	...
	"commands.save.saving": "Το παιχνίδι αποθηκεύεται (αυτό μπορεί να πάρει μια στιγμή)",
	...
	"commands.scoreboard.players.list.empty": "Δεν υπάρχουν παρακολουθούμενες οντότητες",
	...
	"commands.scoreboard.players.list.success": "Υπάρχει/Υπάρχουν %s παρακολουθούμενη οντότητα/παρακολουθούμενες οντότητες: %s",
	...
	"commands.swing.failed.notliving": "Δε βρέθηκαν ζωντανές οντότητες για κούνημα",
	...
	"commands.time.pause.already_paused": "Το ρολόι %s είναι ήδη σε παύση",
	"commands.time.pause.already_running": "Το ρολόι %s τρέχει ήδη",
	...
	"commands.time.rate.already_same": "Το ρολόι %s εξελίσσεται ήδη σε κανονικό ρυθμό %sx",
	...
	"commands.time.set.already_at_time": "Το ρολόι %s έχει ήδη τεθεί σε %s τικ",
	"commands.time.set.already_at_time_marker": "Το ρολόι %s είναι ήδη στον δείκτη χρόνου %s",
	...
	"commands.unpublish.notPublished": "Δεν κοινοποιήθηκε παιχνίδι πολλαπλών παικτών",
	"commands.unpublish.success": "Το παιχνίδι πολλαπλών παικτών είναι τώρα ακοινοποίητο",
	...
	"commands.worldborder.set.grow": "Μεγεθύνονται τα σύνορα του κόσμου σε %s κύβο/κύβους πλάτος ανά %s δευτερόλεπτο/δευτερόλεπτα",
	...
	"connect.p2p.establishing": "Πραγματοποίηση σύνδεσης...",
	"connect.p2p.failed.generic": "Δεν μπόρεσε να γίνει σύνδεση στον παίκτη",
	"connect.p2p.failed.signaling": "Δεν είναι δυνατό να συνδεθείς αυτήν τη στιγμή.\nΔοκίμασε ξανά αργότερα.",
	"connect.p2p.failed.timeout": "Έληξε το χρονικό όριο του αιτήματος σύνδεσης",
	"connect.p2p.failed.unreachable": "Ο παίκτης δεν είναι προσβάσιμος",
	...
	"death.attack.sulfurCubeHot": "Ο παίκτης/το ον %[1]s πέθανε επειδή δεν είναι μόνο το πάτωμα λάβα",
	"death.attack.sulfurCubeHot.item": "Ο παίκτης/το ον %[2]s έδειξε στον παίκτη/το ον %[1]s ότι δεν είναι μόνο το πάτωμα λάβα χρησιμοποιώντας το αντικείμενο %[3]s",
	"death.attack.sulfurCubeHot.player": "Ο παίκτης/το ον %[2]s έδειξε στον παίκτη/το ον %[1]s ότι δεν είναι μόνο το πάτωμα λάβα",
	...
	"debug.improvedTransparency.off": "Βελτιωμένη διαφάνεια: απενεργοποιημένη",
	"debug.improvedTransparency.on": "Βελτιωμένη διαφάνεια: ενεργοποιημένη",
	"debug.inspect.client.block": "Αντιγράφηκαν τα δεδομένα κύβου από την πλευρά του προγράμματος πελάτη στο πρόχειρο",
	"debug.inspect.client.entity": "Αντιγράφηκαν τα δεδομένα οντότητας από την πλευρά του προγράμματος πελάτη στο πρόχειρο",
	"debug.inspect.help": "F3 + I = Αντιγραφή δεδομένων οντότητας ή κύβου στο πρόχειρο",
	"debug.inspect.server.block": "Αντιγράφηκαν τα δεδομένα κύβου από την πλευρά του διακομιστή στο πρόχειρο",
	"debug.inspect.server.entity": "Αντιγράφηκαν τα δεδομένα οντότητας από την πλευρά του διακομιστή στο πρόχειρο",
	...
	"debug.pause.help": "F3 + Esc = Παύση χωρίς το μενού παύσης (αν η παύση είναι δυνατή)",
	...
	"disconnect.timeout": "Έληξε το χρονικό όριο",
	...
	"editGamerule.inGame.disabled.hardcore.tooltip": "Δεν μπορούν να αλλάξουν οι κανόνες παιχνιδιού σε έναν σκληροπυρηνικό κόσμο.",
	...
	"entity.minecraft.armadillo": "Αρμαντίλλο",
	...
	"entity.minecraft.cushion": "Μαξιλάρι",
	...
	"entity.minecraft.poplar_boat": "Βάρκα Λεύκας",
	"entity.minecraft.poplar_chest_boat": "Βάρκα Λεύκας με Σεντούκι",
	...
	"gamerule.blockExplosionDropDecay": "Σε εκρήξεις λόγω χρήσης κύβων, μερικοί κύβοι δε θα ρίξουν τα λάφυρά τους",
	"gamerule.blockExplosionDropDecay.description": "Μερικές από τις ρίψεις από κύβους που καταστρέφονται από εκρήξεις λόγω χρήσης κύβων χάνονται στην έκρηξη.",
	...
	"gamerule.doMobSpawning.description": "Μερικές οντότητες μπορεί να έχουν ξεχωριστούς κανόνες.",
	...
	"gamerule.mobExplosionDropDecay": "Σε εκρήξεις λόγω όντων, μερικοί κύβοι δε θα ρίξουν τα λάφυρά τους",
	"gamerule.mobExplosionDropDecay.description": "Μερικές από τις ρίψεις από κύβους που καταστρέφονται από εκρήξεις λόγω όντων χάνονται στην έκρηξη.",
	...
	"gamerule.tntExplosionDropDecay": "Σε εκρήξεις λόγω TNT, μερικοί κύβοι δε θα ρίξουν τα λάφυρά τους",
	"gamerule.tntExplosionDropDecay.description": "Μερικές από τις ρίψεις από κύβους που καταστρέφονται από εκρήξεις λόγω TNT χάνονται στην έκρηξη.",
	...
	"generator.minecraft.flat_all_dimensions": "Επίπεδος σε Όλες τις Διαστάσεις",
	...
	"gui.abuseReport.attestation": "Υποβάλλοντας αυτήν την αναφορά, επιβεβαιώνεις ότι οι πληροφορίες που έχεις δώσει είναι ακριβείς και πλήρεις σύμφωνα με όσα γνωρίζεις.",
	...
	"gui.chatSelection.context": "Μηνύματα που περιβάλλουν αυτήν την επιλογή θα συμπεριληφθούν για να δώσουν επιπλέον γενικό πλαίσιο",
	...
	"gui.friends.button.loading.invite_request_pending": "Αναμονή για επιβεβαίωση",
	"gui.friends.button.loading.join_request_pending": "Αναμονή για επιβεβαίωση",
	"gui.friends.cancel_request": "Ακύρωση αιτήματος",
	"gui.friends.confirm_title": "Επιβεβαίωση",
	"gui.friends.confirm_unfriend": "Είσαι βέβαιος/βέβαιη ότι θέλεις να καταργήσεις αυτόν τον παίκτη από τη Λίστα Φίλων σου;",
	"gui.friends.copy_to_clipboard": "Αντιγραφή στο Πρόχειρο",
	"gui.friends.decline": "Απόρριψη",
	"gui.friends.empty_nickname": "Εισήγαγε ένα έγκυρο όνομα προφίλ πριν στείλεις αίτημα φιλίας",
	"gui.friends.empty_state": "Οι Φίλοι που προσθέτεις θα καταγράφονται εδώ.\n\nΔιαχειρίσου τη διαδικτυακή ασφάλεια με τον %s.",
	"gui.friends.empty_state.link": "λογαριασμό σου Microsoft",
	"gui.friends.enter_nickname": "Εισήγαγε Όνομα Προφίλ",
	"gui.friends.error.connection_issue": "Η Λίστα Φίλων δε λειτουργεί αυτήν τη στιγμή.\n\nΈλεγξε τη σύνδεσή σου στο διαδίκτυο και δοκίμασε ξανά.",
	"gui.friends.error.failed.message": "Δεν ήταν δυνατή η αποστολή του αιτήματος φιλίας σου αυτήν τη στιγμή",
	"gui.friends.error.forbidden.message": "Απέτυχε η εκτέλεση αυτής της ενέργειας φιλίας. Μπορεί να οφείλεται στις ρυθμίσεις απορρήτου του λογαριασμού.",
	"gui.friends.error.generic": "Κάτι πήγε στραβά — με αυτήν τη λειτουργία, όχι με τους φίλους σου!\n\nΔοκίμασε ξανά αργότερα.",
	"gui.friends.error.rateLimited.message": "Εκτελείς ενέργειες Λίστας Φίλων πολύ γρήγορα. Παρακαλώ περίμενε μια στιγμή και δοκίμασε ξανά.",
	"gui.friends.error.temporary_unavailable": "Η Λίστα Φίλων δε λειτουργεί αυτήν τη στιγμή.\n\nΔοκίμασε ξανά αργότερα.",
	"gui.friends.error.unauthorized": "Δόθηκε μη έγκυρο διακριτικό. Επανεκκίνησε το παιχνίδι και το πρόγραμμα εκκίνησής σου, μετά δοκίμασε ξανά.",
	"gui.friends.error.unavailable.message": "Η υπηρεσία Λίστας Φίλων είναι τώρα μη διαθέσιμη. Παρακαλώ έλεγξε τη σύνδεσή σου και δοκίμασε ξανά αργότερα.",
	"gui.friends.error.upgrade_needed": "Ενημέρωσε το παιχνίδι για να αποκτήσεις πρόσβαση στη Λίστα Φίλων σου.",
	"gui.friends.error.user_may_lack_active_profile": "Δεν υπάρχει παίκτης με αυτό το όνομα προφίλ",
	"gui.friends.join": "Σύνδεση",
	"gui.friends.loading_friends": "Φόρτωση Λίστας Φίλων...",
	"gui.friends.loading_requests": "Φόρτωση αιτημάτων...",
	"gui.friends.manage_account_footer": "Διαχειρίσου τη διαδικτυακή ασφάλεια με τον %s",
	...
	"gui.friends.multiplayer.join_request": "Αίτημα για σύνδεση",
	...
	"gui.friends.my_profile_name.narration": "Αντιγραφή ονόματος προφίλ %s στο πρόχειρο",
	"gui.friends.narration.button.accept": "Πάτημα enter για αποδοχή του αιτήματος φιλίας από τον παίκτη %s",
	"gui.friends.narration.button.cancel_request": "Πάτημα enter για ακύρωση του αιτήματος φιλίας στον παίκτη %s",
	"gui.friends.narration.button.decline": "Πάτημα enter για απόρριψη του αιτήματος φιλίας από τον παίκτη %s",
	"gui.friends.narration.button.unfriend": "Πάτημα enter για κατάργηση του παίκτη %s από τη Λίστα Φίλων",
	"gui.friends.narration.entry.friend": "Φίλος/Φίλη %s",
	"gui.friends.narration.entry.incoming": "Εισερχόμενο αίτημα φιλίας από τον παίκτη %s",
	"gui.friends.narration.entry.outgoing": "Εξερχόμενο αίτημα φιλίας στον παίκτη %s",
	"gui.friends.open": "Φίλοι",
	"gui.friends.open.narration": "Λίστα Φίλων",
	"gui.friends.open.tooltip": "Φίλοι",
	"gui.friends.pending.empty": "Κανένα εκκρεμές αίτημα φιλίας",
	"gui.friends.pending.received": "Λήφθηκαν",
	"gui.friends.pending.sent": "Στάλθηκαν",
	"gui.friends.presence.status.offline": "Εκτός Σύνδεσης",
	"gui.friends.presence.status.online": "Σε Σύνδεση",
	"gui.friends.presence.status.playing_hosted_server": "Σε Σύνδεση (LAN)",
	...
	"gui.friends.toast.friend_added.message": "Ο παίκτης %s δέχτηκε το αίτημα φιλίας σου",
	"gui.friends.toast.friend_invited.message": "Ο παίκτης %s έχει προσκληθεί για να συνδεθεί στον κόσμο σου.",
	"gui.friends.toast.friend_removed.message": "Ο παίκτης %s έχει καταργηθεί από τη λίστα φίλων σου",
	"gui.friends.toast.generic_error": "Προέκυψε ένα μη αναμενόμενο σφάλμα κατά την ενημέρωση της Λίστας Φίλων σου. Παρακαλώ δοκίμασε ξανά αργότερα.",
	"gui.friends.toast.host_invite_expired.message": "Η πρόσκληση στον παίκτη %s για να συνδεθεί σε αυτόν τον κόσμο έχει λήξει.",
	"gui.friends.toast.invite_from_friend.message": "Ο παίκτης %s σε προσκάλεσε για να συνδεθείς στον κόσμο του. Άνοιξε τη λίστα φίλων πατώντας «%s» για να συνδεθείς",
	"gui.friends.toast.join_invite_expired.message": "Η πρόσκληση για να συνδεθείς στον κόσμο του παίκτη %s έχει λήξει.",
	"gui.friends.toast.join_request.message": "Ο παίκτης %s θέλει να συνδεθεί στον κόσμο σου. Άνοιξε τη λίστα Φίλων με «%s» ή από το μενού παιχνιδιού.",
	"gui.friends.toast.request_accepted.message": "Είστε τώρα φίλοι με τον παίκτη %s",
	"gui.friends.toast.request_received.message": "Ο παίκτης %s σου έστειλε ένα αίτημα φιλίας",
	"gui.friends.toast.request_sent.message": "Το αίτημα φιλίας στάλθηκε στον παίκτη %s",
	"gui.friends.toast.request_to_join_friend.message": "Ζήτησες να συνδεθείς στον κόσμο του παίκτη %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s φίλοι δέχτηκαν τα αιτήματά φιλίας σου",
	"gui.friends.toast.requests_received_multiple.message": "Έχεις λάβει %s αιτήματα φιλίας",
	"gui.friends.unfriend": "Κατάργηση Φίλου/Φίλης",
	"gui.friends.validation.already_friend": "Ο παίκτης %s είναι ήδη στη Λίστα Φίλων σου",
	"gui.friends.validation.already_incoming": "Ο παίκτης %s σου έχει ήδη στείλει ένα αίτημα φιλίας",
	"gui.friends.validation.already_outgoing": "Έχεις ήδη στείλει ένα αίτημα φιλίας στον παίκτη %s",
	"gui.friends.validation.cannot_add_self": "Δεν μπορείς να στείλεις αίτημα φιλίας στον εαυτό σου",
	...
	"gui.privacy_link.message": "Άνοιξε αυτόν τον σύνδεσμο για να διαχειριστείς τις ρυθμίσεις σου απορρήτου και διαδικτυακής ασφάλειας.",
	"gui.privacy_link.title": "Οι αλλαγές σε ρυθμίσεις Xbox μπορεί να πάρουν χρόνο για να εφαρμοστούν.\n\nΑν δεν ενημερωθούν, επανεκκίνησε το παιχνίδι.",
	...
	"item.minecraft.armadillo_scute": "Φολίδα Αρμαντίλλο",
	"item.minecraft.armadillo_spawn_egg": "Αβγό Γέννησης Αρμαντίλλο",
	...
	"item.minecraft.black_cushion": "Μαύρο Μαξιλάρι",
	...
	"item.minecraft.blue_cushion": "Μπλε Μαξιλάρι",
	...
	"item.minecraft.brown_cushion": "Καφέ Μαξιλάρι",
	...
	"item.minecraft.buried_treasure_map": "Χάρτης Θαμμένου Θησαυρού",
	...
	"item.minecraft.cyan_cushion": "Κυανό Μαξιλάρι",
	...
	"item.minecraft.desert_village_map": "Χάρτης Χωριού Ερήμου",
	...
	"item.minecraft.firework_rocket.flight_duration": "Διάρκεια Πτήσης: %s",
	...
	"item.minecraft.jungle_explorer_map": "Χάρτης Εξερευνητή Ζούγκλας",
	...
	"item.minecraft.light_blue_cushion": "Γαλάζιο Μαξιλάρι",
	...
	"item.minecraft.light_gray_cushion": "Ανοιχτό Γκρίζο Μαξιλάρι",
	...
	"item.minecraft.lime_cushion": "Λαχανί Μαξιλάρι",
	...
	"item.minecraft.magenta_cushion": "Φούξια Μαξιλάρι",
	...
	"item.minecraft.ocean_explorer_map": "Χάρτης Εξερευνητή Ωκεανού",
	...
	"item.minecraft.orange_cushion": "Πορτοκαλί Μαξιλάρι",
	...
	"item.minecraft.pink_cushion": "Ροζ Μαξιλάρι",
	...
	"item.minecraft.plains_village_map": "Χάρτης Χωριού Πεδιάδας",
	...
	"item.minecraft.poplar_boat": "Βάρκα Λεύκας",
	"item.minecraft.poplar_chest_boat": "Βάρκα Λεύκας με Σεντούκι",
	...
	"item.minecraft.purple_cushion": "Μοβ Μαξιλάρι",
	...
	"item.minecraft.red_cushion": "Κόκκινο Μαξιλάρι",
	...
	"item.minecraft.savanna_village_map": "Χάρτης Χωριού Σαβάνας",
	...
	"item.minecraft.snowy_village_map": "Χάρτης Χιονισμένου Χωριού",
	...
	"item.minecraft.straw_bed": "Κρεβάτι Αχύρου",
	...
	"item.minecraft.swamp_explorer_map": "Χάρτης Εξερευνητή Βάλτου",
	...
	"item.minecraft.taiga_village_map": "Χάρτης Χωριού Τάιγκας",
	...
	"item.minecraft.trial_explorer_map": "Χάρτης Εξερευνητή Δοκιμασίας",
	...
	"item.minecraft.white_cushion": "Λευκό Μαξιλάρι",
	...
	"item.minecraft.woodland_explorer_map": "Χάρτης Εξερευνητή Δάσους",
	...
	"item.minecraft.yellow_cushion": "Κίτρινο Μαξιλάρι",
	...
	"key.debug.improvedTransparency": "Αλλαγή Βελτιωμένης Διαφάνειας",
	...
	"mco.configure.world.buttons.invite_codes": "Κωδικοί Πρόσκλησης",
	...
	"mco.configure.world.edit.subscreen.adventuremap": "Μερικές ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι περιπέτεια",
	"mco.configure.world.edit.subscreen.experience": "Μερικές ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι εμπειρία",
	"mco.configure.world.edit.subscreen.inspiration": "Μερικές ρυθμίσεις είναι απενεργοποιημένες διότι ο τρέχων σου κόσμος είναι έμπνευση",
	...
	"mco.configure.world.invite_codes.copy": "Αντιγραφή",
	"mco.configure.world.invite_codes.create": "Δημιουργία Κωδικού Πρόσκλησης",
	"mco.configure.world.invite_codes.delete": "Διαγραφή",
	"mco.configure.world.invite_codes.edit": "Επεξεργασία",
	"mco.configure.world.invite_codes.edit.active": "Ενεργός",
	"mco.configure.world.invite_codes.edit.expiration_date": "Ημερομηνία Λήξης",
	"mco.configure.world.invite_codes.edit.expires": "Λήγει: %s",
	"mco.configure.world.invite_codes.edit.title": "Επεξεργασία Κωδικού Πρόσκλησης",
	"mco.configure.world.invite_codes.expiration.12_hours": "12 ώρες",
	"mco.configure.world.invite_codes.expiration.1_day": "1 ημέρα",
	"mco.configure.world.invite_codes.expiration.1_hour": "1 ώρα",
	"mco.configure.world.invite_codes.expiration.30_minutes": "30 λεπτά",
	"mco.configure.world.invite_codes.expiration.6_hours": "6 ώρες",
	"mco.configure.world.invite_codes.expiration.7_days": "7 ημέρες",
	"mco.configure.world.invite_codes.expiration.never": "Ποτέ",
	"mco.configure.world.invite_codes.loading": "Φόρτωση κωδικών πρόσκλησης",
	"mco.configure.world.invite_codes.subtitle": "Μπορείς να προσθέσεις μέχρι %s κωδικούς πρόσκλησης και να τους κοινοποιήσεις ώστε ο κόσμος να μπορεί να συνδεθεί στο Realm σου",
	"mco.configure.world.invite_codes.title": "Κωδικοί Πρόσκλησης (%s/%s)",
	...
	"mco.configure.world.renderDistance": "Όριο Απόστασης Απόδοσης",
	"mco.configure.world.renderDistance.tooltip": "Η μέγιστη απόσταση που είναι ορατή σε μέλη Realms. Οι υψηλότερες τιμές μπορεί να επηρεάσουν την απόδοση.",
	...
	"mco.configure.world.simulationDistance": "Απόσταση Προσομοίωσης",
	"mco.configure.world.simulationDistance.tooltip": "Η εμβέλεια γύρω από παίκτες όπου το παιχνίδι φορτώνει και εφαρμόζει αλλαγές.",
	...
	"mco.errorMessage.6002": "Οι Όροι Παροχής Υπηρεσιών δεν έχουν γίνει δεκτοί",
	...
	"mco.onlinePlayers": "Παίκτες σε Σύνδεση",
	...
	"mco.selectServer.joinCode": "Κωδικός Σύνδεσης",
	"mco.selectServer.joinCode.hint": "Εισήγαγε κωδικό σύνδεσης",
	"mco.selectServer.joinCode.invalid": "Ο κωδικός που εισήγαγες είναι μη έγκυρος.",
	"mco.selectServer.joinCode.title": "Εισήγαγε Κωδικό Σύνδεσης",
	"mco.selectServer.joinCode.validating": "Επικύρωση κωδικού",
	"mco.selectServer.joinRealm": "Σύνδεση στο Realm",
	...
	"mco.selectServer.popup": "Τα Realms είναι ένας ασφαλής, απλός τρόπος να απολαύσεις έναν διαδικτυακό κόσμο Minecraft με μέχρι δέκα φίλους τη φορά. Υποστηρίζουν πολλά μίνι-παιχνίδια και αρκετούς προσαρμοσμένους κόσμους! Μόνο ο ιδιοκτήτης του Realm πρέπει να πληρώσει.",
	...
	"mco.snapshot.subscription.info": "Αυτό είναι ένα Realm Στιγμιότυπων που είναι συνδεδεμένο με τη συνδρομή του Realm σου «%s». Θα παραμείνει ενεργό για όσο θα είναι το συνδεδεμένο του Realm.",
	...
	"menu.multiplayerOptions.button": "Άνοιγμα στο LAN",
	...
	"menu.multiplayerOptions.network.online.tooltip": "Οι φίλοι στο διαδίκτυο μπορούν να συνδεθούν.",
	"menu.multiplayerOptions.otherPlayers.header": "Ρυθμίσεις για Άλλους Παίκτες",
	"menu.multiplayerOptions.publish.started.lan": "Αυτός ο κόσμος είναι τώρα ανοιχτός στο LAN. Ο αριθμός θύρας είναι %s",
	"menu.multiplayerOptions.publish.started.online": "Αυτός ο κόσμος είναι τώρα ανοιχτός στο Διαδικτυακό παιχνίδι πολλαπλών παικτών.",
	"menu.multiplayerOptions.publish.stopped": "Αυτός ο κόσμος δεν είναι πλέον ανοιχτός στο παιχνίδι πολλαπλών παικτών",
	"menu.multiplayerOptions.title": "Επιλογές LAN",
	...
	"menu.playerReporting.no_players": "Δεν υπάρχουν παίκτες για να αναφέρεις σε αυτόν τον κόσμο",
	...
	"merchant.deprecated": "Οι Χωρικοί ανεφοδιάζονται μέχρι δύο φορές την ημέρα.",
	...
	"mount.sit": "Πάτησε %[1]s για να σηκωθείς",
	...
	"multiplayer.player.list.narration": "Παίκτες σε σύνδεση: %s",
	...
	"multiplayer.texturePrompt.failure.line2": "Οποιαδήποτε λειτουργία απαιτεί προσαρμοσμένους πόρους μπορεί να μη λειτουργεί όπως αναμενόταν",
	...
	"narration.link.usage.focused": "Πάτημα Enter για ακολούθηση του συνδέσμου",
	"narration.link.usage.hovered": "Αριστερό κλικ για ακολούθηση του συνδέσμου",
	...
	"narrator.ready_to_play": "Έτοιμος/Έτοιμη για παιχνίδι",
	...
	"optimizeWorld.confirm.description": "Το παιχνίδι θα προσπαθήσει να βελτιστοποιήσει τον κόσμο σου επιβεβαιώνοντας ότι όλα τα δεδομένα είναι αποθηκευμένα στην πιο πρόσφατη μορφή παιχνιδιού. Αυτό μπορεί να πάρει πολύ χρόνο, ανάλογα με τον κόσμο σου. Όταν ολοκληρωθεί, ο κόσμος σου μπορεί να παίζεται ταχύτερα αλλά δε θα είναι πλέον συμβατός με παλιότερες εκδόσεις του παιχνιδιού. Είσαι βέβαιος/βέβαιη ότι επιθυμείς να συνεχίσεις;",
	...
	"options.allowFriendRequests.tooltip": "Επίτρεψη άλλων παικτών να σου στέλνουν αιτήματα φιλίας",
	"options.allowServerListing": "Επίτρεψη Καταχωρίσεων Διακομιστών",
	"options.allowServerListing.tooltip": "Οι διακομιστές μπορούν να καταχωρίσουν παίκτες σε σύνδεση ως μέρος της δημόσιας κατάστασής τους.\nΜε αυτήν την επιλογή απενεργοποιημένη, το όνομά σου δε θα εμφανίζεται σε τέτοιες καταχωρίσεις.",
	...
	"options.ctrlClickEmulatesRightClick": "Προσομοίωση Δεξιού Κλικ",
	"options.ctrlClickEmulatesRightClick.tooltip": "Όταν είναι ενεργοποιημένη, το Control + αριστερό κλικ αντιμετωπίζεται ως ένα δεξί κλικ. Ισχύει μόνο σε macOS.",
	...
	"options.debugGuiScale.tooltip": "Παρακάμπτει το επίστρωμα επικάλυψης αποσφαλμάτωσης με μια διαφορετική κλίμακα GUI από το υπόλοιπο παιχνίδι",
	"options.debugGuiScale.unchanged": "Ίδια",
	...
	"options.difficulty.peaceful.info": "Δε γεννιούνται εχθρικά όντα και μόνο μερικά ουδέτερα. Η μπάρα πείνας δεν εξαντλείται και η ζωή αναπληρώνεται με τον χρόνο.",
	...
	"options.exclusiveFullscreen.off.tooltip": "Όλες οι μέθοδοι εισόδου αναμένεται να λειτουργούν σε αυτήν τη λειτουργία πλήρους οθόνης, αλλά ο προσαρμόσιμος συγχρονισμός (Nvidia G-Sync, AMD FreeSync) δε θα λειτουργεί.",
	"options.exclusiveFullscreen.on.tooltip": "Αυτή η λειτουργία πλήρους οθόνης μπορεί να αποτρέψει μερικές μεθόδους εισόδου από το να λειτουργούν, αλλά ο προσαρμόσιμος συγχρονισμός (Nvidia G-Sync, AMD FreeSync) πρέπει να λειτουργεί.",
	"options.exclusiveFullscreen.warningTooltip": "Αυτή η επιλογή μπορεί να αποτρέψει μερικές μεθόδους εισόδου από το να λειτουργούν.",
	...
	"options.friendsList.confirm.message": "Χρησιμοποίησε τη Λίστα Φίλων σου για να στείλεις και να λάβεις αιτήματα φιλίας.\n\nΔιαχειρίσου τις ρυθμίσεις διαδικτυακής ασφάλειας με τον %s.",
	"options.friendsList.confirm.message.link": "λογαριασμό σου Microsoft",
	...
	"options.fullscreen.exclusive.mode": "Λειτουργία Αποκλειστικής Πλήρους Οθόνης",
	"options.fullscreen.exclusive.mode.tooltip": "Αυτή η ρύθμιση εφαρμόζεται μόνο όταν η Αποκλειστική Πλήρης Οθόνη είναι ενεργοποιημένη.",
	...
	"options.graphicsApi.tooltip.vulkan": "Πειραματική. Μπορεί να μειώσει την απόδοση ή να προκαλέσει αστάθεια σε μερικά συστήματα.",
	...
	"options.improvedTransparency.oit.tooltip": "Μια πειραματική προσέγγιση που χρησιμοποιεί έναν αλγόριθμο διαφάνειας ανεξαρτήτως σειράς για να αποφύγει γραφικά σφάλματα που είναι κανονικά παρόντα όταν κοιτάς μέσα από πολλαπλές στρώσεις ημιδιαφανών αντικειμένων.\nΑυτό θα επηρεάσει την απόδοση.",
	"options.improvedTransparency.tooltip": "Μια πειραματική προσέγγιση που χρησιμοποιεί σκίαστρα οθόνης για τη σχεδίαση καιρού, σύννεφων, και σωματιδίων πίσω από ημιδιαφανείς κύβους και νερό.\nΑυτό θα επηρεάσει την απόδοση GPU.",
	...
	"options.language.empty_or_missing_translation": "Το αρχείο μετάφρασης για %s ήταν κενό ή λείπει. Επανεκκίνησε το παιχνίδι και το πρόγραμμα εκκίνησής σου, μετά δοκίμασε ξανά.",
	"options.language.load_translations_failed": "Η φόρτωση των μεταφράσεων απέτυχε",
	...
	"options.multiplayer.title": "Άνοιγμα στο LAN",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Μερικές ενέργειες εντός ενός τμήματος θα επαναμεταγλωττίσουν το τμήμα άμεσα. Αυτό περιλαμβάνει την τοποθέτηση & καταστροφή κύβων.",
	...
	"options.quitShortcuts": "Συντομεύσεις Εξόδου",
	"options.quitShortcuts.tooltip": "Αν οι συντομεύσεις πληκτρολογίου μπορούν να κλείσουν το παιχνίδι. Όταν είναι απενεργοποιημένες, το Alt + F4 σε Windows και Linux, και το Cmd + Q σε macOS, δε θα κλείνουν πλέον το παιχνίδι.",
	...
	"options.renderDistance": "Απόσταση Απόδοσης",
	"options.resourcepack": "Πακέτα Πόρων...",
	"options.restartRequired": "Μερικές από τις αλλαγές σου απαιτούν επανεκκίνηση του παιχνιδιού για να εφαρμοστούν.",
	...
	"options.sharePresence": "Ορατότητα",
	"options.sharePresence.all": "Πλήρης",
	"options.sharePresence.all.tooltip": "Οι φίλοι μπορούν να δουν τι παίζεις.",
	"options.sharePresence.limited": "Περιορισμένη",
	"options.sharePresence.limited.tooltip": "Οι φίλοι μπορούν να δουν πότε είσαι σε σύνδεση, αλλά όχι τι παίζεις.",
	"options.sharePresence.none": "Κρυμμένη",
	"options.sharePresence.none.tooltip": "Οι φίλοι θα σε βλέπουν πάντα ως εκτός σύνδεσης.",
	...
	"options.simulationDistance": "Απόσταση Προσομοίωσης",
	...
	"options.worldOptions.allow_commands.disabled.demo.tooltip": "Δεν μπορούν να επιτραπούν οι εντολές σε έναν κόσμο επίδειξης.",
	"options.worldOptions.allow_commands.disabled.tooltip": "Δεν μπορούν να επιτραπούν οι εντολές σε έναν σκληροπυρηνικό κόσμο.",
	"options.worldOptions.allow_commands.tooltip": "Επιτρέπει τη χρήση εντολών σε αυτόν τον κόσμο.",
	"options.worldOptions.button": "Επιλογές Κόσμου...",
	"options.worldOptions.difficulty.disabled.hardcore.tooltip": "Δεν μπορεί να αλλάξει η δυσκολία σε έναν σκληροπυρηνικό κόσμο.",
	"options.worldOptions.difficulty.disabled.locked.tooltip": "Η δυσκολία είναι κλειδωμένη.",
	"options.worldOptions.difficulty.disabled.operator.tooltip": "Η αλλαγή της δυσκολίας απαιτεί άδειες διαχειριστή.",
	"options.worldOptions.game_mode": "Προεπιλεγμένη Λειτουργία Παιχνιδιού",
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Η αλλαγή της λειτουργίας παιχνιδιού απαιτεί άδειες διαχειριστή.",
	"options.worldOptions.game_mode.disabled.tooltip": "Δεν μπορεί να αλλάξει η λειτουργία παιχνιδιού σε έναν σκληροπυρηνικό κόσμο.",
	"options.worldOptions.game_mode.tooltip": "Αλλάζει την προεπιλεγμένη λειτουργία παιχνιδιού του κόσμου.",
	"options.worldOptions.general.title": "Γενικές",
	"options.worldOptions.guest.command_access": "Πρόσβαση σε Εντολές",
	"options.worldOptions.guest.command_access.disabled.commands.tooltip": "Δεν μπορεί να αλλάξει η πρόσβαση σε εντολές παικτών που συνδέονται στον κόσμο σου όταν οι εντολές δεν επιτρέπονται.",
	"options.worldOptions.guest.command_access.disabled.scope.tooltip": "Δεν μπορεί να αλλάξει η πρόσβαση σε εντολές παικτών που συνδέονται στον κόσμο σου όταν η εμβέλεια παιχνιδιού πολλαπλών παικτών του κόσμου έχει τεθεί σε «Όχι».",
	"options.worldOptions.guest.command_access.tooltip": "Ελέγχει αν οι παίκτες που συνδέονται στον κόσμο σου μπορούν να χρησιμοποιήσουν εντολές ή όχι.",
	"options.worldOptions.guest.force_game_mode": "Επιβολή Λειτουργίας Παιχνιδιού",
	"options.worldOptions.guest.force_game_mode.off.commands.tooltip": "Οι άλλοι παίκτες μπορούν να θέσουν τη δική τους λειτουργία παιχνιδιού μέσω εντολών.",
	...
	"options.worldOptions.guest.force_game_mode.off.tooltip": "Οι άλλοι παίκτες θα κρατήσουν την τρέχουσα λειτουργία παιχνιδιού τους ανεξάρτητα από την προεπιλεγμένη λειτουργία παιχνιδιού του κόσμου.",
	"options.worldOptions.guest.force_game_mode.on.tooltip": "Οι άλλοι παίκτες θα είναι υποχρεωμένοι να παίξουν την προεπιλεγμένη λειτουργία παιχνιδιού του κόσμου.",
	"options.worldOptions.multiplayer.title": "Παιχνίδι Πολλαπλών Παικτών",
	"options.worldOptions.personal_game_mode": "Προσωπική Λειτουργία Παιχνιδιού",
	"options.worldOptions.personal_game_mode.tooltip": "Αλλάζει τη λειτουργία παιχνιδιού σου σε αυτόν τον κόσμο.",
	...
	"quickplay.error.realm_connect": "Δεν μπόρεσε να γίνει σύνδεση σε αυτό το Realm",
	...
	"realms.configuration.region.canada_central": "Καναδάς",
	...
	"realms.configuration.region.mexico_central": "Μεξικό",
	"realms.configuration.region.north_central_us": "Ιλινόι, ΗΠΑ",
	"realms.configuration.region.north_europe": "Ιρλανδία",
	"realms.configuration.region.south_africa_north": "Νότια Αφρική",
	...
	"realms.configuration.region.west_us_3": "Αριζόνα, ΗΠΑ",
	...
	"recover_world.message": "Τα ακόλουθα προβλήματα προέκυψαν κατά την προσπάθεια ανάγνωσης του φακέλου κόσμου «%s».\nΜπορεί να είναι δυνατό να επαναφέρεις τον κόσμο από μια παλιότερη κατάσταση ή μπορείς να αναφέρεις αυτό το πρόβλημα στο πρόγραμμα παρακολούθησης σφαλμάτων.",
	...
	"selectWorld.experiments.info": "Τα Πειράματα είναι πιθανές νέες λειτουργίες. Να προσέχεις επειδή μερικά πράγματα μπορεί να χαλάσουν. Τα Πειράματα δεν μπορούν να απενεργοποιηθούν μετά τη δημιουργία κόσμου.",
	...
	"selectWorld.waitingForBackup.message": "Ανάλογα με το μέγεθος του κόσμου σου, αυτό μπορεί να πάρει αρκετό χρόνο. Παρακαλώ μην κλείσεις το παιχνίδι ή τη συσκευή σου.",
	"selectWorld.waitingForBackup.title": "Δημιουργία Αντιγράφου Ασφαλείας",
	"selectWorld.warning.deprecated.question": "Μερικές λειτουργίες που χρησιμοποιούνται είναι απαρχαιωμένες και θα σταματήσουν να λειτουργούν στο μέλλον. Επιθυμείς να συνεχίσεις;",
	...
	"sign.back_text": "Πίσω Κείμενο:",
	"sign.click_actions_disabled": "Οι ενέργειες κλικ είναι απενεργοποιημένες για αυτήν την πινακίδα",
	"sign.edit": "Επεξεργασία Μηνύματος Πινακίδας",
	"sign.front_text": "Μπροστινό Κείμενο:",
	...
	"spectator.cannot_teleport": "Δεν ήταν δυνατή η τηλεμεταφορά. Η άλλη πλευρά δεν έχει δημιουργηθεί ακόμη.",
	...
	"stat.minecraft.sleep_in_straw_bed": "Αριθμός Ύπνων σε Κρεβάτι Αχύρου",
	...
	"subtitles.block.poplar_leaves.ambient": "Θρόισμα φύλλων",
	...
	"subtitles.block.shelf_mushroom.bounce": "Κάτι αναπηδάει πάνω σε έναν Πολύπορο",
	...
	"subtitles.block.straw_bed.break_leave": "Κρεβάτι Αχύρου σπάει",
	...
	"subtitles.entity.armadillo.ambient": "Αρμαντίλλο γρυλίζει",
	"subtitles.entity.armadillo.brush": "Φολίδα ξεσκονίζεται",
	"subtitles.entity.armadillo.death": "Αρμαντίλλο πεθαίνει",
	"subtitles.entity.armadillo.eat": "Αρμαντίλλο τρώει",
	"subtitles.entity.armadillo.hurt": "Αρμαντίλλο τραυματίζεται",
	"subtitles.entity.armadillo.hurt_reduced": "Αρμαντίλλο προστατεύεται",
	"subtitles.entity.armadillo.land": "Αρμαντίλλο προσγειώνεται",
	"subtitles.entity.armadillo.peek": "Αρμαντίλλο κρυφοκοιτάζει",
	"subtitles.entity.armadillo.roll": "Αρμαντίλλο τυλίγεται",
	"subtitles.entity.armadillo.scute_drop": "Αρμαντίλλο αποβάλλει φολίδα",
	"subtitles.entity.armadillo.unroll_finish": "Αρμαντίλλο ξετυλίγεται",
	"subtitles.entity.armadillo.unroll_start": "Αρμαντίλλο κρυφοκοιτάζει",
	...
	"subtitles.entity.copper_golem.no_item_get": "Γκόλεμ Χαλκού μαζεύει ένα αντικείμενο",
	"subtitles.entity.copper_golem.no_item_no_get": "Γκόλεμ Χαλκού δεν μπορεί να μαζέψει ένα αντικείμενο",
	...
	"subtitles.entity.cushion.break": "Μαξιλάρι σπάει",
	"subtitles.entity.cushion.get_up": "Σηκώνεται από Μαξιλάρι",
	"subtitles.entity.cushion.place": "Μαξιλάρι τοποθετείται",
	"subtitles.entity.cushion.sit": "Κάθεται σε Μαξιλάρι",
	...
	"subtitles.entity.small_sulfur_cube.death": "Μικρή Γλίτσα Θείου πεθαίνει",
	"subtitles.entity.small_sulfur_cube.eat": "Μικρή Γλίτσα Θείου αποκτάει μάζα",
	"subtitles.entity.small_sulfur_cube.hurt": "Μικρή Γλίτσα Θείου τραυματίζεται",
	"subtitles.entity.small_sulfur_cube.jump": "Μικρή Γλίτσα Θείου αναπηδάει",
	...
	"subtitles.entity.sulfur_cube.jump": "Γλίτσα Θείου αναπηδάει",
	...
	"subtitles.item.armor.equip_copper": "Χάλκινη πανοπλία κάνει γδούπο",
	...
	"subtitles.item.armor.equip_turtle": "Κέλυφος Χελώνας κάνει γδούπο",
	...
	"telemetry.event.p2p_connection.description": "Αυτό το συμβάν μας βοηθάει να καταλάβουμε την αξιοπιστία και απόδοση των ομότιμων συνδέσεων μεταξύ παικτών. Καταγράφει αν η σύνδεση ήταν επιτυχής, ο τύπος υποψήφιου Πραγματοποίησης Διαδραστικής Σύνδεσης (ICE, το πρωτόκολλο που χρησιμοποιούμε για να πραγματοποιήσουμε ομότιμες συνδέσεις) που χρησιμοποιείται, και πόσο χρόνο χρειάστηκε για να πραγματοποιηθεί η σύνδεση.",
	"telemetry.event.p2p_connection.title": "Ομότιμη Σύνδεση",
	...
	"telemetry.event.world_load_times.description": "Είναι σημαντική για εμάς η κατανόηση του χρόνου που χρειάζεται για να συνδεθείς σε έναν κόσμο, και πώς αυτό αλλάζει με τον χρόνο. Για παράδειγμα, όταν προσθέτουμε νέο περιεχόμενο ή κάνουμε μεγαλύτερες τεχνικές αλλαγές, πρέπει να δούμε τι επίδραση είχε στους χρόνους φόρτωσης.",
	...
	"telemetry.property.backend_failure_missing_capabilities.title": "Απούσες Δυνατότητες Αποτυχίας Δημιουργίας Παρασκηνίου",
	...
	"telemetry.property.p2p_connection_failure_stage.title": "Στάδιο Αποτυχίας",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Χρόνος Σύνδεσης (Χιλιοστά του Δευτερολέπτου) Πραγματοποίησης Διαδραστικής Σύνδεσης (ICE)",
	"telemetry.property.p2p_connection_ice_path.title": "Διαδρομή Πραγματοποίησης Διαδραστικής Σύνδεσης (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Τύπος Τοπικού Υποψήφιου",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Τύπος Απομακρυσμένου Υποψήφιου",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Χρόνος Σύνδεσης Σηματοδότησης (Χιλιοστά του Δευτερολέπτου)",
	"telemetry.property.p2p_connection_successful.title": "Επιτυχής Σύνδεση",
	"telemetry.property.p2p_connection_total_time_ms.title": "Συνολικός Χρόνος Σύνδεσης (Χιλιοστά του Δευτερολέπτου)",
	...
	"telemetry.property.render_distance.title": "Απόσταση Απόδοσης",
	...
	"telemetry.property.server_session_id.title": "Αναγνωριστικό Συνεδρίας Διακομιστή",
	...
	"telemetry_info.button.show_data": "Εμφάνιση Δεδομένων Μου",
	...
	"test.player.coordinates": "Συντεταγμένες παίκτη: [%s, %s, %s] στη διάσταση %s",
	"test.run.coordinates": "Συντεταγμένες δοκιμής: [%s, %s, %s] στη διάσταση %s",
	...
	"upgradeWorld.joinNow": "Θέλεις να συνδεθείς στον κόσμο τώρα;",
