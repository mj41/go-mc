// Code generated by tools/gen_lang.go from 1.21.11/tt_ru.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Бер генә тапкыр булса да күрсәтелгән шаблоннарны кулланыгыз: «Оч», «Чырай», «Кабырга», «Сакчы», «Тынлык», «Газаплаучы», «Күтәрелү» һәм «Эзләүче»",
	...
	"attribute.name.generic.oxygen_bonus": "Кислород бонусы",
	"attribute.name.generic.safe_fall_distance": "Килеп төшү өчен куркынычсыз биеклек",
	...
	"block.minecraft.chain": "Тимер чылбыр",
	...
	"block.minecraft.cherry_hanging_sign": "Элүле чия билге",
	...
	"block.minecraft.cherry_wall_hanging_sign": "Элүле чия дивардагы билге",
	"block.minecraft.cherry_wall_sign": "Чия дивардагы билге",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "Агуланган уелган таш кирпечләр",
	...
	"block.minecraft.mud_brick_wall": "Саман кирпеч киртәсе",
	...
	"block.minecraft.pale_hanging_moss": "Элүле тонык мүк",
	...
	"block.minecraft.pale_oak_hanging_sign": "Элүле тонык имән билге",
	...
	"block.minecraft.pale_oak_wall_hanging_sign": "Элүле тонык имән дивардагы билге",
	"block.minecraft.pale_oak_wall_sign": "Тонык имән дивардагы билге",
	...
	"book.page_button.previous": "Үткән бит",
	...
	"command.context.parse_error": "%[2]s урында %[1]s: %[3]s",
	...
	"dataPack.redstone_experiments.name": "Редстоун экспериментлары",
	...
	"entity.minecraft.cherry_boat": "Чия",
	...
	"gui.up": "Өскә",
	"gui.waitingForResponse.button.inactive": "Артка (%s с)",
	...
	"item.minecraft.crossbow.projectile.multiple": "Җайланма: ×%s %s",
	"item.minecraft.crossbow.projectile.single": "Җайланма: %s",
	...
	"item.minecraft.smithing_template.armor_trim.applies_to": "Тышча",
	"item.minecraft.smithing_template.armor_trim.base_slot_description": "Тышча өлешен монда куегыз",
	...
	"multiplayer.disconnect.banned.reason.default": "Оператор тарафыннан блокланган.",
	...
	"multiplayer.status.cannot_resolve": "Төен исемен ачыклап булмый",
	...
	"trim_material.minecraft.resin": "Сагыз материалы",
