// Code generated by tools/gen_lang.go from 1.21.11/nl_nl.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"attribute.name.follow_range": "Volgbereik wezens",
	...
	"gui.copy_link_to_clipboard": "Kopiëren naar klembord",
	"gui.days": "%s dag(en)",
	"gui.done": "Gereed",
	"gui.down": "Omlaag",
	...
	"mco.compatibility.incompatible.releaseType.popup.message": "De wereld die je probeert te betreden is niet compatibel met de versie waarin je speelt.",
	"mco.compatibility.incompatible.series.popup.message": "Deze wereld is voor het laatst betreden in versie %s; je speelt nu in versie %s.\n\nDeze versies zijn niet compatibel met elkaar. Om in deze versie te spelen, heb je een nieuwe wereld nodig.",
	...
	"mco.configure.world.leave.question.line1": "Je ziet deze Realm niet meer, tenzij je opnieuw uitgenodigd wordt.",
	...
	"mco.selectServer.popup": "Realms is een veilige en makkelijke manier om een onlinewereld met tot wel tien vrienden te delen. Er zijn veel minispellen en meer dan genoeg aangepaste werelden! Alleen de eigenaar van het domein hoeft te betalen.",
	...
	"selectWorld.backupWarning.file_fixing_required": "Deze wereld heeft een upgrade nodig voor je kunt spelen. Het vooraf maken van een back-up wordt aangeraden voor het geval de wereld beschadigd raakt.",
	...
	"upgradeWorld.joinNow": "Wil je de wereld nu betreden?",
	...
	"upgradeWorld.symlink.message": "De geselecteerde wereld bevat symbolische links. Het wereldupgradeproces ondersteunt symbolische links niet. Om de wereld te upgraden, moeten de links eerst voluit worden geschreven.",
