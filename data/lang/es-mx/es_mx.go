// Code generated by tools/gen_lang.go from 1.21.11/es_mx.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"gui.abuseReport.draft.title": "¿Editar borrador del reporte de chat?",
	...
	"options.graphics.preset.tooltip": "Establece los ajustes de «Calidad y rendimiento» en valores razonables que se corresponden con la calidad deseada.",
	...
	"options.textureFiltering.rgss.tooltip": "(Rotated Grid Super Sampling)\nUn método de filtrado basado en sombreado que mejora la calidad de texturas con un impacto moderado en el rendimiento.",
	...
	"upgradeWorld.done": "Mejora del mundo completada",
	...
	"upgradeWorld.progress.type.legacy_structures": "Mejorando estructuras heredadas",
