// Code generated by tools/gen_lang.go from 26.2/es_mx.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.husbandry.uh_oh.title": "Ay, no",
	...
	"argument.pos.outofbounds": "Esa posición está fuera de los límites permitidos.",
	...
	"attribute.name.below_name_distance": "Distancia del marcador de puntos",
	...
	"biome.minecraft.dappled_forest": "Bosque de álamos",
	...
	"block.minecraft.black_concrete_slab": "Losa de concreto negro",
	...
	"block.minecraft.blue_concrete_slab": "Losa de concreto azul",
	...
	"block.minecraft.brown_concrete_slab": "Losa de concreto café",
	"block.minecraft.brown_concrete_stairs": "Escaleras de concreto café",
	...
	"block.minecraft.brown_wool_slab": "Losa de lana café",
	"block.minecraft.brown_wool_stairs": "Escaleras de lana café",
	...
	"block.minecraft.cyan_concrete_slab": "Losa de concreto cian",
	...
	"block.minecraft.gray_concrete_slab": "Losa de concreto gris",
	...
	"block.minecraft.green_concrete_slab": "Losa de concreto verde",
	...
	"block.minecraft.light_blue_concrete_slab": "Losa de concreto azul claro",
	"block.minecraft.light_blue_concrete_stairs": "Escaleras de concreto azul claro",
	...
	"block.minecraft.light_gray_concrete_slab": "Losa de concreto gris claro",
	...
	"block.minecraft.lime_concrete_slab": "Losa de concreto verde lima",
	...
	"block.minecraft.lime_wool_slab": "Losa de lana verde lima",
	"block.minecraft.lime_wool_stairs": "Escaleras de lana verde lima",
	...
	"block.minecraft.magenta_concrete_slab": "Losa de concreto magenta",
	...
	"block.minecraft.orange_concrete_slab": "Losa de concreto naranja",
	...
	"block.minecraft.pink_concrete_slab": "Losa de concreto rosa",
	...
	"block.minecraft.poplar_hanging_sign": "Letrero colgante de álamo",
	...
	"block.minecraft.poplar_sapling": "Retoño de álamo",
	"block.minecraft.poplar_shelf": "Repisa de álamo",
	"block.minecraft.poplar_sign": "Letrero de álamo",
	...
	"block.minecraft.poplar_wall_hanging_sign": "Letrero colgante de álamo en pared",
	"block.minecraft.poplar_wall_sign": "Letrero de álamo en pared",
	...
	"block.minecraft.potted_poplar_sapling": "Maceta con retoño de álamo",
	...
	"block.minecraft.purple_concrete_slab": "Losa de concreto morado",
	"block.minecraft.purple_concrete_stairs": "Escaleras de concreto morado",
	...
	"block.minecraft.red_concrete_slab": "Losa de concreto rojo",
	...
	"block.minecraft.white_concrete_slab": "Losa de concreto blanco",
	...
	"block.minecraft.yellow_concrete_slab": "Losa de concreto amarillo",
	...
	"chat_restriction.disabled_by_launcher": "Chat restringido por el cliente.",
	...
	"command.compute.result.named.exact": "%s devolvió el valor %s",
	"command.compute.result.named.rounded": "%s devolvió el valor %s (redondeado a %s)",
	"command.compute.result.unnamed.exact": "El proveedor de números devolvió el valor %s",
	"command.compute.result.unnamed.rounded": "El proveedor de números devolvió el valor %s (redondeado a %s)",
	...
	"commands.fillbiome.no_changes": "No se cambiaron entradas de biomas",
	...
	"commands.gamerule.not_set": "La regla %s ya está establecida como %s",
	...
	"commands.item.block.modify.success": "Se modificaron %s ranura(s) en %s, %s, %s",
	"commands.item.block.replace.success": "Se reemplazaron %s ranura(s) en %s, %s, %s",
	"commands.item.block.replace.success.known_item": "Se reemplazaron %s ranura(s) en %s, %s, %s con %s",
	"commands.item.block.set.success": "Espacio en %s, %s, %s reemplazado con %s",
	"commands.item.entity.modify.success.multiple": "Se modificaron ranura(s) en %s entidades",
	"commands.item.entity.modify.success.single": "Se modificaron %s ranura(s) en %s",
	"commands.item.entity.replace.success.multiple": "Se reemplazaron ranura(s) en %s entidades",
	"commands.item.entity.replace.success.multiple.known_item": "Se reemplazaron ranura(s) en %s entidades con %s",
	"commands.item.entity.replace.success.single": "Se reemplazaron %s ranura(s) en %s",
	"commands.item.entity.replace.success.single.known_item": "Se reemplazaron %s ranura(s) en %s con %s",
	...
	"commands.item.source.no_such_slot.unnamed": "El origen no tiene las ranuras especificadas",
	"commands.item.source.not_a_container": "La ubicación %s, %s, %s no es un contenedor",
	"commands.item.target.failed": "Ningún objetivo aceptó objetos en las ranuras especificadas",
	"commands.item.target.failed.known_item": "Ningún objetivo aceptó el objeto %s en las ranuras especificadas",
	...
	"commands.item.target.no_such_slot.unnamed": "El objetivo no tiene las ranuras especificadas",
	...
	"commands.posteffect.add.failed": "El jugador ya tiene el posefecto especificado",
	...
	"commands.posteffect.clear.failed": "El jugador no tiene ningún posefecto que eliminar",
	...
	"commands.posteffect.remove.failed": "El jugador no tiene el posefecto especificado",
	...
	"commands.time.pause.already_running": "El reloj %s ya está ejecutándose",
	...
	"commands.time.rate.already_same": "El reloj %s ya está avanzando al ritmo normal x%s",
	...
	"commands.time.set.already_at_time": "El reloj %s ya está en %s tic(s)",
	"commands.time.set.already_at_time_marker": "El reloj %s ya está en el marcador de tiempo %s",
	...
	"death.attack.sulfurCubeHot.item": "%[2]s le ha demostrado a %[1]s que no solo el suelo es lava con su %[3]s",
	...
	"editGamerule.inGame.disabled.hardcore.tooltip": "No se pueden cambiar las reglas del juego en un mundo en modo extremo.",
	...
	"filled_map.bamboo_camp_map": "Mapa de campamento de la jungla de bambú",
	"filled_map.bamboo_jungle_abandoned_camp": "Mapa de campamento abandonado de la jungla de bambú",
	"filled_map.birch_forest_abandoned_camp": "Mapa de campamento abandonado del abedular",
	"filled_map.birch_forest_camp_map": "Mapa de campamento del abedular",
	"filled_map.buried_treasure": "Mapa del tesoro",
	"filled_map.cherry_grove_abandoned_camp": "Mapa de campamento abandonado de la arboleda de cerezos",
	"filled_map.cherry_grove_camp_map": "Mapa de campamento de la arboleda de cerezos",
	"filled_map.dappled_forest_abandoned_camp": "Mapa de campamento abandonado del bosque de álamos",
	"filled_map.dappled_forest_camp_map": "Mapa de campamento del bosque de álamos",
	"filled_map.explorer_jungle": "Mapa de exploración de la jungla",
	"filled_map.explorer_swamp": "Mapa de exploración del pantano",
	"filled_map.flower_forest_abandoned_camp": "Mapa de campamento abandonado del bosque floral",
	"filled_map.flower_forest_camp_map": "Mapa de campamento del bosque floral",
	"filled_map.id": "Id. n.º %s",
	"filled_map.jungle_temple": "Mapa de templo de la jungla",
	...
	"filled_map.pale_garden_abandoned_camp": "Mapa de campamento abandonado del jardín pálido",
	"filled_map.pale_garden_camp_map": "Mapa de campamento del jardín pálido",
	"filled_map.scale": "Escala 1:%s",
	"filled_map.swamp_abandoned_camp": "Mapa de campamento abandonado del pantano",
	"filled_map.swamp_camp_map": "Mapa de campamento del pantano",
	...
	"filled_map.windswept_forest_abandoned_camp": "Mapa de campamento abandonado del bosque ventoso",
	"filled_map.windswept_forest_camp_map": "Mapa de campamento del bosque ventoso",
	...
	"gamerule.doEntityDrops.description": "Controla que caigan ítems al romper una entidad. Afecta a vagones (incluyendo sus inventarios), marcos, botes, etc.",
	...
	"generator.minecraft.flat_all_dimensions": "Todas las dimensiones planas",
	...
	"gui.friends.error.unauthorized": "Token no válido. Reinicia el juego y el launcher y reinténtalo.",
	...
	"gui.friends.validation.already_incoming": "%s ya te ha enviado una solicitud de amistad",
	...
	"item.minecraft.brown_cushion": "Cojín café",
	...
	"item.minecraft.buried_treasure_map": "Mapa de tesoro enterrado",
	"item.minecraft.buried_trial_chambers_map": "Mapa de cámaras de desafío enterradas",
	...
	"item.minecraft.desert_pyramid_map": "Mapa de pirámide del desierto",
	"item.minecraft.desert_village_map": "Mapa de aldea del desierto",
	...
	"item.minecraft.jungle_explorer_map": "Mapa de exploración de pirámide de la selva",
	"item.minecraft.jungle_pyramid_map": "Mapa de pirámide de la jungla",
	...
	"item.minecraft.ocean_explorer_map": "Mapa de exploración del océano",
	...
	"item.minecraft.plains_village_map": "Mapa de aldea de la llanura",
	...
	"item.minecraft.savanna_village_map": "Mapa de aldea de la sabana",
	...
	"item.minecraft.snowy_village_map": "Mapa de aldea de la llanura nevada",
	...
	"item.minecraft.swamp_explorer_map": "Mapa de exploración de choza del pantano",
	"item.minecraft.swamp_hut_map": "Mapa de choza de pantano",
	...
	"item.minecraft.taiga_village_map": "Mapa de aldea de la taiga",
	...
	"item.minecraft.trial_explorer_map": "Mapa de exploración de cámara de desafío",
	...
	"item.minecraft.warm_ocean_ruins_map": "Mapa de ruinas del océano cálido",
	...
	"item.minecraft.woodland_explorer_map": "Mapa de exploración de mansión del bosque",
	...
	"key.keyboard.left.command": "Comando izdo.",
	"key.keyboard.left.control": "Control izdo.",
	"key.keyboard.left.meta": "Meta izq.",
	"key.keyboard.left.option": "Opción izdo.",
	"key.keyboard.left.shift": "Mayús izdo.",
	"key.keyboard.left.win": "Meta izdo.",
	"key.keyboard.left.windows": "Win izdo.",
	...
	"key.keyboard.right.command": "Comando dcho.",
	"key.keyboard.right.control": "Control dcho.",
	"key.keyboard.right.meta": "Meta der.",
	"key.keyboard.right.option": "Opción dcho.",
	"key.keyboard.right.shift": "Mayús dcho.",
	"key.keyboard.right.win": "Meta dcho.",
	"key.keyboard.right.windows": "Win dcho.",
	...
	"mco.configure.world.invite_codes.edit.expires": "Expira en %s",
	...
	"mco.configure.world.invite_codes.loading": "Cargando código de invitación",
	"mco.configure.world.invite_codes.subtitle": "Puedes añadir hasta %s códigos y compartirlos para que la gente se pueda unir a tu \"Realm\"",
	...
	"mco.pdp.minigames.description": "Explora la variada librería de minijuegos, mapas de aventuras y más.",
	"mco.pdp.minigames.title": "Minijuegos - Contenido gratuito de creadores",
	"mco.pdp.private.backups": "Copias de seguridad automáticas",
	"mco.pdp.private.easyToManage": "• Fácil de configurar, fácil de gestionar",
	"mco.pdp.private.secure": "Privado y seguro",
	"mco.pdp.private.title": "Servidor personal",
	"mco.pdp.private.worldSlots": "• Tres ranuras de mundos",
	"mco.pdp.trial.description": "¡Prueba gratuita de 30 días!",
	...
	"mco.selectServer.joinCode.hint": "Escribir código de acceso",
	"mco.selectServer.joinCode.invalid": "El código que escribiste es inválido.",
	"mco.selectServer.joinCode.title": "Escribir código de acceso",
	"mco.selectServer.joinCode.validating": "Validando código",
	"mco.selectServer.joinRealm": "Únete al Realm",
	...
	"narration.link.usage.focused": "Presiona Enter para visitar el enlace",
	...
	"options.ctrlClickEmulatesRightClick": "Emulación de clic derecho",
	...
	"options.language.empty_or_missing_translation": "El archivo de traducción para %s estaba vacío o no se encontraba. Reinicia el juego y el lanzador, y vuelve a intentarlo.",
	...
	"options.languageWarning": "La traducción podría no ser 100%% precisa",
	...
	"options.quitShortcuts.tooltip": "Controla si los atajos del sistema pueden cerrar el juego. Si está desactivado, Alt + F4 en Windows y Linux, y Cmd + Q y Cmd + W en macOS ya no cerrarán el juego.",
	...
	"options.worldOptions.allow_commands.disabled.demo.tooltip": "No se permiten los comandos en mundo en modo de prueba.",
	"options.worldOptions.allow_commands.disabled.tooltip": "No se permiten los comandos en un mundo en modo extremo.",
	...
	"options.worldOptions.difficulty.disabled.hardcore.tooltip": "No se puede cambiar la dificultar en un mundo en modo extremo.",
	"options.worldOptions.difficulty.disabled.locked.tooltip": "La dificultad está bloqueada.",
	"options.worldOptions.difficulty.disabled.operator.tooltip": "Cambiar la dificultad requiere permisos de operador.",
	"options.worldOptions.game_mode": "Modo de juego por defecto",
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Cambiar el modo del juego requiere permisos de administrador.",
	"options.worldOptions.game_mode.disabled.tooltip": "No se puede cambiar el modo de juego en un mundo en modo extremo.",
	...
	"options.worldOptions.guest.command_access.disabled.commands.tooltip": "No se puede cambiar el acceso a comandos de los jugadores que se unen a tu mundo cuando los comandos están desactivados.",
	"options.worldOptions.guest.command_access.disabled.scope.tooltip": "No se puede cambiar el acceso a comandos de los jugadores que se unen a tu mundo cuando el alcance del multijugador del mundo está establecido como \"No\".",
	"options.worldOptions.guest.command_access.tooltip": "Controla si los jugadores que se unen a tu mundo pueden usar comandos o no.",
	"options.worldOptions.guest.force_game_mode": "Forzar modo de juego",
	"options.worldOptions.guest.force_game_mode.off.commands.tooltip": "Otros jugadores pueden cambiar su propio modo de juego con comandos.",
	"options.worldOptions.guest.force_game_mode.off.hardcore.tooltip": "No se puede cambiar esta configuración en un mundo en modo extremo.",
	"options.worldOptions.guest.force_game_mode.off.scope.tooltip": "No se puede cambiar esta configuración cuando el alcance multijugador del mundo está establecido como \"No\".",
	"options.worldOptions.guest.force_game_mode.off.tooltip": "Los demás jugadores conservarán su modo de juego actual, sin importar el modo de juego predeterminado del mundo.",
	"options.worldOptions.guest.force_game_mode.on.tooltip": "Otros jugadores pueden ser forzados a jugar el modo de juego por defecto del mundo.",
	...
	"selectWorld.conversion.tooltip": "Mira carnal puede que este mundo se heche a perder regrésate a la 1.6.4",
	...
	"selectWorld.load_folder_access": "¡No se pudo acceder o leer la carpeta donde se guardan los mundos!",
	...
	"sign.click_actions_disabled": "Las acciones de clic están desactivadas para este cartel",
	"sign.edit": "Editar mensaje del letrero",
	"sign.front_text": "Texto frontal:",
	...
	"spectator.cannot_teleport": "No se pudo teletransportarse. El otro lado no está generado aún.",
	...
	"stat.minecraft.sleep_in_straw_bed": "Veces que dormí en una cama de paja",
	...
	"subtitles.block.straw_bed.break_leave": "Cojín rompiéndose",
	...
	"subtitles.entity.cushion.break": "Cojín rompiéndose",
	"subtitles.entity.cushion.get_up": "Levantándose de cojín",
	"subtitles.entity.cushion.place": "Cojín colocado",
	"subtitles.entity.cushion.sit": "Sentándose sobre cojín",
	...
	"subtitles.entity.nautilus.riding": "Nautilo burbujeando",
	...
	"subtitles.entity.small_sulfur_cube.death": "Cubo de azufre pequeño muerto",
	"subtitles.entity.small_sulfur_cube.eat": "Cubo de azufre pequeño aumenta de masa",
	"subtitles.entity.small_sulfur_cube.hurt": "Cubo de azufre pequeño es golpeado",
	...
	"telemetry.property.server_session_id.title": "ID de Sesión de Servidor",
	...
	"upgradeWorld.aborted.file_already_exists": "La carpeta del mundo parece ya contener algunos archivos actualizados. El juego no puede actualizar correctamente tu mundo.",
