// Code generated by tools/gen_lang.go from 1.21.11/no_no.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.schedule.cleared.success": "Fjernet %s timeplan(er) med id %s",
	...
	"commands.swing.failed.notliving": "Ingen levende enheter ble funnet for å kunne slå",
	"commands.swing.success.multiple": "Fikk %s enheter til å svinge armene sine",
	"commands.swing.success.single": "Fikk %s til å svinge en arm",
	...
	"commands.time.no_default_clock": "Det er ingen standard verdensklokke i dimensjon %s",
	"commands.time.no_time_marker_found": "Tidsmarkør %s finnes ikke for verdensklokke %s",
	"commands.time.pause": "Satte verdensklokke %s på pause",
	"commands.time.query": "Tiden er %s",
	"commands.time.query.absolute": "Verdensklokke %s er på %s tikk",
	"commands.time.query.gametime": "Verdenstiden er på %s tikk",
	"commands.time.query.timeline": "Tidslinje %s står på %s tikk",
	"commands.time.query.timeline.repetitions": "Tidslinje %s har passert %s repetisjon(er)",
	"commands.time.resume": "Satte verdensklokke %s i gang igjen",
	"commands.time.set": "Setter tiden til %s",
	"commands.time.set.absolute": "Satte %s til %s tikk",
	"commands.time.set.time_marker": "Stilte %s til tidsmarkør %s",
	"commands.time.wrong_timeline_for_clock": "Tidslinje %s er ikke gyldig for verdensklokke %s",
	...
	"datapackFailure.title": "Feil i nåvalgte datapakker forhindret verdenen fra å laste inn.\nDu kan enten prøve å laste inn verdenen med kun Vanilla-datapakken (\"trygg modus\"), eller gå tilbake til hovedmenyen og fikse det manuelt.",
	...
	"editGamerule.inGame.button": "Endre spillregler...",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Spillerens forsinkelse i netherportaler i kreativ modus",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Spillerens forsinkelse i netherportaler utenom kreativ modus",
	...
	"key.debug.lightmapTexture": "Lyskarttekstur",
	"key.debug.modifier": "Feilsøkingsmodifikator",
	...
	"mco.compatibility.unverifiable.message": "Versjonen denne verdenen sist spiltes på kunne ikke fastsettes. Hvis verdenen oppgraderes eller nedgraderes, lagres en reservekopi automatisk i «Verdensreservekopier».",
	"mco.compatibility.unverifiable.title": "Forenlighet kan ikke bekreftes",
	"mco.compatibility.upgrade": "Oppgrader",
	"mco.compatibility.upgrade.description": "Denne verdenen spiltes sist på i versjon %s; du er nå på versjon %s.\n\nEn reservekopi av verdenen din vil lagres i «Verdensreservekopier».\n\nGjenopprett verdenen din derfra om nødvendig.",
	"mco.compatibility.upgrade.friend.description": "Denne verdenen ble sist spilt på i versjon %s; du er nå i versjon %s.\n\nEn reservekopi av verdenen vil lagres i mappen \"World Backups\".\n\nEieren av Realmen kan gjenopprette verdenen om nødvendig.",
	...
	"options.video.display.header": "Visning",
	...
	"selectWorld.backupWarning.file_fixing_required": "Denne verdenen må oppgraderes før du kan spille den. Vi anbefaler sterkt å lage en reservekopi før du fortsetter, i tilfelle du opplever korrupsjoner i verdenen.",
	"selectWorld.backupWarning.snapshot": "Denne verdenen ble sist spilt på i versjon %s; Du er i versjon %s. Vennligst lag en reservekopi i tilfelle du erfarer verdenskorrupsjon.",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Denne verdenen må oppgraderes til den nyeste versjonen før du kan redigere den, på grunn av underliggende endringer gjort til verdensformatet.",
	"selectWorld.requiresFileFixingTooltip.play": "Denne verdenen må oppgraderes til den nyeste versjonen før du kan spille den, på grunn av underliggende endringer gjort til verdensformatet.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Denne verdenen må oppgraderes til den nyeste versjonen før du kan lage den på nytt, på grunn av underliggende endringer gjort til verdensformatet.",
	...
	"selectWorld.waitingForBackup.message": "Dette kan ta en stund, avhengig av størrelsen på verdenen din. Vennligst ikke lukk spillet eller slå av enheten.",
	...
	"selectWorld.world_gen_settings_access": "Kan ikke lese eller få tilgang til filen for verdensgenereringsinnstillinger! %s",
	"selecteWorld.backupRequiredTooltip": "Å laste inn verdenen krever å lage reservekopi først",
	...
	"subtitles.item.golden_dandelion.unuse": "Gyllen løvetann ugjøres",
	"subtitles.item.golden_dandelion.use": "Gyllen løvetann stopper aldring",
	...
	"test.error.expected_block_present": "Forventet at blokk %s ville være til stede",
	...
	"upgradeWorld.symlink.message": "Den valgte verdenen inneholder symbolske lenker.\nStegene som kreves for å oppgradere verdenen til den nåværende versjonen støtter ikke bruk av symbolske lenker. For å oppgradere verdenen må lenkene bli løst først.",
	"upgradeWorld.symlink.title": "Kan ikke oppgradere verden",
