// Code generated by tools/gen_lang.go from 1.21.11/mt_mt.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Issettjar tal-aċċessibilità...",
	"accessibility.onboarding.screen.narrator": "Agħfas enter biex tattiva n-narratur",
	...
	"advMode.notEnabled.spawner": "Blokok tat-tnissil mhumiex attivati",
	...
	"advancements.adventure.arbalistic.description": "Oqtol ħames kreaturi uniċi b'sparatura waħda ta' Qaws Żgħir",
	"advancements.adventure.arbalistic.title": "Arbalistika",
	"advancements.adventure.avoid_vibration.description": "Imxi inkiss inkiss ħdejn Senser tas-Skulk jew Għassies biex tipprevjenih milli jiskoprik",
	"advancements.adventure.avoid_vibration.title": "Inkiss 100",
	"advancements.adventure.blowback.description": "Oqtol Fewwieġ b'Żiffa Riħ sparata minnu stess",
	"advancements.adventure.blowback.title": "Onfoħ Lura",
	"advancements.adventure.brush_armadillo.description": "Akkwista Scutes t'Armadillo bl-użu ta' pinzell",
	"advancements.adventure.brush_armadillo.title": "Mhuwiex Skustuż?",
	"advancements.adventure.bullseye.description": "Ilqa' n-nofs ta' Blokk tal-Mira minn mill-inqas 30 metru l-bogħod",
	"advancements.adventure.bullseye.title": "Ċentru tal-Mira",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Għamel Vażun taċ-Ċeramika Imżejna minn 4 Xaqquf",
	...
	"advancements.adventure.fall_from_world_height.description": "Aqbeż mill-quċċata tad-dinja (il-limitu tal-bini) sal-qiegħ tad-dinja u ibqa' ħaj",
	"advancements.adventure.fall_from_world_height.title": "Għerien u Rdum",
	"advancements.adventure.heart_transplanter.description": "Poġġi Qalb Tiżaqżaq bl-allinjament korrett bejn żewġ blokok taz-Zokk tal-Ballut Pallidu",
	"advancements.adventure.heart_transplanter.title": "Kirurgu tal-Qalb",
	"advancements.adventure.hero_of_the_village.description": "Iddefendi b'suċċess raħal minn attakk",
	"advancements.adventure.hero_of_the_village.title": "Eroj tar-Raħal",
	"advancements.adventure.honey_block_slide.description": "Aqbeż f'Blokk tal-Għasel biex ma tweġġax minn waqgħa",
	"advancements.adventure.honey_block_slide.title": "Sitwazzjoni Dellikija",
	"advancements.adventure.kill_a_mob.description": "Oqtol kwalunkwe mostru ostili",
	"advancements.adventure.kill_a_mob.title": "Kaċċatur tal-Mostri",
	"advancements.adventure.kill_all_mobs.description": "Oqtol wieħed minn kull mostru ostili",
	"advancements.adventure.kill_all_mobs.title": "Mostri Kkaċċjati",
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Oqtol kreatura ħdejn Katalist tas-Skulk",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "Tixxeblek",
	"advancements.adventure.lighten_up.description": "Obrox Bozza tar-Ram b'Manarra sabiex tqawwi d-dawl tagħha",
	"advancements.adventure.lighten_up.title": "Qawwi d-Dawl",
	"advancements.adventure.lightning_rod_with_villager_no_fire.description": "Ipproteġi lil raħli minn żilżla mingħajr ma jaqbad ebda nar",
	"advancements.adventure.lightning_rod_with_villager_no_fire.title": "Protettur miż-Żliezel",
	"advancements.adventure.minecraft_trials_edition.description": "Idħol f'Sala tal-Provi",
	"advancements.adventure.minecraft_trials_edition.title": "Minecraft: Edizzjoni tal-Prova(i)",
	"advancements.adventure.ol_betsy.description": "Spara Qaws Żgħir",
	"advancements.adventure.ol_betsy.title": "Ol' Betsy",
	"advancements.adventure.overoverkill.description": "Għamel 50 qlub ta' weġgħa f'daqqa waħda bl-użu tal-Mazza",
	"advancements.adventure.overoverkill.title": "Ħafna Ħafna Weġgħa",
	"advancements.adventure.play_jukebox_in_meadows.description": "Agħti l-ħajja lill-Mergħat bil-ħoss tal-mużika minn Jukebox",
	"advancements.adventure.play_jukebox_in_meadows.title": "Ħoss tal-Mużika",
	"advancements.adventure.read_power_from_chiseled_bookshelf.description": "Aqra s-sinjal tal-enerġija ta' Xkaffa tal-Kotba Mnaqqxa bl-użu ta' Komparatur",
	"advancements.adventure.read_power_from_chiseled_bookshelf.title": "Il-Qawwa tal-Kotba",
	"advancements.adventure.revaulting.description": "Iftaħ Kannierja Heddidija b'Ċavetta Heddidija tal-Provi",
	"advancements.adventure.revaulting.title": "Qfil Ripetuta",
	"advancements.adventure.root.description": "Avventura, esplorazzjoni u ġlied",
	"advancements.adventure.root.title": "Avventura",
	"advancements.adventure.salvage_sherd.description": "Xkupilja Blokk Suspettuż sabiex tikseb Xaqquf",
	"advancements.adventure.salvage_sherd.title": "Nirrispettaw il-Fdalijiet",
	"advancements.adventure.shoot_arrow.description": "Olqot xi ħaġa b'Vleġġa",
	"advancements.adventure.shoot_arrow.title": "Ħu l-Għan",
	"advancements.adventure.sleep_in_bed.description": "Orqod f'Sodda sabiex tbiddel il-post tal-ħolqien tiegħek",
	...
	"advancements.adventure.sniper_duel.title": "Dwell tal-Isnajpers",
	"advancements.adventure.spear_many_mobs.description": "Olqot ħames kreaturi b'Lanza fl-istess attakk karikat",
	"advancements.adventure.spear_many_mobs.title": "Kebab tal-Kreaturi",
	"advancements.adventure.spyglass_at_dragon.description": "Ħares lejn id-Dragun tat-Tmiem bl-użu ta' Teleskopju Panoramiku",
	"advancements.adventure.spyglass_at_dragon.title": "Huwa Ajruplan?",
	"advancements.adventure.spyglass_at_ghast.description": "Ħares lejn Waħx bl-użu ta' Teleskopju Panoramiku",
	"advancements.adventure.spyglass_at_ghast.title": "Hija Bużżieqa?",
	"advancements.adventure.spyglass_at_parrot.description": "Ħares lejn Pappagall bl-użu ta' Teleskopju Panoramiku",
	"advancements.adventure.spyglass_at_parrot.title": "Huwa Għasfur?",
	"advancements.adventure.summon_iron_golem.description": "Sejjaħ Ġgant tal-Ħadid sabiex jgħinek tiddefendi Raħal",
	"advancements.adventure.summon_iron_golem.title": "Għajnuna Mikrija",
	"advancements.adventure.throw_trident.description": "Venven Trident lejn xi ħaġa.\nNota: Li twaddab l-unika arma tiegħek mhijiex idea tajba.",
	"advancements.adventure.throw_trident.title": "Ċajta Mwaddba",
	"advancements.adventure.totem_of_undying.description": "Uża Totem tal-Immortalità sabiex issalva lilek innifsek mill-mewt",
	"advancements.adventure.totem_of_undying.title": "Immortali",
	"advancements.adventure.trade.description": "Innegozja b'suċċess ma' Raħli",
	...
	"advancements.adventure.trade_at_world_height.title": "Negozjar Qalb l-Istilel",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Applika dawn il-mudelli tal-forġa mill-inqas darba: Spira, Geddum, Kustilja, Sala, Skiet, Kedd, Marea, Sejjieb tal-Mogħdija",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Ħdim bl-Istil",
	"advancements.adventure.trim_with_any_armor_pattern.description": "Sawwar armatura mirquma f'Mejda tal-Ħdim",
	"advancements.adventure.trim_with_any_armor_pattern.title": "Sawran ta' Dehra Ġdida",
	...
	"advancements.adventure.under_lock_and_key.description": "Iftaħ Kannierja b'Ċavetta tal-Provi",
	"advancements.adventure.under_lock_and_key.title": "Taħt Serratura u Ċavetta",
	"advancements.adventure.use_lodestone.description": "Uża Boxxla fuq Ġebla Manjetika",
	"advancements.adventure.use_lodestone.title": "Country Lode, Take Me Home",
	"advancements.adventure.very_very_frightening.description": "Olqot Raħli b'żilżla",
	"advancements.adventure.very_very_frightening.title": "Verament tal-Biża",
	"advancements.adventure.voluntary_exile.description": "Oqtol Kaptan tal-Attakki.\nImissek tikkunsidra tibqa' il-bogħod mill-irħula għalissa...",
	"advancements.adventure.voluntary_exile.title": "Eżilju Volontarju",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Imxi fuq Borra Ħafifa... mingħajr ma tegħereq fiha",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.title": "Ħafif daqs Fenek",
	"advancements.adventure.who_needs_rockets.description": "Uża Żiffa Riħ biex tniedi lilek innifsek 'il fuq 8 blokok",
	"advancements.adventure.who_needs_rockets.title": "Min għandu bżonn r-rokits?",
	"advancements.adventure.whos_the_pillager_now.description": "Agħti Xarraki togħma tal-mediċina tiegħu stess",
	"advancements.adventure.whos_the_pillager_now.title": "Min hu x-Xarraki Issa?",
	"advancements.empty": "Ma jidherx li hawn xejn hawnhekk...",
	"advancements.end.dragon_breath.description": "Iġbor in-Nifs ta' Dragun fi Flixkun tal-Ħġieġ",
	"advancements.end.dragon_breath.title": "Għandek bżonn Menta",
	...
	"advancements.end.find_end_city.description": "Idħol ġewwa, x'hinu l-agħar li jista' jiġri?",
	"advancements.end.find_end_city.title": "Il-Belt fit-Tmiem tal-Logħba",
	"advancements.end.kill_dragon.description": "Ix-xorti t-tajjeb",
	"advancements.end.kill_dragon.title": "Eħles it-Tmiem",
	...
	"advancements.husbandry.axolotl_in_a_bucket.title": "L-Aktar Predatur Ħelu",
	...
	"advancements.husbandry.breed_all_animals.description": "Rabbi l-annimali kollha!",
	"advancements.husbandry.breed_all_animals.title": "Tnejn Tnejn",
	"advancements.husbandry.breed_an_animal.description": "Rabbi żewġ annimali flimkien",
	...
	"advancements.husbandry.feed_snifflet.description": "Għalf Snifflet",
	"advancements.husbandry.feed_snifflet.title": "Sniffs Żgħar",
	...
	"advancements.husbandry.make_a_sign_glow.description": "Agħmel it-test ta 'kull tip ta' sinjal tiddix",
	...
	"advancements.husbandry.obtain_sniffer_egg.description": "Ikseb Bajda Sniffer",
	...
	"advancements.husbandry.place_dried_ghast_in_water.title": "Ibqa' Idratat!",
	"advancements.husbandry.plant_any_sniffer_seed.description": "Pjanta kwalunkwe żerriegħa Sniffer",
	...
	"advancements.husbandry.remove_wolf_armor.description": "Neħħi armaturi tal-klieb minn kelb billi tuża imqass",
	"advancements.husbandry.remove_wolf_armor.title": "X'intelliġezsa ta'barbier",
	"advancements.husbandry.repair_wolf_armor.description": "Irranġa l-armatura ta' kelb billi tuża skute ta' armadillo",
	"advancements.husbandry.repair_wolf_armor.title": "Qisu ġdid",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Uża Campfire biex tiġbor l-Għasel minn Doqqajs billi tuża Flixkun tal-Ħġieġ mingħajr ma tiggrava n-Naħal",
	...
	"advancements.husbandry.wax_off.description": "Brix ix-Xema' minn blokka tar-Ram!",
	"advancements.husbandry.wax_off.title": "Ixgħel",
	"advancements.husbandry.wax_on.description": "Applika x-Xema' għal blokka tar-Ram!",
	"advancements.husbandry.wax_on.title": "Xama 'Fuq",
	"advancements.husbandry.whole_pack.description": "Tħabbeb ma kull varjant ta' kelb",
	...
	"advancements.nether.charge_respawn_anchor.description": "Ikkarga Ankra tal-Qawmien sal-massimu",
	...
	"argument.entity.selector.nearestEntity": "L-eqreb entitá",
	...
	"argument.hexcolor.invalid": "Il-kodiċi tal-kulur eżadeċimali '%s' mhux validu",
	...
	"argument.message.too_long": "Il-messaġ kin wisq twil (%s > maximum %s characters)",
	...
	"argument.pos2d.incomplete": "Mhux komplut (mistennija 2 koordinati)",
	...
	"argument.resource_or_id.failed_to_parse": "Falli biex jibni li struttura:%s",
	"argument.resource_or_id.invalid": "Tag jew id ħażin",
	"argument.resource_or_id.no_such_element": "Ma nstabx l-element '%s' fir-reġistru '%s'",
	"argument.resource_selector.not_found": "Ma nstabitx qabla għas-selettur '%s' tat-tip '%s'",
	...
	"argument.style.invalid": "Stil mhux validu:%s",
	"argument.time.invalid_tick_count": "L-g ħadd tal-qurdien għandu jkun mhux negattiv",
	"argument.time.invalid_unit": "Unità invalida",
	"argument.time.tick_count_too_low": "L-għadd ta' qurdien m'għandux ikun inqas minn %s, misjub %s",
	"argument.uuid.invalid": "UUID invalida",
	"argument.waypoint.invalid": "L-entità magħżula mhix punt ta' riferiment",
	...
	"arguments.item.component.expected": "Il-programm stenna komponent oġġett",
	...
	"arguments.nbtpath.too_deep": "NBT li jirriżulta wisq ibejjed fil-fond",
	"arguments.nbtpath.too_large": "NBT li jirriżulta kbir wisq",
	...
	"attribute.name.attack_knockback": "Rikojl t-Attakk",
	"attribute.name.attack_speed": "Veloċità tal-Attakk",
	"attribute.name.block_break_speed": "Veloċità tat-Tkissir tal-Ġebel",
	"attribute.name.block_interaction_range": "Distanza tal-Interazzjoni mal-Blokok",
	"attribute.name.burning_time": "Żmien tal-Ħruq",
	"attribute.name.camera_distance": "Distanza tal-Kamera",
	"attribute.name.entity_interaction_range": "Distanza tal-Interazzjoni mal-Entitajiet",
	"attribute.name.explosion_knockback_resistance": "Reżistenza għall-Imbuttar mill-Isplużjonijiet",
	"attribute.name.fall_damage_multiplier": "Multiplikatur tal-Ħsara mill-Uqigħ",
	"attribute.name.flying_speed": "Veloċità tat-Titjir",
	"attribute.name.follow_range": "Distanza li Jsegwu l-Kreaturi",
	...
	"attribute.name.generic.block_interaction_range": "Distanza tal-Interazzjoni mal-Blokok",
	"attribute.name.generic.burning_time": "Żmien tal-Ħruq",
	"attribute.name.generic.entity_interaction_range": "Distanza tal-Interazzjoni mal-Entitajiet",
	"attribute.name.generic.explosion_knockback_resistance": "Reżistenza għall-Imbuttar mill-Isplużjonijiet",
	"attribute.name.generic.fall_damage_multiplier": "Multiplikatur tal-Ħsara mill-Uqigħ",
	...
	"attribute.name.generic.max_absorption": "Assorbiment Max",
	"attribute.name.generic.max_health": "Saħħa Massima",
	"attribute.name.generic.movement_efficiency": "Effiċjenza tal-Moviment",
	"attribute.name.generic.movement_speed": "Veloċità",
	"attribute.name.generic.oxygen_bonus": "Bonus tal-Ossiġnu",
	"attribute.name.generic.safe_fall_distance": "Distanza tal-Uqigħ Sikura",
	"attribute.name.generic.scale": "Daqs",
	"attribute.name.generic.step_height": "Għoli tal-Pass",
	"attribute.name.generic.water_movement_efficiency": "Effiċjenza tal-Moviment ġol-Ilma",
	...
	"attribute.name.knockback_resistance": "Reżistenza għall-Imbuttar",
	"attribute.name.luck": "Fortuna",
	"attribute.name.max_absorption": "Assorbiment Massimu",
	"attribute.name.max_health": "Saħħa Massima",
	"attribute.name.mining_efficiency": "Effiċjenza tat-Tħaffir",
	"attribute.name.movement_efficiency": "Effiċjenza fil-mixi",
	"attribute.name.movement_speed": "Veloċità",
	"attribute.name.oxygen_bonus": "Bonus tal-Ossiġnu",
	"attribute.name.player.block_break_speed": "Veloċità tal-Ksur tal-Blokok",
	"attribute.name.player.block_interaction_range": "Distanza tal-Interazzjoni mal-Blokok",
	"attribute.name.player.entity_interaction_range": "Distanza tal-Interazzjoni mal-Entitajiet",
	"attribute.name.player.mining_efficiency": "Effiċjenza tat-Tħaffir",
	"attribute.name.player.sneaking_speed": "Veloċità waqt Għarkupptejk",
	...
	"attribute.name.safe_fall_distance": "Distanza tal-Uqigħ Sikura",
	"attribute.name.scale": "Skala",
	"attribute.name.sneaking_speed": "Veloċità waqt Għarkupptejk",
	"attribute.name.spawn_reinforcements": "Rinforzi taż-Żombi",
	"attribute.name.step_height": "Għoli tal-Pass",
	"attribute.name.submerged_mining_speed": "Veloċità tat-Tħaffir Taħt l-Ilma",
	"attribute.name.sweeping_damage_ratio": "Proporzjon tal-Ħsara tat-Tiċrit",
	"attribute.name.tempt_range": "Distanza tat-Tentazzjoni tal-Kreaturi",
	"attribute.name.water_movement_efficiency": "Effiċjenza tal-Moviment ġol-Ilma",
	"attribute.name.waypoint_receive_range": "Distanza tar-Riċeviment tal-Punti tar-Riferiment",
	"attribute.name.waypoint_transmit_range": "Distanza tat-Trasmissjoni tal-Punti tar-Riferiment",
	"attribute.name.zombie.spawn_reinforcements": "Iktar Mostri",
	"biome.minecraft.badlands": "Kalanki",
	"biome.minecraft.bamboo_jungle": "Ġungla tal-Bambù",
	"biome.minecraft.basalt_deltas": "Delti tal-Bażalt",
	"biome.minecraft.beach": "Bajja",
	"biome.minecraft.birch_forest": "Foresta tal-Betula",
	"biome.minecraft.cherry_grove": "Masġar taċ-Ċirasa",
	"biome.minecraft.cold_ocean": "Oċean Kiesaħ",
	"biome.minecraft.crimson_forest": "Foresta Krimżi",
	"biome.minecraft.dark_forest": "Foresta Skura",
	...
	"biome.minecraft.dripstone_caves": "Għerien tal-Ispeljotemi",
	...
	"biome.minecraft.eroded_badlands": "Kalanki Mikula",
	"biome.minecraft.flower_forest": "Foresta tal-Fjuri",
	...
	"biome.minecraft.grove": "Masġar",
	"biome.minecraft.ice_spikes": "Imrieżaq tas-Silġ",
	...
	"biome.minecraft.nether_wastes": "Xagħri tan-Nether",
	"biome.minecraft.ocean": "Oċean",
	"biome.minecraft.old_growth_birch_forest": "Foresta tal-Betula Qadima",
	"biome.minecraft.old_growth_pine_taiga": "Foresta Boreali taż-Żnuber Qadima",
	"biome.minecraft.old_growth_spruce_taiga": "Foresta Boreali tal-Arżnu Qadima",
	"biome.minecraft.pale_garden": "Ġnien Pallidu",
	"biome.minecraft.plains": "Pjanura",
	"biome.minecraft.river": "Xmara",
	"biome.minecraft.savanna": "Savana",
	"biome.minecraft.savanna_plateau": "Wita tas-Savana",
	"biome.minecraft.small_end_islands": "Gżejjer Żgħar tal-End",
	"biome.minecraft.snowy_beach": "Bajja bil-Borra",
	"biome.minecraft.snowy_plains": "Pjanura bil-Borra",
	"biome.minecraft.snowy_slopes": "Għoljiet bil-Borra",
	"biome.minecraft.snowy_taiga": "Foresta Boreali bil-Borra",
	"biome.minecraft.soul_sand_valley": "Wied l-Erwieħ",
	...
	"block.minecraft.bamboo_block": "Blokka tal-Bambu'",
	...
	"block.minecraft.bamboo_shelf": "Xkaffa tal-Bambu'",
	...
	"block.minecraft.banner.flow.black": "il-Belliegħa Sewda",
	"block.minecraft.banner.flow.blue": "Il-Belliegħa Kaħla",
	"block.minecraft.banner.flow.brown": "il-Belliegħa Kannella",
	"block.minecraft.banner.flow.cyan": "Il-Belliegħa Ċjan",
	"block.minecraft.banner.flow.gray": "Il-Belliegħa Griża",
	"block.minecraft.banner.flow.green": "Il-Belliegħa Ħadra",
	"block.minecraft.banner.flow.light_blue": "Il-Belliegħa Żerqa",
	"block.minecraft.banner.flow.light_gray": "Il-Belliegħa Rmidija",
	"block.minecraft.banner.flow.lime": "Il-Belliegħa Lumiċellija",
	"block.minecraft.banner.flow.magenta": "Il-Belliegħa Maġenta",
	"block.minecraft.banner.flow.orange": "Il-Belliegħa Oranġjo",
	"block.minecraft.banner.flow.pink": "Il-Belliegħa Roża",
	"block.minecraft.banner.flow.purple": "Il-Belliegħa Vjola",
	"block.minecraft.banner.flow.red": "Il-Belliegħa Ħamra",
	"block.minecraft.banner.flow.white": "Il-Belliegħa Bajda",
	"block.minecraft.banner.flow.yellow": "Il-Belliegħa Safra",
	...
	"block.minecraft.banner.guster.black": "Il-Buffurej Iswed",
	"block.minecraft.banner.guster.blue": "Il-Buffurej Ikħal",
	"block.minecraft.banner.guster.brown": "Il-Buffurej Kannella",
	"block.minecraft.banner.guster.cyan": "Il-Buffurej Ċjan",
	"block.minecraft.banner.guster.gray": "Il-Buffurej Griż",
	"block.minecraft.banner.guster.green": "Il-Buffurej Aħdar",
	"block.minecraft.banner.guster.light_blue": "Il-Buffurej Iżraq",
	"block.minecraft.banner.guster.light_gray": "Il-Buffurej Rmiedi",
	"block.minecraft.banner.guster.lime": "Il-Buffurej Lumiċelli",
	"block.minecraft.banner.guster.magenta": "Il-Buffurej Maġenta",
	"block.minecraft.banner.guster.orange": "Il-Buffurej Oranġjo",
	"block.minecraft.banner.guster.pink": "Il-Buffurej Roża",
	"block.minecraft.banner.guster.purple": "Il-Buffurej Vjola",
	"block.minecraft.banner.guster.red": "Il-Buffurej Aħmar",
	"block.minecraft.banner.guster.white": "Il-Buffurej Abjad",
	"block.minecraft.banner.guster.yellow": "Il-Buffurej Isfar",
	...
	"block.minecraft.bed.not_safe": "Ma tistax tistrieħ għalissa; hemm il-mostri fil-qrib",
	"block.minecraft.bed.obstructed": "Din is-sodda hija ostakolata",
	...
	"block.minecraft.beehive": "Doqqajs",
	...
	"block.minecraft.black_shulker_box": "Kaxxa ta' Shulker Sewda",
	...
	"block.minecraft.blue_shulker_box": "Kaxxa ta' Shulker Blu",
	...
	"block.minecraft.brain_coral_block": "Blokka tal-Qroll tal-Moħħ",
	"block.minecraft.brain_coral_fan": "Fann tal-Qroll tal-Moħħ",
	"block.minecraft.brain_coral_wall_fan": "Fann tal-Qroll tal-Moħħ mal-Ħajt",
	...
	"block.minecraft.brown_shulker_box": "Kaxxa ta' Shulker Kannella",
	...
	"block.minecraft.bubble_column": "Kolonna tal-Bżieżaq tal-Ilma",
	"block.minecraft.bubble_coral": "Qroll tal-Bżieżaq",
	"block.minecraft.bubble_coral_block": "Blokka tal-Qroll tal-Bżieżaq",
	"block.minecraft.bubble_coral_fan": "Fann tal-Qroll tal-Bżieżaq",
	"block.minecraft.bubble_coral_wall_fan": "Fann tal-Qroll tal-Bżieżaq mal-Ħajt",
	"block.minecraft.budding_amethyst": "Ametista Kristallanti",
	...
	"block.minecraft.calibrated_sculk_sensor": "Sensor Sculk Ikkalibrat",
	...
	"block.minecraft.cherry_fence": "Ċint taċ-Ċirasa",
	"block.minecraft.cherry_fence_gate": "Grada taċ-Ċirasa",
	"block.minecraft.cherry_hanging_sign": "Tabella Tiddendel taċ-Ċirasa",
	...
	"block.minecraft.cherry_pressure_plate": "Pjanċa tal-Pressjoni taċ-Ċirasa",
	"block.minecraft.cherry_sapling": "Żgħar taċ-Ċirasa",
	...
	"block.minecraft.chipped_anvil": "Inkwina Mlaqqxa",
	"block.minecraft.chiseled_bookshelf": "Xkaffa Imnaqqxa",
	"block.minecraft.chiseled_copper": "Ram Imnaqqax",
	"block.minecraft.chiseled_deepslate": "Lavanja Fonda Mnaqqxa",
	...
	"block.minecraft.chiseled_resin_bricks": "Briks tar-Raża Mnaqqxa",
	...
	"block.minecraft.chiseled_tuff": "Tufu Imnaqqax",
	"block.minecraft.chiseled_tuff_bricks": "Briks tat-Tufu Imnaqqax",
	"block.minecraft.chorus_flower": "Fjura tal-Chorus",
	"block.minecraft.chorus_plant": "Xitla tal-Chorus",
	"block.minecraft.clay": "Tafal",
	"block.minecraft.closed_eyeblossom": "Għajnwara Magħluqa",
	...
	"block.minecraft.cobbled_deepslate": "Lavanja Fonda Mfarrka",
	"block.minecraft.cobbled_deepslate_slab": "Ċangun tal-Lavanja Fonda Mfarrka",
	"block.minecraft.cobbled_deepslate_stairs": "Taraġ tal-Lavanja Fonda Mfarrka",
	"block.minecraft.cobbled_deepslate_wall": "Ħajt tal-Lavanja Fonda Mfarrka",
	...
	"block.minecraft.composter": "Kompostatur",
	...
	"block.minecraft.copper_golem_statue": "Statwa ta' Golem tar-Ram",
	...
	"block.minecraft.copper_torch": "Torċa tar-Ram",
	"block.minecraft.copper_trapdoor": "Bokkaport tar-Ram",
	"block.minecraft.copper_wall_torch": "Torċa tar-Ram mal-Ħajt",
	"block.minecraft.cornflower": "Fjura tal-qam ħirrun",
	"block.minecraft.cracked_deepslate_bricks": "Briks tal-Lavanja Fonda Mxaqqin",
	"block.minecraft.cracked_deepslate_tiles": "Madum tal-Lavanja Fonda Mxaqqaq",
	...
	"block.minecraft.crafter": "Fabbrikatur",
	"block.minecraft.crafting_table": "Mejda tas-Snajja",
	"block.minecraft.creaking_heart": "Qalb Tiżaqżaq",
	...
	"block.minecraft.decorated_pot": "Borma imżejna",
	"block.minecraft.deepslate": "Lavanja Fonda",
	"block.minecraft.deepslate_brick_slab": "Ċangun tal-Briks tal-Lavanja Fonda",
	"block.minecraft.deepslate_brick_stairs": "Taraġ tal-Briks tal-Lavanja Fonda",
	"block.minecraft.deepslate_brick_wall": "Ħajt tal-Briks tal-Lavanja Fonda",
	"block.minecraft.deepslate_bricks": "Briks tal-Lavanja Fonda",
	"block.minecraft.deepslate_coal_ore": "Minerali tal-Faħam fil-Lavanja Fonda\n",
	"block.minecraft.deepslate_copper_ore": "Minerali tar-Ram fil-Lavanja Fonda",
	"block.minecraft.deepslate_diamond_ore": "Minerali tad-Djamant fil-Lavanja Fonda",
	"block.minecraft.deepslate_emerald_ore": "Minerali tal-Iżmerald fil-Lavanja Fonda",
	"block.minecraft.deepslate_gold_ore": "Minerali tad-Deheb fil-Lavanja Fonda",
	"block.minecraft.deepslate_iron_ore": "Minerali tal-Ħadid fil-Lavanja Fonda",
	"block.minecraft.deepslate_lapis_ore": "Minerali tal-Lapis Lażuli fil-Lavanja Fonda",
	"block.minecraft.deepslate_redstone_ore": "Minerali tar-Redstone fil-Lavanja Fonda",
	"block.minecraft.deepslate_tile_slab": "Ċangun tal-Madum tal-Lavanja Fonda",
	"block.minecraft.deepslate_tile_stairs": "Taraġ tal-Madum tal-Lavanja Fonda",
	"block.minecraft.deepslate_tile_wall": "Ħajt tal-Madum tal-Lavanja Fonda",
	"block.minecraft.deepslate_tiles": "Madum tal-Lavanja Fonda",
	...
	"block.minecraft.exposed_copper_chain": "Katina tar-Ram Espost",
	"block.minecraft.exposed_copper_chest": "Senduq tar-Ram Espost",
	"block.minecraft.exposed_copper_door": "Bieb tar-Ram Espost",
	"block.minecraft.exposed_copper_golem_statue": "Statwa ta' Golem tar-Ram Espost",
	"block.minecraft.exposed_copper_grate": "Gradilja tar-Ram Espost",
	...
	"block.minecraft.exposed_cut_copper_slab": "Slab tar-Ram Maqtugħ Espost",
	...
	"block.minecraft.firefly_bush": "Arbuxxell tal-Luzzjoll",
	"block.minecraft.fletching_table": "Fletching table",
	"block.minecraft.flower_pot": "Qasrija",
	"block.minecraft.flowering_azalea": "Ażalea bil-Fjuri",
	"block.minecraft.flowering_azalea_leaves": "Weraq tal-Ażalea bil-Fjuri",
	...
	"block.minecraft.golden_dandelion": "Lelluxa tad-Deheb",
	...
	"block.minecraft.heavy_core": "Qalba Tqila",
	...
	"block.minecraft.infested_deepslate": "Lavanja Fonda Infestata",
	...
	"block.minecraft.jigsaw": "Blokka tal-Jigsaw",
	...
	"block.minecraft.large_amethyst_bud": "Kristall Kbir tal-Ametista",
	...
	"block.minecraft.light_blue_terracotta": "Terrakotta Blu Ċara",
	...
	"block.minecraft.lime_terracotta": "Terrakotta Ħadra Ċara",
	...
	"block.minecraft.oxidized_chiseled_copper": "Ram Imnaqqax Ossidizzat",
	"block.minecraft.oxidized_copper": "Ram Ossidizzat",
	"block.minecraft.oxidized_copper_bars": "Vireg tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_bulb": "Bozza tar-Ram Ossidizzata",
	"block.minecraft.oxidized_copper_chain": "Katina tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_chest": "Senduq tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_door": "Bieb tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_golem_statue": "Statwa ta' Golem tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_grate": "Gradilja tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_lantern": "Fanal tar-Ram Ossidizzat",
	"block.minecraft.oxidized_copper_trapdoor": "Bokkaport tar-Ram Ossidizzat",
	"block.minecraft.oxidized_cut_copper": "Ram Maqtugħ Ossidizzat",
	"block.minecraft.oxidized_cut_copper_slab": "Ċangun tar-Ram Maqtugħ Ossidizzat",
	"block.minecraft.oxidized_cut_copper_stairs": "Taraġ tar-Ramm Maqtugħ Ossidizzat",
	"block.minecraft.oxidized_lightning_rod": "Virga tas-Sajjetti Ossidizzata",
	"block.minecraft.packed_ice": "Silġ Solidu",
	"block.minecraft.packed_mud": "Tajn Ippakkjat",
	"block.minecraft.pale_hanging_moss": "Ħażiż Pallidu Mdendel",
	"block.minecraft.pale_moss_block": "Blokka tal-Ħażiż Pallidu",
	"block.minecraft.pale_moss_carpet": "Tapit tal-Ħażiż Pallidu",
	"block.minecraft.pale_oak_button": "Buttuna tal-Ballut Pallidu",
	"block.minecraft.pale_oak_door": "Bieb tal-Ballut Pallidu",
	"block.minecraft.pale_oak_fence": "Ċint tal-Ballut Pallidu",
	"block.minecraft.pale_oak_fence_gate": "Grada tal-Ballut Pallidu",
	"block.minecraft.pale_oak_hanging_sign": "Tabella Tiddendel tal-Ballut Pallidu",
	"block.minecraft.pale_oak_leaves": "Weraq tal-Ballut Pallidu",
	"block.minecraft.pale_oak_log": "Zokk tal-Ballut Pallidu",
	"block.minecraft.pale_oak_planks": "Twavel tal-Ballut Pallidu",
	"block.minecraft.pale_oak_pressure_plate": "Pjanċa tal-Ballut Pallidu",
	"block.minecraft.pale_oak_sapling": "Żgħar tal-Ballut Pallidu",
	"block.minecraft.pale_oak_shelf": "Xkaffa tal-Ballut Pallidu",
	"block.minecraft.pale_oak_sign": "Tabella tal-Ballut Pallidu",
	"block.minecraft.pale_oak_slab": "Ċangun tal-Ballut Pallidu",
	"block.minecraft.pale_oak_stairs": "Taraġ tal-Ballut Pallidu",
	"block.minecraft.pale_oak_trapdoor": "Blokkaport tal-Ballut Pallidu",
	"block.minecraft.pale_oak_wall_hanging_sign": "Tabella tal-Ballut Pallidu Mdendla mal-Ħajt",
	"block.minecraft.pale_oak_wall_sign": "Tabella tal-Ballut Pallidu mal-Ħajt",
	"block.minecraft.pale_oak_wood": "Injam tal-Ballut Pallidu",
	...
	"block.minecraft.piglin_head": "Piglin ras",
	"block.minecraft.piglin_wall_head": "Piglin ħajt ras",
	...
	"block.minecraft.pink_petals": "Petali roża",
	...
	"block.minecraft.pitcher_crop": "Pitcher Uċuħ tar-raba’",
	"block.minecraft.pitcher_plant": "Pitcher Pjanta",
	...
	"block.minecraft.polished_deepslate": "Lavanja Fonda Illostrata",
	"block.minecraft.polished_deepslate_slab": "Ċangun tal-Lavanja Fonda Illostrata",
	"block.minecraft.polished_deepslate_stairs": "Taraġ tal-Lavanja Fonda Illostrata",
	"block.minecraft.polished_deepslate_wall": "Ħajt tal-Lavanja Fonda Illostrata",
	...
	"block.minecraft.polished_tuff": "Tufu Illostrat",
	"block.minecraft.polished_tuff_slab": "Ċangun tat-Tufu Illostrat",
	"block.minecraft.polished_tuff_stairs": "Taraġ tat-Tufu Illostrat",
	"block.minecraft.polished_tuff_wall": "Ħajt tat-Tufu Illostrat",
	"block.minecraft.poppy": "Peprina",
	"block.minecraft.potatoes": "Patata",
	"block.minecraft.potted_acacia_sapling": "Qasrija taż-Żgħar tal-Akaċja",
	"block.minecraft.potted_allium": "Qasrija tal-Allium",
	"block.minecraft.potted_azalea_bush": "Qasrija tal-Ażalea",
	"block.minecraft.potted_azure_bluet": "Qasrija tal-Azure Bluet",
	"block.minecraft.potted_bamboo": "Bambu' ġo Qasrija",
	"block.minecraft.potted_birch_sapling": "Qasrija taż-Żgħar tal-Betula",
	...
	"block.minecraft.potted_cherry_sapling": "Sapling taċ-Ċirasa mħawla",
	...
	"block.minecraft.potted_dandelion": "Lelluxa ġo Qasrija",
	"block.minecraft.potted_dark_oak_sapling": "Qasrija taż-Żgħar tal-Ballut Skur",
	"block.minecraft.potted_dead_bush": "Qasrija tax-Xitla Niexfa",
	"block.minecraft.potted_fern": "Qasrija tal-Felċa",
	"block.minecraft.potted_flowering_azalea_bush": "Qasrija tal-Ażalea bil-Fjuri",
	"block.minecraft.potted_golden_dandelion": "Lelluxa tad-Deheb ġo Qasrija",
	...
	"block.minecraft.potted_orange_tulip": "Qasrija tat-Tulip Oranġjo",
	"block.minecraft.potted_oxeye_daisy": "Damargerita tal-fu ħħar",
	"block.minecraft.potted_pale_oak_sapling": "Qasrija taż-Żgħar tal-Ballut Pallidu",
	"block.minecraft.potted_pink_tulip": "Qasrija tat-Tulip Roża",
	"block.minecraft.potted_poppy": "Peprin tal-fu ħħar",
	"block.minecraft.potted_red_mushroom": "Faqqiegħ aħmar futed",
	"block.minecraft.potted_red_tulip": "Qasrija tat-Tulip Ħamra",
	"block.minecraft.potted_spruce_sapling": "Spruce sidru",
	"block.minecraft.potted_torchflower": "Torchflower mħawla",
	...
	"block.minecraft.potted_white_tulip": "Qasrija tat-Tulip Bajda",
	"block.minecraft.potted_wither_rose": "Qasrija tal-Warda tal-Wither",
	...
	"block.minecraft.raw_copper_block": "Blokk tar-Ram mhux Maħdum",
	...
	"block.minecraft.reinforced_deepslate": "Lavanja Fonda Rinfurzata",
	"block.minecraft.repeater": "Dajowd tar-Redstone",
	"block.minecraft.repeating_command_block": "Blokka tal-Kodiċi Tirrepeti",
	"block.minecraft.resin_block": "Blokka tar-Raża",
	"block.minecraft.resin_brick_slab": "Ċangun tal-Briks tar-Raża",
	"block.minecraft.resin_brick_stairs": "Taraġ tal-Briks tar-Raża",
	"block.minecraft.resin_brick_wall": "Ħajt tal-Briks tar-Raża",
	"block.minecraft.resin_bricks": "Briks tar-Raża",
	"block.minecraft.resin_clump": "Ċappa Raża",
	...
	"block.minecraft.sniffer_egg": "Bajda ta' Xammiem",
	...
	"block.minecraft.spawner": "Mafqas tal-Mostri",
	"block.minecraft.spawner.desc1": "Interaġixxi mil-Bajda li Ssejjaħ:",
	"block.minecraft.spawner.desc2": "Settijiet Mob Tip",
	...
	"block.minecraft.stripped_bamboo_block": "Blokk tal-Bambu Mqaxxarp",
	...
	"block.minecraft.stripped_jungle_log": "Zokk tal-Ġungla Imqaxxar",
	...
	"block.minecraft.stripped_pale_oak_log": "Zokk tal-Ballut Pallidu Mqaxxar",
	"block.minecraft.stripped_pale_oak_wood": "Injam tal-Ballut Pallidu Mqaxxar",
	...
	"block.minecraft.suspicious_gravel": "Żrar Suspettuż",
	"block.minecraft.suspicious_sand": "Ramel Suspettuż",
	"block.minecraft.sweet_berry_bush": "Il-Sweet berry bush",
	"block.minecraft.tall_dry_grass": "Ħaxix Niexef Twil",
	...
	"block.minecraft.tnt.disabled": "Splużjonijiet tat-TNT huma diżattivati",
	...
	"block.minecraft.trial_spawner": "Nissiel tal-Isfida",
	...
	"block.minecraft.tuff_brick_wall": "Ħajt tal-Briks tat-Tufu",
	...
	"block.minecraft.warped_shelf": "Xkaffa Stramba",
	...
	"block.minecraft.waxed_copper_bars": "Vireg tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_block": "Blokk tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_bulb": "Bozza tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_chain": "Katina tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_chest": "Senduq tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_door": "Bieb tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_golem_statue": "Statwa ta' Golem tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_grate": "Gradilja tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_lantern": "Fanal tar-Ram bix-Xema'",
	"block.minecraft.waxed_copper_trapdoor": "Bokkaport tar-Ram bix-Xema'",
	...
	"block.minecraft.waxed_exposed_copper": "Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_bars": "Vireg tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_bulb": "Bozza tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_chain": "Katina tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_chest": "Senduq tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_door": "Bieb tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Statwa ta' Golem tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_grate": "Gradilja tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_lantern": "Fanal tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Bokkaport tar-Ram Espost bix-Xema'",
	"block.minecraft.waxed_exposed_cut_copper": "Ram Maqtugħ Espost bix-Xema'",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Ċangun tar-Ramm Maqtugħ Espost bix-Xema'",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Taraġ tar-Ramm Maqtugħ Espost bix-Xema'",
	"block.minecraft.waxed_exposed_lightning_rod": "Virga tas-Sajjetti Esposta bix-Xema'",
	"block.minecraft.waxed_lightning_rod": "Virga tas-Sajjetti bix-Xema'",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Ram Imnaqqax Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper": "Ram Ossidat Ix-Xema '",
	"block.minecraft.waxed_oxidized_copper_bars": "Vireg tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_bulb": "Bozza tar-Ram Ossidizzata bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_chain": "Katina tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_chest": "Senduq tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_door": "Bieb tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Statwa ta' Golem tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_grate": "Gradilja tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_lantern": "Fanal tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Bokkaport tar-Ram Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_cut_copper": "Ram Maqtugħ Ossidat Ix-Xema '",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Slab tar-Ram Maqtugħ Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Taraġ tar-Ramm Maqtugħ Ossidizzat bix-Xema'",
	"block.minecraft.waxed_oxidized_lightning_rod": "Virga tas-Sajjetti Ossidizzata bix-Xema'",
	"block.minecraft.waxed_weathered_chiseled_copper": "Ram Imnaqqax Mherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper": "Ram Imherri bix-Xama'",
	"block.minecraft.waxed_weathered_copper_bars": "Vireg tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_bulb": "Bozza tar-Ram Imherrija bix-Xema'",
	"block.minecraft.waxed_weathered_copper_chain": "Katina tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_chest": "Senduq tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_door": "Bieb tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Statwa ta' Golem tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_grate": "Gradilja tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_lantern": "Fanal tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Bokkaport tar-Ram Imherri bix-Xema'",
	"block.minecraft.waxed_weathered_cut_copper": "Ram Maqtugħ Imherri bix-Xama'",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Slab tar-Ram Maqtugħ Imherii bix-Xama'",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Taraġ tar-Ram Maqtugħ Imherri bix-Xama'",
	"block.minecraft.waxed_weathered_lightning_rod": "Virga tas-Sajjetti Mherrija bix-Xema'",
	"block.minecraft.weathered_chiseled_copper": "Ram Imnaqqax Imherri",
	"block.minecraft.weathered_copper": "Ram Imherri",
	"block.minecraft.weathered_copper_bars": "Vireg tar-Ram Imherri",
	"block.minecraft.weathered_copper_bulb": "Bozza tar-Ram Imherrija",
	"block.minecraft.weathered_copper_chain": "Katina tar-Ram Imherri",
	"block.minecraft.weathered_copper_chest": "Senduq tar-Ram Imherri",
	"block.minecraft.weathered_copper_door": "Bieb tar-Ram Imherri",
	"block.minecraft.weathered_copper_golem_statue": "Statwa ta' Golem tar-Ram Imherri",
	"block.minecraft.weathered_copper_grate": "Gradilja tar-Ram Imherri",
	"block.minecraft.weathered_copper_lantern": "Fanal tar-Ram Imherri",
	"block.minecraft.weathered_copper_trapdoor": "Bokkaport tar-Ram Imherri",
	...
	"block.minecraft.weathered_lightning_rod": "Virga tas-Sajjetti Mherrija bix",
	...
	"block.minecraft.wither_rose": "Warda tal-Wither",
	...
	"book.edit.title": "Skrin tal-Editjar tal-Kotba",
	...
	"book.page_button.previous": "Paġna Preċedenti",
	"book.sign.title": "Skrin tal-Iffirmar tal-Kotba",
	...
	"chat.disabled.launcher": "Chat diżattivata mill-għażla tal-lanċjar. Ma tistax tibgħat messaġġ.",
	"chat.disabled.missingProfileKey": "Chat diżattivata minħabba ċavetta pubblika tal-profil nieqsa. Jekk jogħġbok ipprova erġa' għaqqad.",
	"chat.disabled.options": "Chat diżattivata fl-għażliet tal-klijenti.",
	...
	"chat.tag.error": "Server bagħat messaġġ invalidu.",
	...
	"chat.validation_error": "Żball tal-validazzjoni taċ-chat",
	...
	"chunk.toast.lowDiskSpace": "Ftit spazju fuq id-diska!",
	"chunk.toast.lowDiskSpace.description": "Jista' jkun li ma tkunx tista' tissejvja d-dinja.",
	"chunk.toast.saveFailure": "Il-programm ma rnexxielux jissejvja il-biċċa fi %s",
	...
	"commands.attribute.base_value.reset.success": "Il-valur tal-attribut %s għall-entità %s ġie irrisettjat għad-default %s",
	...
	"commands.banip.info": "Din il-projbizzjoni taffettwa %s plejer(i): %s",
	...
	"commands.bossbar.get.players.some": "Il-bossbar personalizzat %s għandu %s plejer(i) bħalissa online: %s",
	...
	"commands.bossbar.set.players.success.some": "Il-bossbar personalizzat %s issa għandu %s plejer(i): %s",
	...
	"commands.clear.success.multiple": "Neħħew %s oġġett(i) minn %s plejers",
	"commands.clear.success.single": "Neħħew %s oġġett(i) minn %s plejers",
	"commands.clear.test.multiple": "Sabu %s oġġett(i) li jaqblu fuq %s plejers",
	"commands.clear.test.single": "Sabu %s oġġett(i) li jaqblu fuq il-plejer %s",
	...
	"commands.dialog.clear.multiple": "Id-djalogu kien imħassar għal %s plejers",
	"commands.dialog.clear.single": "Id-djalogu kien imħassar għal %s",
	"commands.dialog.show.multiple": "Id-djalogu ntwera lil %s plejers",
	...
	"commands.locate.biome.success": "L-eqreb %s tinstab fi %s (%s blokok 'il bogħod)",
	...
	"commands.waypoint.modify.color": "Il-kulur tal-punt ta' riferiment issa huwa %s",
	"commands.waypoint.modify.color.reset": "Irrisettja il-kulur tal-punt ta' riferiment",
	...
	"container.chest": "Kaxxa",
	"container.chestDouble": "Senduq Kbir",
	"container.crafter": "Fabbrikatur",
	...
	"container.upgrade.error_tooltip": "Dan l-oġġett ma jistax jiġi aġġornat b’dan il-mod",
	"container.upgrade.missing_template_tooltip": "Żid Skema tal-Forġa",
	...
	"credits_and_attribution.button.attribution": "Attribuzzjoni",
	"credits_and_attribution.button.credits": "Krediti",
	"credits_and_attribution.button.licenses": "Liċenzji",
	"credits_and_attribution.screen.title": "Krediti u Attribuzzjoni",
	...
	"datapackFailure.safeMode.failed.description": "Din id-dinja fiha data save invalida jew korrotta.",
	"datapackFailure.safeMode.failed.title": "Naqas milli tgħabbi d-dinja fil-Modalità Sikura.",
	"datapackFailure.title": "Żbalji fil-pakketti tad-dejta magħżula bħalissa żammew lid-dinja milli titgħabba.\n Tista 'jew tipprova tgħabbiha bil-pakkett tad-dejta tal-vanilla biss (\"mod sikur\"), jew tmur lura għall-iskrin tat-titlu u waħħalha manwalment.",
	...
	"death.attack.dragonBreath": "%[1]s ġie mixwi f'nifs ta' dragun",
	"death.attack.dragonBreath.player": "%[1]s ġie mixwi f'nifs ta' dragun minn %[2]s",
	...
	"death.attack.even_more_magic": "%[1]s ġie maqtul b' aktar maġija",
	...
	"death.attack.genericKill": "%[1]s inqatel",
	"death.attack.genericKill.player": "%[1]s inqatel waqt li kien qed jiġġieled ma' %[2]s",
	"death.attack.hotFloor": "%[1]s skopra li l-art kienet lava",
	"death.attack.hotFloor.player": "%[1]s mexa għal ġoż-żona perikoluża minħabba %[2]s",
	...
	"death.attack.lightningBolt.player": "%[1]s ġie milqut minn sajjetta waqt li kien qed jiġġieled %[2]s",
	"death.attack.mace_smash": "%[1]s qala’ mazzata minn %[2]s",
	"death.attack.mace_smash.item": "%[1]s qala’ mazzata minn %[2]s b' %[3]s",
	...
	"death.attack.message_too_long": "Propjament, il-messaġġ kien twil wisq biex jidher kollhu. Skużana! Hawn verżjoni mqassra: %s",
	...
	"death.attack.outsideBorder": "%[1]s telaq mil-limiti ta’ din id-dinja",
	"death.attack.outsideBorder.player": "%[1]s telaq mil-limiti ta’ din id-dinja waqt li kien qed jiġġieled ma' %[2]s",
	...
	"death.attack.spear": "%[1]s ġie midrub minn %[2]s",
	"death.attack.spear.item": "%[1]s ġie midrub minn %[2]s b' %[3]s",
	...
	"death.attack.thorns.item": "%[1]s ġie maqtul minn %[3]s hu u jipprova jweġġa' lil %[2]s",
	...
	"deathScreen.titleScreen": "Menu Prinċipali",
	"debug.advanced_tooltips.help": "F3 + H = Deskrizzjonijiet avanzati",
	"debug.advanced_tooltips.off": "Deskrizzjonijiet avvanzati: moħbija",
	"debug.advanced_tooltips.on": "Deskrizzjonijiet avvanzati: murija",
	"debug.chunk_boundaries.help": "F3 + G = Uri l-konfini taċ-chunks",
	"debug.chunk_boundaries.off": "Truf taċ-chunks: moħbija",
	"debug.chunk_boundaries.on": "Truf taċ-chunks: murija",
	"debug.clear_chat.help": "F3 + D = Żvojta ċ-chat",
	...
	"effect.minecraft.breath_of_the_nautilus": "Nifs tan-Nawtilu",
	...
	"effect.minecraft.oozing": "Nixa",
	"effect.minecraft.poison": "Velenu",
	"effect.minecraft.raid_omen": "Malawgurju tal-Inkursjoni",
	...
	"effect.minecraft.trial_omen": "Malawgurju tal-Isfida",
	...
	"effect.minecraft.wind_charged": "Ikkargat bir-Riħ",
	"effect.minecraft.wither": "Tidbil",
	...
	"enchantment.minecraft.channeling": "Kanalizzazzjoni",
	...
	"enchantment.minecraft.lunge": "Salt",
	"enchantment.minecraft.lure": "Sajd",
	"enchantment.minecraft.mending": "Tiswija",
	"enchantment.minecraft.multishot": "Sparar Multiplu",
	...
	"enchantment.minecraft.sweeping_edge": "Tarf Iċarrat",
	...
	"entity.minecraft.acacia_chest_boat": "Dgħajsa tal-Akaċja bis-Senduq",
	"entity.minecraft.allay": "Allay",
	"entity.minecraft.area_effect_cloud": "Sħaba ta' Effett",
	...
	"entity.minecraft.bamboo_chest_raft": "Ċattra tal-Bambu' b'Senduq",
	"entity.minecraft.bamboo_raft": "Ċattra tal-Bambu'",
	"entity.minecraft.bat": "Farfett il-Lejl",
	"entity.minecraft.bee": "Naħla",
	"entity.minecraft.birch_boat": "Dgħajsa tal-Betula",
	"entity.minecraft.birch_chest_boat": "Dgħajsa tal-Betula bis-Senduq",
	...
	"entity.minecraft.breeze": "Żiffa",
	"entity.minecraft.breeze_wind_charge": "Balma tar-Riħ",
	...
	"entity.minecraft.copper_golem": "Golem tar-Ram",
	...
	"entity.minecraft.dark_oak_chest_boat": "Dgħajsa tal-Ballut Skur bis-Senduq",
	...
	"entity.minecraft.egg": "Bajda mitfugħ",
	"entity.minecraft.elder_guardian": "Gwardjan Anzjan",
	"entity.minecraft.end_crystal": "Kristall tal-End",
	"entity.minecraft.ender_dragon": "Dragun tal-Ender",
	"entity.minecraft.ender_pearl": "Perla tal-Ender Imwaddba",
	"entity.minecraft.enderman": "Enderman",
	"entity.minecraft.endermite": "Endermite",
	"entity.minecraft.evoker": "Evokatur",
	"entity.minecraft.evoker_fangs": "Snien tal-Evokatur",
	"entity.minecraft.experience_bottle": "Flixkun tal-Maġija Mwaddab",
	...
	"entity.minecraft.falling_block_type": "%s Qed Jaqa'",
	"entity.minecraft.fireball": "Balma tan-Nar",
	"entity.minecraft.firework_rocket": "Murtal",
	"entity.minecraft.fishing_bobber": "Ħiel tas-Sajd",
	...
	"entity.minecraft.glow_item_frame": "Inkwatru Luminixxenti",
	"entity.minecraft.glow_squid": "Klamar Luminixxenti",
	...
	"entity.minecraft.husk": "Minxuf",
	"entity.minecraft.illusioner": "Illużjonista",
	"entity.minecraft.interaction": "Interazzjoni",
	"entity.minecraft.iron_golem": "Monstru tal-Ħadid",
	"entity.minecraft.item": "Oġġett",
	"entity.minecraft.item_display": "Wirja ta' Oġġett",
	"entity.minecraft.item_frame": "Inkwatru",
	"entity.minecraft.jungle_boat": "Dgħajsa tal-Ġungla",
	"entity.minecraft.jungle_chest_boat": "Dgħajsa tal-Ġungla bis-Senduq",
	"entity.minecraft.killer_bunny": "Il-Fenek Qattiel",
	"entity.minecraft.leash_knot": "Għoqda ta’ Ċinga",
	"entity.minecraft.lightning_bolt": "Sajjetta",
	"entity.minecraft.lingering_potion": "Xarba Persistenti",
	"entity.minecraft.llama": "Llama",
	"entity.minecraft.llama_spit": "Beżqa ta' Llama",
	"entity.minecraft.magma_cube": "Kaxxa tal-Magma",
	"entity.minecraft.mangrove_boat": "Dgħajsa tal-Mangrovja",
	"entity.minecraft.mangrove_chest_boat": "Dgħajsa tal-Mangrovja bis-Senduq",
	...
	"entity.minecraft.nautilus": "Nawtilu",
	"entity.minecraft.oak_boat": "Dgħajsa tal-Ballut",
	"entity.minecraft.oak_chest_boat": "Dgħajsa tal-Ballut bis-Senduq",
	"entity.minecraft.ocelot": "Qattus Salvaġġ",
	"entity.minecraft.ominous_item_spawner": "Nissiel ta’ Oġġett Minaċċuż",
	"entity.minecraft.painting": "Pittura",
	"entity.minecraft.pale_oak_boat": "Dgħajsa tal-Ballut Pallidu",
	"entity.minecraft.pale_oak_chest_boat": "Dgħajsa tal-Ballut Pallidu bis-Senduq",
	...
	"entity.minecraft.pillager": "Ħalliel",
	...
	"entity.minecraft.splash_potion": "Xarba Titwaddab",
	"entity.minecraft.spruce_boat": "Dgħajsa tal-Arżnu",
	"entity.minecraft.spruce_chest_boat": "Dgħajsa tal-Arżnu bis-Senduq",
	...
	"entity.minecraft.text_display": "Wirja ta' Test",
	"entity.minecraft.tnt": "TNT mibdija",
	"entity.minecraft.tnt_minecart": "Karretta bl-Isplussivi",
	"entity.minecraft.trader_llama": "Llama ta' Merkant",
	...
	"entity.minecraft.vex": "Vessatorju",
	...
	"entity.minecraft.villager.toolsmith": "Ħaddiem tal-Għodda",
	"entity.minecraft.villager.weaponsmith": "Ħaddiem tal-Arma",
	"entity.minecraft.vindicator": "Vendikatur",
	"entity.minecraft.wandering_trader": "Vjaġġatur Merkantili",
	"entity.minecraft.warden": "Għassies",
	"entity.minecraft.wind_charge": "Balma tar-Riħ",
	"entity.minecraft.witch": "Saħħara",
	"entity.minecraft.wither": "Wither",
	"entity.minecraft.wither_skeleton": "Skeletru tal-Wither",
	"entity.minecraft.wither_skull": "Kranju tal-Wither",
	"entity.minecraft.wolf": "Lupu",
	"entity.minecraft.zoglin": "Zoglin",
	"entity.minecraft.zombie": "Mostru",
	"entity.minecraft.zombie_horse": "Żiemel Mostru",
	"entity.minecraft.zombie_nautilus": "Nawtilu Żombi",
	"entity.minecraft.zombie_villager": "Villeġġjatur Żombi",
	"entity.minecraft.zombified_piglin": "Piglin Żombifikat",
	"entity.not_summonable": "Ma setax idieher entita' bit-tip %s",
	"event.minecraft.raid": "Inkursjoni",
	"event.minecraft.raid.defeat": "Telfa",
	"event.minecraft.raid.defeat.full": "Inkursjoni - Telfa",
	"event.minecraft.raid.raiders_remaining": "Rajders li fadal: %s",
	"event.minecraft.raid.victory": "Rebħa",
	"event.minecraft.raid.victory.full": "Inkursjoni - Rebħa",
	"filled_map.buried_treasure": "Mappa taċ-ngħożżu",
	"filled_map.explorer_jungle": "Mappa tal-Esploratur tal-Ġungla",
	"filled_map.explorer_swamp": "Mappa tal-Esploratur tal-Mistagħdra",
	"filled_map.id": "Id #%s",
	...
	"filled_map.trial_chambers": "Mappa tal-Esploratur tal-Isfida",
	"filled_map.unknown": "Mappa mhux magħrufa",
	"filled_map.village_desert": "Mappa ta’ Raħal tad-Deżert",
	"filled_map.village_plains": "Mappa ta’ Raħal tal-Pjanura",
	"filled_map.village_savanna": "Mappa ta’ Raħal tas-Savanna",
	"filled_map.village_snowy": "Mappa ta’ Raħal tal-Borra",
	"filled_map.village_taiga": "Mappa ta’ Raħal tat-Taiga",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Ippermetti n-Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Tiddetermina jekk il-plejers humiex permessi jidħlu fin-Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Propagazzjoni tan-nar fil-bogħod",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Tiddetermina jekk in-nar u l-lava għandomx jkunu attivi meta jkunu iktar minn 8 chunks ‘il bogħod minn plejer.",
	"gamerule.announceAdvancements": "Avvanzament mhux magħruf",
	"gamerule.blockExplosionDropDecay": "Fl-isplużjonijiet ta' interazzjonijiet mal-blokok, xi blokok ma jitwaqqgħux",
	"gamerule.blockExplosionDropDecay.description": "Meta interazzjoni ma' blokka tikkawża splużjoni li tkisser blokok, xi wħud tal-oġġetti li ssoltu jitwaqqgħu jintilfu fl-isplużjoni.",
	"gamerule.category.chat": "Chat",
	"gamerule.category.drops": "Waqqa",
	"gamerule.category.misc": "Mixxellanja",
	"gamerule.category.mobs": "Kreaturi",
	"gamerule.category.player": "Plejer",
	...
	"gamerule.commandBlocksEnabled": "Attiva l-Blokok tal-Kodiċi",
	"gamerule.commandModificationBlockLimit": "Limitu tal-blokok modifikabbli għall-kodiċi",
	"gamerule.commandModificationBlockLimit.description": "Numru ta’ blokok li jistgħu jinbidlu f’daqqa b’kodiċi wieħed, bħal /fill jew /clone.",
	"gamerule.disableElytraMovementCheck": "Itfi l-kontroll tal-moviment tal-elytra",
	"gamerule.disablePlayerMovementCheck": "Diżattiva l-verifika tal-moviment tal-plejer",
	"gamerule.disableRaids": "Diżattiva l-inkursjonijiet",
	...
	"gamerule.doLimitedCrafting.description": "Jekk attivata, l-plejers jkunu jistgħu jsawru oġġetti biss jekk jkollhom ir-riċetti għalihom.",
	"gamerule.doMobLoot": "Qatra mob loot",
	"gamerule.doMobLoot.description": "Tiddetermina r-riżorsi li jitwaqqgħu mill-kreaturi, inklużi l-isferi tal-esperjenza.",
	...
	"gamerule.doTileDrops.description": "Tiddetermina r-riżorsi li jitwaqqgħu mill-blokok, inklużi l-isferi tal-esperjenza.",
	"gamerule.doTraderSpawning": "Kummerċjanti tal-wandering ripawn",
	"gamerule.doVinesSpread": "Propagazzjoni tad-Dwieli",
	"gamerule.doVinesSpread.description": "Tiddetermina jekk id-Dwieli jippropagawx għal fuq il-blokok maġenbhom. Ma taffetwax tipi oħra ta’ dwieli bħal Dwieli tal-Biki, Dwieli li Jduru, eċċ.",
	...
	"gamerule.enableCommandBlocks": "Attiva l-Blokok tal-Kodiċi",
	"gamerule.enderPearlsVanishOnDeath": "Perli tal-Ender mwaddba jisparixxu mal-mewt",
	"gamerule.enderPearlsVanishOnDeath.description": "Jekk Perli tal-Ender mwaddba minn plejer jisparixxux meta dak il-plejer imut.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Entitajiet bil-passiġġieri jistgħu jgħaddu minn ġol-portali",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Ippermetti lill-entitajiet bil-passiġġieri jitteleportaw permezz tal-Portali tan-Nether, l-Portali tal-End, u l-Kanċelli tal-End.",
	...
	"gamerule.globalSoundEvents": "Avvenimenti tal-ħsejjes globali",
	"gamerule.globalSoundEvents.description": "Meta ċertu avvenimenti tal-logħba jseħħu, bħat-tnissil ta’ boss, il-ħoss jinstema’ minn kullimkien.",
	"gamerule.keepInventory": "Żomm l-inventarju wara l-mewt",
	"gamerule.lavaSourceConversion": "Lava ssir sors",
	"gamerule.lavaSourceConversion.description": "Meta lava ġierja hija mdawra fuq ż-żewġ naħat minn sorsi ta’ lava, ssir sors ukoll.",
	...
	"gamerule.maxCommandChainLength.description": "Tapplika għal katini ta’ blokok tal-kodiċi u funzjonijiet.",
	"gamerule.maxCommandForkCount": "Limitu tal-kuntesti tal-kodiċi",
	"gamerule.maxCommandForkCount.description": "Numru massimu ta’ kuntesti li jistgħu jintużaw minn kodiċi bħal 'execute as'.",
	"gamerule.maxEntityCramming": "Livell limitu ta' cramming tal-entità",
	"gamerule.minecartMaxSpeed": "Velocità massima tal-Karretti",
	"gamerule.minecartMaxSpeed.description": "Velocità massima dìfolt ta’ Karretta miexja fuq l-art.",
	"gamerule.minecraft.elytra_movement_check": "Ivverifika il-moviment bl-elitra",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radju tat-tifrix tan-nar",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "Ir-radju fi blokki madwar plejer li fih jista' jinfirex in-nar",
	"gamerule.minecraft.player_movement_check": "Ivverifika il-moviment tal-plejer",
	"gamerule.minecraft.raids": "Inkursjonijiet",
	"gamerule.minecraft.universal_anger.description": "Kreaturi newtrali rrabjati jattakkaw kwalunkwe plejer fil-qrib, mhux biss il-plejer li pprovokahom. Taħdem aħjar jekk \"forgive_dead_players\" hija diżattivata.",
	"gamerule.mobExplosionDropDecay": "Fl-isplużjonijiet ta' kreaturi, xi blokok ma jitwaqqgħux",
	"gamerule.mobExplosionDropDecay.description": "Meta kreatura tikkawża splużjoni li tkisser blokok, xi wħud tal-oġġetti li ssoltu jitwaqqgħu jintilfu fl-isplużjoni.",
	"gamerule.mobGriefing": "Ippermetti azzjonijiet distruttivi tal-mob",
	"gamerule.naturalRegeneration": "Riġenerati s-saħħa",
	"gamerule.playersNetherPortalCreativeDelay": "Dewmien fil-portali tan-Nether fil-modalità kreattiva",
	"gamerule.playersNetherPortalCreativeDelay.description": "Ħin (f’ticks) li plejer fil-modalità kreattiva jrid iqatta’ f’portal tan-Nether qabel ma jibdel id-dimensjonijiet.",
	"gamerule.playersNetherPortalDefaultDelay": "Dewmien fil-portali tan-Nether f'modalità mhux kreattiva",
	"gamerule.playersNetherPortalDefaultDelay.description": "Ħin (f’ticks) li plejer mhux fil-modalità kreattiva jrid iqatta’ f’portal tan-Nether qabel ma jibdel id-dimensjonijiet.",
	...
	"gamerule.projectilesCanBreakBlocks": "Projettili jistgħu jkissru blokok",
	"gamerule.projectilesCanBreakBlocks.description": "Tiddetermina jekk projettili tal-impatt jkissrux blokok vulnerabbli.",
	"gamerule.pvp": "Attiva PvP",
	"gamerule.pvp.description": "Tiddetermina jekk il-plejers jistgħux iweġġgħu lill-plejers oħrajn.",
	...
	"gamerule.reducedDebugInfo.description": "Tillimita l-kontenut tal-iskrin tad-debugging.",
	"gamerule.sendCommandFeedback": "Ibgħat feedback tal-kmand",
	"gamerule.showDeathMessages": "Uri l-messaġġi tal-mewt",
	"gamerule.snowAccumulationHeight": "Għoli tal-akkumulazzjoni tal-borra",
	"gamerule.snowAccumulationHeight.description": "Meta tagħmel il-borra, saffi ta’ borra jiffurmaw fuq l-art sa n-numru massimu ta' saffi speċifikat.",
	...
	"gamerule.spawnMonsters": "Nissel il-mostri",
	"gamerule.spawnMonsters.description": "Tiddetermina jekk il-mostri jitnisslux naturalment.",
	"gamerule.spawnRadius": "Raġġ tal-post tar-respawn",
	"gamerule.spawnRadius.description": "Tiddetermina d-daqs tal-erja madwar il-punt tal-qawmien li plejers jistgħu jiġġeneraw fiha.",
	"gamerule.spawnerBlocksEnabled": "Attiva l-Blokok tat-Tnissil",
	"gamerule.spectatorsGenerateChunks": "Ippermetti lill-ispettaturi jiġġeneraw it-terren",
	"gamerule.tntExplodes": "Ippermetti l-isplussivi jiġu attivati u jisplodu",
	"gamerule.tntExplosionDropDecay": "Fl-isplużjonijiet tal-isplussivi, xi blokok ma jitwaqqgħux",
	"gamerule.tntExplosionDropDecay.description": "Meta splussivi jikkawżaw splużjoni li tkisser blokok, xi wħud tal-oġġetti li ssoltu jitwaqqgħu jintilfu fl-isplużjoni.",
	...
	"gamerule.waterSourceConversion": "Ilma jsir sors",
	"gamerule.waterSourceConversion.description": "Meta ilma ġieri huwa mdawwar fuq ż-żewġ naħat minn sorsi tal-ilma, jsir sors ukoll.",
	...
	"gui.abuseReport.attestation": "Billi tissottometti dan ir-rapport, tikkonferma li l-informazzjoni li pprovdejt hija preċiża u kompluta safejn taf int.",
	...
	"item.minecraft.amethyst_shard": "Framment tal-Ametista",
	"item.minecraft.angler_pottery_shard": "Ċaqqufa b’Qasba",
	"item.minecraft.angler_pottery_sherd": "Ċaqqufa b’Qasba",
	"item.minecraft.apple": "Tuffieħa",
	"item.minecraft.archer_pottery_shard": "Ċaqqufa b’Qaws",
	"item.minecraft.archer_pottery_sherd": "Ċaqqufa b’Qaws",
	"item.minecraft.armadillo_scute": "Skuta ta' Armadill",
	"item.minecraft.armadillo_spawn_egg": "Bajda tat-Tnissil ta' Armadill",
	"item.minecraft.armor_stand": "Stand tal-Armar",
	"item.minecraft.arms_up_pottery_shard": "Ċaqqufa b’Dirgħajn ‘il Fuq",
	"item.minecraft.arms_up_pottery_sherd": "Ċaqqufa b’Dirgħajn ‘il Fuq",
	...
	"item.minecraft.bat_spawn_egg": "Bajda tal-Farfett il-lejl",
	"item.minecraft.bee_spawn_egg": "Bajda tan-Naħla",
	...
	"item.minecraft.black_bundle": "Borża Sewda",
	"item.minecraft.black_dye": "Kulur iswed",
	"item.minecraft.black_harness": "Xedd Iswed",
	"item.minecraft.blade_pottery_shard": "Ċaqqufa b’Xafra",
	"item.minecraft.blade_pottery_sherd": "Ċaqqufa b’Xafra",
	"item.minecraft.blaze_powder": "Trab tan-Nar",
	"item.minecraft.blaze_rod": "Virga tan-Nar",
	"item.minecraft.blaze_spawn_egg": "Il-Bajda tal-Blaze",
	"item.minecraft.blue_bundle": "Borża Blu",
	"item.minecraft.blue_dye": "Żebgħa Kaħla",
	"item.minecraft.blue_egg": "Bajda Blu",
	"item.minecraft.blue_harness": "Xedd Blu",
	"item.minecraft.bogged_spawn_egg": "Bajda tat-Tnissil ta' Mgħaddar",
	"item.minecraft.bolt_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Ornament Stil ta' Vit",
	"item.minecraft.bone": "Għadma",
	"item.minecraft.bone_meal": "Fertilizzant",
	"item.minecraft.book": "Ktieb",
	"item.minecraft.bordure_indented_banner_pattern": "Disinn bil-Bordura Indentata",
	"item.minecraft.bow": "Qaws",
	"item.minecraft.bowl": "Skutella",
	"item.minecraft.bread": "Ħobż",
	"item.minecraft.breeze_rod": "Virga ta' Żiffa",
	"item.minecraft.breeze_spawn_egg": "Bajda tat-Tnissil ta' Żiffa",
	"item.minecraft.brewer_pottery_shard": "Ċaqqufa b’Flixkun",
	"item.minecraft.brewer_pottery_sherd": "Ċaqqufa b’Flixkun",
	"item.minecraft.brewing_stand": "Birrerija",
	"item.minecraft.brick": "Briksa",
	"item.minecraft.brown_bundle": "Borża Kannella",
	...
	"item.minecraft.burn_pottery_shard": "Ċaqqufa b’Nar",
	"item.minecraft.burn_pottery_sherd": "Ċaqqufa b’Nar",
	"item.minecraft.camel_husk_spawn_egg": "Bajda tat-Tnissil ta' Ġemel Minxuf",
	"item.minecraft.camel_spawn_egg": "Bajda tal-Ġemel",
	"item.minecraft.carrot": "Karrotta",
	"item.minecraft.carrot_on_a_stick": "Karrotta fuq Stikka",
	"item.minecraft.cat_spawn_egg": "Bajda tal-Qattus",
	"item.minecraft.cauldron": "Kaldarun",
	"item.minecraft.cave_spider_spawn_egg": "Bajda tal-Brimba tal-Għar",
	...
	"item.minecraft.chainmail_leggings": "Qalziet tas-Sidra ta' Katina",
	...
	"item.minecraft.coast_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.coast_armor_trim_smithing_template.new": "Ornament Stil ta’ Xatt",
	...
	"item.minecraft.copper_boots": "Żraben tar-Ram",
	"item.minecraft.copper_chestplate": "Armar tar-Ram",
	"item.minecraft.copper_golem_spawn_egg": "Bajda tat-Tnissil ta' Golem tar-Ram",
	"item.minecraft.copper_helmet": "Elmu tar-Ram",
	"item.minecraft.copper_hoe": "Mgħażqa tar-Ram",
	"item.minecraft.copper_horse_armor": "Armar taż-Żwiemel tar-Ram",
	"item.minecraft.copper_ingot": "Ingotta tar-ram",
	"item.minecraft.copper_leggings": "Saqajn tar-Ram",
	"item.minecraft.copper_nautilus_armor": "Armatura tan-Nawtili tar-Ram",
	...
	"item.minecraft.creaking_spawn_egg": "Bajda tat-Tnissil ta' Żaqżieq",
	"item.minecraft.creeper_banner_pattern": "Banner Pattern",
	"item.minecraft.creeper_banner_pattern.desc": "Ċarġ creeper",
	"item.minecraft.creeper_banner_pattern.new": "Disinn b’Wiċċ ta’ Creeper",
	"item.minecraft.creeper_spawn_egg": "Bajda",
	"item.minecraft.crossbow": "Crossbow",
	"item.minecraft.crossbow.projectile": "Projettili:",
	"item.minecraft.crossbow.projectile.multiple": "Projettili: %s x %s",
	"item.minecraft.crossbow.projectile.single": "Projettili: %s",
	"item.minecraft.cyan_bundle": "Borża Turkważ",
	"item.minecraft.cyan_dye": "Żebgħa Blu fl-Aħdar",
	"item.minecraft.cyan_harness": "Xedd Turkważ",
	"item.minecraft.danger_pottery_shard": "Ċaqqufa b’Periklu",
	"item.minecraft.danger_pottery_sherd": "Ċaqqufa b’Periklu",
	...
	"item.minecraft.debug_stick.empty": "%s m' għandu l-ebda proprjetajiet",
	...
	"item.minecraft.diamond_nautilus_armor": "Armatura tan-Nawtili tad-Djamant",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Ornament Stil ta’ Duna",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Bajda tat-Tnissil ta' Dragun tal-Ender",
	...
	"item.minecraft.endermite_spawn_egg": "Bajd tal-Endermite",
	"item.minecraft.evoker_spawn_egg": "Bajda tal-bajd (evoker)",
	"item.minecraft.experience_bottle": "Flixkun tal-Maġija",
	"item.minecraft.explorer_pottery_shard": "Ċaqqufa b’Mappa",
	"item.minecraft.explorer_pottery_sherd": "Ċaqqufa b’Mappa",
	"item.minecraft.eye_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Ornament Stil ta’ Għajn",
	"item.minecraft.feather": "Rixa",
	"item.minecraft.fermented_spider_eye": "Għajn ta' Brimba Ffermentata",
	"item.minecraft.field_masoned_banner_pattern": "Disinn bil-Briks",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Ornament Stil ta' Fluss",
	"item.minecraft.flow_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.flow_banner_pattern.desc": "Fluss",
	"item.minecraft.flow_banner_pattern.new": "Disinn b'Fluss",
	"item.minecraft.flow_pottery_sherd": "Ċaqqufa b’Fluss",
	"item.minecraft.flower_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.flower_banner_pattern.desc": "Ċarġ tal-fjura",
	"item.minecraft.flower_banner_pattern.new": "Disinn b'Fjura",
	"item.minecraft.flower_pot": "Qasrija",
	"item.minecraft.fox_spawn_egg": "Bajda tal-volpi",
	"item.minecraft.friend_pottery_shard": "Ċaqqufa b’Ħabib",
	"item.minecraft.friend_pottery_sherd": "Ċaqqufa b’Ħabib",
	...
	"item.minecraft.globe_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.globe_banner_pattern.desc": "Dinja",
	"item.minecraft.globe_banner_pattern.new": "Disinn b'Globu",
	...
	"item.minecraft.golden_nautilus_armor": "Armatura tan-Nawtili tad-Deheb",
	...
	"item.minecraft.gray_bundle": "Borża Griża",
	"item.minecraft.gray_dye": "Żebgħa Griża",
	"item.minecraft.gray_harness": "Xedd Griż",
	"item.minecraft.green_bundle": "Borża Ħadra",
	...
	"item.minecraft.guster_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.guster_banner_pattern.desc": "Buffura",
	"item.minecraft.guster_banner_pattern.new": "Disinn b'Buffura",
	"item.minecraft.guster_pottery_sherd": "Ċaqqufa b’Buffura",
	"item.minecraft.happy_ghast_spawn_egg": "Bajda tat-Tnissil ta' Ghast Ferħan",
	"item.minecraft.harness": "Xedd",
	"item.minecraft.heart_of_the_sea": "Il-qalba tal-ba Ħar",
	"item.minecraft.heart_pottery_shard": "Ċaqqufa b’Qalb",
	"item.minecraft.heart_pottery_sherd": "Ċaqqufa b’Qalb",
	"item.minecraft.heartbreak_pottery_shard": "Ċaqqufa b’Qalb Miksura",
	"item.minecraft.heartbreak_pottery_sherd": "Ċaqqufa b’Qalb Miksura",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.host_armor_trim_smithing_template.new": "Ornament Stil ta’ Ospitant",
	"item.minecraft.howl_pottery_shard": "Ċaqqufa b’Lupu",
	"item.minecraft.howl_pottery_sherd": "Ċaqqufa b’Lupu",
	...
	"item.minecraft.iron_golem_spawn_egg": "Bajda tat-Tnissil ta' Golem tal-Ħadid",
	...
	"item.minecraft.iron_nautilus_armor": "Armatura tan-Nawtili tal-Ħadid",
	...
	"item.minecraft.light_blue_bundle": "Borża Ċelesti",
	"item.minecraft.light_blue_dye": "Żebgħa Blu Ċara",
	"item.minecraft.light_blue_harness": "Xedd Ċelesti",
	"item.minecraft.light_gray_bundle": "Borża Griża Ċara",
	"item.minecraft.light_gray_dye": "Żebgħa Griża Ċara",
	"item.minecraft.light_gray_harness": "Xedd Griż Ċar",
	"item.minecraft.lime_bundle": "Borża Ħadra Safranija",
	"item.minecraft.lime_dye": "Żebgħa Ħadra Ċara",
	"item.minecraft.lime_harness": "Xedd Aħdar Safrani",
	...
	"item.minecraft.lingering_potion.effect.infested": "Xarba tal-Infestazzjoni Fumanti",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Xarba tan-Nixa Fumanti",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Xarba tal-Insiġ Fumanti",
	"item.minecraft.lingering_potion.effect.wind_charged": "Xarba tal-Ikkargjar bir-Riħ Fumanti",
	...
	"item.minecraft.magenta_bundle": "Borża Maġenta",
	...
	"item.minecraft.miner_pottery_shard": "Ċaqqufa b’Baqqun",
	"item.minecraft.miner_pottery_sherd": "Ċaqqufa b’Baqqun",
	"item.minecraft.mojang_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.mojang_banner_pattern.desc": "Ħaġa",
	"item.minecraft.mojang_banner_pattern.new": "Disinn b'xi Ħaġa",
	"item.minecraft.mooshroom_spawn_egg": "Mooshroom tal-bajd",
	"item.minecraft.mourner_pottery_shard": "Ċaqqufa b’Imnikket",
	"item.minecraft.mourner_pottery_sherd": "Ċaqqufa b’Imnikket",
	...
	"item.minecraft.music_disc_creator": "Diska tal-Mużika",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Diska tal-Mużika",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Kaxxa Mużikali)",
	"item.minecraft.music_disc_far": "Diska tal-Mużika",
	"item.minecraft.music_disc_far.desc": "C418 - far",
	"item.minecraft.music_disc_lava_chicken": "Diska tal-Mużika",
	...
	"item.minecraft.music_disc_precipice": "Diska tal-Mużika",
	"item.minecraft.music_disc_precipice.desc": "Aaron Cherof - Precipice",
	"item.minecraft.music_disc_relic": "Diska tal-Mużika",
	...
	"item.minecraft.music_disc_tears": "Diska tal-Mużika",
	...
	"item.minecraft.nautilus_shell": "Qoxra ta' Nawtilu",
	"item.minecraft.nautilus_spawn_egg": "Bajda tat-Tnissil ta' Nawtilu",
	...
	"item.minecraft.netherite_horse_armor": "Armar taż-Żwiemel tan-Netherite",
	"item.minecraft.netherite_ingot": "Ingott tan-Netherajt",
	"item.minecraft.netherite_leggings": "Qalziet tan-Netherajt",
	"item.minecraft.netherite_nautilus_armor": "Armatura tan-Nawtili tan-Netherite",
	...
	"item.minecraft.netherite_spear": "Lanza tan-Netherite",
	"item.minecraft.netherite_sword": "Xabla tan-Netherajt",
	"item.minecraft.netherite_upgrade_smithing_template": "Skema tal-Forġa",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Aġġornament tan-Netherajt",
	...
	"item.minecraft.ominous_bottle": "Flixkun Minaċċuż",
	"item.minecraft.ominous_trial_key": "Ċavetta tal-Isfida Minaċċuża",
	"item.minecraft.orange_bundle": "Borża Oranġjo",
	"item.minecraft.orange_dye": "Żebgħa Oranġjo",
	"item.minecraft.orange_harness": "Xedd Oranġjo",
	"item.minecraft.painting": "Pittura",
	"item.minecraft.pale_oak_boat": "Dgħajsa tal-Ballut Pallidu",
	"item.minecraft.pale_oak_chest_boat": "Dgħajsa tal-Ballut Pallidu b'Senduq",
	"item.minecraft.panda_spawn_egg": "Bajda tal-bajd tas-saln",
	"item.minecraft.paper": "Karta",
	"item.minecraft.parched_spawn_egg": "Bajda tat-Tnissil ta' Għatxan",
	...
	"item.minecraft.piglin_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.piglin_banner_pattern.desc": "Geddum",
	"item.minecraft.piglin_banner_pattern.new": "Disinn b’Gdejdem",
	...
	"item.minecraft.pink_bundle": "Borża Roża",
	"item.minecraft.pink_dye": "Żebgħa Roża",
	"item.minecraft.pink_harness": "Xedd Roża",
	"item.minecraft.pitcher_plant": "Buqar Karnivoru",
	"item.minecraft.pitcher_pod": "Miżwed tal-Buqar Karnivoru",
	"item.minecraft.plenty_pottery_shard": "Ċaqqufa b’Teżor",
	"item.minecraft.plenty_pottery_sherd": "Ċaqqufa b’Teżor",
	...
	"item.minecraft.potion.effect.infested": "Xarba tal-Infestazzjoni",
	...
	"item.minecraft.potion.effect.oozing": "Xarba tan-Nixa",
	...
	"item.minecraft.potion.effect.weaving": "Xarba tal-Insiġ",
	"item.minecraft.potion.effect.wind_charged": "Xarba tal-Ikkargjar bir-Riħ",
	"item.minecraft.pottery_shard_archer": "Ċaqqufa b’Qaws",
	"item.minecraft.pottery_shard_arms_up": "Ċaqqufa b’Dirgħajn ‘il Fuq",
	"item.minecraft.pottery_shard_prize": "Ċaqqufa b’Premju",
	"item.minecraft.pottery_shard_skull": "Ċaqqufa b’Kranju",
	...
	"item.minecraft.prize_pottery_shard": "Ċaqqufa b’Premju",
	"item.minecraft.prize_pottery_sherd": "Ċaqqufa b’Premju",
	...
	"item.minecraft.purple_bundle": "Borża Vjola",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.raiser_armor_trim_smithing_template.new": "Ornament Stil ta’ Rabbej",
	...
	"item.minecraft.red_bundle": "Borża Ħamra",
	"item.minecraft.red_dye": "Żebgħa ħamra",
	"item.minecraft.red_harness": "Xedd Aħmar",
	"item.minecraft.redstone": "Trab tar-Redstone",
	"item.minecraft.resin_brick": "Briksa tar-Raża",
	"item.minecraft.resin_clump": "Ċappa Raża",
	"item.minecraft.rib_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.rib_armor_trim_smithing_template.new": "Ornament Stil ta’ Kustilja",
	...
	"item.minecraft.scrape_pottery_sherd": "Ċaqqufa b’Mannara",
	"item.minecraft.scute": "Skuta",
	"item.minecraft.sentry_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.sentry_armor_trim_smithing_template.new": "Ornament Stil ta’ Sentinella",
	"item.minecraft.shaper_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.shaper_armor_trim_smithing_template.new": "Ornament Stil ta’ Mudellatur",
	"item.minecraft.sheaf_pottery_shard": "Ċaqqufa b’Qatta",
	"item.minecraft.sheaf_pottery_sherd": "Ċaqqufa b’Qatta",
	"item.minecraft.shears": "Ġliem",
	"item.minecraft.sheep_spawn_egg": "Bajd tan-nag ħaġ",
	"item.minecraft.shelter_pottery_shard": "Ċaqqufa b’Kenn",
	"item.minecraft.shelter_pottery_sherd": "Ċaqqufa b’Kenn",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.silence_armor_trim_smithing_template.new": "Ornament Stil ta’ Silenzju",
	...
	"item.minecraft.skull_banner_pattern": "Disinn għal Bandiera",
	"item.minecraft.skull_banner_pattern.desc": "Ċarġ tal-kranju",
	"item.minecraft.skull_banner_pattern.new": "Disinn b'Kranju",
	"item.minecraft.skull_pottery_shard": "Ċaqqufa b’Kranju",
	"item.minecraft.skull_pottery_sherd": "Ċaqqufa b’Kranju",
	"item.minecraft.slime_ball": "Ballun tal-Ħama",
	"item.minecraft.slime_spawn_egg": "Bajda tal-bajd tas-sġir",
	"item.minecraft.smithing_template": "Skema tal-Forġa",
	...
	"item.minecraft.smithing_template.netherite_upgrade.additions_slot_description": "Żid Ingott tan-Netherajt",
	...
	"item.minecraft.smithing_template.netherite_upgrade.ingredients": "Ingott tan-Netherajt",
	"item.minecraft.smithing_template.upgrade": "Aġġornament: ",
	"item.minecraft.sniffer_spawn_egg": "Bajda tat-Tnissil ta' Xammiem",
	"item.minecraft.snort_pottery_shard": "Ċaqqufa b’Xammiem",
	"item.minecraft.snort_pottery_sherd": "Ċaqqufa b’Xammiem",
	"item.minecraft.snout_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Ornament Stil ta’ Gdejdem",
	"item.minecraft.snow_golem_spawn_egg": "Bajda tat-Tnissil ta' Golem tas-Silġ",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.spire_armor_trim_smithing_template.new": "Ornament Stil ta’ Spira",
	...
	"item.minecraft.splash_potion.effect.infested": "Xarba tal-Infestazzjoni Tinxtered",
	...
	"item.minecraft.splash_potion.effect.oozing": "Xarba tan-Nixa Tinxtered",
	...
	"item.minecraft.splash_potion.effect.weaving": "Xarba tal-Insiġ Tinxtered",
	"item.minecraft.splash_potion.effect.wind_charged": "Xarba tal-Ikkargjar bir-Riħ Tinxtered",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.tide_armor_trim_smithing_template.new": "Ornament Stil ta’ Medea",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Vleġġa tal-Infestazzjoni",
	...
	"item.minecraft.tipped_arrow.effect.wind_charged": "Vleġġa tal-Ikkargjar bir-Riħ",
	...
	"item.minecraft.trial_key": "Ċavetta tal-Isfida",
	...
	"item.minecraft.turtle_scute": "Skuta ta' Fekruna",
	"item.minecraft.turtle_spawn_egg": "Bajda bajd tal-fekruna",
	"item.minecraft.vex_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.vex_armor_trim_smithing_template.new": "Ornament Stil Vessanti",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ornament Stil ta’ Għassies",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ornament Stil ta’ Traċċatur",
	"item.minecraft.wheat": "Qamħ",
	"item.minecraft.wheat_seeds": "Żerriegħa tal-qam ħ",
	"item.minecraft.white_bundle": "Borża Bajda",
	"item.minecraft.white_dye": "Kulur abjad",
	"item.minecraft.white_harness": "Xedd Abjad",
	"item.minecraft.wild_armor_trim_smithing_template": "Skema tal-Forġa",
	"item.minecraft.wild_armor_trim_smithing_template.new": "Ornament Stil Selvaġġ",
	"item.minecraft.wind_charge": "Balma tar-Riħ",
	"item.minecraft.witch_spawn_egg": "Dawwar il-bajda tal-bajd",
	"item.minecraft.wither_skeleton_spawn_egg": "Il-bajda tal-bajd wither",
	"item.minecraft.wither_spawn_egg": "Bajda tat-Tnissil ta' Wither",
	"item.minecraft.wolf_armor": "Armatura tal-Lupi",
	...
	"item.minecraft.yellow_bundle": "Borża Safra",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Bajda tat-Tnissil ta' Nawtilu Żombi",
	...
	"item.modifiers.any": "Meta jkun mgħammar:",
	"item.modifiers.armor": "Meta jintlibes:",
	"item.modifiers.body": "Meta jkun mgħammar:",
	...
	"item.modifiers.saddle": "Meta jkun bis-Sarġ:",
	"item.nbt_tags": "NBT:%s tags (s)",
	"item.op_block_warning.line1": "Twissija:",
	"item.op_block_warning.line2": "L-użu ta' dan l-oġġett jista' jesegwixxi kmand",
	"item.op_block_warning.line3": "Tużahx sakemm ma tafx eżatt x'jagħmel!",
	"item.spawn_egg.peaceful": "Diżattivata f'diffikultà Paċifika",
	"item.unbreakable": "Ma tinkisirx",
	"itemGroup.buildingBlocks": "Blokok tal-Bini",
	"itemGroup.coloredBlocks": "Blokok Ikkuluriti",
	...
	"jigsaw_block.placement_priority.tooltip": "Meta din il-Blokka tal-Jigsaw taqbad ma biċċa, din tkun l-ordni li fiha dik il-biċċa tiġi pproċessata għal konnessjonijiet fl-istruttura sħieħa.\n\nIl-biċċiet ikunu pproċċessati skont l-ordni ta' prijorità mill-ogħla sa l-aktar baxxa, jew skont l-ordni ta' inserzjoni f'kas ta' parità.",
	...
	"jukebox_song.minecraft.creator_music_box": "Lena Raine - Skepper (Kaxxa Mużikali)",
	...
	"key.categories.spectator": "Spettatur",
	"key.categories.ui": "Interface tal-Logħba",
	"key.category.minecraft.creative": "Mod Kreattiv",
	"key.category.minecraft.debug": "Debug",
	"key.category.minecraft.gameplay": "Kif Tilgħab",
	"key.category.minecraft.inventory": "Inventarju",
	"key.category.minecraft.misc": "Mixxellanja",
	"key.category.minecraft.movement": "Moviment",
	"key.category.minecraft.multiplayer": "Multiplayer",
	"key.category.minecraft.spectator": "Spettatur",
	...
	"key.keyboard.unknown": "Mhux Assenjat",
	...
	"manageServer.edit.title": "Ibdel l-Informazzjoni tas-Server",
	"manageServer.enterIp": "Indirizz tas-Server",
	"manageServer.enterName": "Isem is-Server",
	"manageServer.resourcePack": "Resource Packs tas-Servers",
	"manageServer.resourcePack.disabled": "Diżattivati",
	"manageServer.resourcePack.enabled": "Attivati",
	...
	"mco.backup.entry.enabledPack": "Pakkett(i) Attivat(i)",
	"mco.backup.entry.gameDifficulty": "Diffikultà tal-Logħba",
	"mco.backup.entry.gameMode": "Modalità tal-Logħba",
	...
	"mco.backup.entry.worldType": "Tip ta' Dinja",
	...
	"mco.compatibility.upgrade.title": "Żgur tixtieq taġġorna din id-dinja?",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Dan Is-server jirrikjedi resource pack personalizzat",
	...
	"options.chat.drafts": "Sejvja l-Abbozzi",
	"options.chat.drafts.tooltip": "Messaġġi mhux mibgħuta jiġu ssejvjati u jistgħu jintbagħtu d-darba li jmiss li jinfetaħ iċ-chat.",
	...
	"options.difficulty.easy.info": "Kreaturi ostili jitnisslu imma jinfliġġu inqas ħsara. Il-metru tal-ġuħ jista’ jiżvojta u jnaqqaslek is-saħħa sa 5 iqlub.",
	"options.difficulty.hard": "Tqila",
	"options.difficulty.hard.info": "Kreaturi ostili jitnisslu u jinfliġġu iktar ħsara. Il-metru tal-ġuħ jista’ jiżvojta u jnaqqaslek is-saħħa kollha.",
	"options.difficulty.hardcore": "Tqil Immens",
	"options.difficulty.normal": "Normali",
	"options.difficulty.normal.info": "Kreaturi ostili jitnisslu u jinfliġġu ħsara standard. Il-metru tal-ġuħ jista’ jiżvojta u jnaqqaslek is-saħħa sa nofs qalb.",
	"options.difficulty.online": "Server diffikultà",
	"options.difficulty.peaceful": "Paċifika",
	"options.difficulty.peaceful.info": "Ma titnissel l-ebda kreatura ostili u xi kreaturi newtrali. Il-metru tal-ġuħ ma jiżvojtax u s-saħħa terġa’ timtela biż-żmien.",
	"options.directionalAudio": "Awdjo Direzzjonali",
	"options.directionalAudio.off.tooltip": "Ħoss Klassiku Stereo",
	"options.directionalAudio.on.tooltip": "Juża awdjo direzzjonali bbażat fuq HRTF biex itejjeb is-simulazzjoni tal-ħoss tridimensjonali. Jeħtieġ ħardwer tal-awdjo kompatibbli ma' HRTF, u jinstema' l-aħjar bil-headphones.",
	...
	"options.languageAccuracyWarning": "(It-Traduzzjonijiet tal-lingwi mhux bilfors ikunu kompletament korretti)",
	...
	"options.music_frequency.default": "Dìfolt",
	"options.music_frequency.frequent": "Spiss",
	"options.music_frequency.tooltip": "Tbiddel kemm tindaqq spiss il-mużika waqt ġo dinja tal-logħba.",
	...
	"options.showNowPlayingToast.tooltip": "Tidher notifika kull darba li tibda diska. L-istess notifika tidher kontinwament fil-menu tal-pawża tal-logħba waqt li d-diska qed tindaqq.",
	...
	"options.weatherRadius.tooltip": "Ir-radju tal-erja fejn l-effetti tax-xita u l-borra huma viżibbli. L-impatt fuq il-prestazzjoni huwa ftit li xejn.",
	...
	"painting.minecraft.cavebird.title": "Għasfur tal-Għerien",
	...
	"painting.minecraft.earth.title": "Art",
	"painting.minecraft.endboss.author": "Kristoffer Zetterstrand",
	"painting.minecraft.endboss.title": "L-Aħħar Avversarju ",
	...
	"painting.minecraft.owlemons.title": "Kokka u Lumi",
	"painting.minecraft.passage.author": "Kristoffer Zetterstrand",
	"painting.minecraft.passage.title": "Passaġġ",
	...
	"painting.minecraft.void.title": "Il-vojt",
	...
	"painting.random": "Varjant fortuwitu",
	...
	"recover_world.restore": "Ipprova biex Tirrestawra",
	...
	"selectWorld.allowCommands.info": "Kodiċi bħal /gamemode, /experience",
	"selectWorld.allowCommands.new": "Ippermetti l-Kodiċi",
	...
	"selectWorld.edit.optimize": "Ottimizza d-Dinja",
	...
	"selectWorld.experimental.message": "Attenzjoni!\nDin il-konfigurazzjoni teħtieġ karatteristiċi li għadhom qed jiġu żviluppati. Id-dinja tista' tieqaf f’daqqa, tinkiser, jew ma taħdimx ma’ verżjonijiet futuri.",
	"selectWorld.experimental.title": "Twissija tal-Karrateristiċi Esperimentali",
	"selectWorld.experiments": "Sperimenti",
	"selectWorld.experiments.info": "Sperimenti huma karatteristiċi potenzjali ġodda. Ogħqod attent għax affarijiet jistgħu jinkisru. Sperimenti ma jistgħux jiġu diżattivati wara l-ħolqien ta’ dinja.",
	...
	"selectWorld.gameMode.adventure.info": "L-istess bħall-Modalità tas-Sopravivenza, imma ma tistax iżżid jew tneħħi blokok.",
	...
	"selectWorld.gameMode.creative.info": "Ikkrea, ibni, u esplora mingħajr limitu. Tista’ ttir, għandek materjali bla tmiem, u ma tistax tiġi imweġġa’ mil-mostri.",
	...
	"selectWorld.gameMode.hardcore.info": "Modalità tas-Sopravivenza imsakkra fuq diffikultà 'Tqil’. Ma tistax terġa' tqum jekk tmut.",
	...
	"selectWorld.gameMode.survival.info": "Esplora dinja misterjuża fejn tibni, tiġbor, tissawwar, u tiġġieled il-mostri.",
	...
	"selectWorld.incompatible.description": "Din id-dinja ma tistax tinfetaħ f’din il-verżjoni.\nIntlagħbet l-aħħar fil-verżjoni %s.",
	"selectWorld.incompatible.info": "Verżjoni inkompatibbli: %s",
	"selectWorld.incompatible.title": "Verżjoni inkompatibbli",
	"selectWorld.incompatible.tooltip": "Din id-dinja ma tistax tinfetaħ għax inħolqot f’verżjoni inkompatibbli.",
	...
	"stat.minecraft.happy_ghast_one_cm": "Distanza fuq Ghast Ferħan",
	...
	"stat.minecraft.interact_with_smoker": "Interazzjonijiet ma' Affumikatur",
	...
	"stat.minecraft.raid_trigger": "Inkursjonijiet Ikkawżati",
	"stat.minecraft.raid_win": "Inkursjonijiet Mirbuħa",
	...
	"subtitles.ambient.sound": "Ħoss inkwetanti",
	...
	"subtitles.block.composter.empty": "Kompostatur jitbattal",
	"subtitles.block.composter.fill": "Kompostatur jimtela",
	"subtitles.block.composter.ready": "Kompostatur jikkomposta",
	...
	"subtitles.block.copper_bulb.turn_off": "Il-Bozza tar-Ram titfi",
	"subtitles.block.copper_bulb.turn_on": "Il-Bozza tar-Ram tixgħel",
	"subtitles.block.copper_chest.close": "Senduq jingħalaq",
	"subtitles.block.copper_chest.open": "Senduq jinfetaħ",
	"subtitles.block.copper_trapdoor.close": "Bokkaport ingħalaq",
	"subtitles.block.copper_trapdoor.open": "Bokkaport infetaħ",
	"subtitles.block.crafter.craft": "Fabbrikatur isawwar",
	"subtitles.block.crafter.fail": "Fabbrikatur ma jirnexxilux isawwar",
	"subtitles.block.creaking_heart.hurt": "Qalb Tiżaqżaq tgerger",
	"subtitles.block.creaking_heart.idle": "Ħoss inkwetanti",
	"subtitles.block.creaking_heart.spawn": "Qalb Tiżaqżaq tqum",
	...
	"subtitles.block.dried_ghast.ambient_water": "Ghast Imnixxef jiridrata",
	...
	"subtitles.block.end_portal_frame.fill": "Għajn tal-Ender titpoġġa",
	...
	"subtitles.block.firefly_bush.idle": "Musbieħ il-Lejl iżanżan",
	...
	"subtitles.block.pale_hanging_moss.idle": "Ħoss inkwetanti",
	...
	"subtitles.block.respawn_anchor.ambient": "Ħoss ta' Ankra tal-Qawmien",
	"subtitles.block.respawn_anchor.charge": "Ankra tal-Qawmien tiġi kkargjata",
	...
	"subtitles.block.shelf.activate": "Xkaffa tattiva",
	"subtitles.block.shelf.deactivate": "Xkaffa tiddiżattiva",
	"subtitles.block.shelf.multi_swap": "Oġġetti jitpartu",
	"subtitles.block.shelf.place_item": "Oġġett jitpoġġa",
	"subtitles.block.shelf.single_swap": "Oġġett jitpartat",
	...
	"subtitles.block.sniffer_egg.crack": "Bajda ta' Xammiem tinqasam",
	"subtitles.block.sniffer_egg.hatch": "Bajda ta' Xammiem tfaqqas",
	...
	"subtitles.block.trial_spawner.about_to_spawn_item": "Oġġett minaċċuż jipprepara",
	"subtitles.block.trial_spawner.ambient": "Nissiel tal-Isfida jfaqqa’",
	"subtitles.block.trial_spawner.ambient_charged": "Tfaqqigħ minaċċuż",
	"subtitles.block.trial_spawner.ambient_ominous": "Tfaqqigħ minaċċuż",
	"subtitles.block.trial_spawner.charge_activate": "Malawgurju jifga Nissiel tal-Isfida",
	"subtitles.block.trial_spawner.close_shutter": "Nissiel tal-Isfida jingħalaq",
	"subtitles.block.trial_spawner.detect_player": "Nissiel tal-Isfida jikkarga",
	"subtitles.block.trial_spawner.eject_item": "Nissiel tal-Isfida jixħet oġġett",
	"subtitles.block.trial_spawner.ominous_activate": "Malawgurju jifga Nissiel tal-Isfida",
	"subtitles.block.trial_spawner.open_shutter": "Nissiel tal-Isfida jinfetaħ",
	"subtitles.block.trial_spawner.spawn_item": "Oġġett minaċċuż jaqa’",
	"subtitles.block.trial_spawner.spawn_item_begin": "Oġġett minaċċuż ifeġġ",
	"subtitles.block.trial_spawner.spawn_mob": "Nissiel tal-Isfida jnissel kreatura",
	...
	"subtitles.block.vault.insert_item": "Kaxxaforti jinfetaħ b’ċavetta",
	...
	"subtitles.block.vault.reject_rewarded_player": "Kaxxaforti jirrifjuta plejer",
	...
	"subtitles.chiseled_bookshelf.insert_enchanted": "Ktieb Maġiku jitpoġġa",
	"subtitles.chiseled_bookshelf.take": "Ktieb jittieħed",
	"subtitles.chiseled_bookshelf.take_enchanted": "Ktieb Maġiku jittieħed",
	...
	"subtitles.entity.baby_cat.hiss": "Ferħ ta' Qattus izekzek",
	"subtitles.entity.baby_cat.hurt": "Ferħ ta' Qattus iweġġa'",
	"subtitles.entity.baby_cat.purr": "Ferħ ta' Qattus jagħżel",
	...
	"subtitles.entity.baby_nautilus.ambient": "Nawtilu Żgħir jiċċaċċra",
	"subtitles.entity.baby_nautilus.ambient_land": "Nawtilu Żgħir jiċċaċċra",
	"subtitles.entity.baby_nautilus.death": "Nawtilu Żgħir imut",
	"subtitles.entity.baby_nautilus.death_land": "Nawtilu Żgħir imut",
	"subtitles.entity.baby_nautilus.eat": "Nawtilu Żgħir jiekol",
	"subtitles.entity.baby_nautilus.hurt": "Nawtilu Żgħir iweġġa'",
	"subtitles.entity.baby_nautilus.hurt_land": "Nawtilu Żgħir iweġġa'",
	"subtitles.entity.baby_nautilus.swim": "Nawtilu Żgħir jgħum",
	...
	"subtitles.entity.breeze.charge": "Żiffa tikkarga",
	"subtitles.entity.breeze.death": "Żiffa tmut",
	"subtitles.entity.breeze.deflect": "Żiffa tiddevja",
	"subtitles.entity.breeze.hurt": "Żiffa tweġġa'",
	"subtitles.entity.breeze.idle_air": "Żiffa ttir",
	"subtitles.entity.breeze.idle_ground": "Żiffa trewwaħ",
	"subtitles.entity.breeze.inhale": "Żiffa tieħu n-nifs",
	"subtitles.entity.breeze.jump": "Żiffa taqbeż",
	"subtitles.entity.breeze.land": "Żiffa tinżel mal-art",
	"subtitles.entity.breeze.shoot": "Żiffa tispara",
	"subtitles.entity.breeze.slide": "Żiffa tiżżerżaq",
	"subtitles.entity.breeze.whirl": "Żiffa ddawwar",
	"subtitles.entity.breeze.wind_burst": "Balma tar-Riħ tinfaqa'",
	...
	"subtitles.entity.copper_golem.death": "Golem tar-Ram imut",
	"subtitles.entity.copper_golem.hurt": "Golem tar-Ram iweġġa'",
	"subtitles.entity.copper_golem.item_drop": "Golem tar-Ram qed ipoġġi oġġett",
	"subtitles.entity.copper_golem.item_no_drop": "Golem tar-Ram ma jistax ipoġġi oġġett",
	"subtitles.entity.copper_golem.no_item_get": "Golem tar-Ram qed jiġbor oġġett",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem tar-Ram ma jistax jiġbor oġġett",
	"subtitles.entity.copper_golem.spawn": "Golem tar-Ram ifeġġ",
	"subtitles.entity.copper_golem.spin": "Ras il-Golem tar-Ram iddur",
	"subtitles.entity.copper_golem_become_statue": "Golem tar-Ram jibbies",
	"subtitles.entity.copper_golem_oxidized.death": "Golem tar-Ram imut",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem tar-Ram iweġġa'",
	"subtitles.entity.copper_golem_oxidized.spin": "Ras il-Golem tar-Ram iddur",
	"subtitles.entity.copper_golem_weathered.death": "Golem tar-Ram imut",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem tar-Ram iweġġa'",
	"subtitles.entity.copper_golem_weathered.spin": "Ras il-Golem tar-Ram iddur",
	...
	"subtitles.entity.endermite.ambient": "Endermite infixel",
	"subtitles.entity.endermite.death": "Endermite miet",
	"subtitles.entity.endermite.hurt": "Endermite weġġa'",
	...
	"subtitles.entity.generic.wind_burst": "Balma tar-Riħ tinfaqa'",
	...
	"subtitles.entity.leash_knot.break": "Għoqda ta’ Ċinga tinħall",
	"subtitles.entity.leash_knot.place": "Għoqda ta’ Ċinga tintrabat",
	...
	"subtitles.entity.nautilus.ambient": "Nawtilu jċaqċaq",
	"subtitles.entity.nautilus.ambient_land": "Nawtilu jċaqċaq",
	"subtitles.entity.nautilus.dash": "Nawtilu jippropella",
	"subtitles.entity.nautilus.dash_land": "Nawtilu jippropella",
	"subtitles.entity.nautilus.dash_ready": "Nawtilu jirkupra",
	"subtitles.entity.nautilus.dash_ready_land": "Nawtilu jirkupra",
	"subtitles.entity.nautilus.death": "Nawtilu jmut",
	"subtitles.entity.nautilus.death_land": "Nawtilu jmut",
	"subtitles.entity.nautilus.eat": "Nawtilu jiekol",
	"subtitles.entity.nautilus.hurt": "Nawtilu jweġġa'",
	"subtitles.entity.nautilus.hurt_land": "Nawtilu jweġġa'",
	"subtitles.entity.nautilus.swim": "Nawtilu jgħum",
	...
	"subtitles.entity.pig.saddle": "Sarġ jintrama",
	...
	"subtitles.entity.player.teleport": "Plejer jitteleportja",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Skeletru ta' Żiemel jaqbeż",
	...
	"subtitles.entity.sniffer.digging_stop": "Xammiem iqum bilwieqfa",
	"subtitles.entity.sniffer.drop_seed": "Xammiem iwaqqa' żerriegħa",
	"subtitles.entity.sniffer.eat": "Xammiem jiekol",
	"subtitles.entity.sniffer.egg_crack": "Bajda ta' Xammiem tinqasam",
	"subtitles.entity.sniffer.egg_hatch": "Bajda ta' Xammiem tfaqqas",
	...
	"subtitles.entity.sniffer.step": "Xammiem jirfes",
	...
	"subtitles.entity.wind_charge.throw": "Balma tar-Riħ ittir",
	"subtitles.entity.wind_charge.wind_burst": "Balma tar-Riħ tinfaqa'",
	...
	"subtitles.entity.wolf.pant": "Lupu jleheġ",
	...
	"subtitles.entity.zombie_horse.angry": "Żiemel mostru jiżher",
	"subtitles.entity.zombie_horse.death": "Żiemel mostru miet",
	"subtitles.entity.zombie_horse.eat": "Żiemel mostru jiekol",
	"subtitles.entity.zombie_horse.hurt": "Żiemel mostru weġġa'",
	"subtitles.entity.zombie_nautilus.ambient": "Nawtilu Żombi jbaqbaq",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nawtilu Żombi jbaqbaq",
	"subtitles.entity.zombie_nautilus.dash": "Nawtilu Żombi jippropella",
	"subtitles.entity.zombie_nautilus.dash_land": "Nawtilu Żombi jippropella",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nawtilu Żombi jirkupra",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nawtilu Żombi jirkupra",
	"subtitles.entity.zombie_nautilus.death": "Nawtilu Żombi jmut",
	"subtitles.entity.zombie_nautilus.death_land": "Nawtilu Żombi jmut",
	"subtitles.entity.zombie_nautilus.eat": "Nawtilu Żombi jiekol",
	"subtitles.entity.zombie_nautilus.hurt": "Nawtilu Żombi jweġġa'",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nawtilu Żombi jweġġa'",
	"subtitles.entity.zombie_nautilus.swim": "Nawtilu Żombi jgħum",
	...
	"subtitles.event.mob_effect.bad_omen": "Malawgurju jimmanifesta",
	"subtitles.event.mob_effect.raid_omen": "Inkursjoni imminenti",
	"subtitles.event.mob_effect.trial_omen": "Sfida minaċċuża imminenti",
	"subtitles.event.raid.horn": "Qarn minaċċuż jindaqq",
	...
	"subtitles.item.armor.equip_nautilus": "Armatura tan-Nawtili tintrama",
	...
	"subtitles.item.armor.equip_wolf": "Armatura tal-Ilpup tinqafel",
	"subtitles.item.armor.unequip_nautilus": "Armatura tan-Nawtili titneħħa",
	"subtitles.item.armor.unequip_wolf": "Armatura tal-Ilpup tinqata’",
	...
	"subtitles.item.bundle.insert_fail": "Borża mimlija",
	...
	"subtitles.item.golden_dandelion.unuse": "Lelluxa tad-Deheb tkompli l-iżvilupp",
	"subtitles.item.golden_dandelion.use": "Lelluxa tad-Deheb twaqqaf l-iżvilupp",
	"subtitles.item.hoe.till": "Mgħażqa użata",
	"subtitles.item.honey_bottle.drink": "Gulping",
	"subtitles.item.honeycomb.wax_on": "Ixgħel",
	"subtitles.item.horse_armor.unequip": "Armatura taż-Żwiemel tinqata’",
	...
	"subtitles.item.shears.snip": "Ġelem jaqta’",
	...
	"subtitles.item.spear.lunge": "Lanza tagħti salt 'il quddiem",
	"subtitles.item.spear.use": "Ikkargjar b'Lanza",
	"subtitles.item.spear_wood.attack": "Lanza tidrob",
	"subtitles.item.spear_wood.hit": "Lanza tolqot",
	"subtitles.item.spear_wood.use": "Ikkargjar b'Lanza",
	...
	"subtitles.item.wolf_armor.break": "Armatura tal-Ilpup tinkiser",
	"subtitles.item.wolf_armor.crack": "Armatura tal-Ilpup tinqasam",
	"subtitles.item.wolf_armor.damage": "Armatura tal-Ilpup jiġrilha l-ħsara",
	"subtitles.item.wolf_armor.repair": "Armatura tal-Ilpup tissewwa",
	"subtitles.particle.soul_escape": "Ruħ jaħrab",
	"subtitles.ui.cartography_table.take_result": "Mappa mfassla",
	"subtitles.ui.hud.bubble_pop": "Ossiġnu qed jonqos",
	"subtitles.ui.loom.take_result": "Newl użat",
	"subtitles.ui.stonecutter.take_result": "It-tgħaġġir jintuża",
	"subtitles.weather.end_flash": "Ragħad tal-End",
	...
	"trim_material.minecraft.lapis": "Materjal tal-Lapis",
	"trim_material.minecraft.netherite": "Materjal tan-Netherajt",
	"trim_material.minecraft.quartz": "Materjal tal-Kwarz",
	"trim_material.minecraft.redstone": "Materjal tar-Redstone",
	"trim_material.minecraft.resin": "Materjal tar-Raża",
	"trim_pattern.minecraft.bolt": "Ornament Stil ta' Vit",
	"trim_pattern.minecraft.coast": "Ornament Stil ta’ Xatt",
	"trim_pattern.minecraft.dune": "Ornament Stil ta’ Duna",
	"trim_pattern.minecraft.eye": "Ornament Stil ta’ Għajn",
	"trim_pattern.minecraft.flow": "Ornament Stil ta' Fluss",
	"trim_pattern.minecraft.host": "Ornament Stil ta’ Ospitant",
	"trim_pattern.minecraft.raiser": "Ornament Stil ta’ Rabbej",
	"trim_pattern.minecraft.rib": "Ornament Stil ta’ Kustilja",
	"trim_pattern.minecraft.sentry": "Ornament Stil ta’ Sentinella",
	"trim_pattern.minecraft.shaper": "Ornament Stil ta’ Mudellatur",
	"trim_pattern.minecraft.silence": "Ornament Stil ta’ Silenzju",
	"trim_pattern.minecraft.snout": "Ornament Stil ta’ Gdejdem",
	"trim_pattern.minecraft.spire": "Ornament Stil ta’ Spira",
	"trim_pattern.minecraft.tide": "Ornament Stil ta’ Medea",
	"trim_pattern.minecraft.vex": "Ornament Stil Vessanti",
	"trim_pattern.minecraft.ward": "Ornament Stil ta’ Għassies",
	"trim_pattern.minecraft.wayfinder": "Ornament Stil ta’ Traċċatur",
	"trim_pattern.minecraft.wild": "Ornament Stil Selvaġġ",
