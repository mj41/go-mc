// Code generated by tools/gen_lang.go from 1.21.11/sv_se.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Tid (i tickningar) en spelare som är i kreativt läge måste stå i en Netherportal innan spelaren färdas till den andra dimensionen.",
	...
	"upgradeWorld.symlink.title": "Kan inte uppgradera värld",
