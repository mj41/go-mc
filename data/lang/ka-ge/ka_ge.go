// Code generated by tools/gen_lang.go from 1.21.11/ka_ge.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.husbandry.leash_all_frog_variants.description": "მოაბით თასმა ყველა სახეობის ბაყაყს",
	...
	"death.attack.fall.player": "%[1]s დაარტყა თავი მიწას, როცა %[2]s-(ს)გან გარბოდა",
	"death.attack.fallingBlock": "%[1]s გასრისა ჩამოვარდნილმა ბლოკმა",
	"death.attack.fallingBlock.player": "%[1]s იყო გაგუდული დავარდნილი ბლოკის მიერ %[2]s-სთან ბრძოლის დროს",
	...
	"death.attack.fireworks.player": "%[1]s ბრაგვანი გაადინა %[2]s-სთან ბრძოლის დროს",
	"death.attack.flyIntoWall": "%[1]s-მ(ა) შეიგრძნო კინეტიკური ენერგია",
	"death.attack.flyIntoWall.player": "%[1]s განიცადა კინეტიკური ენერგია %[2]s-(ს)გან გაქცევის დროს",
	...
	"death.attack.lightningBolt.player": "%[1]s-ს დაარტყა ელვამ %[2]s-(ს)თან ბრძოლის დროს",
	...
	"death.attack.magic.player": "%[1]s ჯადომ შეიწირა %[2]s-(ი)სგან გაქცევისას",
	...
	"death.attack.onFire.item": "%[1]s შეიბრაწა, სანამ ებრძოდა %[2]s-ს %[3]s-ის საშუალებით",
	"death.attack.onFire.player": "%[1]s შეიბრაწა %[2]s-(ს)თან ბრძოლისას",
	...
	"death.attack.sonic_boom.item": "%[1]s იყო განადგურებული ხმის ტალღით, სანამ თავს ირჩენდა %[2]s-(ს)გან %[3]s-ის საშუალებით",
	"death.attack.sonic_boom.player": "%[1]s იყო განადგურებული ხმის ტალღით, სანამ თავს ირჩენდა %[2]s-(ს)გან",
	"death.attack.spear": "%[1]s იყო განტყორცნილი %[2]s-(ი)ს მიერ",
	"death.attack.spear.item": "%[1]s იყო განტყორცნილი %[2]s-(ი)ს მიერ %[3]s-ით",
	"death.attack.stalagmite": "%[1]s ჩამოეგო სტალაგმიტზე",
	"death.attack.stalagmite.player": "%[1]s დაიჭრა სტალაგმიტით, როცა იბრძოდა %[2]s-(ს)თან",
	"death.attack.starve": "%[1]s შიმშილით მოკვდა",
	"death.attack.starve.player": "%[1]s მოკვდა შიმშილისგან %[2]s-(ს)თან ბრძოლის დროს",
	...
	"death.attack.sweetBerryBush.player": "%[1]s სასიკვდილოდ დაიჩხვლიტა ტკბილი კენკრის ბუჩქში %[2]s-(ს)გან გაქცევისას",
	"death.attack.thorns": "%[1]s %[2]s-(ი)სთან ბრძოლის დროს მოკვდა",
	"death.attack.thorns.item": "%[1]s მოკვდა %[3]s-ს მიერ, როცა ავნებდა %[2]s-ს",
	...
	"death.attack.wither.player": "%[1]s მოიწამლა %[2]s-(ს)თან ბრძოლის დროს",
	...
	"death.fell.accident.other_climbable": "%[1]s აძვრომისას ჩამოვარდა",
	...
	"gamerule.minecraft.elytra_movement_check": "ელიტრათი მოძრაობის შემოწმება",
	...
	"painting.minecraft.bouquet.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.bouquet.title": "ბუკეტი",
	...
	"painting.minecraft.cavebird.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.cavebird.title": "გამოქვაბულის ჩიტი",
	"painting.minecraft.changing.author": "კრისტოფერ ზეტერსტრენდი",
	...
	"painting.minecraft.endboss.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.endboss.title": "უკანასკნელი ბოსი",
	"painting.minecraft.fern.author": "კრისტოფერ ზეტერსტრენდი",
	...
	"painting.minecraft.finding.author": "კრისტოფერ ზეტერსტრენდი",
	...
	"painting.minecraft.lowmist.author": "კრისტოფერ ზეტერსტრენდი",
	...
	"painting.minecraft.meditative.title": "დაფიქრებული",
	"painting.minecraft.orb.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.orb.title": "ბირთვი",
	"painting.minecraft.owlemons.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.owlemons.title": "ბულემონები",
	"painting.minecraft.passage.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.passage.title": "გასასვლელი",
	"painting.minecraft.pigscene.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.pigscene.title": "ღრუტდადგმა",
	...
	"painting.minecraft.pond.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.pond.title": "გუბე",
	...
	"painting.minecraft.sea.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.sea.title": "სანაპირო",
	"painting.minecraft.skeleton.author": "კრისტოფერ ზეტერსტრენდი",
	"painting.minecraft.skeleton.title": "საწუთროება",
	...
	"painting.minecraft.sunflowers.author": "კრისტოფერ ზეტერსტრენდი",
	...
	"stat.minecraft.nautilus_one_cm": "ნამგზავრია ნაუტილუსით",
	...
	"subtitles.item.lead.break": "თასმა გაწყდა",
	"subtitles.item.lead.tied": "თასმა მიბმულია",
	"subtitles.item.lead.untied": "თასმა გაიხსნა",
