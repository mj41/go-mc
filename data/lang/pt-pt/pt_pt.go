// Code generated by tools/gen_lang.go from 1.21.11/pt_pt.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"argument.pos.unloaded": "A posição não foi carregada",
	...
	"chat.disabled.profile": "As definições atuais da conta Microsoft não permitem usar o chat. Prime \"%s\" para saberes mais.",
	"chat.disabled.profile.moreInfo": "Não é possível enviar ou ver mensagens. O chat foi desativado nas definições da conta Microsoft.",
	"chat.editBox": "chat",
	...
	"commands.profile_fetch.name.success": "Perfil resolvido com o nome %s: %s",
	"commands.publish.alreadyPublished": "O jogo multijogador já está hospedado na porta %s",
	"commands.publish.failed": "Não foi possível hospedar o jogo local",
	"commands.publish.started": "Jogo local hospedado na porta %s",
	"commands.publish.success": "O jogo multijogador está hospedado na porta %s",
	...
	"commands.scoreboard.players.display.name.set.success.single": "O nome de %[2]s foi alterado para %[1]s em %[3]s",
	...
	"commands.team.option.deathMessageVisibility.success": "A visibilidade da mensagem de morte da equipa %s foi definida para \"%s\"",
	...
	"debug.creative_spectator.error": "Não foi possível mudar o modo de jogo",
	...
	"gui.banned.title.permanent": "A conta está banida permanentemente",
	...
	"narration.checkbox.usage.hovered.check": "Clica com o botão esquerdo para marcares",
	"narration.checkbox.usage.hovered.uncheck": "Clica com o botão esquerdo para desmarcares",
	...
	"narration.cycle_button.usage.hovered": "Clica com o botão esquerdo para mudares para %s",
	...
	"selectWorld.backupWarning.snapshot": "Este mundo foi jogado pela última vez na versão %s e estás na %s. Faz uma cópia para o caso do mundo ser corrompido.",
	...
	"selectWorld.versionWarning": "O mundo foi jogado pela última vez na versão %s. Carregá-lo nesta versão pode corrompê-lo!",
