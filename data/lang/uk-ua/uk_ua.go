// Code generated by tools/gen_lang.go from 1.21.11/uk_ua.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.place.template.invalid": "Немає шаблону з id «%s»",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Час (у тактах), який гравець режиму творчости повинен простояти в порталі Незеру перед зміною виміру.",
	"gamerule.playersNetherPortalDefaultDelay": "Затримка гравця в порталі Незеру поза режимом творчости",
	"gamerule.playersNetherPortalDefaultDelay.description": "Час (у тактах), який гравець поза режимом творчости повинен простояти в порталі Незеру перед зміною виміру.",
