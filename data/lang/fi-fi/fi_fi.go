// Code generated by tools/gen_lang.go from 1.21.11/fi_fi.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.husbandry.remove_wolf_armor.description": "Poista sudelta haarniska käyttämällä saksia",
	...
	"argument.resource_or_id.invalid": "Tuntematon id tai tunniste",
	...
	"death.attack.anvil.player": "%[1]s liiskaantui putoavan alasimen alle taistellessaan kohteen %[2]s kanssa",
	...
	"death.attack.fallingBlock.player": "%[1]s liiskaantui putoavan kuution alle taistellessaan kohteen %[2]s kanssa",
	...
	"recover_world.bug_tracker": "Ilmoita bugista",
