// Code generated by tools/gen_lang.go from 1.21.11/pl_pl.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.profile_fetch.id.success": "Rozwiązano profil dla identyfikatora %s: %s",
	...
	"commands.time.no_time_marker_found": "Znacznik czasu %s nie istnieje dla zegara %s",
	...
	"commands.time.set.absolute": "Ustawiono %s na %s tików",
	"commands.time.set.time_marker": "Ustawiono %s na znacznik czasu %s",
	"commands.time.wrong_timeline_for_clock": "Oś czasu %s nie jest powiązana z zegarem %s",
	...
	"gamerule.playersNetherPortalCreativeDelay.description": "Czas (w tikach), przez który gracz w trybie kreatywnym musi stać w portalu do Netheru, zanim zmieni wymiar.",
	"gamerule.playersNetherPortalDefaultDelay": "Opóźnienie przechodzenia przez portal Netheru w trybie nie-kreatywnym",
	...
	"item.minecraft.lingering_potion.effect.infested": "Trwała miotana mikstura zarobaczenia",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Trwała miotana mikstura zaszlamienia",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Trwała miotana mikstura przędzenia",
	"item.minecraft.lingering_potion.effect.wind_charged": "Trwała miotana mikstura napowietrzenia",
	...
	"key.debug.lightmapTexture": "Tekstura mapy światła",
	...
	"selectWorld.backupWarning.file_fixing_required": "Ten świat musi zostać zaktualizowany, zanim będzie można w niego zagrać. Zdecydowanie zalecamy utworzenie kopii zapasowej przed kontynuowaniem, na wypadek uszkodzenia świata.",
	"selectWorld.backupWarning.snapshot": "Ten świat był ostatnio otwierany w wersji %s; obecnie używasz wersji Minecrafta %s. Wykonaj kopię zapasową na wypadek uszkodzenia tego świata!",
	...
	"selectWorld.requiresFileFixingTooltip.edit": "Świat musi zostać zaktualizowany do najnowszej wersji przed edycją ze względu na zmiany w formacie zapisu.",
	"selectWorld.requiresFileFixingTooltip.play": "Świat musi zostać zaktualizowany do najnowszej wersji przed rozpoczęciem gry ze względu na zmiany w formacie zapisu.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Świat musi zostać zaktualizowany do najnowszej wersji przed jego odtworzeniem ze względu na zmiany w formacie zapisu.",
	...
	"selectWorld.world_gen_settings_access": "Nie udało się odczytać lub uzyskać dostępu do pliku ustawień generowania świata! %s",
	...
	"subtitles.entity.baby_cat.ambient": "Kotek miauczy",
	"subtitles.entity.baby_cat.beg_for_food": "Kotek prosi",
	"subtitles.entity.baby_cat.death": "Kotek ginie",
	"subtitles.entity.baby_cat.eat": "Kotek je",
	"subtitles.entity.baby_cat.hiss": "Kotek syczy",
	"subtitles.entity.baby_cat.hurt": "Kotek cierpi",
	"subtitles.entity.baby_cat.purr": "Kotek mruczy",
	...
	"subtitles.entity.baby_pig.ambient": "Świnka chrumka",
	"subtitles.entity.baby_pig.death": "Świnka ginie",
	"subtitles.entity.baby_pig.hurt": "Świnka cierpi",
	...
	"symlink_warning.message": "Ładowanie światów z folderów zawierających symboliczne odnośniki może być niebezpieczne, jeżeli nie wiesz, co dokładnie robisz. Proszę odwiedzić %s w celu zapoznania się.",
	"symlink_warning.message.pack": "Ładowanie paczek z symbolicznymi odnośnikami może być niebezpieczne, jeżeli nie wiesz, co dokładnie robisz. Odwiedź %s, aby dowiedzieć się więcej.",
	...
	"symlink_warning.title": "Folder świata zawiera symboliczne odnośniki",
	...
	"test.error.sequence.invalid_tick": "Powiodło się w nieprawidłowym ticku: oczekiwano %s",
	...
	"upgradeWorld.symlink.title": "Nie udało się zaktualizować świata",
