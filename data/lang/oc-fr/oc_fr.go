// Code generated by tools/gen_lang.go from 26.2/oc_fr.json; DO NOT EDIT.
...
var Map = map[string]string{
	"accessibility.onboarding.accessibility.button": "Accessibilitat...",
	"accessibility.onboarding.accessibility.button.narration": "Configuracions d'accessibilitat",
	"accessibility.onboarding.screen.narrator": "Picatz Entrar per activar lo narrator",
	"accessibility.onboarding.screen.title": "Benvengut sus Minecraft!\n\nVolètz activar lo narrator o veire las configuracions d'accessibilitat?",
	"addServer.add": "Acabat",
	"addServer.enterIp": "Adreça del servidor",
	"addServer.enterName": "Nom del servidor",
	"addServer.resourcePack": "Paquets de ressorsa del servidor",
	"addServer.resourcePack.disabled": "Desactivats",
	"addServer.resourcePack.enabled": "Activats",
	...
	"advMode.mode.redstoneTriggered": "Besonh de redstone",
	"advMode.mode.sequence": "Cadena",
	"advMode.mode.unconditional": "Incondicional",
	"advMode.notAllowed": "Vos cal èsser un operator en mòde creatiu",
	"advMode.notEnabled": "Los blòcs de comandas son pas activats",
	"advMode.notEnabled.spawner": "Los generators son pas activats",
	"advMode.previousOutput": "Sortida precedenta",
	"advMode.setCommand": "Definir una comanda de la consòla pel blòc",
	"advMode.setCommand.disabled": "Comanda definida: %s, mas los blòcs de comandas son pas encara activats",
	"advMode.setCommand.success": "Comanda definida: %s",
	"advMode.trackOutput": "Afichar la sortida",
	"advMode.triggering": "Activacion",
	"advMode.type": "Tipe",
	"advancement.advancementNotFound": "Progrès desconegut: %s",
	"advancements.adventure.adventuring_time.description": "Descobrissètz totes los biòmas",
	"advancements.adventure.adventuring_time.title": "Cap a l'aventura",
	"advancements.adventure.arbalistic.description": "Tuatz cinc creaturas diferentas amb un sol tir de balèsta",
	"advancements.adventure.arbalistic.title": "Arcbalèstaca",
	"advancements.adventure.avoid_vibration.description": "Agrovatz-vos près d'un captaire sculk o d'un warden per l'empachar de vos detectar",
	"advancements.adventure.avoid_vibration.title": "Sens un bruch",
	"advancements.adventure.blowback.description": "Tuatz un ventolet amb la siá pròpria carga de vent",
	"advancements.adventure.blowback.title": "Retorn de ventada",
	"advancements.adventure.brush_armadillo.description": "Brossatz un tató per obténer de placas.",
	"advancements.adventure.brush_armadillo.title": "Tatoatge de placas",
	"advancements.adventure.bullseye.description": "Tiratz una sageta al centre d'una buta a almens 30 mètres de distància",
	"advancements.adventure.bullseye.title": "Al centre",
	"advancements.adventure.craft_decorated_pot_using_only_sherds.description": "Fasètz un vas ondrat amb 4 tèstes de terralha",
	...
	"advancements.adventure.fall_from_world_height.description": "Casètz dempuèi la cima (limit de blòcs) fins al fons del mond e subrevivètz",
	"advancements.adventure.fall_from_world_height.title": "Baumas e bauces",
	"advancements.adventure.heart_transplanter.description": "Plaçatz un còr de cruisseire plan alinhat entre doas buscas d'euse palle",
	...
	"advancements.adventure.honey_block_slide.description": "Sautatz contra un blòc de mèl per facilitar vòstra casuda",
	"advancements.adventure.honey_block_slide.title": "Situacion pegosa",
	"advancements.adventure.kill_a_mob.description": "Tuatz quin mostre que siá",
	"advancements.adventure.kill_a_mob.title": "Caçaire de mostres",
	"advancements.adventure.kill_all_mobs.description": "Tuatz cada mostre un còp",
	"advancements.adventure.kill_all_mobs.title": "Mostres caçats",
	"advancements.adventure.kill_mob_near_sculk_catalyst.description": "Tuatz una creatura près d'un catalisaire de sculk",
	"advancements.adventure.kill_mob_near_sculk_catalyst.title": "S'espandís",
	"advancements.adventure.lighten_up.description": "Desruscatz una ampola en coire amb una pigassa per la far mai lusenta",
	...
	"advancements.adventure.minecraft_trials_edition.description": "Entratz dins una cambra d'espròva",
	"advancements.adventure.minecraft_trials_edition.title": "Mesa a l'espròva",
	"advancements.adventure.ol_betsy.description": "Tiratz amb una balèsta",
	...
	"advancements.adventure.play_jukebox_in_meadows.description": "Fasètz que las pradariás viscan amb lo bruch de la musica d'un jukebox.",
	"advancements.adventure.play_jukebox_in_meadows.title": "Lo bruch de la musica",
	...
	"advancements.adventure.revaulting.description": "Desverrolhatz un còfrefòrt funèst amb un clau de las espròvas funèsta",
	...
	"advancements.adventure.shoot_arrow.description": "Tiratz sus quicòm amb una sageta",
	"advancements.adventure.shoot_arrow.title": "Dins la linha de mira",
	"advancements.adventure.sleep_in_bed.description": "Dormissetz dins un lièch per cambiar lo vòstre ponch de reaparicion",
	"advancements.adventure.sleep_in_bed.title": "De polits sòmis",
	"advancements.adventure.sniper_duel.description": "Tuatz una esqueleta a mai de 50 mètres luènh",
	"advancements.adventure.sniper_duel.title": "Duèl de snipers",
	"advancements.adventure.spear_many_mobs.description": "Traucatz cinc creaturas amb una sola carga en emplegant una lança",
	"advancements.adventure.spear_many_mobs.title": "Astada de creaturas",
	"advancements.adventure.spyglass_at_dragon.description": "Espiatz lo dragon d'Ender a travèrs una pòrtavista",
	...
	"advancements.adventure.summon_iron_golem.title": "Agent de seguretat",
	"advancements.adventure.throw_trident.description": "Lançatz un trident sus quicòm.\nNòta: Lançar vòstra sola arma es pas una bona idèa.",
	...
	"advancements.adventure.trade_at_world_height.title": "Mercadièr d'estela",
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.description": "Aplicatz aquelas ondraduras almens un còp: de las torres, dels morres, de las còstelas, de las prigondors, del silenci, dels vex, de las marèas e dels exploradors",
	...
	"advancements.adventure.two_birds_one_arrow.description": "Tuatz doas fantaumas amb una sageta perforanta",
	"advancements.adventure.two_birds_one_arrow.title": "D'una sageta dos còps",
	"advancements.adventure.under_lock_and_key.description": "Desverrolhatz un còfrefòrt amb una clau de las espròvas",
	...
	"advancements.adventure.very_very_frightening.title": "Periclada d'amor",
	"advancements.adventure.voluntary_exile.description": "Tuatz un capitani de pilhards.\nVal mai restar alunhat dels vilatges pel moment...",
	"advancements.adventure.voluntary_exile.title": "Exili volontari",
	"advancements.adventure.walk_on_powder_snow_with_leather_boots.description": "Caminatz sus de nèu polverosa... sens s'i enfonsar",
	...
	"advancements.adventure.who_needs_rockets.title": "Qual a besonh de fusadas?",
	"advancements.adventure.whos_the_pillager_now.description": "Tornatz a un pilhard la moneda de la siá peça",
	"advancements.adventure.whos_the_pillager_now.title": "Es qui lo pilhard ara?",
	"advancements.empty": "Sembla i aver pas res aquí...",
	"advancements.end.dragon_breath.description": "Reculhissètz de buf de dragon dins una fiòla",
	"advancements.end.dragon_breath.title": "Sens alen",
	"advancements.end.dragon_egg.description": "Tenètz l'uòu de dragon",
	...
	"advancements.end.enter_end_gateway.description": "Fugissètz l'isla",
	"advancements.end.enter_end_gateway.title": "Escapada a distància",
	"advancements.end.find_end_city.description": "Anatz al dedins, qué se pòt passar?",
	"advancements.end.find_end_city.title": "La vila a la fin del jòc",
	"advancements.end.kill_dragon.description": "Bon astre",
	"advancements.end.kill_dragon.title": "Desliuratz l'End",
	"advancements.end.levitate.description": "Levitatz a una nautor de 50 blòcs après l'ataca d'un shulker",
	"advancements.end.levitate.title": "Mirador grandiós",
	"advancements.end.respawn_dragon.description": "Fasètz reaparéisser lo dragon d'Ender",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fasètz en sòrta qu'un allay escampe un pastís sus un blòc musical",
	...
	"advancements.husbandry.balanced_diet.description": "Manjatz tot çò que se pòt manjar, quita çò qu'es pas bon per vos",
	"advancements.husbandry.balanced_diet.title": "Una alimentacion equilibrada",
	"advancements.husbandry.breed_all_animals.description": "Fasètz se reprodusir cada tipes d'animals almens un còp!",
	"advancements.husbandry.breed_all_animals.title": "Dos per dos",
	"advancements.husbandry.breed_an_animal.description": "Fasètz se reprodusir dos animals amassas",
	"advancements.husbandry.breed_an_animal.title": "I a de l'amor dins l'aire",
	"advancements.husbandry.complete_catalogue.description": "Aprivadatz totas las variantas de cats!",
	...
	"advancements.husbandry.fishy_business.description": "Pescatz un peis",
	...
	"advancements.husbandry.kill_axolotl_target.description": "Fasètz equipa amb un axolòtl e ganhatz un combat",
	"advancements.husbandry.kill_axolotl_target.title": "L'union que da fòrça!",
	"advancements.husbandry.leash_all_frog_variants.description": "Menatz cada varianta de granolha a l'estaca",
	"advancements.husbandry.leash_all_frog_variants.title": "Las tres mosquetièras",
	"advancements.husbandry.make_a_sign_glow.description": "Fasètz lusar lo tèxt de quina pancarta que siá",
	"advancements.husbandry.make_a_sign_glow.title": "Una idèa lusenta!",
	"advancements.husbandry.netherite_hoe.description": "Apondètz un lingòt de netherita sus un bigòs, e puèi tornatz avalorar vòstras causidas de vida",
	...
	"advancements.husbandry.place_dried_ghast_in_water.title": "Banhat coma un anedon!",
	...
	"advancements.husbandry.plant_seed.description": "Plantatz una grana e vesètz-la créisser",
	"advancements.husbandry.plant_seed.title": "Creisson tan lèu...",
	...
	"advancements.husbandry.repair_wolf_armor.description": "Reparatz completament una armadura per lop damatjada amb de placas de tató",
	"advancements.husbandry.repair_wolf_armor.title": "Coma nòu",
	"advancements.husbandry.ride_a_boat_with_a_goat.description": "Montatz dins un batèl e navigatz amb la vòstra cabra",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Utilizatz un fuòc de camp e una fiòla per reculhir lo mèl d'un bornhon en sens provocar las abelhas",
	"advancements.husbandry.safely_harvest_honey.title": "Siatz mèl convidat",
	...
	"advancements.husbandry.silk_touch_nest.title": "Mèl-dadís",
	...
	"advancements.husbandry.tadpole_in_a_bucket.description": "Capturatz un capgròs dins un ferrat",
	"advancements.husbandry.tadpole_in_a_bucket.title": "La pichota granolha",
	...
	"advancements.husbandry.uh_oh.description": "Fasètz en sòrta qu'un cube de solpre absorbisca un blòc de TNT",
	"advancements.husbandry.uh_oh.title": "Va petar!",
	...
	"advancements.nether.all_effects.title": "Cossí sèm arribats aquí?",
	"advancements.nether.all_potions.description": "Ajatz totes los efièches de pocion a l'encòp",
	"advancements.nether.all_potions.title": "Mesclas perilhosas",
	"advancements.nether.brew_potion.description": "Preparatz una pocion",
	"advancements.nether.brew_potion.title": "Distillariá locala",
	"advancements.nether.charge_respawn_anchor.description": "Cargatz una ancora de reaparicion al sieu maximum",
	"advancements.nether.charge_respawn_anchor.title": "Pas exactament \"nòu\" vidas",
	...
	"advancements.nether.explore_nether.description": "Descobrissètz totes los biòmas del Nether",
	...
	"advancements.nether.fast_travel.title": "Trauc de vèrm",
	...
	"advancements.nether.obtain_crying_obsidian.description": "Obtenètz d'obsidiana plorosa",
	"advancements.nether.obtain_crying_obsidian.title": "Qual copa de ceba?",
	"advancements.nether.return_to_sender.description": "Tuatz un ghast amb una bola de fuòc",
	"advancements.nether.return_to_sender.title": "Retorn al mandaire",
	"advancements.nether.ride_strider.description": "Cavalgatz e dirigissètz un arpentaire amb un fonge bescornut sus un baston",
	"advancements.nether.ride_strider.title": "Aqueste batèl a de patas",
	"advancements.nether.ride_strider_in_overworld_lava.description": "Emmenatz un arpentaire far una loooonga passejada sus un lac de lava a la susfàcia",
	"advancements.nether.ride_strider_in_overworld_lava.title": "Coma a l'ostal",
	"advancements.nether.root.description": "Benvengut en infèrn",
	...
	"advancements.nether.uneasy_alliance.description": "Prenètz un ghast del Nether, emmenatz-lo en tota seguretat a la susfacia... e tuatz-lo",
	...
	"advancements.story.cure_zombie_villager.title": "Zombiològ",
	"advancements.story.deflect_arrow.description": "Paratz un projectil amb un bloquièr",
	"advancements.story.deflect_arrow.title": "Pas d'uèi, mercé",
	"advancements.story.enchant_item.description": "Encantatz un objècte dins una taula d'encantament",
	"advancements.story.enchant_item.title": "Encantat!",
	"advancements.story.enter_the_end.description": "Dintratz dins un portal de l'End",
	"advancements.story.enter_the_end.title": "La fin?",
	"advancements.story.enter_the_nether.description": "Construsètz, alucatz e dintratz dins un portal del Nether",
	...
	"advancements.story.form_obsidian.description": "Obtenètz d'obsidiana",
	"advancements.story.form_obsidian.title": "Menta fresca",
	"advancements.story.iron_tools.description": "Melhoratz vòstra trenca",
	"advancements.story.iron_tools.title": "Es pas una trenca de fèrre?",
	...
	"advancements.story.smelt_iron.title": "L'Edat del Fèrre",
	...
	"advancements.toast.goal": "Objectiu atengut!",
	"advancements.toast.task": "Progrès realizat!",
	"argument.anchor.invalid": "Posicion d'ancoratge de l'entitat pas valida: %s",
	...
	"argument.block.property.novalue": "Valor esperada per la proprietat \"%s\" sul bloc %s",
	"argument.block.property.unclosed": "Un \"]\" de barradura es esperat per las proprietats d'estat del bloc",
	"argument.block.property.unknown": "Lo blòc %s a pas la proprietat \"%s\"",
	...
	"argument.component.invalid": "Compausant de chat pas valid: %s",
	"argument.criteria.invalid": "Critèri desconegut: %s",
	"argument.dimension.invalid": "Dimension desconeguda: %s",
	"argument.double.big": "A un doble, li cal pas èsser superior a %s, valor trobada : %s",
	"argument.double.low": "A un doble, li cal pas èsser inferior a %s, valor trobada : %s",
	"argument.entity.invalid": "Nom o UUID pas valid",
	"argument.entity.notfound.entity": "Cap d'entitat trobada",
	"argument.entity.notfound.player": "Cap de jogaire trobat",
	"argument.entity.options.advancements.description": "Jogaires amb de progrèsses",
	...
	"argument.entity.options.gamemode.description": "Jogaires dins un mòde de jòc",
	"argument.entity.options.inapplicable": "L'opcion \"%s\"es pas aplicabla aicí",
	...
	"argument.entity.options.mode.invalid": "Mòde de jòc desconegut o pas valid: %s",
	...
	"argument.entity.options.scores.description": "Entitats amb marcas",
	...
	"argument.entity.options.unknown": "Opcion desconeguda: %s",
	"argument.entity.options.unterminated": "Fin de las opcions esperada",
	"argument.entity.options.valueless": "Valor esperada per l'opcion \"%s\"",
	...
	"argument.entity.selector.allEntities": "Totas las entitats",
	"argument.entity.selector.allPlayers": "Totes los jogaires",
	"argument.entity.selector.missing": "Tipe de seleccionaire mancant",
	"argument.entity.selector.nearestEntity": "Entitat mai pròcha",
	"argument.entity.selector.nearestPlayer": "Jogaire mai pròche",
	...
	"argument.entity.toomany": "Pas qu'una entitat es autorizada, mas lo seleccionaire provesit n'autoriza mai d'una",
	"argument.enum.invalid": "Valor pas valida: %s",
	"argument.float.big": "A un flotant, li cal pas èsser superior a %s, valor trobada : %s",
	"argument.float.low": "A un flotant, li cal pas èsser inferior a %s, valor trobada : %s",
	"argument.gamemode.invalid": "Mòde de jòc desconegut: %s",
	...
	"argument.integer.big": "A un entièr, li cal pas èsser superior a %s, valor trobada : %s",
	"argument.integer.low": "A un entièr, li cal pas èsser inferior a %s, valor trobada : %s",
	...
	"argument.long.big": "A un long, li cal pas èsser superior a %s, valor trobada : %s",
	"argument.long.low": "A un long, li cal pas èsser inferior a %s, valor trobada : %s",
	...
	"argument.nbt.array.mixed": "Se pòt pas inserir %s dins %s",
	...
	"argument.nbt.list.mixed": "Se pòt pas inserir %s dins la lista de %s",
	"argument.nbt.trailing": "Donadas de fin pas esperadas",
	"argument.player.entities": "I a pas que los jogaires pòdon èsser afectats per aquela comanda, mas lo seleccionaire provesit enclau las entitats",
	"argument.player.toomany": "Pas qu'un jogaire es autorizat, mas lo seleccionaire provesit n'autoriza mai d'un",
	"argument.player.unknown": "Aquel jogaire existís pas",
	"argument.pos.missing.double": "Coordenadas esperadas",
	"argument.pos.missing.int": "Posicion d'un blòc esperada",
	"argument.pos.mixed": "Se pòt pas mesclar de coordenadas localas e del mond (totas devon utilizar ^ o non)",
	"argument.pos.outofbounds": "Aquesta posicion es fòra dels limits autorizats",
	"argument.pos.outofworld": "Aquesta posicion es al defòra d'aquel mond!",
	"argument.pos.unloaded": "Aquesta posicion es pas cargada",
	...
	"argument.range.ints": "I a pas que los nombres entièrs son autorizats, pas los decimals",
	"argument.range.swapped": "Lo minimum pòt pas èsser mai grand que lo maximum",
	"argument.resource.invalid_type": "L'element \"%s\" a lo mal tipe \"%s\" (\"%s\" esperat)",
	"argument.resource.not_found": "Se pòt pas trobar l'element \"%s\" de tipe \"%s\"",
	"argument.resource_or_id.failed_to_parse": "Fracàs de l'analisi sintaxica de l'estructura: %s",
	...
	"argument.resource_tag.not_found": "Se pòt pas trobar lo tag \"%s\" de tipe \"%s\"",
	"argument.rotation.incomplete": "Incomplet (2 coordenadas esperadas)",
	"argument.scoreHolder.empty": "Cap de detentor de marca pertinent trobat",
	"argument.scoreboardDisplaySlot.invalid": "Emplaçament d'afichatge desconegut: %s",
	"argument.style.invalid": "Estil pas valid: %s",
	"argument.swing_animation.invalid": "Tipe d'animacion de bolegadís de braç desconegut: %s",
	"argument.time.invalid_tick_count": "Lo nombre de cicles deu pas èsser negatiu",
	"argument.time.invalid_unit": "Unitat pas valida",
	"argument.time.tick_count_too_low": "Al nombre de cicles, li cal pas èsser inferior a %s, valor trobada : %s",
	"argument.uuid.invalid": "UUID pas valid",
	...
	"arguments.item.component.malformed": "Compausant \"%s\" incorrècte: %s",
	"arguments.item.component.repeated": "Lo compausant d'objècte \"%s\" es estat repetit, mas pas qu'una valor pòt èsser provesida",
	"arguments.item.component.unknown": "Compausant d'objècte desconegut: %s",
	"arguments.item.malformed": "Objècte incorrècte: %s",
	"arguments.item.overstacked": "%s pòt pas s'apilar que fins a %s",
	...
	"arguments.item.tag.unknown": "Tag d'objècte desconegut: %s",
	"arguments.nbtpath.node.invalid": "Element de camin NBT pas valid",
	"arguments.nbtpath.nothing_found": "Cap d'element correspondent a %s trobat",
	"arguments.nbtpath.too_deep": "Lo NBT resultant es tròp prigondament imbricat",
	"arguments.nbtpath.too_large": "Lo NBT resultant es tròp grand",
	...
	"arguments.swizzle.invalid": "Combinacion dels axes pas valida, combinacion de \"x\", \"y\" e \"z\" esperada",
	...
	"attribute.name.air_drag_modifier": "Modificator de resisténcia a l'aire",
	...
	"attribute.name.below_name_distance": "Distància d'afichatge de la marca jos lo nom",
	"attribute.name.block_break_speed": "Velocitat per trencar de blòcs",
	"attribute.name.block_interaction_range": "Portada d'interaccion amb los blòcs",
	"attribute.name.bounciness": "Rebomb",
	...
	"attribute.name.fall_damage_multiplier": "Multiplicador dels degalhs de casuda",
	"attribute.name.flying_speed": "Velocitat de vòl",
	"attribute.name.follow_range": "Rai de deteccion de las creaturas",
	"attribute.name.friction_modifier": "Modificator de friccion",
	"attribute.name.generic.armor": "Armadura",
	"attribute.name.generic.armor_toughness": "Robustessa",
	...
	"attribute.name.generic.scale": "Talha",
	"attribute.name.generic.step_height": "Nautor dels passes",
	"attribute.name.generic.water_movement_efficiency": "Eficacitat de movement aigassièr",
	"attribute.name.gravity": "Gravetat",
	"attribute.name.horse.jump_strength": "Poténcia de saut del caval",
	...
	"attribute.name.nameplate_distance": "Distància d'afichatge del nom",
	"attribute.name.oxygen_bonus": "Bonus d'oxigèn",
	"attribute.name.player.block_break_speed": "Velocitat per trencar de blòcs",
	"attribute.name.player.block_interaction_range": "Portada d'interaccion amb los blòcs",
	...
	"attribute.name.player.sweeping_damage_ratio": "Taus de degalh per escobatge",
	"attribute.name.safe_fall_distance": "Distància de casuda segura",
	"attribute.name.scale": "Talha",
	"attribute.name.sneaking_speed": "Velocitat agrovat",
	"attribute.name.spawn_reinforcements": "Prodèls de zòmbis",
	"attribute.name.step_height": "Nautor dels passes",
	"attribute.name.submerged_mining_speed": "Velocitat de minatge jos l'aiga",
	"attribute.name.sweeping_damage_ratio": "Taus de degalh per escobatge",
	...
	"biome.minecraft.eroded_badlands": "Badlands erodats",
	...
	"biome.minecraft.mushroom_fields": "Camp de camparòls",
	"biome.minecraft.nether_wastes": "Èrmes del Nether",
	...
	"biome.minecraft.snowy_beach": "Plaja ennevada",
	"biome.minecraft.snowy_plains": "Planas ennevadas",
	"biome.minecraft.snowy_slopes": "Travèrs ennevats",
	"biome.minecraft.snowy_taiga": "Taiga ennevada",
	"biome.minecraft.soul_sand_valley": "Val de las anmas",
	...
	"biome.minecraft.sulfur_caves": "Baumas de solpre",
	...
	"biome.minecraft.wooded_badlands": "Badlands boscoses",
	...
	"block.minecraft.bamboo_mosaic_slab": "Lausa de mosaïc de bambó",
	"block.minecraft.bamboo_mosaic_stairs": "Escalièrs de mosaïc de bambó",
	...
	"block.minecraft.bamboo_slab": "Lausa de bambó",
	"block.minecraft.bamboo_stairs": "Escalièrs de bambó",
	...
	"block.minecraft.banner.circle.black": "Tortèl negre",
	"block.minecraft.banner.circle.blue": "Tortèl blau",
	"block.minecraft.banner.circle.brown": "Tortèl brun",
	"block.minecraft.banner.circle.cyan": "Tortèl cian",
	"block.minecraft.banner.circle.gray": "Tortèl gris",
	"block.minecraft.banner.circle.green": "Tortèl verd",
	"block.minecraft.banner.circle.light_blue": "Tortèl blau clar",
	"block.minecraft.banner.circle.light_gray": "Tortèl gris clar",
	"block.minecraft.banner.circle.lime": "Tortèl lima",
	"block.minecraft.banner.circle.magenta": "Tortèl magenta",
	"block.minecraft.banner.circle.orange": "Tortèl irange",
	"block.minecraft.banner.circle.pink": "Tortèl ròse",
	"block.minecraft.banner.circle.purple": "Tortèl violet",
	"block.minecraft.banner.circle.red": "Tortèl roge",
	"block.minecraft.banner.circle.white": "Tortèl blanc",
	"block.minecraft.banner.circle.yellow": "Tortèl jaune",
	...
	"block.minecraft.banner.cross.light_gray": "Sautador gris clar",
	...
	"block.minecraft.banner.half_vertical_right.light_gray": "Partit, 2nd gris clar",
	...
	"block.minecraft.banner.square_bottom_left.brown": "Canton dèstre en poncha brun",
	...
	"block.minecraft.banner.square_top_right.black": "Canton senèstre en cap negre",
	...
	"block.minecraft.banner.stripe_center.yellow": "Pal jaune",
	...
	"block.minecraft.banner.stripe_left.black": "Pal negre a dèstre",
	"block.minecraft.banner.stripe_left.blue": "Pal blau a dèstre",
	"block.minecraft.banner.stripe_left.brown": "Pal brun a dèstre",
	"block.minecraft.banner.stripe_left.cyan": "Pal cian a dèstre",
	"block.minecraft.banner.stripe_left.gray": "Pal gris a dèstre",
	"block.minecraft.banner.stripe_left.green": "Pal verd a dèstre",
	"block.minecraft.banner.stripe_left.light_blue": "Pal blau clar a dèstre",
	"block.minecraft.banner.stripe_left.light_gray": "Pal gris clar a dèstre",
	"block.minecraft.banner.stripe_left.lime": "Pal lima a dèstre",
	"block.minecraft.banner.stripe_left.magenta": "Pal magenta a dèstre",
	"block.minecraft.banner.stripe_left.orange": "Pal irange a dèstre",
	"block.minecraft.banner.stripe_left.pink": "Pal ròse a dèstre",
	"block.minecraft.banner.stripe_left.purple": "Pal violet a dèstre",
	"block.minecraft.banner.stripe_left.red": "Pal roge a dèstre",
	"block.minecraft.banner.stripe_left.white": "Pal blanc a dèstre",
	"block.minecraft.banner.stripe_left.yellow": "Pal jaune a dèstre",
	...
	"block.minecraft.banner.stripe_right.black": "Pal negre a senèstre",
	"block.minecraft.banner.stripe_right.blue": "Pal blau a senèstre",
	"block.minecraft.banner.stripe_right.brown": "Pal brun a senèstre",
	"block.minecraft.banner.stripe_right.cyan": "Pal cian a senèstre",
	"block.minecraft.banner.stripe_right.gray": "Pal gris a senèstre",
	"block.minecraft.banner.stripe_right.green": "Pal verd a senèstre",
	"block.minecraft.banner.stripe_right.light_blue": "Pal blau clar a senèstre",
	"block.minecraft.banner.stripe_right.light_gray": "Pal gris clar a senèstre",
	"block.minecraft.banner.stripe_right.lime": "Pal lima a senèstre",
	"block.minecraft.banner.stripe_right.magenta": "Pal magenta a senèstre",
	"block.minecraft.banner.stripe_right.orange": "Pal irange a senèstre",
	"block.minecraft.banner.stripe_right.pink": "Pal ròse a senèstre",
	"block.minecraft.banner.stripe_right.purple": "Pal violet a senèstre",
	"block.minecraft.banner.stripe_right.red": "Pal roge a senèstre",
	"block.minecraft.banner.stripe_right.white": "Pal blanc a senèstre",
	"block.minecraft.banner.stripe_right.yellow": "Pal jaune a senèstre",
	...
	"block.minecraft.banner.triangle_bottom.light_blue": "Mantelat blau clar",
	...
	"block.minecraft.banner.triangles_bottom.black": "Emmargadura negra en poncha",
	"block.minecraft.banner.triangles_bottom.blue": "Emmargadura blava en poncha",
	"block.minecraft.banner.triangles_bottom.brown": "Emmargadura bruna en poncha",
	"block.minecraft.banner.triangles_bottom.cyan": "Emmargadura cian en poncha",
	"block.minecraft.banner.triangles_bottom.gray": "Emmargadura grisa en poncha",
	"block.minecraft.banner.triangles_bottom.green": "Emmargadura verda en poncha",
	"block.minecraft.banner.triangles_bottom.light_blue": "Emmargadura blau clar en poncha",
	"block.minecraft.banner.triangles_bottom.light_gray": "Emmargadura gris clar en poncha",
	"block.minecraft.banner.triangles_bottom.lime": "Emmargadura lima en poncha",
	"block.minecraft.banner.triangles_bottom.magenta": "Emmargadura magenta en poncha",
	"block.minecraft.banner.triangles_bottom.orange": "Emmargadura iranja en poncha",
	"block.minecraft.banner.triangles_bottom.pink": "Emmargadura ròsa en poncha",
	"block.minecraft.banner.triangles_bottom.purple": "Emmargadura violeta en poncha",
	"block.minecraft.banner.triangles_bottom.red": "Emmargadura roja en poncha",
	"block.minecraft.banner.triangles_bottom.white": "Emmargadura blanca en poncha",
	"block.minecraft.banner.triangles_bottom.yellow": "Emmargadura jauna en poncha",
	"block.minecraft.banner.triangles_top.black": "Emmargadura negra en cap",
	"block.minecraft.banner.triangles_top.blue": "Emmargadura blava en cap",
	"block.minecraft.banner.triangles_top.brown": "Emmargadura bruna en cap",
	"block.minecraft.banner.triangles_top.cyan": "Emmargadura cian en cap",
	"block.minecraft.banner.triangles_top.gray": "Emmargadura grisa en cap",
	"block.minecraft.banner.triangles_top.green": "Emmargadura verda en cap",
	"block.minecraft.banner.triangles_top.light_blue": "Emmargadura blau clar en cap",
	"block.minecraft.banner.triangles_top.light_gray": "Emmargadura gris clar en cap",
	"block.minecraft.banner.triangles_top.lime": "Emmargadura lima en cap",
	"block.minecraft.banner.triangles_top.magenta": "Emmargadura magenta en cap",
	"block.minecraft.banner.triangles_top.orange": "Emmargadura iranja en cap",
	"block.minecraft.banner.triangles_top.pink": "Emmargadura ròsa en cap",
	"block.minecraft.banner.triangles_top.purple": "Emmargadura violeta en cap",
	"block.minecraft.banner.triangles_top.red": "Emmargadura roja en cap",
	"block.minecraft.banner.triangles_top.white": "Emmargadura blanca en cap",
	"block.minecraft.banner.triangles_top.yellow": "Emmargadura jauna en cap",
	...
	"block.minecraft.bed.no_sleep": "Podètz pas dormir que la nuèch o pendent los auratges",
	"block.minecraft.bed.not_safe": "Podètz pas dormir ara; i a de mostres pas luènh",
	"block.minecraft.bed.obstructed": "Aqueste lièch es obstruït",
	...
	"block.minecraft.birch_slab": "Lausa de bèç",
	"block.minecraft.birch_stairs": "Escalièrs de bèç",
	...
	"block.minecraft.black_concrete_slab": "Lausa de beton negre",
	"block.minecraft.black_concrete_stairs": "Escalièrs de beton negre",
	...
	"block.minecraft.black_stained_glass_pane": "Vitra negra",
	"block.minecraft.black_terracotta": "Tèrra cuècha negra",
	"block.minecraft.black_wool": "Lana negra",
	"block.minecraft.black_wool_slab": "Lausa de lana negra",
	"block.minecraft.black_wool_stairs": "Escalièrs de lana negra",
	...
	"block.minecraft.blast_furnace": "Naut fornèl",
	...
	"block.minecraft.blue_concrete_slab": "Lausa de beton blau",
	"block.minecraft.blue_concrete_stairs": "Escalièrs de beton blau",
	...
	"block.minecraft.blue_stained_glass_pane": "Vitra blava",
	"block.minecraft.blue_terracotta": "Tèrra cuècha blava",
	"block.minecraft.blue_wool": "Lana blava",
	"block.minecraft.blue_wool_slab": "Lausa de lana blava",
	"block.minecraft.blue_wool_stairs": "Escalièrs de lana blava",
	"block.minecraft.bone_block": "Blòc d'òs",
	"block.minecraft.bookshelf": "Bibliotèca",
	"block.minecraft.brain_coral": "Coralh cervèl",
	"block.minecraft.brain_coral_block": "Blòc de coralh cervèl",
	"block.minecraft.brain_coral_fan": "Gorgònia de coralh cervèl",
	"block.minecraft.brain_coral_wall_fan": "Gorgònia de coralh cervèl murala",
	"block.minecraft.brewing_stand": "Alambic",
	"block.minecraft.brick_slab": "Lausa de bricas",
	"block.minecraft.brick_stairs": "Escalièrs de bricas",
	...
	"block.minecraft.brown_concrete_slab": "Lausa de beton brun",
	"block.minecraft.brown_concrete_stairs": "Escalièrs de beton brun",
	...
	"block.minecraft.brown_stained_glass_pane": "Vitra bruna",
	"block.minecraft.brown_terracotta": "Tèrra cuècha bruna",
	"block.minecraft.brown_wool": "Lana bruna",
	"block.minecraft.brown_wool_slab": "Lausa de lana bruna",
	"block.minecraft.brown_wool_stairs": "Escalièrs de lana bruna",
	"block.minecraft.bubble_column": "Colomna de botiòlas",
	"block.minecraft.bubble_coral": "Coralh botiòla",
	"block.minecraft.bubble_coral_block": "Blòc de coralh botiòla",
	"block.minecraft.bubble_coral_fan": "Gorgònia de coralh botiòla",
	"block.minecraft.bubble_coral_wall_fan": "Gorgònia de coralh botiòla murala",
	...
	"block.minecraft.chain_command_block": "Blòc de comanda en cadena",
	...
	"block.minecraft.cherry_slab": "Lausa de cerièis",
	"block.minecraft.cherry_stairs": "Escalièrs de cerièis",
	...
	"block.minecraft.cherry_wood": "Fusta de cerièis",
	...
	"block.minecraft.chiseled_cinnabar": "Cinabre escultat",
	"block.minecraft.chiseled_copper": "Coire escultat",
	"block.minecraft.chiseled_deepslate": "Ardesa prigonda escultada",
	"block.minecraft.chiseled_nether_bricks": "Bricas del Nether escultadas",
	...
	"block.minecraft.chiseled_sulfur": "Solpre escultat",
	...
	"block.minecraft.cinnabar_brick_slab": "Lausa de bricas de cinabre",
	"block.minecraft.cinnabar_brick_stairs": "Escalièrs de bricas de cinabre",
	"block.minecraft.cinnabar_brick_wall": "Muret de bricas de cinabre",
	"block.minecraft.cinnabar_bricks": "Bricas de cinabre",
	"block.minecraft.cinnabar_slab": "Lausa de cinabre",
	"block.minecraft.cinnabar_stairs": "Escalièrs de cinabre",
	"block.minecraft.cinnabar_wall": "Muret de cinabre",
	"block.minecraft.clay": "Argila",
	"block.minecraft.closed_eyeblossom": "Uèlhquidèa barrada",
	...
	"block.minecraft.cobbled_deepslate": "Pèiras prigondas",
	"block.minecraft.cobbled_deepslate_slab": "Lausa de pèiras prigondas",
	"block.minecraft.cobbled_deepslate_stairs": "Escalièrs de pèiras prigondas",
	"block.minecraft.cobbled_deepslate_wall": "Muret de pèiras prigondas",
	...
	"block.minecraft.crimson_roots": "Raices cremesinas",
	...
	"block.minecraft.cut_copper_slab": "Lausa de coire talhat",
	"block.minecraft.cut_copper_stairs": "Escalièrs de coire talhat",
	...
	"block.minecraft.cut_sandstone_slab": "Lausa de gres talhat",
	...
	"block.minecraft.cyan_concrete_slab": "Lausa de beton cian",
	"block.minecraft.cyan_concrete_stairs": "Escalièrs de beton cian",
	...
	"block.minecraft.cyan_stained_glass_pane": "Vitra cian",
	"block.minecraft.cyan_terracotta": "Tèrra cuècha cian",
	"block.minecraft.cyan_wool": "Lana cian",
	"block.minecraft.cyan_wool_slab": "Lausa de lana cian",
	"block.minecraft.cyan_wool_stairs": "Escalièrs de lana cian",
	...
	"block.minecraft.dark_oak_slab": "Lausa d'euse escur",
	"block.minecraft.dark_oak_stairs": "Escalièrs d'euse escur",
	...
	"block.minecraft.dark_prismarine_stairs": "Escalièrs de prismarina escura",
	"block.minecraft.daylight_detector": "Detector de lutz solara",
	"block.minecraft.dead_brain_coral": "Coralh cervèl mòrt",
	"block.minecraft.dead_brain_coral_block": "Blòc de coralh cervèl mòrt",
	"block.minecraft.dead_brain_coral_fan": "Gorgònia de coralh cervèl mòrta",
	"block.minecraft.dead_brain_coral_wall_fan": "Gorgònia de coralh cervèl mòrta murala",
	"block.minecraft.dead_bubble_coral": "Coralh botiòla mòrt",
	"block.minecraft.dead_bubble_coral_block": "Blòc de coralh botiòla mòrt",
	"block.minecraft.dead_bubble_coral_fan": "Gorgònia de coralh botiòla mòrta",
	"block.minecraft.dead_bubble_coral_wall_fan": "Gorgònia de coralh botiòla mòrta murala",
	...
	"block.minecraft.dead_fire_coral_fan": "Gorgònia de coralh de fuòc mòrta",
	"block.minecraft.dead_fire_coral_wall_fan": "Gorgònia de coralh de fuòc mòrta murala",
	"block.minecraft.dead_horn_coral": "Coralh cornut mòrt",
	"block.minecraft.dead_horn_coral_block": "Blòc de coralh cornut mòrt",
	"block.minecraft.dead_horn_coral_fan": "Gorgònia de coralh cornut mòrta",
	"block.minecraft.dead_horn_coral_wall_fan": "Gorgònia de coralh cornut mòrta murala",
	"block.minecraft.dead_tube_coral": "Coralh tubular mòrt",
	"block.minecraft.dead_tube_coral_block": "Blòc de coralh tubular mòrt",
	"block.minecraft.dead_tube_coral_fan": "Gorgònia de coralh tubular mòrta",
	"block.minecraft.dead_tube_coral_wall_fan": "Gorgònia de coralh tubular mòrta murala",
	"block.minecraft.decorated_pot": "Vas ondrat",
	"block.minecraft.deepslate": "Ardesa prigonda",
	"block.minecraft.deepslate_brick_slab": "Lausa de bricas d'ardesa prigonda",
	"block.minecraft.deepslate_brick_stairs": "Escalièrs de bricas d'ardesa prigonda",
	"block.minecraft.deepslate_brick_wall": "Muret de bricas d'ardesa prigonda",
	"block.minecraft.deepslate_bricks": "Bricas d'ardesa prigonda",
	"block.minecraft.deepslate_coal_ore": "Minièra de carbon prigonda",
	"block.minecraft.deepslate_copper_ore": "Minièra de coire prigonda",
	"block.minecraft.deepslate_diamond_ore": "Minièra de diamant prigonda",
	"block.minecraft.deepslate_emerald_ore": "Minièra d'esmerauda prigonda",
	"block.minecraft.deepslate_gold_ore": "Minièra d'aur prigonda",
	"block.minecraft.deepslate_iron_ore": "Minièra de fèrre prigonda",
	"block.minecraft.deepslate_lapis_ore": "Minièra de lapislazuli prigonda",
	"block.minecraft.deepslate_redstone_ore": "Minièra de redstone prigonda",
	"block.minecraft.deepslate_tile_slab": "Lausa de rajòlas d'ardesa prigonda",
	"block.minecraft.deepslate_tile_stairs": "Escalièrs de rajòlas d'ardesa prigonda",
	"block.minecraft.deepslate_tile_wall": "Muret de rajòlas d'ardesa prigonda",
	...
	"block.minecraft.end_stone": "Pèira de l'End",
	"block.minecraft.end_stone_brick_slab": "Lausa de bricas de pèira de l'End",
	"block.minecraft.end_stone_brick_stairs": "Escalièrs de bricas de pèira de l'End",
	"block.minecraft.end_stone_brick_wall": "Muret de bricas de pèira de l'End",
	...
	"block.minecraft.exposed_copper_bars": "Barrets de coire expausat",
	"block.minecraft.exposed_copper_bulb": "Ampola en coire expausat",
	"block.minecraft.exposed_copper_chain": "Cadena de coire expausat",
	"block.minecraft.exposed_copper_chest": "Còfre en coire expausat",
	"block.minecraft.exposed_copper_door": "Pòrta en coire expausat",
	"block.minecraft.exposed_copper_golem_statue": "Estatua de golem de coire expausat",
	"block.minecraft.exposed_copper_grate": "Grasilha en coire expausat",
	"block.minecraft.exposed_copper_lantern": "Lantèrna de coire expausat",
	"block.minecraft.exposed_copper_trapdoor": "Trapa en coire expausat",
	"block.minecraft.exposed_cut_copper": "Coire talhat expausat",
	"block.minecraft.exposed_cut_copper_slab": "Lausa de coire talhat expausat",
	"block.minecraft.exposed_cut_copper_stairs": "Escalièrs de coire talhat expausat",
	"block.minecraft.exposed_lightning_rod": "Paratron expausat",
	...
	"block.minecraft.flower_pot": "Pòt",
	...
	"block.minecraft.glass_pane": "Vitra",
	...
	"block.minecraft.golden_dandelion": "Pissalach daurat",
	"block.minecraft.granite": "Granit",
	"block.minecraft.granite_slab": "Lausa de granit",
	"block.minecraft.granite_stairs": "Escalièrs de granit",
	...
	"block.minecraft.gray_concrete_slab": "Lausa de beton gris",
	"block.minecraft.gray_concrete_stairs": "Escalièrs de beton gris",
	...
	"block.minecraft.gray_stained_glass_pane": "Vitra grisa",
	"block.minecraft.gray_terracotta": "Tèrra cuècha grisa",
	"block.minecraft.gray_wool": "Lana grisa",
	"block.minecraft.gray_wool_slab": "Lausa de lana grisa",
	"block.minecraft.gray_wool_stairs": "Escalièrs de lana grisa",
	...
	"block.minecraft.green_concrete_slab": "Lausa de beton verd",
	"block.minecraft.green_concrete_stairs": "Escalièrs de beton verd",
	...
	"block.minecraft.green_stained_glass_pane": "Vitra verda",
	"block.minecraft.green_terracotta": "Tèrra cuècha verda",
	"block.minecraft.green_wool": "Lana verda",
	"block.minecraft.green_wool_slab": "Lausa de lana verda",
	"block.minecraft.green_wool_stairs": "Escalièrs de lana verda",
	"block.minecraft.grindstone": "Mòla",
	"block.minecraft.hanging_roots": "Raices penjantas",
	...
	"block.minecraft.infested_chiseled_stone_bricks": "Bricas de pèira escultadas infestadas",
	"block.minecraft.infested_cobblestone": "Pèiras infestadas",
	"block.minecraft.infested_cracked_stone_bricks": "Bricas de pèira fendilhadas infestadas",
	"block.minecraft.infested_deepslate": "Ardesa prigonda infestada",
	"block.minecraft.infested_mossy_stone_bricks": "Bricas de pèira mofudas infestadas",
	...
	"block.minecraft.iron_chain": "Cadena de fèrre",
	...
	"block.minecraft.light_blue_concrete_slab": "Lausa de beton blau clar",
	"block.minecraft.light_blue_concrete_stairs": "Escalièrs de beton blau clar",
	...
	"block.minecraft.light_blue_stained_glass_pane": "Vitra blau clar",
	"block.minecraft.light_blue_terracotta": "Tèrra cuècha blau clar",
	"block.minecraft.light_blue_wool": "Lana blau clar",
	"block.minecraft.light_blue_wool_slab": "Lausa de lana blau clar",
	"block.minecraft.light_blue_wool_stairs": "Escalièrs de lana blau clar",
	...
	"block.minecraft.light_gray_concrete_slab": "Lausa de beton gris clar",
	"block.minecraft.light_gray_concrete_stairs": "Escalièrs de beton gris clar",
	...
	"block.minecraft.light_gray_stained_glass_pane": "Vitra gris clar",
	"block.minecraft.light_gray_terracotta": "Tèrra cuècha gris clar",
	"block.minecraft.light_gray_wool": "Lana gris clar",
	"block.minecraft.light_gray_wool_slab": "Lausa de lana gris clar",
	"block.minecraft.light_gray_wool_stairs": "Escalièrs de lana gris clar",
	...
	"block.minecraft.lime_candle_cake": "Pastís amb candèla lima",
	...
	"block.minecraft.lime_concrete_slab": "Lausa de beton lima",
	"block.minecraft.lime_concrete_stairs": "Escalièrs de beton lima",
	"block.minecraft.lime_glazed_terracotta": "Tèrra cuècha esmaltada lima",
	"block.minecraft.lime_shulker_box": "Bóstia de shulker lima",
	"block.minecraft.lime_stained_glass": "Veire lima",
	"block.minecraft.lime_stained_glass_pane": "Vitra lima",
	"block.minecraft.lime_terracotta": "Tèrra cuècha lima",
	"block.minecraft.lime_wool": "Lana lima",
	"block.minecraft.lime_wool_slab": "Lausa de lana lima",
	"block.minecraft.lime_wool_stairs": "Escalièrs de lana lima",
	...
	"block.minecraft.magenta_concrete_slab": "Lausa de beton magenta",
	"block.minecraft.magenta_concrete_stairs": "Escalièrs de beton magenta",
	...
	"block.minecraft.magenta_stained_glass_pane": "Vitra magenta",
	"block.minecraft.magenta_terracotta": "Tèrra cuècha magenta",
	"block.minecraft.magenta_wool": "Lana magenta",
	"block.minecraft.magenta_wool_slab": "Lausa de lana magenta",
	"block.minecraft.magenta_wool_stairs": "Escalièrs de lana magenta",
	...
	"block.minecraft.mangrove_slab": "Lausa de manglièr",
	"block.minecraft.mangrove_stairs": "Escalièrs de manglièr",
	...
	"block.minecraft.medium_amethyst_bud": "Cristal d'ametista mejan",
	...
	"block.minecraft.mossy_cobblestone_stairs": "Escalièrs de pèiras mofudas",
	"block.minecraft.mossy_cobblestone_wall": "Muret de pèiras mofudas",
	"block.minecraft.mossy_stone_brick_slab": "Lausa de bricas de pèiras mofudas",
	"block.minecraft.mossy_stone_brick_stairs": "Escalièrs de bricas de pèiras mofudas",
	"block.minecraft.mossy_stone_brick_wall": "Muret de bricas de pèiras mofudas",
	"block.minecraft.mossy_stone_bricks": "Bricas de pèira mofudas",
	"block.minecraft.moving_piston": "Piston en movement",
	"block.minecraft.mud": "Fanga",
	"block.minecraft.mud_brick_slab": "Lausa de bricas de fanga",
	"block.minecraft.mud_brick_stairs": "Escalièrs de bricas de fanga",
	"block.minecraft.mud_brick_wall": "Muret de bricas de fanga",
	"block.minecraft.mud_bricks": "Bricas de fanga",
	"block.minecraft.muddy_mangrove_roots": "Raices de manglièr fangosas",
	...
	"block.minecraft.nether_brick_slab": "Lausa de bricas del Nether",
	"block.minecraft.nether_brick_stairs": "Escalièrs de bricas del Nether",
	"block.minecraft.nether_brick_wall": "Muret de bricas del Nether",
	...
	"block.minecraft.nether_wart_block": "Blòc de verrugas del Nether",
	...
	"block.minecraft.oak_slab": "Lausa d'euse",
	"block.minecraft.oak_stairs": "Escalièrs d'euse",
	...
	"block.minecraft.ominous_banner": "Bandièra funèsta",
	"block.minecraft.open_eyeblossom": "Uèlhquidèa dobèrta",
	...
	"block.minecraft.orange_concrete_slab": "Lausa de beton irange",
	"block.minecraft.orange_concrete_stairs": "Escalièrs de beton irange",
	"block.minecraft.orange_glazed_terracotta": "Tèrra cuècha esmaltada iranja",
	"block.minecraft.orange_poplar_leaves": "Fuèlhas de pibol iranjas",
	"block.minecraft.orange_shulker_box": "Bóstia de shulker iranja",
	"block.minecraft.orange_stained_glass": "Veire irange",
	"block.minecraft.orange_stained_glass_pane": "Vitra iranja",
	...
	"block.minecraft.orange_wool_slab": "Lausa de lana iranja",
	"block.minecraft.orange_wool_stairs": "Escalièrs de lana iranja",
	...
	"block.minecraft.oxidized_copper_bars": "Barrets de coire oxidat",
	"block.minecraft.oxidized_copper_bulb": "Ampola en coire oxidat",
	"block.minecraft.oxidized_copper_chain": "Cadena de coire oxidat",
	"block.minecraft.oxidized_copper_chest": "Còfre en coire oxidat",
	"block.minecraft.oxidized_copper_door": "Pòrta en coire oxidat",
	"block.minecraft.oxidized_copper_golem_statue": "Estatua de golem de coire oxidat",
	"block.minecraft.oxidized_copper_grate": "Grasilha en coire oxidat",
	"block.minecraft.oxidized_copper_lantern": "Lantèrna de coire oxidat",
	"block.minecraft.oxidized_copper_trapdoor": "Trapa en coire oxidat",
	"block.minecraft.oxidized_cut_copper": "Coire talhat oxidat",
	"block.minecraft.oxidized_cut_copper_slab": "Lausa de coire talhat oxidat",
	"block.minecraft.oxidized_cut_copper_stairs": "Escalièrs de coire talhat oxidat",
	"block.minecraft.oxidized_lightning_rod": "Paratron oxidat",
	...
	"block.minecraft.pale_oak_slab": "Lausa d'euse palle",
	"block.minecraft.pale_oak_stairs": "Escalièrs d'euse palle",
	...
	"block.minecraft.petrified_oak_slab": "Lausa d'euse petrificada",
	...
	"block.minecraft.pink_concrete_slab": "Lausa de beton ròse",
	"block.minecraft.pink_concrete_stairs": "Escalièrs de beton ròse",
	...
	"block.minecraft.pink_stained_glass_pane": "Vitra ròsa",
	...
	"block.minecraft.pink_wool_slab": "Lausa de lana ròsa",
	"block.minecraft.pink_wool_stairs": "Escalièrs de lana ròsa",
	"block.minecraft.piston": "Piston",
	"block.minecraft.piston_head": "Cap de piston",
	"block.minecraft.pitcher_crop": "Plant de planta jarra",
	...
	"block.minecraft.polished_blackstone_brick_slab": "Lausa de bricas de ròca negra polida",
	"block.minecraft.polished_blackstone_brick_stairs": "Escalièrs de bricas de ròca negra polida",
	"block.minecraft.polished_blackstone_brick_wall": "Muret de bricas de ròca negra polida",
	"block.minecraft.polished_blackstone_bricks": "Bricas de ròca negra polida",
	"block.minecraft.polished_blackstone_button": "Boton en ròca negra polida",
	...
	"block.minecraft.polished_cinnabar": "Cinabre polit",
	"block.minecraft.polished_cinnabar_slab": "Lausa de cinabre polit",
	"block.minecraft.polished_cinnabar_stairs": "Escalièrs de cinabre polit",
	"block.minecraft.polished_cinnabar_wall": "Muret de cinabre polit",
	"block.minecraft.polished_deepslate": "Ardesa prigonda polida",
	"block.minecraft.polished_deepslate_slab": "Lausa d'ardesa prigonda polida",
	"block.minecraft.polished_deepslate_stairs": "Escalièrs d'ardesa prigonda polida",
	"block.minecraft.polished_deepslate_wall": "Muret d'ardesa prigonda polida",
	"block.minecraft.polished_diorite": "Diorita polida",
	"block.minecraft.polished_diorite_slab": "Lausa de diorita polida",
	"block.minecraft.polished_diorite_stairs": "Escalièrs de diorita polida",
	"block.minecraft.polished_granite": "Granit polit",
	"block.minecraft.polished_granite_slab": "Lausa de granit polit",
	"block.minecraft.polished_granite_stairs": "Escalièrs de granit polit",
	"block.minecraft.polished_sulfur": "Solpre polit",
	"block.minecraft.polished_sulfur_slab": "Lausa de solpre polit",
	"block.minecraft.polished_sulfur_stairs": "Escalièrs de solpre polit",
	"block.minecraft.polished_sulfur_wall": "Muret de solpre polit",
	...
	"block.minecraft.polished_tuff_wall": "Muret de tuf polit",
	"block.minecraft.poplar_button": "Boton en pibol",
	"block.minecraft.poplar_door": "Pòrta en pibol",
	"block.minecraft.poplar_fence": "Barralha en pibol",
	"block.minecraft.poplar_fence_gate": "Pòrta de barralha en pibol",
	"block.minecraft.poplar_hanging_sign": "Pancarta penjanta en pibol",
	"block.minecraft.poplar_leaves": "Fuèlhas de pibol",
	"block.minecraft.poplar_log": "Busca de pibol",
	"block.minecraft.poplar_planks": "Plancas de pibol",
	"block.minecraft.poplar_pressure_plate": "Placa de pression en pibol",
	"block.minecraft.poplar_sapling": "Grelh de pibol",
	"block.minecraft.poplar_shelf": "Estaudèla en pibol",
	"block.minecraft.poplar_sign": "Pancarta en pibol",
	"block.minecraft.poplar_slab": "Lausa de pibol",
	"block.minecraft.poplar_stairs": "Escalièrs de pibol",
	"block.minecraft.poplar_trapdoor": "Trapa en pibol",
	"block.minecraft.poplar_wall_hanging_sign": "Pancarta penjanta en pibol murala",
	"block.minecraft.poplar_wall_sign": "Pancarta en pibol murala",
	"block.minecraft.poplar_wood": "Fusta de pibol",
	"block.minecraft.poppy": "Rosèla",
	"block.minecraft.potatoes": "Patanas",
	"block.minecraft.potent_sulfur": "Solpre reactiu",
	...
	"block.minecraft.potted_closed_eyeblossom": "Uèlhquidèa barrada en pòt",
	"block.minecraft.potted_cornflower": "Blavet en pòt",
	"block.minecraft.potted_crimson_fungus": "Fonge cremesin en pòt",
	"block.minecraft.potted_crimson_roots": "Raices cremesinas en pòt",
	"block.minecraft.potted_dandelion": "Pissalach en pòt",
	"block.minecraft.potted_dark_oak_sapling": "Grelh d'euse escur en pòt",
	...
	"block.minecraft.potted_golden_dandelion": "Pissalach daurat en pòt",
	...
	"block.minecraft.potted_oak_sapling": "Grelh d'euse en pòt",
	"block.minecraft.potted_open_eyeblossom": "Uèlhquidèa dobèrta en pòt",
	"block.minecraft.potted_orange_tulip": "Tulipa iranja en pòt",
	"block.minecraft.potted_oxeye_daisy": "Margarida en pòt",
	"block.minecraft.potted_pale_oak_sapling": "Grelh d'euse palle en pòt",
	"block.minecraft.potted_pink_tulip": "Tulipa ròsa en pòt",
	"block.minecraft.potted_poplar_sapling": "Grelh de pibol en pòt",
	...
	"block.minecraft.potted_torchflower": "Entòrcha-flor en pòt",
	"block.minecraft.potted_warped_fungus": "Fonge bescornut en pòt",
	"block.minecraft.potted_warped_roots": "Raices bescornudas en pòt",
	...
	"block.minecraft.prismarine_brick_slab": "Lausa de bricas de prismarina",
	"block.minecraft.prismarine_brick_stairs": "Escalièrs de bricas de prismarina",
	"block.minecraft.prismarine_bricks": "Bricas de prismarina",
	"block.minecraft.prismarine_slab": "Lausa de prismarina",
	"block.minecraft.prismarine_stairs": "Escalièrs de prismarina",
	...
	"block.minecraft.purple_concrete_slab": "Lausa de beton violet",
	"block.minecraft.purple_concrete_stairs": "Escalièrs de beton violet",
	...
	"block.minecraft.purple_stained_glass_pane": "Vitra violeta",
	"block.minecraft.purple_terracotta": "Tèrra cuècha violeta",
	"block.minecraft.purple_wool": "Lana violeta",
	"block.minecraft.purple_wool_slab": "Lausa de lana violeta",
	"block.minecraft.purple_wool_stairs": "Escalièrs de lana violeta",
	...
	"block.minecraft.quartz_stairs": "Escalièrs de qüars",
	...
	"block.minecraft.red_concrete_slab": "Lausa de beton roge",
	"block.minecraft.red_concrete_stairs": "Escalièrs de beton roge",
	...
	"block.minecraft.red_nether_brick_slab": "Lausa de bricas del Nether rojas",
	"block.minecraft.red_nether_brick_stairs": "Escalièrs de bricas del Nether rojas",
	"block.minecraft.red_nether_brick_wall": "Muret de bricas del Nether rojas",
	"block.minecraft.red_nether_bricks": "Bricas del Nether rojas",
	"block.minecraft.red_poplar_leaves": "Fuèlhas de pibol rojas",
	...
	"block.minecraft.repeating_command_block": "Blòc de comanda a repeticion",
	"block.minecraft.resin_block": "Blòc de resina",
	"block.minecraft.resin_brick_slab": "Lausa de bricas de resina",
	"block.minecraft.resin_brick_stairs": "Escalièrs de bricas de resina",
	"block.minecraft.resin_brick_wall": "Muret de bricas de resina",
	"block.minecraft.resin_bricks": "Bricas de resina",
	"block.minecraft.resin_clump": "Amàs de resina",
	...
	"block.minecraft.sandstone_stairs": "Escalièrs de gres",
	...
	"block.minecraft.shelf_mushroom": "Polipòre",
	...
	"block.minecraft.small_amethyst_bud": "Cristal d'ametista pichon",
	...
	"block.minecraft.smooth_basalt": "Basalt lis",
	"block.minecraft.smooth_quartz": "Blòc de qüars lis",
	"block.minecraft.smooth_quartz_slab": "Lausa de qüars lis",
	"block.minecraft.smooth_quartz_stairs": "Escalièrs de qüars lis",
	"block.minecraft.smooth_red_sandstone": "Gres roge lis",
	"block.minecraft.smooth_red_sandstone_slab": "Lausa de gres roge lis",
	"block.minecraft.smooth_red_sandstone_stairs": "Escalièrs de gres roge lis",
	"block.minecraft.smooth_sandstone": "Gres lis",
	"block.minecraft.smooth_sandstone_slab": "Lausa de gres lis",
	"block.minecraft.smooth_sandstone_stairs": "Escalièrs de gres lis",
	...
	"block.minecraft.spawner": "Generator de creaturas",
	...
	"block.minecraft.spore_blossom": "Flor d'espòras",
	...
	"block.minecraft.spruce_slab": "Lausa d'avet",
	"block.minecraft.spruce_stairs": "Escalièrs d'avet",
	...
	"block.minecraft.stone_brick_slab": "Lausa de bricas de pèira",
	"block.minecraft.stone_brick_stairs": "Escalièrs de bricas de pèira",
	"block.minecraft.stone_brick_wall": "Muret de bricas de pèira",
	...
	"block.minecraft.straw_bed": "Lièch de palha",
	"block.minecraft.stripped_acacia_log": "Busca de cacièr desruscada",
	"block.minecraft.stripped_acacia_wood": "Fusta de cacièr desruscada",
	"block.minecraft.stripped_bamboo_block": "Blòc de bambó desruscat",
	"block.minecraft.stripped_birch_log": "Busca de bèç desruscada",
	"block.minecraft.stripped_birch_wood": "Fusta de bèç desruscada",
	...
	"block.minecraft.stripped_crimson_hyphae": "Ifas cremesinas desruscada",
	"block.minecraft.stripped_crimson_stem": "Tija cremesina desruscada",
	"block.minecraft.stripped_dark_oak_log": "Busca d'euse escur desruscada",
	"block.minecraft.stripped_dark_oak_wood": "Fusta d'euse escur desruscada",
	"block.minecraft.stripped_jungle_log": "Busca de jungla desruscada",
	"block.minecraft.stripped_jungle_wood": "Fusta de jungla desruscada",
	"block.minecraft.stripped_mangrove_log": "Busca de manglièr desruscada",
	"block.minecraft.stripped_mangrove_wood": "Fusta de manglièr desruscada",
	"block.minecraft.stripped_oak_log": "Busca d'euse desruscada",
	"block.minecraft.stripped_oak_wood": "Fusta d'euse desruscada",
	"block.minecraft.stripped_pale_oak_log": "Busca d'euse palle deruscada",
	"block.minecraft.stripped_pale_oak_wood": "Fusta d'euse palle deruscada",
	"block.minecraft.stripped_poplar_log": "Busca de pibol desrucada",
	"block.minecraft.stripped_poplar_wood": "Fusta de pibol desruscada",
	"block.minecraft.stripped_spruce_log": "Busca d'avet desruscada",
	"block.minecraft.stripped_spruce_wood": "Fusta d'avet desruscada",
	"block.minecraft.stripped_warped_hyphae": "Ifas bescornudas desruscada",
	"block.minecraft.stripped_warped_stem": "Tija bescornuda desruscada",
	...
	"block.minecraft.sulfur": "Solpre",
	"block.minecraft.sulfur_brick_slab": "Lausa de bricas de solpre",
	"block.minecraft.sulfur_brick_stairs": "Escalièrs de bricas de solpre",
	"block.minecraft.sulfur_brick_wall": "Muret de bricas de solpre",
	"block.minecraft.sulfur_bricks": "Bricas de solpre",
	"block.minecraft.sulfur_slab": "Lausa de solpre",
	"block.minecraft.sulfur_spike": "Pica de solpre",
	"block.minecraft.sulfur_stairs": "Escalièrs de solpre",
	"block.minecraft.sulfur_wall": "Muret de solpre",
	...
	"block.minecraft.sweet_berry_bush": "Boisson de baias doças",
	...
	"block.minecraft.test_block": "Blòc de tèst",
	"block.minecraft.test_instance_block": "Blòc d'instància de tèst",
	...
	"block.minecraft.torchflower_crop": "Plant d'entòrcha-flor",
	"block.minecraft.trapped_chest": "Còfre tracanard",
	...
	"block.minecraft.tuff_brick_slab": "Lausa de bricas de tuf",
	"block.minecraft.tuff_brick_stairs": "Escalièrs de bricas de tuf",
	"block.minecraft.tuff_brick_wall": "Muret de bricas de tuf",
	...
	"block.minecraft.warped_roots": "Raices bescornudas",
	...
	"block.minecraft.warped_wart_block": "Blòc de verrugas bescornudas del Nether",
	...
	"block.minecraft.waxed_copper_bars": "Barrets de coire encerat",
	"block.minecraft.waxed_copper_block": "Blòc de coire encerat",
	"block.minecraft.waxed_copper_bulb": "Ampola en coire encerat",
	"block.minecraft.waxed_copper_chain": "Cadena de coire encerat",
	"block.minecraft.waxed_copper_chest": "Còfre en coire encerat",
	"block.minecraft.waxed_copper_door": "Pòrta en coire encerat",
	"block.minecraft.waxed_copper_golem_statue": "Estatua de golem de coire encerat",
	"block.minecraft.waxed_copper_grate": "Grasilha en coire encerat",
	"block.minecraft.waxed_copper_lantern": "Lantèrna de coire encerat",
	"block.minecraft.waxed_copper_trapdoor": "Trapa en coire encerada",
	"block.minecraft.waxed_cut_copper": "Coire talhat encerat",
	"block.minecraft.waxed_cut_copper_slab": "Lausa de coire talhat encerat",
	"block.minecraft.waxed_cut_copper_stairs": "Escalièrs de coire talhat encerat",
	...
	"block.minecraft.waxed_exposed_copper_bars": "Barrets de coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_bulb": "Ampola en coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena de coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_chest": "Còfre en coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_door": "Pòrta en coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estatua de golem de coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_grate": "Grasilha en coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_lantern": "Lantèrna de coire expausat encerat",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trapa en coire expausat encerat",
	"block.minecraft.waxed_exposed_cut_copper": "Coire talhat expausat encerat",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Lausa de coire talhat expausat encerat",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Escalièrs de coire talhat expausat encerat",
	"block.minecraft.waxed_exposed_lightning_rod": "Paratron expausat encerat",
	"block.minecraft.waxed_lightning_rod": "Paratron encerat",
	...
	"block.minecraft.waxed_oxidized_copper_bars": "Barrets de coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_bulb": "Ampola en coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_chain": "Cadena de coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_chest": "Còfre en coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_door": "Pòrta en coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estatua de golem de coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_grate": "Grasilha en coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_lantern": "Lantèrna de coire oxidat encerat",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Trapa en coire oxidat encerat",
	"block.minecraft.waxed_oxidized_cut_copper": "Coire talhat oxidat encerat",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Lausa de coire talhat oxidat encerat",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Escalièrs de coire talhat oxidat encerat",
	"block.minecraft.waxed_oxidized_lightning_rod": "Paratron oxidat encerat",
	...
	"block.minecraft.waxed_weathered_copper_bars": "Barrets de coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_bulb": "Ampola en coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_chain": "Cadena de coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_chest": "Còfre en coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_door": "Pòrta en coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estatua de golem de coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_grate": "Grasilha en coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_lantern": "Lantèrna de coire corroït encerat",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trapa en coire corroït encerat",
	"block.minecraft.waxed_weathered_cut_copper": "Coire talhat corroït encerat",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Lausa de coire talhat corroït encerat",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Escalièrs de coire talhat corroït encerat",
	"block.minecraft.waxed_weathered_lightning_rod": "Paratron corroït encerat",
	"block.minecraft.weathered_chiseled_copper": "Coire escultat corroït",
	"block.minecraft.weathered_copper": "Coire corroït",
	"block.minecraft.weathered_copper_bars": "Barrets de coire corroït",
	"block.minecraft.weathered_copper_bulb": "Ampola en coire corroït",
	"block.minecraft.weathered_copper_chain": "Cadena de coire corroït",
	"block.minecraft.weathered_copper_chest": "Còfre en coire corroït",
	"block.minecraft.weathered_copper_door": "Pòrta en coire corroït",
	"block.minecraft.weathered_copper_golem_statue": "Estatua de golem de coire corroït",
	"block.minecraft.weathered_copper_grate": "Grasilha en coire corroït",
	"block.minecraft.weathered_copper_lantern": "Lantèrna de coire corroït",
	"block.minecraft.weathered_copper_trapdoor": "Trapa en coire corroït",
	"block.minecraft.weathered_cut_copper": "Coire talhat corroït",
	"block.minecraft.weathered_cut_copper_slab": "Lausa de coire talhat corroït",
	"block.minecraft.weathered_cut_copper_stairs": "Escalièrs de coire talhat corroït",
	"block.minecraft.weathered_lightning_rod": "Paratron corroït",
	...
	"block.minecraft.white_concrete_slab": "Lausa de beton blanc",
	"block.minecraft.white_concrete_stairs": "Escalièrs de beton blanc",
	...
	"block.minecraft.white_stained_glass_pane": "Vitra blanca",
	...
	"block.minecraft.white_wool_slab": "Lausa de lana blanca",
	"block.minecraft.white_wool_stairs": "Escalièrs de lana blanca",
	...
	"block.minecraft.yellow_concrete_slab": "Lausa de beton jaune",
	"block.minecraft.yellow_concrete_stairs": "Escalièrs de beton jaune",
	"block.minecraft.yellow_glazed_terracotta": "Tèrra cuècha esmaltada jauna",
	"block.minecraft.yellow_poplar_leaves": "Fuèlhas de pibol jaunas",
	"block.minecraft.yellow_shulker_box": "Bóstia de shulker jauna",
	"block.minecraft.yellow_stained_glass": "Veire jaune",
	"block.minecraft.yellow_stained_glass_pane": "Vitra jauna",
	"block.minecraft.yellow_terracotta": "Tèrra cuècha jauna",
	"block.minecraft.yellow_wool": "Lana jauna",
	"block.minecraft.yellow_wool_slab": "Lausa de lana jauna",
	"block.minecraft.yellow_wool_stairs": "Escalièrs de lana jauna",
	"block.minecraft.zombie_head": "Cap de zòmbi",
	"block.minecraft.zombie_wall_head": "Cap de zòmbi mural",
	...
	"build.spawn_protection": "%s es jos la proteccion del ponch de reaparicion",
	"build.tooHigh": "La nautor maximala per bastir es de %s",
	"build.tooLow": "La nautor minimala per bastir es de %s",
	"chat.cannotSend": "Se pòt pas enviar de messatge dins lo chat",
	"chat.coordinates": "%s, %s, %s",
	"chat.coordinates.tooltip": "Picatz per vos i teleportar",
	"chat.copy": "Copiar",
	"chat.copy.click": "Clicatz per copiar dins lo cachapapièrs",
	"chat.deleted_marker": "Aqueste messatge es estat suprimit pel servidor.",
	"chat.disabled.chain_broken": "Chat desactivat en causa d'una cadena rompuda. Se vos plai, ensajatz de vos tornar connectar.",
	"chat.disabled.expiredProfileKey": "Chat desactivat en causa de l'expiracion de la clau publica. Se vos plai, ensajatz de vos tornar connectar.",
	...
	"chat.disabled.invalid_signature": "Signatura pas valida pel chat. Se vos plai, ensajatz de vos tornar connectar.",
	"chat.disabled.launcher": "Chat desactivat dins las opcions del lançaire. Se pòt pas enviar de messatge.",
	"chat.disabled.missingProfileKey": "Chat desactivat en causa de l'abséncia de la clau publica. Se vos plai, ensajatz de vos tornar connectar.",
	"chat.disabled.options": "Chat desactivat dins las opcions del client.",
	"chat.disabled.out_of_order_chat": "Chat recebut desordonat. L'òra del sistèma a cambiada?",
	"chat.disabled.profile": "Chat pas autorizat pels paramètres del compte. Tornatz picar \"%s\" per mai d'informacions.",
	"chat.disabled.profile.moreInfo": "Chat pas autorizat pels paramètres del compte. Se pòt pas enviar o veire de messatge.",
	"chat.editBox": "chat",
	"chat.filtered": "Filtrat pel servidor.",
	"chat.filtered_full": "Lo servidor a amagat los vòstres messatges per d'unes jogaires.",
	...
	"chat.link.open": "Dobrir lo ligam",
	"chat.link.warning": "Dobriscatz pas jamai de ligam de personas en que vos fisatz pas!",
	"chat.queue": "[+%s messatge(s) en espèra]",
	"chat.queue.tooltip": "Clicatz per afichar lo messatge seguent",
	"chat.square_brackets": "[%s]\n",
	"chat.tag.error": "Lo servidor a enviat un messatge pas valid.",
	"chat.tag.modified": "Messatge modificat pel servidor. Messatge original:",
	...
	"chat.type.admin": "[%s: %s]",
	"chat.type.advancement.challenge": "%s a completat lo desfís %s",
	"chat.type.advancement.goal": "%s a atengut l'objectiu %s",
	"chat.type.advancement.task": "%s a fach lo progrès %s",
	"chat.type.announcement": "[%s] %s",
	"chat.type.emote": "* %s %s",
	"chat.type.team.hover": "Mandar un messatge a la còla",
	"chat.type.team.sent": "-> %s <%s> %s",
	"chat.type.team.text": "%s <%s> %s",
	"chat.type.text": "<%s> %s",
	"chat.type.text.narrate": "%s ditz %s",
	"chat.validation_error": "Fracàs de la validacion del chat",
	"chat_restriction.chat_and_commands_disabled_by_options": "Chat restrench dins las opcions del client.",
	"chat_restriction.chat_disabled_by_options": "Chat dels jogaires restrench dins las opcions del client.",
	"chat_restriction.chat_disabled_by_options.action": "Anar a l'ecran de configuracion del chat",
	"chat_restriction.disabled_by_launcher": "Chat restrench pel lançaire.",
	"chat_restriction.disabled_by_profile": "Chat restrench dins las opcions del perfil.",
	"chat_restriction.disabled_by_profile.action": "Anar a l'ecran de configuracion del perfil",
	"chat_screen.commands_not_allowed": "Lo mandadís de comandas es pas autorizat",
	"chat_screen.message": "Messatge a enviar: %s",
	"chat_screen.messages_not_allowed": "Lo mandadís de messatges es pas autorizat",
	"chat_screen.restricted": "Chat restrench. Clicatz sul messatge per ne saber mai.",
	"chat_screen.restricted.narration": "Chat restrench. Anatz a l'ecran de las restriccions dins las opcions del mond.",
	"chat_screen.title": "Fenèstra del chat",
	"chat_screen.usage": "Escrivètz lo tèxt e picatz Entrar pel mandar",
	"chunk.toast.checkLog": "Consultatz lo registre per mai de detalhs",
	"chunk.toast.loadFailure": "Fracàs del cargament del tròç en %s",
	"chunk.toast.lowDiskSpace": "Espaci disc feble!",
	"chunk.toast.lowDiskSpace.description": "La sauvagarda del mond poiriá èsser pas possibla.",
	"chunk.toast.saveFailure": "Fracàs de la sauvagarda del tròç en %s",
	"clear.failed.multiple": "Cap d'objècte trobat sus %s jogaires",
	"clear.failed.single": "Cap d'objècte trobat sul jogaire %s",
	...
	"command.compute.result.named.exact": "%s a retornat la valor %s",
	"command.compute.result.named.rounded": "%s a retornat la valor %s (arrondit a %s)",
	"command.compute.result.unnamed.exact": "Lo fornidor de nombre a retornat la valor %s",
	"command.compute.result.unnamed.rounded": "Lo fornidor de nombre a retornat la valor %s (arrondit a %s)",
	"command.context.here": "<--[AICÍ]",
	"command.context.parse_error": "%s a la posicion %s: %s",
	"command.exception": "Fracàs de l'analisi sintaxica de la comanda: %s",
	"command.expected.separator": "Un espaci blanc es esperat per acabar un argument, mas de donadas de fin son estadas trobadas",
	"command.failed": "Una mèuca inesperada s'es produsida mentre qu'ensajava de complir aquela comanda",
	"command.forkLimit": "Nombre maximal de contèxts (%s) atench",
	"command.trailing_data": "Donadas de fin trobadas: %s",
	...
	"commands.advancement.grant.criterion.to.many.failure": "Se pòt pas acordar lo critèri \"%s\" del progrès %s a %s jogaires pr'amor l'an ja",
	"commands.advancement.grant.criterion.to.many.success": "Lo critèri \"%s\" del progrès %s es estat acordat a %s jogaires",
	"commands.advancement.grant.criterion.to.one.failure": "Se pòt pas acordar lo critèri \"%s\" del progrès %s al jogaire %s pr'amor l'a ja",
	"commands.advancement.grant.criterion.to.one.success": "Lo critèri \"%s\" del progrès %s es estat acordat a %s",
	"commands.advancement.grant.many.to.many.failure": "Se pòt pas acordar %s progrèsses a %s jogaires pr'amor los an ja",
	"commands.advancement.grant.many.to.many.success": "%s progrèsses son estats acordats a %s jogaires",
	"commands.advancement.grant.many.to.one.failure": "Se pòt pas acordar %s progrèsses al jogaire %s pr'amor los a ja",
	"commands.advancement.grant.many.to.one.success": "%s progrèsses son estats acordats a %s",
	"commands.advancement.grant.one.to.many.failure": "Se pòt pas acordar lo progrès %s a %s jogaires pr'amor l'an ja",
	"commands.advancement.grant.one.to.many.success": "Lo progrès %s es estat acordat a %s jogaires",
	"commands.advancement.grant.one.to.one.failure": "Se pòt pas acordar lo progrès %s al jogaire %s pr'amor l'a ja",
	"commands.advancement.grant.one.to.one.success": "Lo progrès %s es estat acordat a %s",
	"commands.advancement.revoke.criterion.to.many.failure": "Se pòt pas levar lo critèri \"%s\" del progrès %s a %s jogaires pr'amor l'an pas",
	"commands.advancement.revoke.criterion.to.many.success": "Lo critèri \"%s\" del progrès %s es estat levat a %s jogaires",
	"commands.advancement.revoke.criterion.to.one.failure": "Se pòt pas levar lo critèri \"%s\" del progrès %s al jogaire %s pr'amor l'a pas",
	"commands.advancement.revoke.criterion.to.one.success": "Lo critèri \"%s\" del progrès %s es estat levat al jogaire %s",
	"commands.advancement.revoke.many.to.many.failure": "Se pòt pas levar %s progrèsses a %s jogaires pr'amor los an pas",
	"commands.advancement.revoke.many.to.many.success": "%s progrèsses son estats levats a %s jogaires",
	"commands.advancement.revoke.many.to.one.failure": "Se pòt pas levar %s progrèsses al jogaire %s pr'amor los a pas",
	"commands.advancement.revoke.many.to.one.success": "%s progrèsses son estats levats al jogaire %s",
	"commands.advancement.revoke.one.to.many.failure": "Se pòt pas levar lo progrès %s a %s jogaires pr'amor l'an pas",
	"commands.advancement.revoke.one.to.many.success": "Lo progrès %s es estat levat a %s jogaires",
	"commands.advancement.revoke.one.to.one.failure": "Se pòt pas levar lo progrès %s al jogaire %s pr'amor l'a pas",
	"commands.advancement.revoke.one.to.one.success": "Lo progrès %s es estat levat al jogaire %s",
	"commands.attribute.base_value.get.success": "La valor de basa de l'atribut \"%s\" de l'entitat \"%s\" es de %s",
	"commands.attribute.base_value.reset.success": "La valor de basa de l'atribut \"%s\" de l'entitat \"%s\" es estada reïnicializada a %s",
	"commands.attribute.base_value.set.success": "La valor de basa de l'atribut \"%s\" de l'entitat \"%s\" es botada a %s",
	"commands.attribute.failed.entity": "%s es pas una entitat valida per aquela comanda",
	"commands.attribute.failed.modifier_already_present": "Lo modificaire %s es ja aplicat a l'atribut \"%s\" de l'entitat \"%s\"",
	...
	"commands.attribute.modifier.add.success": "Lo modificaire %s es estat apondut a l'atribut \"%s\" de l'entitat \"%s\"",
	"commands.attribute.modifier.remove.success": "Lo modificaire %s es estat retirat de l'atribut \"%s\" de l'entitat \"%s\"",
	"commands.attribute.modifier.value.get.success": "La valor del modificaire %s de l'atribut \"%s\" de l'entitat \"%s\" es de %s",
	"commands.attribute.value.get.success": "La valor de l'atribut \"%s\" de l'entitat \"%s\" es de %s",
	...
	"commands.banip.invalid": "Adreça IP pas valida o jogaire desconegut",
	"commands.banip.success": "L'adreça IP %s es estada fòrabandida: %s",
	...
	"commands.bossbar.create.failed": "Una barra de capmèstre amb l'ID \"%s\" existís ja",
	"commands.bossbar.create.success": "La barra de capmèstre personalizada %s es estada creada",
	"commands.bossbar.get.max": "La barra de capmèstre personalizada %s a una valor maximala de %s",
	"commands.bossbar.get.players.none": "La barra de capmèstre personalizada %s a pas de jogaire connectat a l'ora d'ara",
	"commands.bossbar.get.players.some": "La barra de capmèstre personalizada %s a %s jogaire(s) connectat(s) a l'ora d'ara: %s",
	"commands.bossbar.get.value": "La barra de capmèstre personalizada %s a una valor de %s",
	"commands.bossbar.get.visible.hidden": "La barra de capmèstre personalizada %s es amagada ara",
	"commands.bossbar.get.visible.visible": "La barra de capmèstre personalizada %s es visibla ara",
	"commands.bossbar.list.bars.none": "I a pas cap de barra de capmèstre personalizada activa",
	"commands.bossbar.list.bars.some": "I a %s barra(s) de capmèstre personalizada(s) activa(s): %s",
	"commands.bossbar.remove.success": "La barra de capmèstre personalizada %s es estada retirada",
	"commands.bossbar.set.color.success": "La color de la barra de capmèstre personalizada %s es estada cambiada",
	"commands.bossbar.set.color.unchanged": "Res es cambiat. Es ja la color de la barra de capmèstre",
	"commands.bossbar.set.max.success": "Lo maximum de la barra de capmèstre personalizada %s es estat botat a %s",
	"commands.bossbar.set.max.unchanged": "Res es cambiat. Es ja lo maximum de la barra de capmèstre",
	"commands.bossbar.set.name.success": "Lo nom de la barra de capmèstre %s es estat cambiat",
	"commands.bossbar.set.name.unchanged": "Res es cambiat. Es ja lo nom de la barra de capmèstre",
	"commands.bossbar.set.players.success.none": "La barra de capmèstre personalizada %s a pas mai de jogaire",
	"commands.bossbar.set.players.success.some": "La barra de capmèstre personalizada %s a ara %s jogaire(s): %s",
	"commands.bossbar.set.players.unchanged": "Res es cambiat. Aqueles jogaires son ja sus la barra de capmèstre amb degun a apondre o a retirar",
	"commands.bossbar.set.style.success": "L'estil de la barra de capmèstre %s es estat cambiat",
	"commands.bossbar.set.style.unchanged": "Res es cambiat. Es ja l'estil de la barra de capmèstre",
	"commands.bossbar.set.value.success": "La valor de la barra de capmèstre personalizada %s es estada botada a %s",
	"commands.bossbar.set.value.unchanged": "Res es cambiat. Es ja la valor de la barra de capmèstre",
	"commands.bossbar.set.visibility.unchanged.hidden": "Res es cambiat. La barra de capmèstre es ja amagada",
	"commands.bossbar.set.visibility.unchanged.visible": "Res es cambiat. La barra de capmèstre es ja visibla",
	"commands.bossbar.set.visible.success.hidden": "La barra de capmèstre personalizada %s es ara amagada",
	"commands.bossbar.set.visible.success.visible": "La barra de capmèstre personalizada %s es ara visibla",
	"commands.bossbar.unknown": "I a pas de barra de capmèstre amb l'ID \"%s\"",
	"commands.clear.success.multiple": "Retirada de %s objècte(s) de l'inventari de %s jogaires",
	"commands.clear.success.single": "Retirada de %s objècte(s) de l'inventari de %s",
	...
	"commands.damage.success": "%[2]s patís %[1]s ponch(es) de degalh",
	...
	"commands.data.entity.get": "La proprietat %s de %s, après un factor d'escala de %s, es de %s",
	"commands.data.entity.invalid": "Se pòt pas modificar las donadas del jogaire",
	"commands.data.entity.modified": "Donadas modificadas per l'entitat %s",
	...
	"commands.data.get.multiple": "Aqueste argument accèpta pas qu'una valor NBT",
	"commands.data.get.unknown": "Se pòt pas obténer %s, lo tag existís pas",
	"commands.data.merge.failed": "Res es cambiat. Son ja las valors de las proprietats especificadas",
	...
	"commands.data.modify.expected_value": "S'esperava una valor, valor recebuda: %s",
	"commands.data.modify.invalid_index": "Indèx de lista invalid: %s",
	"commands.data.modify.invalid_substring": "Indèxes de soscadena invalids: de %s a %s",
	"commands.data.storage.get": "La proprietat %s dins l'estocatge %s, après un factor d'escala de %s, es de %s",
	"commands.data.storage.modified": "L'estocatge %s a cambiat",
	"commands.data.storage.query": "L'estocatge %s conten: %s",
	"commands.datapack.create.already_exists": "Un paquet amb lo nom \"%s\" existís ja",
	"commands.datapack.create.invalid_full_name": "\"%s\" es pas un nom valid per un paquet",
	"commands.datapack.create.invalid_name": "Caractèrs pas valids dins lo nom del nòu paquet \"%s\"",
	"commands.datapack.create.io_failure": "Se pòt pas crear un paquet amb lo nom \"%s\", consultatz lo registre",
	"commands.datapack.create.metadata_encode_failure": "Fracàs al temps de l'encodatge pel paquet amb lo nom \"%s\": %s",
	"commands.datapack.create.success": "Creacion d'un nòu paquet amb lo nom \"%s\"",
	"commands.datapack.disable.failed": "Lo paquet de donadas \"%s\" es pas activat!",
	"commands.datapack.disable.failed.feature": "Lo paquet de donadas \"%s\" pòt pas èsser desactivat, pr'amor forma part d'una variable activa!",
	"commands.datapack.enable.failed": "Lo paquet de donadas \"%s\" es ja actiu!",
	"commands.datapack.enable.failed.no_flags": "Lo paquet de donadas \"%s\" pòt pas èsser activat, pr'amor las variablas requesidas son pas activadas dins aquel mond: %s!",
	"commands.datapack.list.available.none": "I a pas cap d'autre paquet de donadas disponible",
	"commands.datapack.list.available.success": "I a %s paquet(s) de donadas disponible(s): %s",
	"commands.datapack.list.enabled.none": "I a pas cap de paquet de donadas activat",
	"commands.datapack.list.enabled.success": "I a %s paquet(s) de donadas activat(s): %s",
	"commands.datapack.modify.disable": "Desactivacion del paquet de donadas %s",
	"commands.datapack.modify.enable": "Activacion del paquet de donadas %s",
	"commands.datapack.unknown": "Paquet de donadas desconegut: \"%s\"",
	"commands.debug.alreadyRunning": "Lo profilador de cicles es ja amodat",
	"commands.debug.function.noRecursion": "Se pòt pas traçar dempuèi l'interior d'una foncion",
	...
	"commands.debug.function.traceFailed": "Fracàs del traçat de la foncion",
	...
	"commands.debug.stopped": "Arrèst del profilador de cicles après %s segonda(s) e %s cicle(s) (%s cicle(s) per segonda)",
	"commands.defaultgamemode.success": "Lo mòde de jòc per deca es ara %s",
	...
	"commands.dialog.clear.multiple": "Los dialògs son estats escafats per %s jogaires",
	"commands.dialog.clear.single": "Los dialògs son estats escafats per %s",
	...
	"commands.difficulty.failure": "Res es cambiat. La dificultat es ja botada a %s",
	"commands.difficulty.query": "La dificultat es %s",
	"commands.difficulty.success": "La dificultat es estada botada a %s",
	"commands.drop.no_held_items": "L'entitat pòt pas téner cap d'objècte",
	"commands.drop.no_loot_table": "L'entitat \"%s\" a pas de taula de butin",
	"commands.drop.no_loot_table.block": "Lo blòc %s a pas de taula de butin",
	"commands.drop.success.multiple": "%s objèctes escampats",
	"commands.drop.success.multiple_with_table": "%s objectès escampats de la taula de butin %s",
	"commands.drop.success.single": "%s %s escampat(da)(s)",
	"commands.drop.success.single_with_table": "%s %s escampat(da)(s) de la taula de butin %s",
	"commands.effect.clear.everything.failed": "La cibla a pas cap d'efièch a retirar",
	"commands.effect.clear.everything.success.multiple": "Totes les efièches son estats retirats de %s ciblas",
	"commands.effect.clear.everything.success.single": "Totes les efièches son estats retirats de %s",
	"commands.effect.clear.specific.failed": "La cibla a pas l'efièch volgut",
	"commands.effect.clear.specific.success.multiple": "L'efièch %s es estat retirat de %s ciblas",
	"commands.effect.clear.specific.success.single": "L'efièch %s es estat retirat de %s",
	"commands.effect.give.failed": "Se pòt pas aplicar aqueste efièch (la cibla es immunizat als efièches o a quicòm mai fort)",
	"commands.effect.give.success.multiple": "L'efièch %s es estat aplicat a %s ciblas",
	"commands.effect.give.success.single": "L'efièch %s es estat aplicat a %s",
	"commands.enchant.failed": "Res es cambiat. Las ciblas an pas d'objècte dins lors mans o l'encantament pòt pas èsser aplicat",
	"commands.enchant.failed.entity": "%s es pas una entitat valida per aquela comanda",
	"commands.enchant.failed.incompatible": "%s pòt pas aver aquel encantament",
	"commands.enchant.failed.itemless": "%s ten pas cap d'objècte",
	"commands.enchant.failed.level": "%s es mai que lo nivèl maximal (%s) d'aquel encantament",
	"commands.enchant.success.multiple": "L'encantament %s es aplicat a %s entitats",
	"commands.enchant.success.single": "L'encantament %s es aplicat a l'objècte de %s",
	"commands.execute.blocks.toobig": "Tròp de blòcs dins la zona especificada (%s al maximum, %s especificats)",
	"commands.execute.conditional.fail": "Tèst pas capitat",
	"commands.execute.conditional.fail_count": "Tèst pas capitat, quantitat: %s",
	"commands.execute.conditional.pass": "Tèst capitat",
	"commands.execute.conditional.pass_count": "Tèst capitat, quantitat: %s",
	"commands.execute.function.instantiationFailure": "Fracàs de l'instanciacion de la foncion \"%s\" : %s",
	"commands.experience.add.levels.success.multiple": "Don de %s nivèl(s) d'experiéncia a %s jogaires",
	"commands.experience.add.levels.success.single": "Don de %s nivèl(s) d'experiéncia a %s",
	"commands.experience.add.points.success.multiple": "Don de %s ponch(es) d'experiéncia a %s jogaires",
	"commands.experience.add.points.success.single": "Don de %s ponch(es) d'experiéncia a %s",
	"commands.experience.query.levels": "%s a %s nivèl(s) d'experiéncia",
	"commands.experience.query.points": "%s a %s ponch(es) d'experiéncia",
	"commands.experience.set.levels.success.multiple": "Lo nombre de nivèls d'experiéncia es estat botat a %s per %s jogaires",
	"commands.experience.set.levels.success.single": "Lo nombre de nivèls d'experiéncia es estat botat a %s per %s",
	"commands.experience.set.points.invalid": "Se pòt pas botar lo nombre de ponches d'experiéncia al delà del maximum de ponches del nivèl actual del jogaire",
	"commands.experience.set.points.success.multiple": "Lo nombre de ponches d'expériencia es estat botat a %s per %s jogaires",
	"commands.experience.set.points.success.single": "Lo nombre de ponches d'expériencia es estat botat a %s per %s",
	"commands.fetchprofile.copy_component": "Còpiar lo compausant",
	"commands.fetchprofile.copy_text": "Còpiar %s",
	"commands.fetchprofile.entity.success": "Perfil resolgut per l'entitat \"%s\": %s",
	"commands.fetchprofile.failed_to_serialize": "Fracàs de la serialisacion del perfil: %s",
	"commands.fetchprofile.give_item": "Balhar l'objècte",
	"commands.fetchprofile.id.failure": "Fracàs de la resolucion del perfil per l'ID \"%s\"",
	"commands.fetchprofile.id.success": "Perfil resolgut per l'ID \"%s\": %s",
	"commands.fetchprofile.name.failure": "Fracàs de la resolucion del perfil pel nom \"%s\"",
	"commands.fetchprofile.name.success": "Perfil resolgut pel nom \"%s\": %s",
	"commands.fetchprofile.no_profile": "L'entitat \"%s\" a pas de perfil",
	"commands.fetchprofile.summon_mannequin": "Invocar un manequin",
	"commands.fill.failed": "Cap de blòc es estat emplit",
	"commands.fill.success": "Empliment de %s blòc(s) capitat",
	"commands.fill.toobig": "Tròp de blòcs dins la zona especificada (%s al maximum, %s especificats)",
	"commands.fillbiome.no_changes": "Cap d'entrada de biòma es estada cambiada",
	...
	"commands.forceload.added.failure": "Cap de tròces marcat coma forçat a cargar",
	"commands.forceload.added.multiple": "Los %s tròces dins la dimension %s de %s a %s son ara marcats coma forçats a cargar",
	"commands.forceload.added.none": "Cap de tròç forçat a cargar trobat dins la dimension %s",
	...
	"commands.forceload.removed.all": "Totes los tròces dins la dimension %s son pas pus marcats coma forçats a cargar",
	"commands.forceload.removed.failure": "Cap de tròç retirat del cargament forçat",
	"commands.forceload.removed.multiple": "Los %s tròces dins la dimension %s de %s a %s son ara pas pus marcats coma forçats a cargar",
	"commands.forceload.removed.single": "Lo tròç %s dins la dimension %s es ara pas pus marcat coma forçat a cargar",
	...
	"commands.function.instantiationFailure": "Fracàs de l'instanciacion de la foncion \"%s\": %s",
	"commands.function.result": "La foncion \"%s\" a retornat %s",
	"commands.function.scheduled.multiple": "Execucion de las foncions \"%s\"",
	"commands.function.scheduled.no_functions": "Se pòt pas trobar una foncion amb lo nom %s",
	"commands.function.scheduled.single": "Execucion de la foncion \"%s\"",
	"commands.function.success.multiple": "Execucion de %s comanda(s) dempuèi %s foncions",
	"commands.function.success.multiple.result": "%s foncions executadas",
	"commands.function.success.single": "Execucion de %s comanda(s) dempuèi la foncion \"%s\"",
	"commands.function.success.single.result": "La foncion \"%[2]s\" a retornat %[1]s",
	...
	"commands.gamerule.not_set": "La règla de jòc %s es ja botada a: %s",
	"commands.gamerule.query": "La règla de jòc %s es botada a: %s",
	"commands.gamerule.set": "La règla de jòc %s es ara botada a: %s",
	"commands.give.failed.toomanyitems": "Se pòt pas donar mai de %s %s",
	"commands.give.success.multiple": "%s %s donat(s) a %s jogaires",
	"commands.give.success.single": "%s %s donat(s) a %s",
	"commands.help.failed": "Comanda desconeguda o permissions pas sufisentas",
	"commands.item.block.modify.success": "%s espaci(s) modificat(s) en %s, %s, %s",
	"commands.item.block.replace.success": "%s espaci(s) remplaçat(s) en %s, %s, %s",
	"commands.item.block.replace.success.known_item": "%s espaci(s) remplaçat(s) en %s, %s, %s amb %s",
	"commands.item.block.set.success": "S'es remplaçat un espaci a %s, %s, %s amb %s",
	"commands.item.entity.modify.success.multiple": "Espaci(s) modificat(s) sus %s entitats",
	"commands.item.entity.modify.success.single": "%s espaci(s) modificat(s) sus %s",
	"commands.item.entity.replace.success.multiple": "Espaci(s) remplaçat(s) sus %s entitats",
	"commands.item.entity.replace.success.multiple.known_item": "Espaci(s) remplaçat(s) sus %s entitats amb %s",
	"commands.item.entity.replace.success.single": "%s espaci(s) remplaçat(s) sus %s",
	"commands.item.entity.replace.success.single.known_item": "%s espaci(s) remplaçat(s) sus %s amb %s",
	...
	"commands.item.source.no_such_slot": "La sorsa a pas l'espaci %s",
	"commands.item.source.no_such_slot.unnamed": "La sorsa a pas aquels espacis",
	"commands.item.source.not_a_container": "La posicion sorsa en %s, %s, %s es pas un contenador",
	"commands.item.target.failed": "Cap de cibla acceptant l'objècte dins l'espaci especificat",
	"commands.item.target.failed.known_item": "Cap de cibla acceptant l'objècte %s dins l'espaci especificat",
	"commands.item.target.no_changed.known_item": "Cap de ciblas acceptant l'objècte %s dins l'espaci %s",
	"commands.item.target.no_changes": "Cap de ciblas acceptant l'objècte dins l'espaci %s",
	"commands.item.target.no_such_slot": "La cibla a pas l'espaci %s",
	"commands.item.target.no_such_slot.unnamed": "La cibla a pas aquels espacis",
	"commands.item.target.not_a_container": "La posicion ciblada en %s, %s, %s es pas un contenador",
	"commands.jfr.dump.failed": "Fracàs a l'enregistrament del perfilatge JFR: %s",
	"commands.jfr.start.failed": "Fracàs del desmarratge del perfilatge JFR",
	"commands.jfr.started": "Desmarratge del perfilatge JFR",
	"commands.jfr.stopped": "Arrèst del perfilatge JFR e enregistrament dins %s",
	"commands.kick.owner.failed": "Se pòt pas expulsar lo proprietari del sevidor d'una partida en ret local",
	"commands.kick.singleplayer.failed": "Se pòt pas expulsar un jogador d'una partida fòra de linha",
	"commands.kick.success": "%s es estat(da) expulsat(da): %s",
	"commands.kill.success.multiple": "%s entitats son estadas tuadas",
	"commands.kill.success.single": "%s es estat(da) tuat(da)",
	"commands.list.nameAndId": "%s (%s)",
	"commands.list.players": "I a %s / %s jogaires en linha: %s",
	"commands.locate.biome.not_found": "Se pòt pas trobar un biòma \"%s\" a una distància rasonabla",
	"commands.locate.biome.success": "Lo biòma \"%s\" mai prèp es situat en %s (%s blòcs de distància)",
	"commands.locate.poi.not_found": "Se pòt pas trobar un ponch d'interès \"%s\" a una distància rasonabla",
	"commands.locate.poi.success": "Lo ponch d'interès \"%s\" mai prèp es situat en %s (%s blòcs de distància)",
	...
	"commands.locate.structure.success": "L'estructura \"%s\" mai prèpa es situada en %s (%s blòcs de distància)",
	"commands.message.display.incoming": "%s vos chita: %s",
	"commands.message.display.outgoing": "Chitatz a %s: %s",
	...
	"commands.pardonip.invalid": "Adreça IP pas valida",
	"commands.pardonip.success": "L'adreça IP %s es pas mai fòrabandida",
	"commands.particle.failed": "La particula èra pas visibla per degun",
	"commands.particle.success": "Afichatge de la particula %s",
	"commands.perf.alreadyRunning": "L'analisador de performàncias es ja amodat",
	"commands.perf.notRunning": "L'analisador de performàncias es pas amodat",
	"commands.perf.reportFailed": "Fracàs de la creacion del rapòrt de debugatge",
	"commands.perf.reportSaved": "Rapòrt de debugatge creat dins %s",
	"commands.perf.started": "Desmarratge de l'analisador de performàncias pendent 10 segondas (utilizatz \"/perf stop\" pel copar)",
	"commands.perf.stopped": "Arrèst de l'analisador de performàncias après %s segonda(s) e %s cicle(s) (%s cicle(s) per segonda)",
	"commands.place.feature.failed": "Fracàs del plaçament de l'element",
	...
	"commands.place.feature.success.inline": "L'element es estat plaçat en %s, %s, %s",
	"commands.place.jigsaw.failed": "Fracàs de la generacion del copacap",
	"commands.place.jigsaw.invalid": "L'ensemble de modèl \"%s\" existís pas",
	"commands.place.jigsaw.success": "Lo copacap es estat generat en %s, %s, %s",
	"commands.place.structure.failed": "Fracàs del plaçament de l'estructura",
	...
	"commands.place.template.failed": "Fracàs del plaçament del modèl",
	...
	"commands.posteffect.add.failed": "Lo jogaire a ja l'efièch visual especificat",
	"commands.posteffect.add.success.multiple": "L'efièch visual \"%s\" es estat apondut a %s jogaires",
	"commands.posteffect.add.success.single": "L'efièch visual \"%s\" es estat apondut a %s",
	"commands.posteffect.clear.failed": "Lo jogaire a pas d'efièch visual a retirar",
	"commands.posteffect.clear.success.multiple": "Totes los efièches visuals son estats retirats de %s jogaires",
	"commands.posteffect.clear.success.single": "Totes los efièches visuals son estats retirats de %s",
	"commands.posteffect.list.empty": "Lo jogaire %s a pas cap d'efièch visual",
	"commands.posteffect.list.success": "Lo jogaire %s a %s d'efièch(es) visual(s): %s",
	"commands.posteffect.remove.failed": "Lo jogaire a pas l'efièch visual especificat",
	"commands.posteffect.remove.success.multiple": "L'efièch visual \"%s\" es estat retirat de %s jogaires",
	"commands.posteffect.remove.success.single": "L'efièch visual \"%s\" es estat retirat de %s",
	"commands.profile_fetch.copy_component": "Còpiar lo compausant",
	"commands.profile_fetch.failed_to_serialize": "Fracàs de la serialisacion del perfil : %s",
	"commands.profile_fetch.give_item": "Balhar l'objècte",
	"commands.profile_fetch.id.failure": "Fracàs de la resolucion del perfil per l'ID %s",
	"commands.profile_fetch.id.success": "Perfil resolgut per l'ID \"%s\": %s",
	"commands.profile_fetch.name.failure": "Fracàs de la resolucion del perfil pel nom %s",
	"commands.profile_fetch.name.success": "Perfil resolgut pel nom \"%s\": %s",
	"commands.publish.alreadyPublished": "Lo jòc multijogaire es ja albergat sul pòrt %s",
	"commands.publish.alreadyPublished.lan": "Lo jòc local es ja albergat sul pòrt %s",
	"commands.publish.alreadyPublished.online": "Lo jòc en linha es ja albergat",
	"commands.publish.failed": "Se pòt pas albergar lo jòc local",
	"commands.publish.started": "Jòc local albergat sul pòrt %s",
	"commands.publish.started.lan": "Jòc local albergat sul pòrt %s",
	"commands.publish.started.online": "Jòc multijogaire albergat",
	"commands.publish.success": "Lo jòc multijogaires es ara albergat sul pòrt %s",
	"commands.random.error.range_too_large": "L'interval de valors aleatòrias cal pas èsser superior a 2147483646",
	"commands.random.error.range_too_small": "L'interval de valors aleatòrias cal pas èsser inferior a 2",
	...
	"commands.recipe.give.failed": "Cap de nòvas recèptas son estadas apresas",
	...
	"commands.recipe.take.failed": "Cap de recèpta pòt èsser oblidada",
	...
	"commands.reload.failure": "Fracàs del recargament; se guardèron las donadas inicialas",
	...
	"commands.ride.not_riding": "%s es pas cavalgant cap de veïcul",
	"commands.rotate.success": "%s es estat virat(da)",
	...
	"commands.schedule.same_tick": "Se pòt pas preveire per lo cicle actual",
	"commands.scoreboard.objectives.add.duplicate": "Un objectiu amb aquel nom existís ja",
	"commands.scoreboard.objectives.add.success": "L'objectiu %s es estat creat",
	"commands.scoreboard.objectives.display.alreadyEmpty": "Res es cambiat. Aquel emplaçament d'afichatge es ja void",
	...
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Lo format numeric per deca%s es estat escafat",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Lo format numeric per deca %s a cambiat",
	"commands.scoreboard.objectives.modify.rendertype": "Lo tipe de rendut del objectiu %s es estat cambiat",
	"commands.scoreboard.objectives.remove.success": "L'objectiu %s es estat retirat",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Lo nom d'afichatge de %s entitats es estat escafat dins %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Lo nom d'afichatge de %s es estat escafat dins %s",
	...
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Lo format numeric de %s entitats es estat escafat dins %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Lo format numeric de %s es estat escafat dins %s",
	...
	"commands.scoreboard.players.enable.invalid": "\"Enable\" fonciona pas que suls objectius de tipe \"trigger\"",
	...
	"commands.setidletimeout.success": "Lo temps d'espèra abans percaça es ara a %s minuta(s)",
	"commands.setidletimeout.success.disabled": "Lo temps d'espèra abans percaça es ara desactivat",
	"commands.setworldspawn.failure.not_overworld": "Se pòt pas definir lo ponch d'aparicion del mond fòra de la susfàcia",
	"commands.setworldspawn.success": "Lo ponch d'aparicion del mond es estat definit en %s, %s, %s [%s]",
	"commands.setworldspawn.success.new": "Lo ponch d'aparicion del mond es estat definit en %s, %s, %s [%s, %s] dins la dimension %s",
	"commands.spawnpoint.success.multiple": "Lo ponch d'aparicion es estat definit en %s, %s, %s [%s] dins la dimension %s per %s jogaires",
	"commands.spawnpoint.success.multiple.new": "Lo ponch d'aparicion es estat definit en %s, %s, %s [%s, %s] dins la dimension %s per %s jogaires",
	"commands.spawnpoint.success.single": "Lo ponch d'aparicion es estat definit en %s, %s, %s [%s] dins la dimension %s per %s",
	"commands.spawnpoint.success.single.new": "Lo ponch d'aparicion es estat definit en %s, %s, %s [%s, %s] dins la dimension %s per %s",
	"commands.spectate.cannot_spectate": "Pòt pas observar %s",
	"commands.spectate.not_spectator": "%s es pas en mòde espectator",
	...
	"commands.stopwatch.already_exists": "Un cronomètre amb lo nom \"%s\" existís ja",
	"commands.stopwatch.create.success": "Lo cronomètre \"%s\" es creat",
	"commands.stopwatch.does_not_exist": "Lo cronomètre \"%s\" existís pas",
	"commands.stopwatch.query": "Lo cronomètre \"%s\" a foncionat pendent %s s",
	"commands.stopwatch.remove.success": "Lo cronomètre \"%s\" es estat suprimit",
	"commands.stopwatch.restart.success": "Lo cronomètre \"%s\" es estat tornat amodat",
	"commands.summon.failed": "Se pòt pas invocar l'entitat",
	"commands.summon.failed.peaceful": "Pòt pas invocar de mostre en pacifica",
	...
	"commands.swing.failed.notliving": "Cap d'entitat a nadar trobada",
	"commands.swing.success.multiple": "%s creaturas an bolegat lors braces",
	"commands.swing.success.single": "%s a bolegat un braç",
	...
	"commands.tag.remove.success.single": "Lo tag \"%s\" es estat retirat de %s",
	...
	"commands.team.empty.unchanged": "Res es cambiat. Aquela còla es ja voida",
	...
	"commands.team.option.color.clear.success": "La color de la còla %s es estada escafada",
	...
	"commands.team.option.seeFriendlyInvisibles.alreadyDisabled": "Res es cambiat. Aquela còla ja pòt pas veire los sieus coequipièr invisibles",
	"commands.team.option.seeFriendlyInvisibles.alreadyEnabled": "Res es cambiat. Aquela còla ja pòt veire los sieus coequipièr invisibles",
	"commands.team.option.seeFriendlyInvisibles.disabled": "La còla %s pòt pas mai veire los coequipièr invisibles",
	"commands.team.option.seeFriendlyInvisibles.enabled": "La còla %s pòt ara veire los coequipièr invisibles",
	...
	"commands.test.clear.error.no_tests": "Se pòt pas trobar un tèst a escafar",
	...
	"commands.time.no_default_clock": "I a pas de relòtge per deca dins la dimension %s",
	"commands.time.no_time_marker_found": "La marca de temps %s existís pas pel relòtge %s",
	"commands.time.pause": "Lo relòtge %s es estat arrestat",
	"commands.time.pause.already_paused": "Lo relòtge %s es ja pausat",
	"commands.time.pause.already_running": "Lo relòtge %s es ja amodat",
	"commands.time.query": "Lo temps es %s",
	"commands.time.query.absolute": "Lo relòtge %s es a %s cicle(s)",
	"commands.time.query.gametime": "Lo temps del jòc es %s cicle(s)",
	"commands.time.query.timeline": "La linha de temps %s es a %s cicle(s)",
	"commands.time.query.timeline.repetitions": "La linha de temps %s s'es repetit %s còp(s)",
	"commands.time.rate": "Lo relòtge %s ara avança a %s còps la velocitat normala",
	"commands.time.rate.already_same": "Lo relòtge %s ja avança a %s còps la velocitat normala",
	"commands.time.resume": "Lo relòtge %s es tornat amodat",
	"commands.time.set": "Temps fixat a %s",
	"commands.time.set.absolute": "Lo relòtge %s es estat reglat a %s cicle(s)",
	"commands.time.set.already_at_time": "Lo relòtge %s es ja a %s cicle(s)",
	"commands.time.set.already_at_time_marker": "Lo relòtge %s es ja a la marca de temps %s",
	"commands.time.set.time_marker": "Lo relòtge %s es estat reglat a la marca de temps %s",
	"commands.time.wrong_timeline_for_clock": "La marca de temps %s pòt pas èsser emplegada pel relòtge %s",
	"commands.title.cleared.multiple": "Los títols son estats escafats per %s jogaires",
	"commands.title.cleared.single": "Los títols son estats escafats per %s",
	...
	"commands.trigger.add.success": "%s activat (valor aumentada de %s)",
	...
	"commands.trigger.set.success": "%s activat (valor definida a %s)",
	"commands.trigger.simple.success": "%s activat",
	"commands.unpublish.notPublished": "Cap de jòc multijogaire publicat",
	"commands.unpublish.success": "Lo jòc multijogaire es pas mai publicat",
	...
	"commands.waypoint.modify.style": "L'estile de la balisa es cambiat",
	...
	"commands.whitelist.add.success": "%s es estat apondut a la lista blanca",
	...
	"commands.whitelist.reloaded": "Lista blanca tornada cargar",
	"commands.whitelist.remove.failed": "Lo jogaire es pas sus la lista blanca",
	"commands.whitelist.remove.success": "%s es pas mai dins la lista blanca",
	...
	"connect.p2p.establishing": "Establiment de la connexion...",
	"connect.p2p.failed.generic": "Pòt pas se connectar al jogaire",
	"connect.p2p.failed.signaling": "Pòt pas se connectar a l'ora d'ara.\nTornatz ensajar mai tard.",
	"connect.p2p.failed.timeout": "Demanda de connexion expirada",
	"connect.p2p.failed.unreachable": "Lo jogaire pòt pas èsser junt",
	...
	"container.beehive.honey": "Mèl : %s / %s",
	"container.blast_furnace": "Naut fornèl",
	...
	"container.upgrade": "Melhorar l'equipament",
	...
	"createWorld.customize.buffet.search": "Cercar...",
	"createWorld.customize.buffet.title": "Personalizacion del mond bufet",
	"createWorld.customize.flat.height": "Nautor",
	"createWorld.customize.flat.layer": "%s",
	"createWorld.customize.flat.layer.bottom": "Fons - %s",
	"createWorld.customize.flat.layer.top": "Susfàcia - %s",
	...
	"createWorld.customize.presets.list": "Siquenon, vaquí qualques unes qu'avèm creat per vos!",
	...
	"createWorld.customize.presets.title": "Causida del prereglatge",
	...
	"dataPack.bundle.description": "Activa l'objècte experimental \"Sac\"",
	...
	"dataPack.minecart_improvements.name": "Vagonets melhorats",
	...
	"dataPack.validation.failed": "La validacion dels paquets de donadas a pas capitat!",
	"dataPack.validation.reset": "Restablir lo paquet per defaut",
	"dataPack.validation.working": "Validacion dels paquets de donadas causits...",
	"dataPack.vanilla.description": "Las donadas per defaut de Minecraft",
	"dataPack.vanilla.name": "Per deca",
	...
	"datapackFailure.safeMode.failed.title": "Fracàs del cargament del mond en mòde sens mèuca.",
	"datapackFailure.title": "De mèucas dins los paquets de donadas causits empachan lo cargament del mond.\nPodètz siá ensajar de cargar lo mond amb solament lo paquet de donadas vanilla (\"Mòde sens fracàs \"), siá tornar al menut principal e corregir lo problèma manualament.",
	...
	"death.attack.badRespawnPoint.link": "una foncionalitat intencionala",
	"death.attack.badRespawnPoint.message": "%[1]s foguèt tuat per %[2]s",
	"death.attack.cactus": "%[1]s foguèt ponch a mòrt per un cactus",
	"death.attack.cactus.player": "%[1]s caminèt dins un cactus mentre qu'ensajava de fugir (un(a)) %[2]s",
	...
	"death.attack.drown.player": "%[1]s se neguèt mentre qu'ensajava de fugir (un(a))  %[2]s",
	"death.attack.dryout": "%[1]s es mòrt de desitratacion",
	"death.attack.dryout.player": "%[1]s es mòrt de desitratacion mentre qu'ensajava de fugir (un(a)) %[2]s",
	...
	"death.attack.explosion.player.item": "%[1]s espetèt en causa de %[2]s en emplegant %[3]s",
	"death.attack.fall": "%[1]s s'esclafèt au sòu",
	"death.attack.fall.player": "%[1]s s'esclafèt al sòl mentre qu'ensajava de fugir (un(a)) %[2]s",
	...
	"death.attack.flyIntoWall.player": "%[1]s a descobèrt l'energia cinetica mentre qu'ensajava de fugir (un(a)) %[2]s",
	"death.attack.freeze": "%[1]s es mòrt(a) de freg",
	"death.attack.freeze.player": "%[1]s es mòrt(a) de freg en causa de %[2]s",
	"death.attack.generic": "%[1]s es mòrt(a)",
	"death.attack.generic.player": "%[1]s es mòrt(a) en causa de %[2]s",
	"death.attack.genericKill": "%[1]s foguèt tuat",
	"death.attack.genericKill.player": "%[1]s foguèt tuat mentre que combatiá (un(a)) %[2]s",
	"death.attack.hotFloor": "%[1]s a descobèrt que lo sòl èra de lava",
	...
	"death.attack.indirectMagic": "%[1]s foguèt tuat per %[2]s en emplegant de magia",
	...
	"death.attack.magic.player": "%[1]s foguèt tuat amb magia mentre qu'ensajava de fugir (un(a)) %[2]s",
	"death.attack.message_too_long": "Malurosament, lo messatge es tròp long per èsser afichat completament. Vaquí una version reducha : %s",
	"death.attack.mob": "%[1]s foguèt tuat per un(a) %[2]s",
	"death.attack.mob.item": "%[1]s foguèt tuat per un(a) %[2]s en emplegant %[3]s",
	...
	"death.attack.outOfWorld": "%[1]s tombèt fòra del mond",
	"death.attack.outOfWorld.player": "%[1]s volguèt pas viure dins lo meteis mond que %[2]s",
	...
	"death.attack.sonic_boom.item": "%[1]s foguèt anientat per un udolament sonic mentre qu'ensajava de fugir (un(a)) %[2]s brandissent %[3]s",
	"death.attack.sonic_boom.player": "%[1]s foguèt anientat per un udolament sonic mentre qu'ensajave de fugir (un(a)) %[2]s",
	"death.attack.spear": "%[1]s es estat traucat per %[2]s",
	"death.attack.spear.item": "%[1]s es estat traucat per %[2]s en emplegant %[3]s",
	...
	"death.attack.sting": "%[1]s foguèt picat a mòrt",
	"death.attack.sting.item": "%[1]s foguèt picat a mòrt per %[2]s en emplegant %[3]s",
	"death.attack.sting.player": "%[1]s foguèt picat a mòrt per %[2]s",
	"death.attack.sulfurCubeHot": "%[1]s a descobèrt qu'i a pas que lo sòl qu'es en lava",
	"death.attack.sulfurCubeHot.item": "%[2]s a ensenhat a %[1]s qu'i a pas que lo sòl qu'es en lava en emplegant %[3]s",
	"death.attack.sulfurCubeHot.player": "%[2]s a ensenhat a %[1]s qu'i a pas que lo sòl qu'es en lava",
	"death.attack.sweetBerryBush": "%[1]s foguèt ponch a mòrt per un boisson de baias doças",
	"death.attack.sweetBerryBush.player": "%[1]s foguèt ponch a mòrt per un boisson de baias doças mentre qu'ensajava de fugir (un(a)) %[2]s",
	"death.attack.thorns": "%[1]s foguèt tuat mentre qu'ensajava de nafrar (un(a)) %[2]s",
	"death.attack.thorns.item": "%[1]s foguèt tuat per %[3]s  m'entre qu'ensajava de nafrar (un(a)) %[2]s",
	...
	"death.attack.witherSkull.item": "%[1]s foguèt tuat per un cran de Wither tirat per (un(a)) %[2]s en emplant %[3]s",
	"death.fell.accident.generic": "%[1]s tombèt d'un luòc naut",
	"death.fell.accident.ladder": "%[1]s tombèt d'una escala",
	"death.fell.accident.other_climbable": "%[1]s tombèt mentre qu'escalava",
	"death.fell.accident.scaffolding": "%[1]s tombèt d'un enart",
	"death.fell.accident.twisting_vines": "%[1]s tombèt de lianas torsadas",
	"death.fell.accident.vines": "%[1]s tombèt de lianas",
	"death.fell.accident.weeping_vines": "%[1]s tombèt de lianas plorosas",
	"death.fell.assist": "%[1]s foguèt condemnat a tombar per %[2]s",
	"death.fell.assist.item": "%[1]s foguèt condemnat a tombar per %[2]s en emplegant %[3]s",
	"death.fell.finish": "%[1]s se tombèt e foguèt acabat per (un(a)) %[2]s",
	"death.fell.finish.item": "%[1]s se tombèt e foguèt acabat per (un(a)) %[2]s en emplegant %[3]s",
	"death.fell.killer": "%[1]s foguèt condemnat a tombar",
	...
	"deathScreen.spectate": "Observar lo mond",
	"deathScreen.title": "Sètz mòrt(a)!",
	"deathScreen.title.hardcore": "Partida acabada!",
	"deathScreen.titleScreen": "Menut principal",
	"debug.advanced_tooltips.help": "F3 + H = Botiòlas-conselh avançadas",
	...
	"debug.crash.message": "Las tòcas F3 + C son mantengudas. Aquò va far crashèr el jòc se las daissatz pas anar.",
	"debug.crash.message.rebindable": "Las tòcas %s + %s son mantengudas. Aquò va far crashèr el jòc se las daissatz pas anar.",
	"debug.crash.warning": "Crash del jòc dins %s...",
	"debug.creative_spectator.error": "Avètz pas la permission de cambiar de mòde de jòc",
	"debug.creative_spectator.help": "F3 + N = Alternar mòde de jòc precedent <-> espectator",
	...
	"debug.entry.always": "Totjorn",
	"debug.entry.currently.alwaysOn": "%s : ara totjorn vesedor",
	"debug.entry.currently.inF3": "%s : ara pas que dins F3",
	"debug.entry.currently.inOverlay": "%s : ara pas que dins la superposicion de debugatge",
	"debug.entry.currently.never": "%s : ara amagat",
	"debug.entry.f3": "Dins F3",
	"debug.entry.overlay": "Superposicion",
	...
	"debug.improvedTransparency.off": "Lindetat melhorada : desactivada",
	"debug.improvedTransparency.on": "Lindetat melhorada : activada",
	...
	"debug.options.category.renderer": "Motor de rendut de debugatge",
	"debug.options.category.text": "Tèxt del ecran de debugatge",
	"debug.options.help": "F3 + F6 = Cambiar los paramètres de debugatge",
	"debug.options.notAllowed.tooltip": "Pas visible quand las informacions de debugatge son reduchas",
	"debug.options.profile.default": "Perfil per deca",
	"debug.options.profile.performance": "Perfil de performanças",
	"debug.options.search": "Cercar...",
	"debug.options.title": "Opcions de debugatge",
	"debug.options.warning": "Aquels paramètres son prepausats per far de tèsts. Pòdon ralentir l'ordinator, far crashèr lo jòc, o panar lo vespralh.",
	...
	"debug.profiling.start.rebindable": "Desmarratge del perfilatge pendent %s segondas. Utilizatz %s + %s per copar",
	...
	"demo.day.1": "Aquesta demonstracion durarà cinc jorns dins lo jòc. Fasètz çò melhor que podètz!",
	...
	"demo.help.fullWrapped": "Aquesta demostracion durarà cinc jorns dins lo jòc (apr'aquí 1 ora e 40 minutas realas). Agachatz los progrèsses per vos ajudar! Bon jòc!",
	...
	"disconnect.exceeded_packet_rate": "Expulsat(da) per aver despassat lo limit de debit de paquets",
	"disconnect.genericReason": "%s",
	"disconnect.ignoring_status_request": "Requèsta d'estatut ignorada",
	"disconnect.loginFailedInfo": "Mèuca de la connexion : %s",
	"disconnect.loginFailedInfo.insufficientPrivileges": "Lo mòde multijogaires es desactivat. Se vos plai, verificatz los paramètres del vòstre compte Microsoft.",
	"disconnect.loginFailedInfo.invalidSession": "Session pas valida (Ensajatz de tornar amodar vòstre jòc e lo lançador)",
	"disconnect.loginFailedInfo.serversUnavailable": "Lo servici d'autentificacion es pas accessible a l'ora d'ara. Se vos plai, tornatz ensajar.",
	"disconnect.loginFailedInfo.userBanned": "Sètz fòrabandit(ida) del jòc en linha",
	...
	"download.pack.failed": "Fracàs del telecargament de %s paquet(s) sus %s",
	"download.pack.progress.bytes": "Progression : %s (Talha totala desconeguda)",
	"download.pack.progress.percent": "Progression : %s %%",
	"download.pack.title": "Telecargament del paquet de ressorsa %s/%s",
	"editGamerule.default": "Per defaut: %s",
	"editGamerule.inGame.button": "Modificar las règlas del jòc...",
	"editGamerule.inGame.disabled.hardcore.tooltip": "Pòt pas cambiar las règlas del jòc dins un mond extrèm.",
	"editGamerule.inGame.disabled.tooltip": "Avètz besonh de las permissions d'operator per metre a jorn las règlas del jòc.",
	"editGamerule.inGame.discardChanges.message": "Sètz segur de voler abandonar lo cambiament de las règlas de jòcs?",
	"editGamerule.inGame.discardChanges.title": "Cambiament de las règlas del jòc",
	"editGamerule.inGame.downloadingGamerules": "Recuperant las règlas del jòc...",
	"editGamerule.title": "Modificar las règlas dau juòc",
	"effect.duration.infinite": "∞",
	"effect.minecraft.absorption": "Absorpcion",
	"effect.minecraft.bad_omen": "Marrit signe",
	"effect.minecraft.blindness": "Cecitat",
	"effect.minecraft.breath_of_the_nautilus": "Respiracion del nautile",
	...
	"effect.minecraft.fire_resistance": "Resisténcia al fuòc",
	...
	"effect.minecraft.infested": "Infestacion",
	...
	"effect.minecraft.weaving": "Teisseire",
	...
	"enchantment.minecraft.fire_protection": "Resisténcia al fuòc",
	...
	"enchantment.minecraft.lunge": "Aviada",
	...
	"enchantment.minecraft.soul_speed": "Velocitat de las anmas",
	...
	"entity.minecraft.acacia_boat": "Batèl en cacièr",
	"entity.minecraft.acacia_chest_boat": "Batèl en cacièr amb còfre",
	"entity.minecraft.allay": "Allay",
	"entity.minecraft.area_effect_cloud": "Nívol d'efièch persistant",
	...
	"entity.minecraft.bamboo_chest_raft": "Radèl en bambó amb còfre",
	"entity.minecraft.bamboo_raft": "Radèl en bambó",
	"entity.minecraft.bat": "Ratapenada",
	"entity.minecraft.bee": "Abelha",
	"entity.minecraft.birch_boat": "Batèl en bèç",
	"entity.minecraft.birch_chest_boat": "Batèl en bèç amb còfre",
	"entity.minecraft.blaze": "Blaze",
	"entity.minecraft.block_display": "Visual de bloc",
	"entity.minecraft.boat": "Batèl",
	...
	"entity.minecraft.camel_husk": "Dromadari momificat",
	"entity.minecraft.cat": "Cat",
	"entity.minecraft.cave_spider": "Aranha de bauma",
	"entity.minecraft.cherry_boat": "Batèl en cerièis",
	"entity.minecraft.cherry_chest_boat": "Batèl en cerièis amb còfre",
	"entity.minecraft.chest_boat": "Batèl amb còfre",
	...
	"entity.minecraft.copper_golem": "Golem de coire",
	"entity.minecraft.cow": "Vaca",
	"entity.minecraft.creaking": "Cruisseire",
	"entity.minecraft.creaking_transient": "Cruisseire",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.cushion": "Coissin",
	"entity.minecraft.dark_oak_boat": "Batèl en euse escur",
	"entity.minecraft.dark_oak_chest_boat": "Batèl en euse escur amb còfre",
	...
	"entity.minecraft.jungle_boat": "Batèl de jungla",
	"entity.minecraft.jungle_chest_boat": "Batèl de jungla amb còfre",
	"entity.minecraft.killer_bunny": "Conilh Tuaire",
	"entity.minecraft.leash_knot": "Nos d'estaca",
	...
	"entity.minecraft.mangrove_boat": "Batèl en manglièr",
	"entity.minecraft.mangrove_chest_boat": "Batèl en manglièr amb còfre",
	"entity.minecraft.mannequin": "Manequin",
	...
	"entity.minecraft.oak_boat": "Batèl en euse",
	"entity.minecraft.oak_chest_boat": "Batèl en euse amb còfre",
	...
	"entity.minecraft.pale_oak_boat": "Batèl en euse palle",
	"entity.minecraft.pale_oak_chest_boat": "Batèl en euse palle amb còfre",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Assecat",
	...
	"entity.minecraft.poplar_boat": "Batèl en pibol",
	"entity.minecraft.poplar_chest_boat": "Batèl en pibol amb còfre",
	...
	"entity.minecraft.skeleton_horse": "Caval esqueleta",
	...
	"entity.minecraft.spruce_boat": "Batèl en avet",
	"entity.minecraft.spruce_chest_boat": "Batèl en avet amb còfre",
	"entity.minecraft.squid": "Tautena",
	"entity.minecraft.stray": "Barrutlaire",
	"entity.minecraft.strider": "Arpentaire",
	"entity.minecraft.sulfur_cube": "Cube de solpre",
	"entity.minecraft.sulfur_cube.content": "Conten: %s",
	"entity.minecraft.tadpole": "Capgròs",
	"entity.minecraft.text_display": "Visual de tèxt",
	"entity.minecraft.tnt": "TNT amorsada",
	"entity.minecraft.tnt_minecart": "Vagonet amb de TNT",
	"entity.minecraft.trader_llama": "Lama de mercant",
	"entity.minecraft.trident": "Trident",
	"entity.minecraft.tropical_fish": "Peis tropical",
	...
	"entity.minecraft.tropical_fish.predefined.11": "Peis parpalhon ornat",
	...
	"entity.minecraft.tropical_fish.predefined.3": "Peis parpalhon",
	...
	"entity.minecraft.tropical_fish.predefined.9": "Mulid",
	...
	"entity.minecraft.tropical_fish.type.dasher": "Ronçaire",
	...
	"entity.minecraft.zombie_horse": "Caval zòmbi",
	"entity.minecraft.zombie_nautilus": "Nautile zòmbi",
	...
	"filled_map.bamboo_camp_map": "Mapa del camp de bambó",
	"filled_map.bamboo_jungle_abandoned_camp": "Mapa del camp abandonat de la jungla de bambó",
	"filled_map.birch_forest_abandoned_camp": "Mapa del camp abandonat del bòsc de bèç",
	"filled_map.birch_forest_camp_map": "Mapa del camp del bòsc de bèç",
	"filled_map.buried_treasure": "Mapa del tresaur enterrat",
	"filled_map.cherry_grove_abandoned_camp": "Mapa del camp abandonat del bòsque de cerièr",
	"filled_map.cherry_grove_camp_map": "Mapa del camp del bòsque de cerièr",
	"filled_map.dappled_forest_abandoned_camp": "Mapa del camp abandonat del bòsc moscalhat",
	"filled_map.dappled_forest_camp_map": "Mapa del camp del bòsc moscalhat",
	"filled_map.explorer_jungle": "Mapa d'exploracion de las junglas",
	"filled_map.explorer_swamp": "Mapa d'exploracion dels paluns",
	"filled_map.flower_forest_abandoned_camp": "Mapa del camp abandonat del bòsc de flors",
	"filled_map.flower_forest_camp_map": "Mapa del camp del bòsc de flors",
	"filled_map.id": "ID #%s",
	"filled_map.jungle_temple": "Mapa del temple de la jungla",
	...
	"filled_map.pale_garden_abandoned_camp": "Mapa del camp abandonat del jardin palle",
	"filled_map.pale_garden_camp_map": "Mapa del camp del jardin palle",
	"filled_map.scale": "Escala 1 :%s",
	"filled_map.swamp_abandoned_camp": "Mapa del camp abandonat del palun",
	"filled_map.swamp_camp_map": "Mapa del camp del palun",
	...
	"filled_map.windswept_forest_abandoned_camp": "Mapa del camp abandonat del bòsc ventós",
	"filled_map.windswept_forest_camp_map": "Mapa del camp del bòsc ventós",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Autorizar lo Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Contraròtla se los jogaires pòdon anar dins lo Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Actualizacion del fuòc luènh dels jogaires",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Contraròtla se lo fuòc e la lava pòdon s'actualizar a mai de 8 tròces de quin jogaire que siá.",
	...
	"gamerule.commandBlocksEnabled": "Blòcs de comandas activats",
	"gamerule.commandModificationBlockLimit": "Limit de blòcs modificables per comanda",
	...
	"gamerule.doEntityDrops.description": "Contraròtla los butins dels vagonets (Lo lor inventari enclaus), dels quadres, dels batèus, etc.",
	...
	"gamerule.doMobLoot.description": "Contraròtla los butin de las creaturas, òrbes d'experiéncia enclausa.",
	...
	"gamerule.doTileDrops.description": "Contraròtla los butin dels blòcs, òrbes d'experiéncia enclausa.",
	"gamerule.doTraderSpawning": "Generar de mercants ambulants",
	"gamerule.doVinesSpread": "Propagacion de las lianas",
	"gamerule.doVinesSpread.description": "Contraròtla la propagacion aleatòria de las lianas suls blòcs vesins. Afecta pas los autes tipes de lianas tal que las lianas plorosas, las lianas torsadas, etc.",
	...
	"gamerule.enableCommandBlocks": "Blòcs de comandas activats",
	"gamerule.enderPearlsVanishOnDeath": "Disparicion de las pèrlas d'Ender lançadas a la mòrt",
	"gamerule.enderPearlsVanishOnDeath.description": "Contraròtla se las pèrlas d'Ender lançadas per un jogaire desapareisson quand aqueste morís.",
	...
	"gamerule.maxCommandChainLength": "Limit de cadenas de comandas",
	"gamerule.maxCommandChainLength.description": "S'aplica als blòcs de comandas en cadena e a las foncions.",
	"gamerule.maxCommandForkCount": "Limit de contèxts de las comandas",
	...
	"gamerule.maxEntityCramming": "Limit d'amolonament de las entitats",
	"gamerule.minecartMaxSpeed": "Velocitat maximala dels vagonets",
	"gamerule.minecartMaxSpeed.description": "La velocitat maximala per deca de vagonets en movement sul sòl.",
	"gamerule.minecraft.elytra_movement_check": "Verificacion del vòl en elitras",
	"gamerule.minecraft.fire_spread_radius_around_player": "Rai de propagacion del fuòc",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "La rai (en blòc) al entorn d'un jogaire ont lo fuòc se pòt propagar",
	"gamerule.minecraft.player_movement_check": "Verificacion del movement del jogaire",
	"gamerule.minecraft.raids": "Invasions",
	"gamerule.minecraft.universal_anger.description": "Las creaturas neutras encoleradas atacan tots los jogaires a proximitat, pas solament lo jogaire que l'an encoleradas. Fonciona melhor quand la règla \"forgive_dead_players\" es desactivada.",
	...
	"gamerule.projectilesCanBreakBlocks.description": "Contraròtla se los projectils copan los blòcs copables per aqueste al impacte.",
	"gamerule.pvp": "Activar JcJ (PvP)",
	"gamerule.pvp.description": "Contraròtla se los jogaires pòdon nafrar los autres jogaires.",
	...
	"gamerule.spawnMonsters": "Generar los mostres",
	"gamerule.spawnMonsters.description": "Contraròtla se los mostres pòdon aparéisser naturalament.",
	"gamerule.spawnRadius": "Rai de la zòna de reaparicion",
	"gamerule.spawnRadius.description": "Contraròtla la talha de la zòna dins la quina los jogaires pòdon reapareisser.",
	"gamerule.spawnerBlocksEnabled": "Generators activats",
	...
	"generator.minecraft.flat_all_dimensions": "Mond planièr (totas las dimensions)",
	...
	"gui.abuseReport.discard.draft": "Sauvagardar un brolhon",
	...
	"gui.abuseReport.more_comments": "Se vos plai, descrivètz çò que s'es passat :",
	...
	"gui.abuseReport.observed_what": "Perqué senhalatz aquò?",
	...
	"gui.abuseReport.send.service_unavailable": "Se pòt pas dintrar en contact amb lo servici de senhalaments dels abuses. Se vos plai, acertatz-vos d'èsser conectat(da) a Internet e tornatz ensajar.",
	...
	"gui.banned.skin.description": "La vòstra aparéncia enfranh nòstres Estandards de la comunautat. Podètz encara jogar amb una aparéncia per deca, o ne causir una autra.\n\nPer ne saber mai o per demandar-nos de tornar examinar lo vòstre cas, consultatz lo ligam seguent : %s",
	...
	"gui.chatReport.discard.draft": "Sauvagardar un brolhon",
	...
	"gui.chatReport.more_comments": "Se vos plai, descrivètz çò que s'es passat :",
	"gui.chatReport.observed_what": "Perqué senhalatz aquò?",
	...
	"gui.chatSelection.join": "%s a rejonch lo chat",
	...
	"gui.fileDropFailure.title": "Fracàs de l'apondi dels fichièrs",
	"gui.friends.accept": "Acceptar",
	"gui.friends.button.loading": "Esperar...",
	"gui.friends.button.loading.invite_request_pending": "En espèra de confirmacion",
	"gui.friends.button.loading.join_request_pending": "En espèra de confirmacion",
	"gui.friends.cancel_request": "Anullar la demanda",
	"gui.friends.confirm_title": "Confirmar",
	"gui.friends.confirm_unfriend": "Sètz segur que volètz levar aqueste jogaire de la vòstra lista d'amics?",
	"gui.friends.copy_to_clipboard": "Copiar dins lo cachapapièrs",
	"gui.friends.decline": "Refusar",
	"gui.friends.empty_nickname": "Entratz un nom de perfil valid abans de mandar una demanda d'amistat",
	"gui.friends.empty_state": "Los amics aponduts van èsser listats aicí.\n\nAdministratz vòstra seguretat en linha amb vòstra %s.",
	"gui.friends.empty_state.link": "Compte Microsoft",
	"gui.friends.enter_nickname": "Entratz un nom de perfil",
	"gui.friends.error.connection_issue": "La lista d'amics fonciona pas a l'ora d'ara.\n\nVerificatz vòstra connexion internet e tornatz ensajar.",
	"gui.friends.error.failed.message": "Pòt pas mandar la demanda d'amistat a l'ora d'ara",
	"gui.friends.error.forbidden.message": "L'accion a pas capitat. Aquò pòt venir dels paramètres de confidencialitat del compte.",
	"gui.friends.error.generic": "Quicòm va mal... amb la foncionalitat, pas amb vòstres amics!\n\nTornatz ensajar mai tard.",
	"gui.friends.error.rateLimited.message": "Anatz tròp viste amb la vòstra lista d'amics! Esparatz un pauc e tornatz ensajar.",
	"gui.friends.error.temporary_unavailable": "La lista d'amics fonciona pas a l'ora d'ara.\n\nTornatz ensajar mai tard.",
	"gui.friends.error.unauthorized": "Geton pas valid, tornatz amodar vòstre jòc e lo lançador e tornatz ensajar",
	"gui.friends.error.unavailable.message": "Lo servici de lista d'amics es pas disponible a l'ora d'ara. Verificatz vòstre connexion e tornatz ensajar.",
	"gui.friends.error.upgrade_needed": "Metètz vòstre jòc a jorn per accedir a la vòstra lista d'amics.",
	"gui.friends.error.user_may_lack_active_profile": "I a pas cap de jogaire amb aquel nom de perfil",
	"gui.friends.join": "Rejónher",
	"gui.friends.loading_friends": "Cargament de la lista d'amics...",
	"gui.friends.loading_requests": "Cargament de las demandas...",
	"gui.friends.manage_account_footer": "Administratz vòstra seguretat en linha amb vòstra %s",
	"gui.friends.multiplayer.invite": "Convidar",
	"gui.friends.multiplayer.invite_accept": "Acceptar",
	"gui.friends.multiplayer.invite_reject": "Refusar",
	"gui.friends.multiplayer.join_request": "Demandar a rejónher",
	"gui.friends.multiplayer.join_request_accept": "Acceptar",
	"gui.friends.multiplayer.join_request_reject": "Refusar",
	"gui.friends.my_profile_name": "Lo nom del mieu perfil : ",
	"gui.friends.my_profile_name.narration": "Copiar lo nom del perfil %s dins lo cachapapièrs",
	"gui.friends.narration.button.accept": "Picatz Entrar per acceptar la demanda d'amistat de %s",
	"gui.friends.narration.button.cancel_request": "Picatz Entrar per anular la demanda d'amistat de %s",
	"gui.friends.narration.button.decline": "Picatz Entrar per refusar la demanda d'amistat de %s",
	"gui.friends.narration.button.unfriend": "Picatz Entrar per levar %s de la vòstra lista d'amics",
	"gui.friends.narration.entry.friend": "Amic %s",
	"gui.friends.narration.entry.incoming": "Demanda d'amistat recebuda de %s",
	"gui.friends.narration.entry.outgoing": "Demanda d'amistat mandada a %s",
	"gui.friends.open": "Amics",
	"gui.friends.open.narration": "Lista d'amics",
	"gui.friends.open.tooltip": "Amics",
	"gui.friends.pending.empty": "Cap de demanda d'amistat en espèra",
	"gui.friends.pending.received": "Recebudas",
	"gui.friends.pending.sent": "Mandadas",
	"gui.friends.presence.status.offline": "Fòra de linha",
	"gui.friends.presence.status.online": "En linha",
	"gui.friends.presence.status.playing_hosted_server": "En linha (LAN)",
	"gui.friends.presence.status.playing_offline": "En linha (mond)",
	"gui.friends.presence.status.playing_realms": "En linha (Realm)",
	"gui.friends.presence.status.playing_server": "En linha (servidor)",
	"gui.friends.requests_count": "Demandas (%s)",
	"gui.friends.send_request": "Mandar una demanda d'amistat",
	"gui.friends.tab_friends": "Amics",
	"gui.friends.toast.friend_added.message": "%s a acceptat vòstra demanda d'amistat",
	"gui.friends.toast.friend_invited.message": "Avètz convidat %s a rejónher vòstre mond.",
	"gui.friends.toast.friend_removed.message": "Avètz levat %s de la vòstra lista d'amics",
	"gui.friends.toast.generic_error": "Una mèuca inesperada se produsís en ensajant de metre a jorn la vòstra lista d'amics. Se vos plai, tornatz ensajar mai tard.",
	"gui.friends.toast.host_invite_expired.message": "L'invitacion a rejónher aquel mond, mandada per %s, a expirat.",
	"gui.friends.toast.invite_from_friend.message": "%s vos a invitat a rejónher lo sieu mond. Dobrissètz vòstra lista d'amics amb \"%s\" per rejónher.",
	"gui.friends.toast.join_invite_expired.message": "L'invitacion a rejónher lo mond de %s a expirat.",
	"gui.friends.toast.join_request.message": "%s vòl rejónher lo vòstre mond. Dobrissètz la lista d'amics amb \"%s\" o dempuèi lo menut del jòc.",
	"gui.friends.toast.request_accepted.message": "D'ara enlà, sètz amic amb %s",
	"gui.friends.toast.request_received.message": "%s vos a mandat una demanda d'amistat",
	"gui.friends.toast.request_sent.message": "Demanda d'amistat mandada a %s",
	"gui.friends.toast.request_to_join_friend.message": "Avètz demandat a rejónher lo mond de %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s jogaires an acceptat vòstras demandas d'amistat",
	"gui.friends.toast.requests_received_multiple.message": "Avètz recebut %s demanda d'amistat",
	"gui.friends.unfriend": "Levar l'amic",
	"gui.friends.validation.already_friend": "Sètz ja amic amb %s",
	"gui.friends.validation.already_incoming": "%s vos a ja mandat una demanda d'amistat",
	"gui.friends.validation.already_outgoing": "Avètz ja mandat una demanda d'amistat a %s",
	"gui.friends.validation.cannot_add_self": "Podètz pas vos mandar una demanda d'amistat",
	"gui.game_rule.search": "Cercar...",
	"gui.hours": "%s òra(s)",
	"gui.language.search": "Cercar...",
	...
	"gui.packSelection.search": "Cercar...",
	"gui.privacy_link.message": "Dobrissètz aquel ligam per administrar vòstres paramètres de confidencialitat e de seguretat en linha.",
	"gui.privacy_link.title": "Los cambiaments dels paramètres Xbox pòdon prene de temps per s'aplicar.\n\nSe s'aplican pas, tornatz amodar lo vòstre jòc.",
	"gui.proceed": "Contunhar",
	"gui.recipebook.moreRecipes": "Clic drech per mai",
	"gui.recipebook.next_page": "Pagina seguenta",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Pagina precedenta",
	...
	"gui.selectWorld.search": "Cercar...",
	"gui.socialInteractions.blocking_hint": "Administrar amb lo compte Microsoft",
	"gui.socialInteractions.empty_blocked": "Cap de jogaire blocat dins lo chat",
	...
	"gui.socialInteractions.search_empty": "Impossible de trobar de jogaires amb aquel nom",
	...
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Aquel jogaire pòt pas èsser senhalat, pr'amor lo chat es desactivat o blocat",
	"gui.socialInteractions.tooltip.report.disabled": "Lo servici de senhalament es pas disponible",
	"gui.socialInteractions.tooltip.report.no_messages": "Cap de messatge del jogaire %s a senhalar",
	...
	"gui.stats.none_found": "Cap d'estatisticas trobadas.",
	...
	"instrument.minecraft.seek_goat_horn": "Quèrre",
	...
	"inventory.hotbarSaved": "Barra rapida sauvagardada (restauratz-lo amb %[1]s + %[2]s)",
	...
	"item.minecraft.abandoned_camp_map": "Mapa del camp abandonat",
	"item.minecraft.abandoned_campsite_map": "Mapa del camp",
	"item.minecraft.acacia_boat": "Batèl en cacièr",
	"item.minecraft.acacia_chest_boat": "Batèl en cacièr amb còfre",
	"item.minecraft.allay_spawn_egg": "Uòu d'aparicion d'allay",
	"item.minecraft.amethyst_shard": "Fragment d'ametista",
	"item.minecraft.ancient_city_map": "Mapa de la ciutat anciana",
	...
	"item.minecraft.arms_up_pottery_shard": "Tèst de terralha de braces alçats",
	"item.minecraft.arms_up_pottery_sherd": "Tèst de terralha de braces alçats",
	...
	"item.minecraft.bamboo_chest_raft": "Radèl en bambó amb còfre",
	"item.minecraft.bamboo_raft": "Radèl en bambó",
	...
	"item.minecraft.birch_chest_boat": "Batèl en bèç amb còfre",
	"item.minecraft.black_bundle": "Sac negre",
	"item.minecraft.black_cushion": "Coissin negre",
	...
	"item.minecraft.blue_cushion": "Coissin blau",
	...
	"item.minecraft.brown_cushion": "Coissin brun",
	...
	"item.minecraft.bundle.empty": "Void",
	"item.minecraft.bundle.empty.description": "Pòt conténer una pila de mai d'un objècte",
	"item.minecraft.bundle.full": "Plen",
	"item.minecraft.bundle.fullness": "%s/%s",
	"item.minecraft.buried_ancient_city_map": "Mapa de la ciutat anciana sosterranha",
	"item.minecraft.buried_mineshaft_map": "Mapa de la mina abandonada sosterranha",
	"item.minecraft.buried_treasure_map": "Mapa del tresaur enterrat",
	"item.minecraft.buried_trial_chambers_map": "Mapa de la cambra de las espròvas sosterranha",
	"item.minecraft.burn_pottery_shard": "Tèst de terralha de fuòc",
	"item.minecraft.burn_pottery_sherd": "Tèst de terralha de fuòc",
	"item.minecraft.camel_husk_spawn_egg": "Uòu d'aparicion de dromadari momificat",
	...
	"item.minecraft.cherry_boat": "Batèl en cerièis",
	"item.minecraft.cherry_chest_boat": "Batèl en cerièis amb còfre",
	...
	"item.minecraft.command_block_minecart": "Vagonet amb blòc de comanda",
	...
	"item.minecraft.copper_axe": "Pigassa en coire",
	"item.minecraft.copper_boots": "Bòtas en coire",
	"item.minecraft.copper_chestplate": "Plastron en coire",
	"item.minecraft.copper_golem_spawn_egg": "Uòu d'aparicion de golem de coire",
	"item.minecraft.copper_helmet": "Casco en coire",
	"item.minecraft.copper_hoe": "Bigòs en coire",
	"item.minecraft.copper_horse_armor": "Armadura en coire per caval",
	"item.minecraft.copper_ingot": "Lingòt de coire",
	"item.minecraft.copper_leggings": "Cambièras en coire",
	"item.minecraft.copper_nautilus_armor": "Armadura en coire per nautile",
	"item.minecraft.copper_nugget": "Bocinet de coire",
	"item.minecraft.copper_pickaxe": "Trenca en coire",
	"item.minecraft.copper_shovel": "Pala en coire",
	"item.minecraft.copper_spear": "Lança en coire",
	"item.minecraft.copper_sword": "Espasa en coire",
	...
	"item.minecraft.cyan_cushion": "Coissin cian",
	...
	"item.minecraft.dark_oak_chest_boat": "Batèl en euse escur amb còfre",
	"item.minecraft.debug_stick": "Baston de desbogatge",
	"item.minecraft.debug_stick.empty": "%s a pas cap de proprietat",
	"item.minecraft.debug_stick.select": "\"%s\" seleccionat (%s)",
	"item.minecraft.debug_stick.update": "\"%s\" a %s",
	"item.minecraft.desert_pyramid_map": "Mapa de la piramida del desèrt",
	"item.minecraft.desert_village_map": "Mapa d'exploracion de vilatge del desèrt",
	...
	"item.minecraft.diamond_nautilus_armor": "Armadura en diamant per nautile",
	"item.minecraft.diamond_pickaxe": "Trenca en diamant",
	"item.minecraft.diamond_shovel": "Pala en diamant",
	"item.minecraft.diamond_spear": "Lança en diamant",
	...
	"item.minecraft.firework_rocket.flight_duration": "Temps de vòl: %s",
	...
	"item.minecraft.glistering_melon_slice": "Talhon de pastèca daurat",
	...
	"item.minecraft.glow_berries": "Baias lusentas",
	...
	"item.minecraft.goat_horn": "Còrna de cabra",
	...
	"item.minecraft.iron_nautilus_armor": "Armadura en fèrre per nautile",
	...
	"item.minecraft.iron_spear": "Lança en fèrre",
	"item.minecraft.iron_sword": "Espasa en fèrre",
	"item.minecraft.item_frame": "Quadre",
	"item.minecraft.jungle_boat": "Batèl de jungla",
	"item.minecraft.jungle_chest_boat": "Batèl de jungla amb còfre",
	"item.minecraft.jungle_explorer_map": "Mapa d'exploracion de la piramida de la jungla",
	"item.minecraft.jungle_pyramid_map": "Mapa de la piramida de la jungla",
	"item.minecraft.knowledge_book": "Libre de las coneissenças",
	"item.minecraft.lapis_lazuli": "Lapislazuli",
	"item.minecraft.lava_bucket": "Ferrat de lava",
	"item.minecraft.lead": "Estaca",
	...
	"item.minecraft.light_blue_cushion": "Coissin blau clar",
	...
	"item.minecraft.light_gray_cushion": "Coissin gris clar",
	...
	"item.minecraft.lime_cushion": "Coissin lima",
	"item.minecraft.lime_dye": "Tencha lima",
	"item.minecraft.lime_harness": "Arnesc lima",
	...
	"item.minecraft.lingering_potion.effect.empty": "Pocion persistenta non fabricabla",
	"item.minecraft.lingering_potion.effect.fire_resistance": "Pocion de resisténcia al fuòc persistenta",
	...
	"item.minecraft.lingering_potion.effect.infested": "Pocion d'infestacion persistenta",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Pocion de viscositat persistenta",
	...
	"item.minecraft.lingering_potion.effect.turtle_master": "Pocion del mèstre tartuga persistenta",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Pocion de teisseire persistenta",
	"item.minecraft.lingering_potion.effect.wind_charged": "Pocion de buf persistenta",
	...
	"item.minecraft.magenta_cushion": "Coissin magenta",
	...
	"item.minecraft.mangrove_boat": "Batèl en manglièr",
	"item.minecraft.mangrove_chest_boat": "Batèl en manglièr amb còfre",
	...
	"item.minecraft.mineshaft_map": "Mapa de la mina abandonada",
	"item.minecraft.mojang_banner_pattern": "Motiu de bandièra",
	"item.minecraft.mojang_banner_pattern.desc": "Emblèma",
	"item.minecraft.mojang_banner_pattern.new": "Motiu d'emblèma per bandièra",
	"item.minecraft.mooshroom_spawn_egg": "Uòu d'aparicion de mooshroom",
	...
	"item.minecraft.mushroom_stew": "Sopa de camparòls",
	...
	"item.minecraft.music_disc_bounce": "Disc de musica",
	...
	"item.minecraft.music_disc_creator": "Disc de musica",
	"item.minecraft.music_disc_creator.desc": "Lena Raine - Creator",
	"item.minecraft.music_disc_creator_music_box": "Disc de musica",
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (caissa de musica)",
	...
	"item.minecraft.music_disc_precipice": "Disc de musica",
	...
	"item.minecraft.nautilus_spawn_egg": "Uòu d'aparicion de nautile",
	...
	"item.minecraft.netherite_horse_armor": "Armadura en netherita per caval",
	"item.minecraft.netherite_ingot": "Lingòt de netherita",
	"item.minecraft.netherite_leggings": "Cambièras en netherita",
	"item.minecraft.netherite_nautilus_armor": "Armadura en netherita per nautile",
	...
	"item.minecraft.netherite_spear": "Lança en netherita",
	...
	"item.minecraft.oak_chest_boat": "Batèl en euse amb còfre",
	"item.minecraft.ocean_explorer_map": "Mapa d'exploracion dels monuments de l'ocean",
	"item.minecraft.ocean_monument_map": "Mapa del monument oceanic",
	"item.minecraft.ocelot_spawn_egg": "Uòu d'aparcion d'ocelòt",
	"item.minecraft.ominous_bottle": "Fiòla funèsta",
	"item.minecraft.ominous_trial_key": "Clau de las espròvas funèsta",
	"item.minecraft.orange_bundle": "Sac irange",
	"item.minecraft.orange_cushion": "Coissin irange",
	"item.minecraft.orange_dye": "Tencha iranja",
	"item.minecraft.orange_harness": "Arnesc irange",
	"item.minecraft.painting": "Pintura",
	"item.minecraft.pale_oak_boat": "Batèl en euse palle",
	"item.minecraft.pale_oak_chest_boat": "Batèl en euse palle amb còfre",
	"item.minecraft.panda_spawn_egg": "Uòu d'aparicion de panda",
	"item.minecraft.paper": "Papièr",
	"item.minecraft.parched_spawn_egg": "Uòu d'aparicion d'assecat",
	...
	"item.minecraft.pink_cushion": "Coissin ròse",
	...
	"item.minecraft.plains_village_map": "Mapa d'exploracion de vilatge de las planas",
	...
	"item.minecraft.poplar_boat": "Batèl en pibol",
	"item.minecraft.poplar_chest_boat": "Batèl en pibol amb còfre",
	...
	"item.minecraft.potion.effect.infested": "Pocion d'infestacion",
	...
	"item.minecraft.potion.effect.turtle_master": "Pocion del mèstre tartuga",
	...
	"item.minecraft.pottery_shard_arms_up": "Tèst de terralha de braces alçats",
	...
	"item.minecraft.purple_cushion": "Coissin violet",
	...
	"item.minecraft.red_cushion": "Coissin roge",
	...
	"item.minecraft.savanna_village_map": "Mapa d'exploracion de vilatge de la savana",
	"item.minecraft.scrape_pottery_sherd": "Tèst de terralha de pigassa",
	...
	"item.minecraft.skeleton_horse_spawn_egg": "Uòu d'aparicion de caval esqueleta",
	...
	"item.minecraft.smithing_template.armor_trim.additions_slot_description": "Apondètz un lingòt o un cristal",
	...
	"item.minecraft.smithing_template.armor_trim.ingredients": "Lingòts e cristals",
	...
	"item.minecraft.snowy_village_map": "Mapa d'exploracion de vilatge ennevat",
	...
	"item.minecraft.splash_potion.effect.awkward": "Pocion estranha getabla",
	...
	"item.minecraft.splash_potion.effect.infested": "Pocion d'infestacion getabla",
	...
	"item.minecraft.splash_potion.effect.oozing": "Pocion de viscositat getabla",
	...
	"item.minecraft.splash_potion.effect.thick": "Pocion espessa getabla",
	"item.minecraft.splash_potion.effect.turtle_master": "Pocion del mèstre tartuga getabla",
	"item.minecraft.splash_potion.effect.water": "Fiòla d'aiga getabla",
	...
	"item.minecraft.splash_potion.effect.weaving": "Pocion de teisseire getabla",
	"item.minecraft.splash_potion.effect.wind_charged": "Pocion de buf getabla",
	"item.minecraft.spruce_boat": "Batèl en avet",
	"item.minecraft.spruce_chest_boat": "Batèl en avet amb còfre",
	...
	"item.minecraft.stone_spear": "Lança en pèira",
	"item.minecraft.stone_sword": "Espasa en pèira",
	"item.minecraft.straw_bed": "Lièch de palha",
	...
	"item.minecraft.sulfur_cube_bucket": "Cube de solpre dins un ferrat",
	"item.minecraft.sulfur_cube_spawn_egg": "Uòu d'aparicion de cube de solpre",
	"item.minecraft.suspicious_stew": "Sopa suspècta",
	"item.minecraft.swamp_explorer_map": "Mapa d'exploracion de la cabana dels paluns",
	"item.minecraft.swamp_hut_map": "Mapa de la cabana del palun",
	"item.minecraft.sweet_berries": "Baias doças",
	"item.minecraft.tadpole_bucket": "Capgròs dins un ferrat",
	"item.minecraft.tadpole_spawn_egg": "Uòu d'aparicion de capgròs",
	"item.minecraft.taiga_village_map": "Mapa d'exploracion de vilatge de la taiga",
	...
	"item.minecraft.tipped_arrow.effect.awkward": "Sageta a aiga estranha",
	...
	"item.minecraft.tipped_arrow.effect.infested": "Sageta d'infestacion",
	...
	"item.minecraft.tipped_arrow.effect.mundane": "Sageta a aiga banala",
	...
	"item.minecraft.tipped_arrow.effect.thick": "Sageta a aiga espessa",
	"item.minecraft.tipped_arrow.effect.turtle_master": "Sageta del mèstre tartuga",
	...
	"item.minecraft.tipped_arrow.effect.weaving": "Sageta de teisseire",
	...
	"item.minecraft.trader_llama_spawn_egg": "Uòu d'aparicion de lama de mercant",
	"item.minecraft.trial_explorer_map": "Mapa d'exploracion de las cambras de las espròvas",
	...
	"item.minecraft.tropical_fish_spawn_egg": "Uòu d'aparicion de peis tropical",
	...
	"item.minecraft.ward_armor_trim_smithing_template.new": "Ondradura de las prigondors",
	"item.minecraft.warden_spawn_egg": "Uòu d'aparicion de warden",
	"item.minecraft.warm_ocean_ruins_map": "Mapa de las roïnas oceanicas caudas",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template.new": "Ondradura dels exploradors",
	"item.minecraft.wheat": "Blat",
	"item.minecraft.wheat_seeds": "Granas de blat",
	"item.minecraft.white_bundle": "Sac blanc",
	"item.minecraft.white_cushion": "Coissin blanc",
	...
	"item.minecraft.wooden_spear": "Lança en fusta",
	"item.minecraft.wooden_sword": "Espasa en fusta",
	"item.minecraft.woodland_explorer_map": "Mapa d'exploracion de l'ostal dels bòsques",
	"item.minecraft.woodland_mansion_map": "Mapa del castelet forestièr",
	...
	"item.minecraft.yellow_cushion": "Coissin jaune",
	"item.minecraft.yellow_dye": "Tencha jauna",
	"item.minecraft.yellow_harness": "Arnesc jaune",
	"item.minecraft.zoglin_spawn_egg": "Uòu d'aparicion de zoglin",
	"item.minecraft.zombie_horse_spawn_egg": "Uòu d'aparicion de caval zòmbi",
	"item.minecraft.zombie_nautilus_spawn_egg": "Uòu d'aparicion de nautile zòmbi",
	...
	"item.modifiers.mainhand": "Dins la man principala :",
	...
	"item.op_block_warning.line3": "Utilizatz-o pas fòra se sabètz exactament çò qu'el conten!",
	"item.spawn_egg.peaceful": "Desactivat en pacifica",
	...
	"jigsaw_block.pool": "Lista d'elements ciblats :",
	...
	"key.categories.spectator": "Espectator",
	"key.categories.ui": "Interfàcia dau juòc",
	"key.category.minecraft.creative": "Mòde creatiu",
	"key.category.minecraft.debug": "Debugatge",
	"key.category.minecraft.gameplay": "Jogabilitat",
	"key.category.minecraft.inventory": "Inventari",
	"key.category.minecraft.misc": "Divèrs",
	"key.category.minecraft.movement": "Movement",
	"key.category.minecraft.multiplayer": "Multijogaire",
	"key.category.minecraft.spectator": "Espectator",
	"key.chat": "Dobrir lo chat",
	"key.command": "Dobrir la comanda",
	"key.debug.clearChat": "Escafat lo chat",
	"key.debug.copyLocation": "Còpiar la posicion",
	"key.debug.copyRecreateCommand": "Còpiar las donadas",
	"key.debug.crash": "Fa crashèr lo jòc",
	"key.debug.debugOptions": "Opcions de debugatge",
	"key.debug.dumpDynamicTextures": "Exportar las texturas dinamicas",
	"key.debug.dumpVersion": "Exportar las informacions de version",
	"key.debug.focusPause": "Pausa al moment de pèrda de focus",
	"key.debug.fpsCharts": "Grafic dels FPS",
	"key.debug.improvedTransparency": "(Des)activar la lindetat melhorada",
	"key.debug.lightmapTexture": "Textura de la carta de lum",
	"key.debug.modifier": "Tècla de modificacion del mòde de debugatge",
	"key.debug.networkCharts": "Grafic de ret",
	"key.debug.overlay": "(Des)activar la superposicion",
	"key.debug.profiling": "Amodar/Arrestar lo perfilatge",
	"key.debug.profilingChart": "Grafic de perfilatge",
	"key.debug.reloadChunk": "Recargar los tròces",
	"key.debug.reloadResourcePacks": "Recardar los paquets de ressorsa",
	"key.debug.showAdvancedTooltips": "Mostrar las botiòlas-conselh avançadas",
	"key.debug.showChunkBorders": "Mostrar los limits de tròces",
	"key.debug.showHitboxes": "Mostrar las boitas de collision",
	"key.debug.spectate": "Alternar lo mòde espectator",
	"key.debug.switchGameMode": "Selector de mòde de jòc",
	"key.drop": "Escampar l'Objècte Seleccionat",
	"key.forward": "Avançar",
	"key.friends": "Lista d'amics",
	...
	"key.jump": "Sautar",
	"key.keyboard.ac.back": "Retorn (CA)",
	"key.keyboard.ac.bookmarks": "Favorits (CA)",
	"key.keyboard.ac.close": "Barrar (CA)",
	"key.keyboard.ac.exit": "Quitar (CA)",
	"key.keyboard.ac.forward": "Avançar (CA)",
	"key.keyboard.ac.home": "Debuta (CA)",
	"key.keyboard.ac.new": "Nòu (CA)",
	"key.keyboard.ac.open": "Dobrir (CA)",
	"key.keyboard.ac.print": "Estampar (CA)",
	"key.keyboard.ac.properties": "Proprietats (CA)",
	"key.keyboard.ac.refresh": "Refrescar (CA)",
	"key.keyboard.ac.save": "Enregistrar (CA)",
	"key.keyboard.ac.search": "Cercar (CA)",
	"key.keyboard.ac.stop": "Arrestar (CA)",
	"key.keyboard.again": "Encara",
	"key.keyboard.alternate.erase": "Escafada alt.",
	"key.keyboard.apostrophe": "'",
	"key.keyboard.application": "Menut",
	"key.keyboard.backslash": "\\",
	"key.keyboard.backspace": "Retorn arrièr",
	"key.keyboard.call": "Apelar",
	"key.keyboard.cancel": "Anullar",
	"key.keyboard.caps.lock": "Ver. maj.",
	"key.keyboard.channel.down": "Canal seguent",
	"key.keyboard.channel.up": "Canal precedent",
	"key.keyboard.clear": "Escafar",
	"key.keyboard.clear.again": "Escafar/Repetir",
	"key.keyboard.comma": ",",
	"key.keyboard.copy": "Copiar",
	"key.keyboard.crsel": "CrSel",
	"key.keyboard.currency.subunit": "Sosunitat monetària",
	"key.keyboard.currency.unit": "Unitat monetària",
	"key.keyboard.cut": "Copar",
	"key.keyboard.decimal.separator": "Separator decimal",
	"key.keyboard.delete": "Suprimir",
	"key.keyboard.down": "Flecha de bas",
	"key.keyboard.end": "Fin",
	"key.keyboard.end.call": "Copar l'apèl",
	"key.keyboard.enter": "Entrada",
	"key.keyboard.enter2": "Entrada 2",
	"key.keyboard.equal": "=",
	"key.keyboard.escape": "Quitar",
	"key.keyboard.execute": "Executar",
	...
	"key.keyboard.f8": "F8",
	"key.keyboard.f9": "F9",
	"key.keyboard.find": "Trobar",
	"key.keyboard.grave.accent": "`",
	"key.keyboard.help": "Ajuda",
	"key.keyboard.home": "Debuta",
	"key.keyboard.insert": "Inser",
	"key.keyboard.international1": "Internacional 1",
	"key.keyboard.international2": "Internacional 2",
	"key.keyboard.international3": "Internacional 3",
	"key.keyboard.international4": "Internacional 4",
	"key.keyboard.international5": "Internacional 5",
	"key.keyboard.international6": "Internacional 6",
	"key.keyboard.international7": "Internacional 7",
	"key.keyboard.international8": "Internacional 8",
	"key.keyboard.international9": "Internacional 9",
	"key.keyboard.keypad.0": "Tòca num. 0",
	"key.keyboard.keypad.00": "Tòca num. 00",
	"key.keyboard.keypad.000": "Tòca num. 000",
	...
	"key.keyboard.keypad.a": "Tòca num. A",
	"key.keyboard.keypad.add": "Tòca num. +",
	"key.keyboard.keypad.ampersand": "Tòca num. &",
	"key.keyboard.keypad.at": "Tòca num. @",
	"key.keyboard.keypad.b": "Tòca num. B",
	"key.keyboard.keypad.backspace": "Tòca num. Retorn arrièr",
	"key.keyboard.keypad.binary": "Tòca num. Binari",
	"key.keyboard.keypad.c": "Tòca num. C",
	"key.keyboard.keypad.clear": "Tòca num. Escafar",
	"key.keyboard.keypad.clear.entry": "Tòca num. Escafar tot",
	"key.keyboard.keypad.colon": "Tòca num. :",
	"key.keyboard.keypad.comma": "Tòca num. ,",
	"key.keyboard.keypad.d": "Tòca num. D",
	"key.keyboard.keypad.decimal": "Tòca num. Ponch",
	"key.keyboard.keypad.divide": "Tòca num. /",
	"key.keyboard.keypad.double.ampersand": "Tòca num. &&",
	"key.keyboard.keypad.double.vertical.bar": "Tòca num. ||",
	"key.keyboard.keypad.e": "Tòca num. E",
	"key.keyboard.keypad.enter": "Tòca num. Entrada",
	"key.keyboard.keypad.equal": "Tòca num. =",
	"key.keyboard.keypad.equals.as400": "Tòca num. = (AS400)",
	"key.keyboard.keypad.exclamation": "Tòca num. !",
	"key.keyboard.keypad.f": "Tòca num. F",
	"key.keyboard.keypad.greater": "Tòca num. >",
	"key.keyboard.keypad.hash": "Tòca num. #",
	"key.keyboard.keypad.hexadecimal": "Tòca num. Exadecimal",
	"key.keyboard.keypad.left.brace": "Tòca num. {",
	"key.keyboard.keypad.left.parenthesis": "Tòca num. (",
	"key.keyboard.keypad.less": "Tòca num. <",
	"key.keyboard.keypad.memory.add": "Tòca num. M+",
	"key.keyboard.keypad.memory.clear": "Tòca num. MC",
	"key.keyboard.keypad.memory.divide": "Tòca num. M/",
	"key.keyboard.keypad.memory.multiply": "Tòca num. M*",
	"key.keyboard.keypad.memory.recall": "Tòca num. MR",
	"key.keyboard.keypad.memory.store": "Tòca num. MS",
	"key.keyboard.keypad.memory.subtract": "Tòca num. M-",
	"key.keyboard.keypad.multiply": "Tòca num. *",
	"key.keyboard.keypad.octal": "Tòca num. Octal",
	"key.keyboard.keypad.percent": "Tòca num. %",
	"key.keyboard.keypad.period": "Tòca num. .",
	"key.keyboard.keypad.plus.minus": "Tòca num. ±",
	"key.keyboard.keypad.power": "Tòca num. ^",
	"key.keyboard.keypad.right.brace": "Tòca num. }",
	"key.keyboard.keypad.right.parenthesis": "Tòca num. )",
	"key.keyboard.keypad.space": "Tòca num. Espaci",
	"key.keyboard.keypad.subtract": "Tòca num. -",
	"key.keyboard.keypad.tab": "Tòca num. Tab",
	"key.keyboard.keypad.vertical.bar": "Tòca num. |",
	"key.keyboard.keypad.xor": "Tòca num. XOR",
	"key.keyboard.lang1": "Lenga 1",
	"key.keyboard.lang2": "Lenga 2",
	"key.keyboard.lang3": "Lenga 3",
	"key.keyboard.lang4": "Lenga 4",
	"key.keyboard.lang5": "Lenga 5",
	"key.keyboard.lang6": "Lenga 6",
	"key.keyboard.lang7": "Lenga 7",
	"key.keyboard.lang8": "Lenga 8",
	"key.keyboard.lang9": "Lenga 9",
	"key.keyboard.left": "Flècha d'esquèrra",
	"key.keyboard.left.alt": "Alt esquèr",
	"key.keyboard.left.bracket": "[",
	"key.keyboard.left.command": "Comanda esquèrra",
	"key.keyboard.left.control": "Ctrl esquèr",
	"key.keyboard.left.meta": "Meta esquèrra",
	"key.keyboard.left.option": "Opcion esquèrra",
	"key.keyboard.left.shift": "Maj esquèr",
	"key.keyboard.left.win": "Windows esquèr",
	"key.keyboard.left.windows": "Windows esquèr",
	"key.keyboard.media.eject": "Ejectar",
	"key.keyboard.media.fast.forward": "Avança rapida",
	"key.keyboard.media.next.track": "Pista seguenta",
	"key.keyboard.media.pause": "Pausa mèdia",
	"key.keyboard.media.play": "Lectura mèdia",
	"key.keyboard.media.play.pause": "Jogar/Pausar",
	"key.keyboard.media.previous.track": "Pista precedenta",
	"key.keyboard.media.record": "Enregistrar mèdia",
	"key.keyboard.media.rewind": "Tornar embobinar",
	"key.keyboard.media.select": "Causir mèdia",
	"key.keyboard.media.stop": "Arrèst mèdia",
	"key.keyboard.menu": "Menut",
	"key.keyboard.minus": "-",
	"key.keyboard.mode": "Mòde",
	"key.keyboard.mute": "Amudir",
	"key.keyboard.new": "Nòu",
	"key.keyboard.num.lock": "Ver. num.",
	"key.keyboard.oper": "Oper",
	"key.keyboard.out": "Transmetre",
	"key.keyboard.page.down": "Pag. seguenta",
	"key.keyboard.page.up": "Pag. precedenta",
	"key.keyboard.paste": "Pegar",
	"key.keyboard.pause": "Pausa",
	"key.keyboard.period": ".",
	"key.keyboard.power": "Poder",
	"key.keyboard.print.screen": "Estampar ecran",
	"key.keyboard.prior": "Ante.",
	"key.keyboard.right": "Flecha de dreita",
	"key.keyboard.right.alt": "Alt drech",
	"key.keyboard.right.bracket": "]",
	"key.keyboard.right.command": "Comanda drecha",
	"key.keyboard.right.control": "Ctrl drech",
	"key.keyboard.right.meta": "Meta drecha",
	"key.keyboard.right.option": "Opcion drecha",
	"key.keyboard.right.shift": "Maj drech",
	"key.keyboard.right.win": "Windows drech",
	"key.keyboard.right.windows": "Windows drech",
	"key.keyboard.save": "Sauvar",
	"key.keyboard.scroll.lock": "Ver. desfilament",
	"key.keyboard.select": "Causir",
	"key.keyboard.semicolon": ";",
	"key.keyboard.separator": "Separator",
	"key.keyboard.slash": "/",
	"key.keyboard.sleep": "Velha",
	"key.keyboard.soft.left": "Logicial esquèrre",
	"key.keyboard.soft.right": "Logicial drech",
	"key.keyboard.space": "Espaci",
	"key.keyboard.stop": "Arrestar",
	"key.keyboard.sys.req": "ReqSis",
	"key.keyboard.tab": "Tab",
	"key.keyboard.thousands.separator": "Separator de milièrs",
	"key.keyboard.undo": "Restablir",
	"key.keyboard.unknown": "Pas assignada",
	"key.keyboard.up": "Flecha de naut",
	"key.keyboard.volume.down": "Volum bas",
	"key.keyboard.volume.up": "Volum naut",
	"key.keyboard.wake": "Revelh",
	...
	"key.smoothCamera": "(Des)activar lo mòde cinematic per la camèra",
	"key.sneak": "S'agrovar",
	"key.socialInteractions": "Interaccions socialas",
	"key.spectatorHotbar": "Causir dins la barra rapida",
	"key.spectatorOutlines": "Metre en Evidéncia los Jogaires (Espectators)",
	"key.sprint": "Córrer",
	"key.swapOffhand": "Escambiar amb la man segondària",
	"key.toggleGui": "(Des)activar l'interfàcia",
	"key.togglePerspective": "Cambiar Perspectiva",
	"key.toggleSpectatorShaderEffects": "Efièches d'ombrejaire en mòde especator",
	...
	"lanServer.port.invalid": "Pas un pòrt valid.\nDaissatz lo camp de sasida void o entratz un nombre entre 1024 e 65535.",
	"lanServer.port.invalid.new": "Pas un pòrt valid.\nDaissatz lo camp de sasida void o entratz un nombre entre %s e %s.",
	"lanServer.port.unavailable": "Pas un pòrt disponible.\nDaissatz lo camp de sasida void o entratz un autre nombre entre 1024 e 65535.",
	"lanServer.port.unavailable.new": "Pas un pòrt disponible.\nDaissatz lo camp de sasida void o entratz un autre nombre entre %s e %s.",
	"lanServer.scanning": "Recèrca de partidas sus vòstra ret local",
	...
	"loading.progress": "%s %%",
	"manageServer.add.title": "Apondre un servidor",
	"manageServer.edit.title": "Modificar las informacions del servidor",
	"manageServer.enterIp": "Adreça del servidor",
	"manageServer.enterName": "Nom del servidor",
	"manageServer.resourcePack": "Paquets de ressorsas del servidor",
	"manageServer.resourcePack.disabled": "Desactivats",
	"manageServer.resourcePack.enabled": "Activats",
	"manageServer.resourcePack.prompt": "Demandar",
	...
	"mco.backup.entry.gameMode": "Mòde de jòc",
	...
	"mco.backup.entry.worldType": "Tipe de mond",
	"mco.backup.entry.worldType.adventureMap": "Aventura",
	"mco.backup.entry.worldType.experience": "Experiéncia",
	"mco.backup.entry.worldType.inspiration": "Inspiracion",
	"mco.backup.entry.worldType.minigame": "Mini-jòc",
	...
	"mco.backup.info.title": "Cambiaments dempuèi la darrièra sauvagarda",
	"mco.backup.narration": "Sauvagarda del %s",
	"mco.backup.nobackups": "Aqueste Realm a pas cap de sauvagarda per ara.",
	...
	"mco.compatibility.downgrade": "Retrogradacion",
	"mco.compatibility.downgrade.description": "Aqueste mond foguèt jogat pel darrièr còp dins la version %s; sètz en version %s. Retrogradar un mond pòt causar de corrupcion - pòdem pas garantir que se cargarà o foncionarà.\nUna còpia de seguretat del vòstre mond serà enregistrada dins \"Sauvagardas\". Se vos plai, restauratz lo vòstre mond se necessari.",
	...
	"mco.compatibility.incompatible.series.popup.message": "Aqueste mond foguèt jogat pel darrièr còp dins la version %s; sètz en version %s.\n\nAquestas versions son pas compatiblas entre elas. Cal un mond nòu per jogar amb aquesta version.",
	"mco.compatibility.unverifiable.message": "La version amb la quina aqueste mond foguèt jogat pel darrièr còp a pas pogut èsser verificada. Se lo mond es actualizat o retrogradat, una còpia de securetat serà creada automaticament e sauvagardada dins \"Còpias de securetat dels monds\".",
	"mco.compatibility.unverifiable.title": "La compatibilitat pòt pas èsser verificada",
	"mco.compatibility.upgrade": "Melhorament",
	"mco.compatibility.upgrade.description": "Aqueste mond foguèt jogat pel darrièr còp amb la version %s, sètz en version %s.\n\nUna còpia de securetat de vòstre mond serà sauvagardada dins \"Còpias de securetat del mond\".\n\nMercé de restaurar vòstre mond se es necessari.",
	"mco.compatibility.upgrade.friend.description": "Aqueste mond foguèt jogat pel darrièr còp amb la version %s, sètz en version %s.\n\nUna còpia de securetat de vòstre mond serà sauvagardada dins \"Còpias de securetat del mond\".\n\nLo proprietari del Realm pòt restaurar lo mond se es necessari.",
	"mco.compatibility.upgrade.title": "Volètz de verai actualizar aqueste mond?",
	...
	"mco.configure.world.buttons.close": "Barrar lo realm per un temps",
	...
	"mco.configure.world.buttons.invite": "Convidar un jogaire",
	"mco.configure.world.buttons.invite_codes": "Còdis d'invitacion",
	"mco.configure.world.buttons.moreoptions": "Mai d'opcions",
	"mco.configure.world.buttons.newworld": "Mond nòu",
	"mco.configure.world.buttons.open": "Dobrir lo Realm",
	"mco.configure.world.buttons.options": "Opcions del mond",
	"mco.configure.world.buttons.players": "Jogaires",
	"mco.configure.world.buttons.region_preference": "Seleccionar la region...",
	"mco.configure.world.buttons.resetworld": "Reinicializar lo mond",
	"mco.configure.world.buttons.save": "Sauvagardar",
	"mco.configure.world.buttons.settings": "Paramètres",
	"mco.configure.world.buttons.subscription": "Abonament",
	"mco.configure.world.buttons.switchminigame": "Cambiar de mini-jòc",
	"mco.configure.world.close.question.line1": "Pòdetz barrar temporàriament vòstre Realm per empachar los jogaires d'i jogar del temps que fasètz d'ajustaments. Torna-o obrir quand sètz prèst.\n\nAquò anullarà pas vòstre abonament a Realms.",
	"mco.configure.world.close.question.line2": "Sètz segur de voler far aquò ?",
	"mco.configure.world.close.question.title": "Cal modificar sens relambi?",
	...
	"mco.configure.world.forceGameMode": "Forçar lo mòde de jòc",
	"mco.configure.world.invite.narration": "Avètz %s invitacion(s) nòva(s)",
	"mco.configure.world.invite.profile.name": "Nom",
	"mco.configure.world.invite_codes.copy": "Copiar",
	"mco.configure.world.invite_codes.create": "Crear un còdi d'invitacion",
	"mco.configure.world.invite_codes.delete": "Suprimir",
	"mco.configure.world.invite_codes.edit": "Modificar",
	"mco.configure.world.invite_codes.edit.active": "Actiu",
	"mco.configure.world.invite_codes.edit.expiration_date": "Data d'expiracion",
	"mco.configure.world.invite_codes.edit.expires": "Expira: %s",
	"mco.configure.world.invite_codes.edit.title": "Modificar lo còdi d'invitacion",
	"mco.configure.world.invite_codes.expiration.12_hours": "12 oras",
	"mco.configure.world.invite_codes.expiration.1_day": "1 jorn",
	"mco.configure.world.invite_codes.expiration.1_hour": "1 ora",
	"mco.configure.world.invite_codes.expiration.30_minutes": "30 minutas",
	"mco.configure.world.invite_codes.expiration.6_hours": "6 oras",
	"mco.configure.world.invite_codes.expiration.7_days": "7 jorns",
	"mco.configure.world.invite_codes.expiration.never": "Jamai",
	"mco.configure.world.invite_codes.loading": "Cargament dels còdis d'invitacion",
	"mco.configure.world.invite_codes.subtitle": "Podètz apondre fins a %s còdis d'invitacion e los partejar per permetre a d'autres de rejónher lo vòstre Realm",
	"mco.configure.world.invite_codes.title": "Còdis d'invitacion (%s/%s)",
	"mco.configure.world.invited": "Convidat",
	"mco.configure.world.invited.number": "Convidat (%s)",
	"mco.configure.world.invites.normal.tooltip": "Jogaire normal",
	...
	"mco.configure.world.name.validation.whitespace": "Cal pas ni començar finir amb un espaci blanc. Se n'i a un, serà escafat.",
	...
	"mco.configure.world.players.invite.duplicate": "Un jogaire amb aquel nom es ja invitat al Realm",
	"mco.configure.world.players.inviting": "Convidant jogaire...",
	"mco.configure.world.players.title": "Jogaires",
	"mco.configure.world.pvp": "PVP",
	"mco.configure.world.region_preference": "Preferéncia de region",
	"mco.configure.world.region_preference.title": "Seleccion de la preferéncia de region",
	"mco.configure.world.renderDistance": "Limit de distància d'afichatge",
	"mco.configure.world.renderDistance.tooltip": "La distància maximala visibla pels membres del Realm. De valors nautas pòdon impactar las performàncias.",
	...
	"mco.configure.world.resourcepack.question": "Avètz besonh d'un paquet de ressorsas personalizat per jogar sus aquel Realm.\n\nVòlez lo telecargar e jogar?",
	...
	"mco.configure.world.restore.download.question.line1": "Lo monde serà telecargat e apondut a vòstres monds un jogaire.",
	...
	"mco.configure.world.simulationDistance": "Limit de distància de simulacion",
	"mco.configure.world.simulationDistance.tooltip": "Lo rai a l'entorn dels jogaires ont lo jòc carga e s'actualizat.",
	"mco.configure.world.slot": "Monde %s",
	"mco.configure.world.slot.empty": "Vuèg",
	"mco.configure.world.slot.switch.question.line1": "Vòstre Realm es per cambiar per un autre mond",
	...
	"mco.configure.world.spawnMonsters": "Mostres",
	"mco.configure.world.spawnNPCs": "Generar los PNJ",
	"mco.configure.world.spawnProtection": "Proteccion del ponch de reaparicion",
	"mco.configure.world.spawn_toggle.message": "Desactivar aquesta opcion supprimirà totas las entitats existentas d'aquel tipe",
	"mco.configure.world.spawn_toggle.message.npc": "Desactivar aquesta opcion suprimirà totas las entitats existentas d'aquel tipe, còma los vilatgeses",
	...
	"mco.configure.world.switch.slot.subtitle": "Aqueste mond es void, causissètz cossí crear vòstre mond",
	...
	"mco.create.world.failed": "Fracàs a la creacion del mond!",
	"mco.create.world.reset.title": "Creacion dau monde...",
	"mco.create.world.skip": "Passar",
	"mco.create.world.subtitle": "S'o volètz, causissètz quin mond voldriatz metre sul vòstre nòu Realm",
	...
	"mco.download.confirmation.line2": "Poiretz pas mai metre lo vòstre mond en linha suls vòstres Realms",
	...
	"mco.download.failed": "Fracàs del telecargament",
	"mco.download.percent": "%s %%",
	"mco.download.preparing": "Preparacion dau telecargament",
	"mco.download.resourcePack.fail": "Fracàs del telecargament del paquet de ressorsa!",
	...
	"mco.errorMessage.6002": "Las condicions d'utilizacion son pas estadas acceptadas",
	...
	"mco.errorMessage.6007": "Lo jogaire es dins tròp de Realms",
	"mco.errorMessage.6008": "Nom del Realm pas vaild",
	"mco.errorMessage.6009": "Descripcion del Realm pas valid",
	"mco.errorMessage.connectionFailure": "Una error s'es produsida. Se vos plai, tornatz ensajar mai tard.",
	"mco.errorMessage.generic": "Una error s'es produsida : ",
	"mco.errorMessage.initialize.failed": "Impossible d’inicializar lo Realm",
	"mco.errorMessage.noDetails": "Detalhs de la mèuca pas provesits",
	"mco.errorMessage.realmsService": "Una error s'es produsida (%s) :",
	"mco.errorMessage.realmsService.configurationError": "Fracàs al temps de modificar las opcions del mond",
	...
	"mco.errorMessage.serviceBusy": "Realms es ocupat d'aquesta passa.\nEnsajatz de vos tornar connectar al vòstre Realm dins qualques minutas.",
	"mco.gui.button": "Boton",
	"mco.gui.ok": "D'acòrdi",
	"mco.info": "Informacions!",
	"mco.invited.player.narration": "Invitacion enviada a %s",
	...
	"mco.minigame.world.changeButton": "Causir un autre mini-jòc",
	...
	"mco.minigame.world.restore": "Fin del mini-jòc...",
	"mco.minigame.world.restore.question.line1": "Lo mini-jòc es per s'acabar e vòstre realm es per èsser restaurat.",
	"mco.minigame.world.restore.question.line2": "Sètz segur de voler far aquò?",
	"mco.minigame.world.selected": "Mini-jòc causit :",
	"mco.minigame.world.slot.screen.title": "Cambiament de mond...",
	"mco.minigame.world.startButton": "Cambiar",
	"mco.minigame.world.starting.screen.title": "Lançament del minijòc...",
	"mco.minigame.world.stopButton": "Acabar lo mini-jòc",
	"mco.minigame.world.switch.new": "Causir un autre minijuòc?",
	"mco.minigame.world.switch.title": "Cambiar lo mini-jòc",
	"mco.minigame.world.title": "Cambiar lo realm en un mini-jòc",
	"mco.news": "Nòvas de Realms",
	"mco.notification.dismiss": "Regetar",
	"mco.notification.transferSubscription.buttonText": "Transferir",
	"mco.notification.transferSubscription.message": "Los abonaments a Java Realms son transferits cap al Microsoft Store. Daissetz pas vòstre abonament expirar!\nTransferissètz-o ara e profechatz de 30 jorns gratuits sus Realms.\nTornatz-vos sus vòstre perfil sus minecraft.net per transferir vòstre subrescrit.",
	...
	"mco.pdp.friends.description": "Los amics invitats pòdon jogar sul vòstre Realm a res-non-còst, totjorn - quita se siatz pas en linha. Jogatz amb fins a 10 a l'encòp!",
	"mco.pdp.friends.title": "Un biais melhor de jogar amassas",
	"mco.pdp.minigames.description": "Exploratz la bibliotèca varianta de mini-jòcs, de cartas d'aventuras e mai.",
	"mco.pdp.minigames.title": "Mini-jòcs - Contengut de creators gratuit",
	"mco.pdp.private.backups": "• Còpias automaticas",
	"mco.pdp.private.easyToManage": "• Aisit a configurar e a administrar",
	"mco.pdp.private.secure": "• Privat e segur",
	"mco.pdp.private.title": "Servidor personal",
	"mco.pdp.private.worldSlots": "• Tres emplaçaments de mond",
	"mco.pdp.trial.description": "Ensag de 30 jorns gratuit!",
	"mco.pdp.trial.title": "Vòstre pròpri servidor, totjorn en linha",
	"mco.pdp.tryForFree": "Ensajatz a res-non-còst",
	...
	"mco.reset.world.generate": "Mond nòu",
	...
	"mco.reset.world.template": "Modèls de mond",
	"mco.reset.world.title": "Reïnicializar lo mond",
	"mco.reset.world.upload": "Televersar lo mond",
	"mco.reset.world.warning": "Aquò remplaçarà lo mond actual del vòstre Realm",
	...
	"mco.selectServer.create.subtitle": "Seleccionatz qual mond botar dins lo Realm novèl",
	...
	"mco.selectServer.freeTrial": "Ensag gratuit",
	"mco.selectServer.joinCode": "Còdi d'accès",
	"mco.selectServer.joinCode.hint": "Entratz un còdi d'accès",
	"mco.selectServer.joinCode.invalid": "Lo còdi qu'avètz entrat es pas valide.",
	"mco.selectServer.joinCode.title": "Entratz un còdi d'accès",
	"mco.selectServer.joinCode.validating": "Validacion del còdi",
	"mco.selectServer.joinRealm": "Rejónher un Realm",
	...
	"mco.selectServer.minigameName": "Minijòc : %s",
	"mco.selectServer.minigameNotSupportedInVersion": "Impossible de jogar a aqueste minijuòc en %s",
	"mco.selectServer.noRealms": "Semblatz pas aver de Realm. N'apondètz un per jogar amb los amics.",
	...
	"mco.selectServer.popup": "Realms es un biais simple e segur de jogar a un mond Minecraft amb fins a dètz amics. Se pòt jogar a un molon de mini-jòcs, e a un molon de monds personalizats. Sonque al proprietari lo cal pagar.",
	"mco.selectServer.purchase": "Apondre un realm",
	"mco.selectServer.trial": "Ensajatz!",
	"mco.selectServer.uninitialized": "Clicatz per crear un Realm!",
	"mco.snapshot.createSnapshotPopup.text": "Sètz a mand de crear un Realm del Snapshot gratuit que serà associat a vòstre abonament Realms pagant. Aquel novèl Realm del Snapshot serà accessible tant que lo subrescrit pagant es actiu. Vòstre Realm pagant serà pas afectat.",
	"mco.snapshot.createSnapshotPopup.title": "Volètz crear un Realm del Snapshot?",
	"mco.snapshot.creating": "Creacion del Realm del Snapshot...",
	"mco.snapshot.description": "Associat a \"%s\"",
	"mco.snapshot.friendsRealm.downgrade": "Devètz èsser sus la version %s per rejónher aqueste Realm",
	"mco.snapshot.friendsRealm.upgrade": "%s deu actualizar son Realm abans que pòscas jogar amb aquela version",
	"mco.snapshot.paired": "Aqueste Realm del Snapshot es associat a \"%s\"",
	"mco.snapshot.parent.tooltip": "Utilizatz la darrièra version de Minecraft per jogar sus aqueste Realm",
	"mco.snapshot.start": "Començar un Realm del Snapshot gratuit",
	"mco.snapshot.subscription.info": "Es un Realm del Snapshot associat al abonament del vòstre Realm \"%s\". Demorarà actiu tant que son Realm associat o serà.",
	"mco.snapshot.tooltip": "Utilizatz los Realms del Snapshot per aver un apercebut de las versions de Minecraft que venon, que poirián inclure de novèlas foncionalitats e d'autres cambiaments.\n\nPòdetz trobar tos Realms normals dins la version oficiala del jòc.",
	"mco.snapshotRealmsPopup.message": "Los Realms son d'ara enlà disponibles dins los Snapshots a partir del Snapshot 23w41a. Cada abonament Realms compren un Realms del Snapshot gratuit, distint de tot Realms Java abituals!",
	...
	"mco.template.select.none": "Ops, sembla que lo qu'aquesta categoria es voida a l'ora d'ara.\nSe vos plai, verificatz mai tard per de contengut novèl, o se sètz un creator,\n%s.",
	...
	"mco.upload.close.failure": "S'es pas pogut barrar vòstre Realm. Se vos plai, ensajatz mai tard.",
	...
	"mco.worldSlot.minigame": "Mini-jòc",
	...
	"menu.custom_screen_info.contents": "Lo contengut d'aquel ecran es contraròtlat per de servidors e de cartas tèrces que son pas detenguts, espleitats o supervisats per Mojang Studios o Microsoft.\n\nAtencion! Fasètz mostra de prudéncia quand seguissètz de ligams et partejatz pas las vòstras informacions personalas, informacions de connexion compresas.\n\nSe aquel ecran vos empacha de jogar, podètz vos desconnectar del servidor actual en clicant lo boton çai-jos.",
	...
	"menu.multiplayerOptions.applyChanges": "Aplicar los cambiaments",
	"menu.multiplayerOptions.button": "Dobrir al ret local",
	"menu.multiplayerOptions.lan": "Ret local",
	"menu.multiplayerOptions.network": "Multijogaire",
	"menu.multiplayerOptions.network.header": "Ret",
	"menu.multiplayerOptions.network.lan": "Ret local",
	"menu.multiplayerOptions.network.lan.tooltip": "Los jogaires sus lo meteis ret pòdon rejónher aquel mond.",
	"menu.multiplayerOptions.network.off": "Non",
	"menu.multiplayerOptions.network.off.tooltip": "Degun pòt rejónher aquel mond.",
	"menu.multiplayerOptions.network.online": "En linha",
	"menu.multiplayerOptions.network.online.tooltip": "Los amics en linha pòdon rejónher aquel mond.",
	"menu.multiplayerOptions.otherPlayers.header": "Opcions pels autres jogaires",
	"menu.multiplayerOptions.publish.started.lan": "D'ara enlà, aquel mond es dobèrt al ret local. Lo numero del pòrt es %s",
	"menu.multiplayerOptions.publish.started.online": "D'ara enlà, aquel mond es dobèrt al multijogaires en linha. Lo numero del pòrt es.",
	"menu.multiplayerOptions.publish.stopped": "Aquel mond es pas mai dobèrt al multijogaire",
	"menu.multiplayerOptions.title": "Opcions de ret local",
	...
	"menu.playerReporting.no_players": "I a pas cap de jogaires a senhalar dins aquel mond",
	...
	"mount.sit": "Picatz %[1]s per se levar",
	"multiplayer.applyingPack": "Aplicacion del paquet de ressorsas",
	"multiplayer.codeOfConduct.check": "Me mostretz pas mai aquel còde de conducha",
	"multiplayer.codeOfConduct.title": "Còde de conducha del servidor",
	"multiplayer.confirm_command.parse_errors": "Ensajatz d’executar una comanda desconeguda o invalida.\nSètz segur\u202f?\nComanda : %s",
	"multiplayer.confirm_command.permissions_required": "Ensajatz d'executar una comanda que necessita de permissions nautas.\nAquò poiriá afectar negativament lo vòstre jòc.\nSètz segur?\nComanda : %s",
	"multiplayer.confirm_command.run_command": "Executar la comanda",
	"multiplayer.confirm_command.signature_required": "Ensajatz d'executar una comanda que mandarà de messatges dins lo chat en emplegant vòstre nom.\nPòt pas èsser mandada que dempuèi lo chat.\nComanda : %s",
	"multiplayer.confirm_command.suggest_command": "Copiar dins lo chat",
	"multiplayer.confirm_command.title": "Confirmar l'execucion d'una comanda",
	"multiplayer.disconnect.authservers_down": "Los servidors d'autenficacion son pas disponibles. Se vos plai, tornatz ensajar mai tard. Desolat!",
	"multiplayer.disconnect.bad_chat_index": "Un messatge que mancava o tornat ordonat recebut del servidor es estat detectat",
	"multiplayer.disconnect.banned": "Sètz fòrabandit(da) d'aquel servidor",
	"multiplayer.disconnect.banned.expiration": "\nVòstre fòrabandiment serà retirat lo %s",
	"multiplayer.disconnect.banned.reason": "Sètz fòrabandit(da) d'aquel servidor.\nRason: %s",
	"multiplayer.disconnect.banned.reason.default": "Fòrabandit(da) pel operator",
	"multiplayer.disconnect.banned_ip.expiration": "\nVòstre destèrro vai èsser retirar en %s",
	"multiplayer.disconnect.banned_ip.reason": "Vòstra adreça IP es fòrabandida d'aquel servidor.\nRason: %s",
	"multiplayer.disconnect.chat_validation_failed": "Fracàs de la validacion del messatge del chat",
	"multiplayer.disconnect.code_of_conduct": "Aquel servidor exigís qu'accèptatz lo còde de conducha",
	"multiplayer.disconnect.configuration_error": "Mèuca inesperada al temps de configurar",
	"multiplayer.disconnect.duplicate_login": "Sètz ja connectat dempuèi un autre emplaçament",
	"multiplayer.disconnect.expired_public_key": "Clau publica del perfil expirada. Verificatz que la data e l'ora de vòstre sistèma son sincronizadas e ensajatz de tornar amodar lo jòc.",
	"multiplayer.disconnect.flying": "Volar non es permetent en aqueth servidor",
	"multiplayer.disconnect.generic": "Desligat",
	"multiplayer.disconnect.idling": "Avètz pas bolegat per tròp de temps!",
	...
	"multiplayer.disconnect.invalid_entity_attacked": "Ensag d'atacar una entitat pas valida",
	...
	"multiplayer.disconnect.invalid_player_movement": "Paquet de desplaçament del jogaire pas valid recebut",
	"multiplayer.disconnect.invalid_public_key_signature": "Signatura pas valida per la clau publica del perfil.\nEnsajatz de tornar amodar vòstre jòc.",
	"multiplayer.disconnect.invalid_public_key_signature.new": "Signatura pas valida per la clau publica del perfil.\nEnsajatz de tornar amodar vòstre jòc.",
	"multiplayer.disconnect.invalid_vehicle_movement": "Paquet de desplaçament en veïcul pas valid recebut",
	"multiplayer.disconnect.ip_banned": "Vòstra adreça IP es fòabandida d'aqueste servidor",
	"multiplayer.disconnect.kicked": "Expulsat(da) pel operator",
	"multiplayer.disconnect.missing_tags": "Lo servidor a mandat un ensemble d'etiquetas pas complet.\nSe vos plai, contactatz l'operator del servidor.",
	"multiplayer.disconnect.name_taken": "Aqueste nom es ja pres",
	"multiplayer.disconnect.not_whitelisted": "Sètz pas sus la lista blanca d'aquel servidor!",
	"multiplayer.disconnect.out_of_order_chat": "Lo paquet de chat es pas estat recebut dins l'òrdre. L'òra del sistèma es cambiada?",
	...
	"multiplayer.disconnect.server_full": "Lo servidor es plen!",
	"multiplayer.disconnect.server_shutdown": "Servidor barrat",
	"multiplayer.disconnect.slow_login": "La connexion a pres tròp de temps",
	"multiplayer.disconnect.too_many_pending_chats": "Tròp de messatges pas reconeguts dins lo chat",
	"multiplayer.disconnect.transfers_disabled": "Aquel servidor accèpta pas los transferiments",
	"multiplayer.disconnect.unexpected_query_response": "Donadas personalizadas inesperadas de la part del client",
	"multiplayer.disconnect.unsigned_chat": "Un paquet de chat recebut a una signatura que manca o pas valida.",
	...
	"multiplayer.lan.server_found": "Nòu servidor trobat : %s",
	"multiplayer.message_not_delivered": "Impossible de transmetre lo messatge dins lo chat. Vejatz los jornals del servidor : %s",
	"multiplayer.player.joined": "%s a rejonch lo juòc",
	"multiplayer.player.joined.renamed": "%s (ancianament conegut(da) jol nom de %s) a rejonch lo jòc",
	...
	"multiplayer.requiredTexturePrompt.disconnect": "Aquel servidor exigís un paquet de ressorsas personalizat",
	"multiplayer.requiredTexturePrompt.line1": "Aquel servidor exigís l'emplec d'un paquet de ressorsas personalizat.",
	...
	"multiplayer.socialInteractions.not_available": "Las interaccions socialas son pas disponiblas que sus de monds multijogaire",
	"multiplayer.status.and_more": "... e %s mai... ...",
	"multiplayer.status.anonymous_player": "Jogaire anonim",
	...
	"multiplayer.status.ping.narration": "Laténcia : %s milisegondas",
	...
	"multiplayer.status.request_handled": "La demanda d'estatut es estada tractada",
	"multiplayer.status.unknown": "???",
	"multiplayer.status.unrequested": "Estatut pas demandat recebut",
	...
	"multiplayer.texturePrompt.failure.line2": "Las foncionalitats qu'exigisson de ressorsas personalizadas pòdon pas foncionar coma cal",
	...
	"multiplayer.unsecureserver.toast": "Los messatges mandadas sul servidor pòdon èsser modificats e pòdon èsser pas lo messatge d'origina",
	"multiplayer.unsecureserver.toast.title": "Impossible de verificar los messatges",
	"multiplayerWarning.check": "Pas pus mostrar aquel messatge",
	"multiplayerWarning.header": "Atencion : jòc en linha tèrç",
	"multiplayerWarning.message": "Atencion : Lo jòc en linha es prepausat per de servidors tèrces que son pas, ni detenguts, ni esplechats, ni supervisats per Mojang Studio o Microsoft.\nAl temps del jòc en linha, podètz èsser expausat(da) a de messatges pas moderats dins lo chat o a d'autres tipes de contengut generats pels utilizaires que pòdon pas convenir a totòm.",
	...
	"narration.checkbox.usage.focused": "Picatz Entrar per (des)activar",
	"narration.checkbox.usage.focused.check": "Picatz Entrar per entalhar",
	"narration.checkbox.usage.focused.uncheck": "Picatz Entrar per desentalhar",
	"narration.checkbox.usage.hovered": "Clic esquèr per (des)activar",
	"narration.checkbox.usage.hovered.check": "Clic esquèr per entalhar",
	"narration.checkbox.usage.hovered.uncheck": "Clic esquèr per desentalhar",
	"narration.component_list.usage": "Picatz Tab per navigar a l'element seguent",
	"narration.cycle_button.usage.focused": "Picatz Entrar per cambiar a %s",
	...
	"narration.link.usage.focused": "Picatz Entrar per seguir o ligam",
	"narration.link.usage.hovered": "Clic esquèr per seguir o ligam",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Picatz Entrar per començar a cambiar la valor del cursor",
	"narration.slider.usage.hovered": "Fasètz lisar lo cursor per cambiar sa valor",
	"narration.suggestion": "Suggestion %s sus %s seleccionat : %s",
	"narration.suggestion.tooltip": "Suggestion %s sus %s seleccionat : %s (%s)",
	...
	"narrator.position.list": "Linha %s sus %s de la lista",
	...
	"narrator.ready_to_play": "Prèst per jogar",
	...
	"narrator.toast.disabled": "Narrator desactivat",
	"narrator.toast.enabled": "Narrator activat",
	"optimizeWorld.confirm.description": "Aquesta operacion va ensajar d'optimisar lo vòstre mond en s'assegurant que totas las donadas siagan estocadas dins lo format de jòc lo mai recent. Aquò pòt prendre mai o mens de temps en fonccion de la talha del vòstre mond. Un còp fach, vòstre mond deuriá fonccionar mai lèu, mas serà pas pus compatible amb las ancianas versions del jòc. Volètz vertadièrament contunhar?",
	"optimizeWorld.confirm.proceed": "Sauvagardar e optimizar",
	...
	"optimizeWorld.stage.finished.chunks": "Finalizacion de la mesa a jorn dels tròces...",
	"optimizeWorld.stage.finished.entities": "Finalizacion de la mesa a jorn de las entitats...",
	"optimizeWorld.stage.finished.poi": "Finalizacion de la mesa a jorn dels ponches d'interès...",
	...
	"options.accessibility": "Accessibilitat...",
	"options.accessibility.high_contrast": "Contrast naut",
	"options.accessibility.high_contrast.error.tooltip": "Lo paquet de ressorsas \"Naut contrast\" es pas disponible.",
	"options.accessibility.high_contrast.tooltip": "Aumenta lo contrast dels elements de l'interfàcia.",
	"options.accessibility.high_contrast_block_outline": "Contrast naut del contorn dels blòcs",
	"options.accessibility.high_contrast_block_outline.tooltip": "Aumenta lo contrast del contorn del blòc ciblat.",
	"options.accessibility.link": "Guida d'accessibilitat",
	"options.accessibility.menu_background_blurriness": "Fosc del fons dels menuts",
	"options.accessibility.menu_background_blurriness.tooltip": "Modifica lo fosc del fons dels menuts.",
	"options.accessibility.narrator_hotkey": "Tòca rapida del narrator",
	"options.accessibility.narrator_hotkey.mac.tooltip": "Permet al narrator d'èsser (des)activat amb \"Cmd + B\".",
	"options.accessibility.narrator_hotkey.tooltip": "Permet al narraror d'èsser (des)activat amb \"Ctrl + B\".",
	"options.accessibility.panorama_speed": "Velocitat del panoramà ",
	...
	"options.accessibility.tooltip": "Configuracion d'accessibilitat",
	"options.allowCursorChanges": "Cambiaments del cursor",
	"options.allowCursorChanges.tooltip": "Permés al cursor de la mirga de cambiar la sieuna forma ensús d'unes elements de l'interfàcia.",
	"options.allowFriendRequests": "Autorizar las demandas",
	"options.allowFriendRequests.tooltip": "Autorizar los autres jogaires a vos mandar de demandas d'amistat",
	"options.allowServerListing": "Nom listat dins los servidors",
	"options.allowServerListing.tooltip": "Los servidors pòdon listar los jogaires en linha dins lor estatut public.\nAmb aquela opcion desactivada, lo vòstre nom apareisserà pas dins aquelas listas.",
	...
	"options.blocks": "%s blòcs",
	"options.chat": "Opcions del chat...",
	"options.chat.color": "Colors",
	"options.chat.delay": "Relambi del chat : %s segonda(s)",
	"options.chat.delay_none": "Relambi del chat : Pas cap",
	"options.chat.drafts": "Sauvagardar los brolhons",
	"options.chat.drafts.tooltip": "Los messatges pas mandats seràn sauvagardar e podèron èsser mandats a l'obertura de chat que ven.",
	...
	"options.chat.opacity": "Opacitat del tèxt del chat",
	"options.chat.scale": "Talha del tèxt del chat",
	...
	"options.chunkFade": "Temps de desaparicion dels tròces",
	"options.chunkFade.none": "Desaparicion dels tròces : Non",
	"options.chunkFade.seconds": "Desaparicion dels tròces : %s segonda(s)",
	"options.chunkFade.tooltip": "Quant de segondas per l'aparicion dels tròces quand son afichats pel primièr còp.",
	"options.chunks": "%s tròces",
	"options.clouds.fancy": "Detalhats",
	"options.clouds.fast": "Rapids",
	"options.controls": "Contraròtles...",
	"options.credits_and_attribution": "Crèdits e atribucions...",
	"options.ctrlClickEmulatesRightClick": "Emulacion del clic drech",
	"options.ctrlClickEmulatesRightClick.tooltip": "Se activat, Ctrl + clic esquèrre es considerat coma un clic drech. Fonciona pas que sus macOS.",
	"options.cutoutLeaves": "Fuèlhas lindas",
	"options.cutoutLeaves.tooltip": "Permés de veire a travèrs l'espaci entre las fuèlhas. Desactivar aquela opcion pòt melhorar las performàncias.",
	"options.damageTiltStrength": "Trantida de degalh",
	"options.damageTiltStrength.tooltip": "Contròtla l'amplor de la trantida de la camèra causada pels degalhs recebuts.",
	"options.darkMojangStudiosBackgroundColor": "Logo monocratic",
	"options.darkMojangStudiosBackgroundColor.tooltip": "Cambia lo color del fons del ecran de cargament de Mojang Studios per de negre.",
	...
	"options.debugGuiScale.tooltip": "Fòrça la superposicion de debugatge a una escala diferenta del rèste del jòc",
	"options.debugGuiScale.unchanged": "Pas cambiat",
	"options.difficulty": "Dificultat",
	"options.difficulty.easy": "Aisida",
	"options.difficulty.easy.info": "Los mòstres apareisson mas fan mens de degalhs. La barra de fam se vuèja e nafra fins a cinq còrs.",
	"options.difficulty.hard": "Malaisida",
	"options.difficulty.hard.info": "Los mòstres apareisson e fan mai de degalhs. La barra de fam se vuèja e nafra fins a la mòrt.",
	"options.difficulty.hardcore": "Extrèm",
	"options.difficulty.normal": "Normal",
	"options.difficulty.normal.info": "Los mòstres apareisson e fan los degalhs normals. La barra de fam se vuèja e nafra fins a un mièg còr.",
	"options.difficulty.online": "Dificultat del servidor",
	"options.difficulty.peaceful": "Pacifica",
	"options.difficulty.peaceful.info": "Los mòstres apareisson pas e i a pas que qualques creaturas passivas qu'apareisson. La barra de fam se vuèja pas e la vida es recuperada amb lo temps.",
	"options.directionalAudio": "Àudio direccional",
	"options.directionalAudio.off.tooltip": "Son estereo classic.",
	"options.directionalAudio.on.tooltip": "Emplega l'àudio direccional basat sul HRTF (Foncion de Transferiment Ligada al Cap) per melhorar la simulacion del son tri-dimensional.\nNecessita de material àudio compatible ambe la HRTF, e es nautament recomandat amb un casco.",
	"options.discrete_mouse_scroll": "Desfilament discrèt",
	"options.entityDistanceScaling": "Distància d'entitats",
	"options.entityShadows": "Ombras d'entitats",
	"options.exclusiveFullscreen": "Plen ecran exclusiu",
	"options.exclusiveFullscreen.off.tooltip": "Totas las menas de sasida deurián foncionar dins aquel mòde de plen ecran, mas la sincronizacion adaptativa (Nvidia G-sync, AMD FreeSync) foncionarà pas.",
	"options.exclusiveFullscreen.on.tooltip": "Es possible qu'aquel mòde de plen ecran empache d'unas menas de sasida de foncionar, mas la sincronizacion adaptativa (Nvidia G-sync, AMD FreeSync) deuriá foncionar.",
	"options.exclusiveFullscreen.warningTooltip": "Aquela opcion poiriá empachar d'unas menas de sasida de foncionar.",
	"options.font": "Opcions de polissa...",
	"options.font.title": "Opcions de polissa",
	...
	"options.fovEffectScale.tooltip": "Regula l'amplitud de las variacions del camp de vision en foncion dels efièches en jòc.",
	"options.framerate": "%s fps",
	"options.framerateLimit": "FPS maximom",
	"options.framerateLimit.max": "Illimitat",
	"options.friendsList": "Lista d'amics",
	"options.friendsList.confirm.message": "Emplegatz aquela lista d'amics per mandar e recebre de demandas d'amistat.\n\nAdministratz los paramètres de seguretat en linha amb vòstre %s.",
	"options.friendsList.confirm.message.link": "Compte Microsoft",
	"options.friendsList.confirm.title": "Lista d'amics",
	...
	"options.fullscreen.exclusive.mode": "Mòde plen ecran exlusiu",
	"options.fullscreen.exclusive.mode.tooltip": "Aqueste paramètre foncionará pas que se lo plen ecran exclusiu es activat.",
	...
	"options.glintSpeed": "Velocitat del scintilhament ",
	"options.glintSpeed.tooltip": "Contraròtla la velocitat del scintilhament dels objèctes encantats.",
	"options.glintStrength": "Fòrça del scintilhament ",
	"options.glintStrength.tooltip": "Contraròtla la lindetat dels objèctes encantats.",
	"options.graphics": "Grafics",
	"options.graphics.custom": "Personalizats",
	"options.graphics.fabulous": "Fabuloses!",
	"options.graphics.fabulous.tooltip": "Los grafismes \"%s\" emplegan los ombrejaires per dessenhar los nívols e las particulas, coma aquelas de la meteo, darrièr los blòcs translucids.\nPòt impactar fòrça las qualitats tecnicas dels aparelhs portables e dels ecrans 4K.",
	"options.graphics.fancy": "Detalhats",
	"options.graphics.fancy.tooltip": "Los grafismes \"Detalhats\" porgisson un equilibri entre qualitats tecnicas e graficas per la magèr part dels aparelhs.\nLo temps atmosferic e las particulas, que las del temps atmosferic, pòdon o pas aparreisser darrièr los blòcs lindes e l'aiga.",
	"options.graphics.fast": "Rapides",
	"options.graphics.fast.tooltip": "Los grafismes \"rapids\" redusisson la qualitat de la pluèja e de la nèu visibles al ecran.\nLos efièches de lindetat son desactivats per d'unes blòcs, tal coma las fuèlhas.",
	"options.graphics.preset": "Prereglatge",
	"options.graphics.preset.tooltip": "Bota los paramètres \"Qualitats tecnicas e graficas\" sus de valors per deca adaptadas a la qualitat volguda.",
	"options.graphics.warning.accept": "Contunhar sens assistància",
	"options.graphics.warning.cancel": "Revenir en arrièra",
	"options.graphics.warning.message": "Vòstre periferic grafic es estat detectat coma pas compatible amb l'opcion grafica \"%s\".\n\nPodètz causir d'ignorar aqueste messatge, mas pas cap de presa en carga serà provesida se causissètz d'emplegar los grafismes \"%s\".",
	"options.graphics.warning.renderer": "Motor de rendut detectat : [%s]",
	"options.graphics.warning.title": "Periferic grafic pas compatible",
	"options.graphics.warning.vendor": "Fornisseire detectat : [%s]",
	"options.graphics.warning.version": "Version d'OpenGL detectada: [%s]",
	"options.graphicsApi": "API grafica",
	"options.graphicsApi.default": "Per deca",
	"options.graphicsApi.opengl": "Preferir OpenGL",
	"options.graphicsApi.restart": "Devètz tornar amodar vòstre jòc per cambiar l'API grafica.",
	"options.graphicsApi.tooltip": "Quin API (Interfàcia de Programacion d'Aplicacion) grafica es emplegada pel rendut. Daissatz \"Per deca\" s'avètz pas de rason especifica per o cambiar!",
	"options.graphicsApi.tooltip.vulkan": "Experimental. Pòt reduire las performanças o provocar una instabilitat sus d'unes sistèmas.",
	...
	"options.hideLightningFlashes": "Amagar la lutz dels fólzers",
	...
	"options.hideMatchedNames.tooltip": "Los servidors tèrces pòdon mandar de messatges de format pas estandard dins lo chat.\nSe aquesta opcion es activada, los jogaires amagats seràn associats segonlo nom dels mandaires dins lo chat.",
	"options.hideSplashTexts": "Amagar los tèxts d'acuèlh",
	"options.hideSplashTexts.tooltip": "Amaga lo tèxt d'acuèlh jaune sul menut principal.",
	"options.improvedTransparency": "Lindetat melhorada",
	"options.improvedTransparency.oit.tooltip": "Un apròchi experimental qu'emplega d'ombrejaires d'ecran per dessenhar lo temps atmosferic, los nívols e las particulas darrièr los blòcs lindes e l'aiga.\nAquò impactarà las performanças de la carta grafica.",
	"options.improvedTransparency.tooltip": "Un apròchi experimental qu'emplega d'ombrejaires d'ecran per dessenhar lo temps atmosferic, los nívols e las particulas darrièr los blòcs lindes e l'aiga.\nAquò impactarà las performanças de la carta grafica.",
	"options.inGameNotification": "Notificacions en jòc",
	"options.inGameNotification.tooltip": "Mostrar las notificacions dels amics en jòc",
	"options.inactivityFpsLimit": "Reduire los FPS quand",
	"options.inactivityFpsLimit.afk": "Inactiu",
	"options.inactivityFpsLimit.afk.tooltip": "Limita la quantitat d'imatges per segonda a 30 quand lo jogaire es inactiu pendent mai d'una minuta, e a 10 aprèp 9 minutas de mai.",
	"options.inactivityFpsLimit.minimized": "Fenèstra reducha",
	"options.inactivityFpsLimit.minimized.tooltip": "Limita pas la quantitat d'imatges per segonda que quand la fenèstra del jòc es reducha.",
	"options.invertMouse": "Inversar la Mirga",
	"options.invertMouseX": "Inversar l'ais X",
	"options.invertMouseY": "Inversar l'ais Y",
	"options.japaneseGlyphVariants": "Caractèrs japoneses",
	"options.japaneseGlyphVariants.tooltip": "Emplega las versions japoneses dels caractèrs CJC dins la polissa per deca.",
	"options.key.hold": "Segurar",
	"options.key.toggle": "Alternar",
	"options.language": "Lenga...",
	"options.language.empty_or_missing_translation": "Lo fichièr de revirada per \"%s\" es void o mancant. Tornatz iniciar los vòstres jòc e lançaire, e puèi tornatz ensajar.",
	"options.language.load_translations_failed": "Cargament de las reviradas pas capitat",
	"options.language.narration": "Cambiar la lenga",
	"options.language.title": "Lenga",
	"options.language.tooltip": "Cambiar la lenga",
	...
	"options.maxAnisotropy": "Filtratge anistropic",
	"options.maxAnisotropy.tooltip": "Cada nivèl melhora fòrça l'aspècte lis de las texturas, mas impacta las performanças e aumenta fòrça l'empleg de la memòria video. Necessita d'aver botat lo \"Filtratge de las texturas\" a \"Anistropic\".",
	...
	"options.multiplayer.title": "Dobrir al ret local",
	"options.multiplier": "%sx",
	"options.musicToast": "Notificacion musicala",
	"options.musicToast.never": "Jamai",
	"options.musicToast.never.tooltip": "Cap de notificacions musicalas es mostrada.",
	"options.musicToast.pauseMenu": "Menut",
	"options.musicToast.pauseMenu.tooltip": "Una notificacion musicala es mostrada dins lo menut de pausa mentre qu'una musica es jogada.",
	"options.musicToast.pauseMenuAndToast": "Òc",
	"options.musicToast.pauseMenuAndToast.tooltip": "Mostra una notificacion quand una musica comença. Aquela notificacion es tanben mostrada dins lo menut de pausa mentre que la musica es jogada.",
	"options.music_frequency": "Frequéncia de la musica",
	"options.music_frequency.constant": "En continú",
	"options.music_frequency.default": "Per deca",
	...
	"options.narrator.all": "Narrar tot",
	"options.narrator.chat": "Narrar lo chat",
	"options.narrator.notavailable": "Pas disponible",
	"options.narrator.off": "Desactivat",
	"options.narrator.system": "Narrar lo sistèma",
	"options.needsRestart": "A besonh de tornar amodar lo jòc.",
	"options.notifications.display_time": "Durada de las notificacions",
	"options.notifications.display_time.tooltip": "Contraròtla la durada d'afichatge de las notificacions sul ecran.",
	"options.off": "Desactivat",
	"options.off.composed": "%s: Desactivat",
	"options.on": "Activat",
	"options.on.composed": "%s:  Activat",
	"options.online": "En linha...",
	"options.online.friends.header": "Lista d'amics",
	...
	"options.onlyShowSecureChat": "Chat securizat",
	"options.onlyShowSecureChat.tooltip": "Aficha pas que los messatges verificats e pas modificats dels autres jogaires.",
	...
	"options.prioritizeChunkUpdates.nearby": "Totjorn",
	"options.prioritizeChunkUpdates.nearby.tooltip": "Los tròces a proximitat son totjorn compilats tre que possible. Pòt afectar las performanças del jòc quand de blòcs son plaçats o trencats.",
	"options.prioritizeChunkUpdates.none": "En parallèl",
	"options.prioritizeChunkUpdates.none.tooltip": "Los tròces pròches son compilats dins de fials d'execucion parallèls. Pòt causar de traucs visuals bracs quand de blòcs son trencats.",
	"options.quitShortcuts": "Corchas de barradura",
	"options.quitShortcuts.tooltip": "Règla se las corchas clavièr pòdon barrar lo jòc. Se desactivat, Alt + F4 sus Windows e Linux, e Cmd + Q e Cmd + W sus macOS, barraràn pas mai lo jòc.",
	"options.rawMouseInput": "Dintrada dirècta",
	"options.realmsNotifications": "Notificacions de Realms",
	"options.realmsNotifications.button": "Novèlas e invitacions",
	"options.realmsNotifications.tooltip": "Recobra las novèlas e las invitacions de Realms dins lo menut principal e aficha lors icònas respectivs sul boton de Realms.",
	"options.reducedDebugInfo": "Informacions de desbogatge reduchas",
	"options.renderClouds": "Nívols",
	"options.renderCloudsDistance": "Distància dels nívols",
	"options.renderDistance": "Dist. d'afichatge",
	"options.resourcepack": "Paquets de ressorsa...",
	"options.restartRequired": "D'unes cambiaments an besonh de tornar amodar lo jòc.",
	"options.rotateWithMinecart": "Virar amb los vagonets",
	"options.rotateWithMinecart.tooltip": "Contraròtla se la vista del jogaire deu virar amb lo vagonet. Pas disponible que sus de monds ont lo paramètre experimental \"Vagonets melhorats\" es activat.",
	...
	"options.sharePresence": "Visibilitat",
	"options.sharePresence.all": "Totala",
	"options.sharePresence.all.tooltip": "Los amics pòdon veire çò a que jogatz.",
	"options.sharePresence.limited": "Limitada",
	"options.sharePresence.limited.tooltip": "Los amics pòdon veire se sètz en linha, mas pas çò a que jogatz.",
	"options.sharePresence.none": "Pas cap",
	"options.sharePresence.none.tooltip": "Los amics vos veiràn totjorn fòra de linha.",
	"options.showNowPlayingToast": "Notificacion musicala",
	"options.showNowPlayingToast.tooltip": "Mostra una notificacion quand una musica comença. Aquela notificacion es tanben mostrada dins lo menut de pausa mentre que la musica es jogada.",
	"options.showSubtitles": "Sostítols",
	"options.showSubtitles.tooltip": "Activar los sostítols des sons jogats dins lo jòc.",
	...
	"options.sprintWindow": "Interval de correguda",
	"options.sprintWindow.tooltip": "Interval de temps, en cicles, mentre lo qual clicar dos còps la tòca \"Avançar\" fa córrer.",
	"options.telemetry": "Donadas de telemesura...",
	"options.telemetry.button": "Collècta de donadas",
	"options.telemetry.button.tooltip": "\"%s\" inclutz pas que las donadas requesidas.\n\"%s\" inclutz las donadas facultativas e requesidas.",
	"options.telemetry.disabled": "La telemesura es desactivada.",
	"options.telemetry.state.all": "Tot",
	"options.telemetry.state.minimal": "Minimala",
	"options.telemetry.state.none": "Cap",
	"options.textureFiltering": "Filtratge de las texturas",
	"options.textureFiltering.anisotropic": "Anistropic",
	"options.textureFiltering.anisotropic.tooltip": "Un biais de filtratge material qu'impacta las performanças e aumenta fòrça l'empleg de la memòria video. Pòt èsser pas pres en carga per totes los aparelhs.",
	"options.textureFiltering.none": "Cap",
	"options.textureFiltering.none.tooltip": "Las texturas son afichadas sens filtratge. Los blòcs pòdon aparéisser foscs se vists d'unas perspectivas.",
	"options.textureFiltering.rgss": "EEGR",
	"options.textureFiltering.rgss.tooltip": "L'Extrà-Escandalhatge a Grilha Rotativa (EEGR) es un biais de filtratge basat sus los ombrejaires que melhoran la qualitat de las texturas amb un impacte moderat sus las performanças.",
	"options.title": "Opcions",
	"options.touchscreen": "Mòde Fenestron Tactil",
	"options.value": "%s",
	"options.video": "Opcions graficas...",
	"options.video.display.header": "Afichatge",
	"options.video.interface.header": "Interfàcia",
	"options.video.preferences.header": "Preferéncias",
	"options.video.quality.header": "Qualitats tecnicas e graficas",
	"options.videoTitle": "Opcions graficas",
	"options.viewBobbing": "Movement de vision",
	"options.vignette": "Mostrar las vinhetas",
	"options.vignette.tooltip": "Un tèxt subtil aplicat al ecran del jòc per reduire la luminositat cap als bòrds de la vista e indicar al jogaire que se sarra de la bordadura del mond.",
	"options.visible": "Vesible",
	"options.vsync": "VSync",
	"options.weatherRadius": "Rai dels efièches meteorologics",
	"options.weatherRadius.tooltip": "Rai de la zona ont los efièches de la pluèja e de la nèu son visibles. Pauc d'impacte sus las performanças.",
	"options.worldOptions.allow_commands.disabled.demo.tooltip": "Pòt pas autorizar las comandas dins un mond d'ensag.",
	"options.worldOptions.allow_commands.disabled.tooltip": "Pòt pas autorizar las comandas dins un mond extrèm.",
	"options.worldOptions.allow_commands.tooltip": "Permés d'utilizar las comandas dins aquel mond.",
	"options.worldOptions.button": "Opcions del mond...",
	"options.worldOptions.difficulty.disabled.hardcore.tooltip": "Pòt pas cambiar la dificultat dins un mond extrèm.",
	"options.worldOptions.difficulty.disabled.locked.tooltip": "La dificultat es verrolhada.",
	"options.worldOptions.difficulty.disabled.operator.tooltip": "Avètz besonh de las permissions d'operator per cambiar la dificultat.",
	"options.worldOptions.game_mode": "Mòde de jòc per deca",
	"options.worldOptions.game_mode.disabled.operator.tooltip": "Avètz besonh de las permissions d'operator per cambiar lo mòde de jòc.",
	"options.worldOptions.game_mode.disabled.tooltip": "Pòt pas cambiar lo mòde de jòc dins un mond extrèm.",
	"options.worldOptions.game_mode.tooltip": "Cambia lo mòde de jòc per deca.",
	"options.worldOptions.general.title": "General",
	"options.worldOptions.guest.command_access": "Accès a las comandas",
	"options.worldOptions.guest.command_access.disabled.commands.tooltip": "Pòt pas cambiar l'accès a las comandas pels jogaires que rejonhan lo mond se las comandas son pas autorizadas.",
	"options.worldOptions.guest.command_access.disabled.scope.tooltip": "Pòt pas cambiar l'accès a las comandas pels jogaires que rejonhan lo mond se lo paramètre multijogaire del mond es botat a \"Desactivat\".",
	"options.worldOptions.guest.command_access.tooltip": "Contraròtla se los jogaires que rejonhan lo mond pòdon utilizar de comandas o pas.",
	"options.worldOptions.guest.force_game_mode": "Forçar lo mòde de jòc",
	"options.worldOptions.guest.force_game_mode.off.commands.tooltip": "Los autres jogaires pòdon causir lor mòde de jòc amb de comandas.",
	"options.worldOptions.guest.force_game_mode.off.hardcore.tooltip": "Pòt pas cambiar aquel paramètre dins un mond extrèm.",
	"options.worldOptions.guest.force_game_mode.off.scope.tooltip": "Pòt pas cambiar aquel paramètre se lo paramètre multijogaire del mond es botat a \"Desactivat\".",
	"options.worldOptions.guest.force_game_mode.off.tooltip": "Los autres jogaires gardaràn lor mòde de jòc actual, quin que sià lo mòde de jòc per deca del mond.",
	"options.worldOptions.guest.force_game_mode.on.tooltip": "Los autres jogaires seràn forçats de jogar dins lo mòde de jòc per deca del mond.",
	"options.worldOptions.multiplayer.title": "Multijogaire",
	"options.worldOptions.personal_game_mode": "Mòde de jòc personal",
	"options.worldOptions.personal_game_mode.tooltip": "Cambia lo vòstre mòde de jòc dins aquel mond.",
	"options.worldOptions.title": "Opcions del mond",
	"outOfMemory.message": "Minecraft a pas pro de memòria.\n\nPòt èsser degut a un bug dins lo jòc o a la manca de memòria disponible de la maquina virtuala Java.\n\nPer empachar la corrupcion del mond, la partida es estada barrada. Avèm ensajat de liberar pro de memòria per que tornatz al menut principal e contunhatz a jogar, mas benlèu a pas capitat.\n\nSe vos plai, tornatz amodar lo jòc se vesètz encara aquel messatge.",
	"outOfMemory.title": "Pas pus de memòria!",
	"pack.available.title": "Disponibles",
	"pack.copyFailure": "Fracàs de la còpia dels paquets",
	"pack.dropConfirm": "Volètz apondre los paquets que venon a Minecraft?",
	"pack.dropInfo": "Lisatz-depausatz de fichièrs dins aquesta fenèstra per apondre de paquets",
	...
	"pack.incompatible.confirm.new": "Aqueste paquet es estat creat per une version mai nòva de Minecraft, e pòt foncionar pas corrèctament.",
	"pack.incompatible.confirm.old": "Aqueste paquet es estat creat per une version mai anciana de Minecraft, e pòt foncionar pas mai corrèctament.",
	"pack.incompatible.confirm.title": "Sètz segur de voler cargar aqueste paquet?",
	"pack.incompatible.confirm.unknown": "Aqueste paquet es endecat o creat per una version desconeguda e pòt foncionar pas corrèctament.",
	...
	"pack.incompatible.unknown": "(Endecat o incompatible)",
	"pack.nameAndSource": "%s (%s)\n",
	"pack.openFolder": "Dobrir lo dossièr dels paquets",
	"pack.selected.title": "Seleccionats",
	"pack.source.builtin": "integrat",
	"pack.source.feature": "foncionalitat",
	...
	"painting.minecraft.fern.title": "La falguièra",
	...
	"parsing.quote.escape": "Sequéncia d'escapament \"\\%s\" pas valida dins una cadena entre verguetas",
	"parsing.quote.expected.end": "Cadena entre verguetas pas barrada",
	"parsing.quote.expected.start": "S'esperava una vergueta per inciar la cadena",
	"particle.invalidOptions": "Fracàs de l'analisi sintaxica de las opcions de particulas : %s",
	"particle.notFound": "Particula desconeguda : \"%s\"",
	"permissions.requires.entity": "Una entitat es requesida per executar aquesta comanda aicí",
	"permissions.requires.player": "Un jogaire es requesiy per executar aquesta comanda aicí",
	"potion.potency.1": "II",
	"potion.potency.2": "III",
	"potion.potency.3": "IV",
	"potion.potency.4": "V",
	"potion.potency.5": "VI",
	"potion.whenDrank": "Efièch aplicat :",
	"potion.withAmplifier": "%s %s",
	"potion.withDuration": "%s (%s)",
	"predicate.unknown": "Predicat desconegut: %s",
	"quickplay.error.invalid_identifier": "Se pòt pas trobar un mond amb l'identificant provesit",
	"quickplay.error.realm_connect": "Se pòt pas connectar al Realm",
	"quickplay.error.realm_permission": "Avètz pas la permission de vos connectar a aqueste Realm",
	"quickplay.error.title": "Mèuca del lançament de la partida rapida",
	...
	"realms.configuration.region.canada_central": "Canadà",
	...
	"realms.configuration.region.west_us_3": "Estats Units (Arizòna)",
	...
	"recipe.toast.title": "Nòva(s) recèpta(s)!",
	"record.nowPlaying": "Lectura en cors : %s",
	"recover_world.bug_tracker": "Senhalar un bug",
	"recover_world.button": "Ensajar de recobrar",
	"recover_world.done.failed": "Mèuca de la recobrada del estat d'abans.",
	"recover_world.done.success": "Recobrada capitada!",
	"recover_world.done.title": "Recobrada acabada",
	"recover_world.issue.missing_file": "Fichièr mancant",
	"recover_world.issue.none": "Cap de problèma",
	"recover_world.message": "Los problèmas que venon son estats produsits en ensajant de legir lo repertòri del mond \"%s\".\nEnsajatz de recobrar lo mond dempuèi una version mai anciana o senhalètz lo bug sus lo siti vodat.",
	"recover_world.no_fallback": "Cap d'estat a recobrar disponible",
	"recover_world.restore": "Ensajar de recobrar",
	"recover_world.restoring": "Ensag de recombrar lo mond...",
	"recover_world.state_entry": "Estat de %s : ",
	"recover_world.state_entry.unknown": "desconegut",
	"recover_world.title": "Fracàs al cargament del mond",
	"recover_world.warning": "Fracàs al cargament del resumit del mond",
	"resourcePack.broken_assets": "RESSORSAS ENDECADAS DETECTADAS",
	"resourcePack.high_contrast.name": "Contrast naut",
	"resourcePack.load_fail": "Error en recargar los recorsos",
	"resourcePack.programmer_art.name": "Art del programaire",
	"resourcePack.runtime_failure": "Error detectada dins lo paquet de ressorsa",
	"resourcePack.server.name": "Ressorças especificas au monde",
	"resourcePack.title": "Seleccionar de paquets de ressorsa",
	"resourcePack.vanilla.description": "L'aparéncia per deca de Minecraft",
	...
	"restrictions_screen.permission.receive_player_messages.allowed": "Podètz recebre de messatges dels jogaires",
	"restrictions_screen.permission.receive_player_messages.denied": "Podètz pas recebre de messatges dels jogaires",
	"restrictions_screen.permission.receive_system_messages.allowed": "Podètz recebre de messatges sistèma del servidor",
	"restrictions_screen.permission.receive_system_messages.denied": "Podètz recebre de messatges sistèma del servidor",
	"restrictions_screen.permission.send_commands.allowed": "Podètz mandar de comandas",
	"restrictions_screen.permission.send_commands.denied": "Podètz pas mandar de comandas",
	"restrictions_screen.permission.send_messages.allowed": "Podètz mandar de messatges dins lo chat",
	"restrictions_screen.permission.send_messages.denied": "Podètz pas mandar de messatges dins lo chat",
	...
	"selectServer.deleteWarning": "\"%s\" serà perdut per totjorn! (Plan longtemps)",
	...
	"selectWorld.access_failure": "Fracàs de l'accès al mond",
	...
	"selectWorld.backupEraseCache": "Escafar las informacions amagadas",
	...
	"selectWorld.backupQuestion.downgrade": "La retrogradacion d'un mond cap a una version mai anciana es pas presa en carga",
	"selectWorld.backupQuestion.experimental": "Los mondes qu'utilizan de paramètres experimentaus son pas suportats",
	"selectWorld.backupQuestion.file_fixing_required": "Crear una sauvagarda abans d'optimizar aqueste mond?",
	"selectWorld.backupQuestion.snapshot": "Volètz de verai cargar aqueste mond?",
	"selectWorld.backupWarning.customized": "Malurosament, los monds personalizats son pas suportats in aquela version de Minecraft. Podèm ensajar de cargar aquel mond e gardar tot coma èra, mas cada novèl terren generat podrà pas èsser personalizat. Desencusatz-nos per aquela inconveniéncia!",
	"selectWorld.backupWarning.downgrade": "Aqueste mond foguèt jogat pel darrièr còp dins la version %s; sètz en version %s. Retrogradar un mond pòt causar de corrupcion - pòdem pas garantir que se cargarà o foncionarà.\nSe volètz pasmens contunhar, se vos plai, fasètz una sauvagarda.",
	"selectWorld.backupWarning.experimental": "Aquel mond utiliza de paramètres experimentaus que pòdon arrestar de foncionar a cada instant. Pòdem pas assegurar que va cargar o capitar. Aquò es a vòstre risc!",
	"selectWorld.backupWarning.file_fixing_required": "Aqueste mond deu èsser mes a jorn abans de poder i jogar. Vos recomandam de lo sauvagardar abans de contunhar, en cas que vòstre mond se corrompa.",
	"selectWorld.backupWarning.snapshot": "Aquel mond foguèt jogat en darrièr en version %s, sètz sus la Snapshot %s. Mercé de far una sauvagarda en cas que lo mond serià corromput.",
	...
	"selectWorld.conversion.tooltip": "Aquel mond dèu èsser dobèrt dins una version mai anciana (coma la 1.6.4) per èsser convertit en tota seguretat",
	...
	"selectWorld.delete_failure": "Pas capitat a suprimir lo mond",
	...
	"selectWorld.edit.backupSize": "talha : %s Mo",
	...
	"selectWorld.edit.openFolder": "Dobrir lo dossièr del mond",
	"selectWorld.edit.optimize": "Optimizar lo mond",
	...
	"selectWorld.experimental.details.entry": "Foncionalitats experimentalas requesidas : %s",
	"selectWorld.experimental.details.title": "Exigéncias de foncionalitats experimentalas",
	"selectWorld.experimental.message": "Atencion!\nAquesta configuracion a besonh de foncionalitats que son encara en desvolopament. Vòstre mond poiriá crashèr, se corrompre o pas foncionar mai amb las mesas a jorn que venon.",
	"selectWorld.experimental.title": "Avís sus las foncionalitats experimentalas",
	"selectWorld.experiments": "Experimentacions",
	"selectWorld.experiments.info": "Las experimentacions son de foncionalitats potencialas nòvas. Fasètz atencion, per que d'unas causas pòdon se corrompre. Las experimentacions pòdon pas èsser desactivadas un còp lo mond creat.",
	"selectWorld.futureworld.error.text": "Mèuca al temps de cargar lo mond dempuèi una version mai recenta. Èra ja riscat d'entrada, desolat s'a pas capitat.",
	...
	"selectWorld.gameMode.adventure.info": "Identic au mòde subrevida, mas los blòcs pòdon pas èsser plaçats o trencats.",
	...
	"selectWorld.gameMode.creative.info": "Creatz, bastissètz e explòratz sens limits. Podètz volar, aver de ressorsas a l'infinit e recebre pas de degalhs.",
	...
	"selectWorld.gameMode.hardcore.line1": "Identic al mòde subrevida, blocat a la",
	...
	"selectWorld.gameMode.survival.info": "Explòratz un mond misteriós ont podètz bastir, collectar, fargar e combatre de mostres.",
	...
	"selectWorld.incompatible.description": "Aqueste mond pòt ps èsser dobèrt dins aquesta version.\nEs estat dobèrt pel darrièr còp dins la version %s.",
	"selectWorld.incompatible.info": "Version incompatibla : %s",
	"selectWorld.incompatible.title": "Version incompatibla",
	"selectWorld.incompatible.tooltip": "Aqueste mond pòt pas èsser dobèrt pr'amor èra creat amb una version pas compatibla.",
	...
	"selectWorld.recreate.customized.text": "Los monds personalizats son pas mai suportats dins aquesta version de Minecraft. Podèm ensajar de o tornar crear amb las meteissas grana e proprietats, mas las personalizacions del terren seràn perdudas. Desencusatz-nos per aquela inconveniéncia!",
	"selectWorld.recreate.customized.title": "Los monds personalizats son pas mai suportats",
	"selectWorld.recreate.error.text": "Una mèuca se produsís mentre qu'ensajava de tornar crear un mond.",
	"selectWorld.recreate.error.title": "Una error s'es produsida!",
	"selectWorld.requiresFileFixingTooltip.edit": "Aqueste mond deu èsser mes a jorn a la darrièra version abans d'èsser modificat. Es degut a de cambiaments al format del mond.",
	"selectWorld.requiresFileFixingTooltip.play": "Aqueste mond deu èsser mes a jorn a la darrièra version abans d'i jogar. Es degut a de cambiaments al format del mond.",
	"selectWorld.requiresFileFixingTooltip.recreate": "Aqueste mond deu èsser mes a jorn a la darrièra version abans d'èsser tornat creat. Es degut a de cambiaments al format del mond.",
	"selectWorld.resource_load": "Preparacion de las ressorsas...",
	...
	"selectWorld.targetFolder": "Dossièr de sauvagarda : %s",
	...
	"selectWorld.tooltip.fromNewerVersion2": "e cargar aquel mond pòt pausar problèma!",
	...
	"selectWorld.upgrade_and_play": "Metre a jorn e jogar",
	...
	"selectWorld.waitingForBackup.message": "Segon la talha de vòstre mond, pòt prene de temps. Se vos plai, barretz pas vòstre jòc e atudetz pas vòstre aparelh.",
	"selectWorld.waitingForBackup.title": "Creacion de la sauvagarda",
	"selectWorld.warning.deprecated.question": "D'unas foncionalitats emplegadas son obsoletas e foncionaràn pas mai a l'avenidor. Volètz contunhar?",
	"selectWorld.warning.deprecated.title": "Atencion! Aquestes paramètres utilizan de foncionalitats obsoletas",
	"selectWorld.warning.experimental.question": "Aquestes paramètres son experimentals e pòdon daissar de foncionar un jorn. Volètz contunhar?",
	"selectWorld.warning.experimental.title": "Atencion! Aquestes paramètres utilizan de foncionalitats experimentalas",
	"selectWorld.warning.lowDiskSpace.description": "I a pas pus gaire d'espaci sul vòstre aparelh.\nMancar d'espaci sul disc pendent la partida poiriá damatjar vòstre mond.",
	"selectWorld.warning.lowDiskSpace.title": "Atencion! Espaci disc feble!",
	"selectWorld.world": "Mond",
	"selectWorld.world_gen_settings_access": "Impossible de legir o d'accedir al fichièr dels paramètres de generacion del mond! %s",
	"selecteWorld.backupRequiredTooltip": "Devètz far una sauvagarda abans de cargar aquel mond",
	"sign.back_text": "Tèxt del revèrs :",
	"sign.click_actions_disabled": "Las accions de clics son desactivadas sus aquesta pancarta",
	"sign.edit": "Modificar lo tèxte de la pancarta",
	"sign.front_text": "Tèxt del endrech :",
	"sleep.not_possible": "Pòt pas passar la nuèch",
	"sleep.players_sleeping": "%s/%s jogaires endormits",
	"sleep.skipping_night": "Passatz la nuèch",
	"slot.only_single_allowed": "Sonque los emplaçaments unencs son autorizats (valor recebuda: %s)",
	...
	"snbt.parser.expected_string_uuid": "Cadena que representa un UUID valid esperada",
	"snbt.parser.expected_unquoted_string": "Cadena sens verguetas esperada",
	"snbt.parser.infinity_not_allowed": "Los nombres pas finits son pas autorizats",
	"snbt.parser.invalid_array_element_type": "Tipe d'element de vector pas valid",
	"snbt.parser.invalid_character_name": "Nom del caractèr Unicòdi invalid",
	"snbt.parser.invalid_codepoint": "Valor del caractèr Unicòdi invalid : %s",
	"snbt.parser.invalid_string_contents": "Contengut de la cadena pas valid",
	"snbt.parser.invalid_unquoted_start": "Las cadenas sens verguetas pòdon pas començar per de chifras de 0 a 9, + o -",
	"snbt.parser.leading_zero_not_allowed": "Los nombres decimals pòdon pas començar per un 0",
	"snbt.parser.no_such_operation": "Aquesta operacion existís pas : %s",
	"snbt.parser.number_parse_failure": "Fracàs de l'analisi sintaxica del nombre : %s",
	"snbt.parser.undescore_not_allowed": "Los tirets del bas son pas autorizats al començament o la fin d'un nombre",
	...
	"soundCategory.record": "Blòcs musicals",
	"soundCategory.ui": "Interfàcia",
	"soundCategory.voice": "Narrator/Votz",
	"soundCategory.weather": "Temps Atmosferic",
	"spectator.cannot_teleport": "Podètz pas vos teleportar. La destinacion a pas cargat ja.",
	"spectatorMenu.close": "Barrar lo menut",
	...
	"stat.minecraft.boat_one_cm": "Distància en batèl",
	"stat.minecraft.clean_armor": "Pèças d'Armaduras Netejadas",
	"stat.minecraft.clean_banner": "Bandièras netejadas",
	"stat.minecraft.clean_shulker_box": "Bóstias de shulker netejadas",
	...
	"stat.minecraft.horse_one_cm": "Distància a caval",
	...
	"stat.minecraft.interact_with_blast_furnace": "Interaccions amb un naut fornèl",
	...
	"stat.minecraft.nautilus_one_cm": "Distància en nautile",
	...
	"stat.minecraft.pig_one_cm": "Distància montat sus un pòrc",
	"stat.minecraft.play_noteblock": "Blòcs musicals jogats",
	"stat.minecraft.play_record": "Discs de musica jogats",
	...
	"stat.minecraft.sleep_in_straw_bed": "Nuèches Passadas dins un lièch de palha",
	"stat.minecraft.sneak_time": "Temps Agrovat",
	"stat.minecraft.sprint_one_cm": "Distància corruda",
	"stat.minecraft.strider_one_cm": "Distància sus un arpentaire",
	...
	"stat.minecraft.tune_noteblock": "Blòcs musicals acordats",
	...
	"structure_block.custom_data": "Nom del tag de donanadas personalizat",
	"structure_block.detect_size": "Detectar la posicion e la talha :",
	...
	"structure_block.integrity.integrity": "Plenor de l'estructura",
	...
	"structure_block.mode.save": "Sauvagardar",
	"structure_block.mode_info.corner": "Mòde Canton - Marca de posicion e de talha",
	"structure_block.mode_info.data": "Mòde Donadas - Marca de la logica del jòc",
	"structure_block.mode_info.load": "Mòde cargar - cargar dempuèi un fichièr",
	"structure_block.mode_info.save": "Mòde sauvagardar - escriure dins un fiquièr",
	...
	"structure_block.show_air": "Mostrar los blòcs invisibles :",
	...
	"structure_block.size_failure": "Impossible de detectar la talha de l'estructura. Apondètz de cantons amb los noms d'estructura que correspondon",
	"structure_block.size_success": "Tailha detectada amb escasuda pòr '%s'",
	"structure_block.strict": "Plaçament estricte:",
	...
	"subtitles.block.barrel.close": "Barrica que se barra",
	"subtitles.block.barrel.open": "Barrica que se dobrís",
	...
	"subtitles.block.beehive.drip": "Mèl que goteja",
	"subtitles.block.beehive.enter": "Abelha dintra dins un bornhon",
	"subtitles.block.beehive.exit": "Abelha que sortís d'un bornhon",
	"subtitles.block.beehive.shear": "Rasclament de cisalhas",
	"subtitles.block.beehive.work": "Abelhas trabalhan",
	"subtitles.block.bell.resonate": "Campana que ressona",
	"subtitles.block.bell.use": "Campana que tinda",
	"subtitles.block.big_dripleaf.tilt_down": "Gotafuèlha plega",
	"subtitles.block.big_dripleaf.tilt_up": "Gotafuèlha se redreçar",
	"subtitles.block.blastfurnace.fire_crackle": "Naut fornèl que peteja",
	"subtitles.block.brewing_stand.brew": "Bolhona d'alambic",
	"subtitles.block.bubble_column.bubble_pop": "Botiòlas qu'esclatan",
	"subtitles.block.bubble_column.upwards_ambient": "Botiòlas que flòtan",
	"subtitles.block.bubble_column.upwards_inside": "Botiòlas que pujan",
	"subtitles.block.bubble_column.whirlpool_ambient": "Botiòlas que remolinan",
	"subtitles.block.bubble_column.whirlpool_inside": "Botiòlas qu'aspiran",
	...
	"subtitles.block.candle.crackle": "Candèla que peteja",
	"subtitles.block.candle.extinguish": "Candèla s'escantís",
	"subtitles.block.chest.close": "Còfre que se barra",
	"subtitles.block.chest.locked": "Còfre varrolhat",
	"subtitles.block.chest.open": "Còfre que se dobrís",
	...
	"subtitles.block.conduit.attack.target": "Atac de conduch",
	...
	"subtitles.block.copper_chest.close": "Còfre que se barra",
	"subtitles.block.copper_chest.open": "Còfre que se dobrís",
	"subtitles.block.copper_trapdoor.close": "Trapa que se barra",
	"subtitles.block.copper_trapdoor.open": "Trapa que se dobrís",
	...
	"subtitles.block.creaking_heart.spawn": "Còr de cruisseire que se desvelha",
	...
	"subtitles.block.dried_ghast.ambient": "Bruches d'assecada",
	"subtitles.block.dried_ghast.ambient_water": "Ghast secat que se torna idratar",
	"subtitles.block.dried_ghast.place_in_water": "Ghast secat que banha",
	"subtitles.block.dried_ghast.transition": "Ghast secat que se sent mièlhs",
	"subtitles.block.dry_grass.ambient": "Bruches de la ventada",
	"subtitles.block.enchantment_table.use": "Taula d'encantament utilizada",
	"subtitles.block.end_portal.spawn": "Portal de l'End que se dobrís",
	"subtitles.block.end_portal_frame.fill": "Uèlh d'Ender plaçat",
	"subtitles.block.eyeblossom.close": "Uèlhquidèa que se barra",
	"subtitles.block.eyeblossom.idle": "Mormolh d'uèlhquidèa",
	"subtitles.block.eyeblossom.open": "Uèlhquidèa que se dobrís",
	...
	"subtitles.block.firefly_bush.idle": "Bronzin de lusetas",
	"subtitles.block.frogspawn.hatch": "Capgròs qu'espelís",
	...
	"subtitles.block.hanging_sign.waxed_interact_fail": "Pancarta qu'oscilla",
	"subtitles.block.honey_block.slide": "Limpada sus un blòc de mèl",
	"subtitles.block.iron_trapdoor.close": "Trapa que se barra",
	"subtitles.block.iron_trapdoor.open": "Trapa que se dobrís",
	...
	"subtitles.block.note_block.note": "Blòc musical que jòga",
	...
	"subtitles.block.pointed_dripstone.drip_lava_into_cauldron": "Lava que goteja dins una pairòla",
	"subtitles.block.pointed_dripstone.drip_water": "Aiga gota",
	"subtitles.block.pointed_dripstone.drip_water_into_cauldron": "Aiga que goteja dins una pairòla",
	"subtitles.block.pointed_dripstone.land": "Estalactita que s'esclafa",
	"subtitles.block.poplar_leaves.ambient": "Brusiment de la fuèlhas",
	...
	"subtitles.block.potent_sulfur.geyser_eruption": "Erupcion de guèiser",
	"subtitles.block.potent_sulfur.noxious_gas": "Gas toxis qu'apareis",
	"subtitles.block.pressure_plate.click": "Clics de Placa de Pression",
	"subtitles.block.pumpkin.carve": "Cisalhas qu'escultan",
	"subtitles.block.redstone_torch.burnout": "Entòrcha que grasilha",
	"subtitles.block.respawn_anchor.ambient": "Ancora de reaparicion que brusís",
	"subtitles.block.respawn_anchor.charge": "Acora de reaparicion cargada",
	"subtitles.block.respawn_anchor.deplete": "Ancora de reaparicion que s'agota",
	"subtitles.block.respawn_anchor.set_spawn": "Ancora de reaparicion activada",
	"subtitles.block.sand.idle": "Bruches de sabla",
	"subtitles.block.sand.wind": "Bruches del ventada",
	"subtitles.block.sculk.charge": "Sculk que bolhona",
	...
	"subtitles.block.shelf.activate": "Estaudèla activada",
	"subtitles.block.shelf.deactivate": "Estaudèla desactivada",
	"subtitles.block.shelf.multi_swap": "Objèctes intercambiats",
	"subtitles.block.shelf.place_item": "Objècte plaçat",
	"subtitles.block.shelf.single_swap": "Objècte escambiat",
	"subtitles.block.shelf.take_item": "Objècte pres",
	"subtitles.block.shelf_mushroom.bounce": "Quicòm sauta sus un polipòre",
	"subtitles.block.shulker_box.close": "Shulker que se barra",
	"subtitles.block.shulker_box.open": "Bóstia de shulker que se dobrís",
	"subtitles.block.sign.waxed_interact_fail": "Pancarta oscilla",
	"subtitles.block.smithing_table.use": "Taula de fargatge utilizada",
	"subtitles.block.smoker.smoke": "Fumador que fuma",
	...
	"subtitles.block.sponge.absorb": "Esponja qu'absorbís",
	"subtitles.block.straw_bed.break_leave": "Lièch de palha trencat",
	"subtitles.block.sweet_berry_bush.pick_berries": "Baias culhidas",
	"subtitles.block.trapdoor.close": "Trapa que se barra",
	"subtitles.block.trapdoor.open": "Trapa que se dobrís",
	"subtitles.block.trapdoor.toggle": "Trapa que peta",
	...
	"subtitles.block.trial_spawner.open_shutter": "Generator de las espròvas que se dobrís",
	...
	"subtitles.block.vault.ambient": "Còfrefòrt que peteja",
	...
	"subtitles.entity.allay.ambient_with_item": "Allay que cèrca",
	"subtitles.entity.allay.ambient_without_item": "Allay que se languís",
	"subtitles.entity.allay.death": "Allay que morís",
	"subtitles.entity.allay.hurt": "Allay nafrat",
	"subtitles.entity.allay.item_given": "Allay clocís",
	"subtitles.entity.allay.item_taken": "Allay que s'apasima",
	"subtitles.entity.allay.item_thrown": "Allay que lança",
	"subtitles.entity.armadillo.ambient": "Tató que rena",
	"subtitles.entity.armadillo.brush": "Brossatge d'un tató",
	"subtitles.entity.armadillo.death": "Tató que morís",
	...
	"subtitles.entity.armadillo.land": "Tató qu'aterrís",
	...
	"subtitles.entity.axolotl.attack": "Axolòtl qu'ataca",
	"subtitles.entity.axolotl.death": "Axolòtl morís",
	"subtitles.entity.axolotl.hurt": "Axolòtl nafrat",
	"subtitles.entity.axolotl.idle_air": "Axolòtl que bresilha",
	"subtitles.entity.axolotl.idle_water": "Axolòtl que bresilha",
	"subtitles.entity.axolotl.splash": "Axolòtl qu'esposca",
	"subtitles.entity.axolotl.swim": "Axolòtl que nada",
	"subtitles.entity.baby_cat.ambient": "Caton que miaula",
	"subtitles.entity.baby_cat.beg_for_food": "Caton que mendica",
	"subtitles.entity.baby_cat.death": "Caton que morís",
	"subtitles.entity.baby_cat.eat": "Caton que manja",
	"subtitles.entity.baby_cat.hiss": "Caton que siula",
	"subtitles.entity.baby_cat.hurt": "Caton nafrat",
	"subtitles.entity.baby_cat.purr": "Caton que ronroneja",
	"subtitles.entity.baby_chicken.ambient": "Poleton que piaula",
	"subtitles.entity.baby_chicken.death": "Poleton que morís",
	"subtitles.entity.baby_chicken.hurts": "Poleton nafrat",
	"subtitles.entity.baby_horse.ambient": "Polin qu'endilha",
	"subtitles.entity.baby_horse.angry": "Polin encanhat qu'endilha",
	"subtitles.entity.baby_horse.breathe": "Alen d'un polin",
	"subtitles.entity.baby_horse.death": "Polin que morís",
	"subtitles.entity.baby_horse.eat": "Polin que manja",
	"subtitles.entity.baby_horse.hurt": "Polin nafrat",
	"subtitles.entity.baby_horse.land": "Polin qu'aterrís",
	"subtitles.entity.baby_nautilus.ambient": "Nenet de nautile que babilha",
	"subtitles.entity.baby_nautilus.ambient_land": "Nenet de nautile que babilha",
	"subtitles.entity.baby_nautilus.death": "Nenet de nautile que morís",
	"subtitles.entity.baby_nautilus.death_land": "Nenet de nautile que morís",
	"subtitles.entity.baby_nautilus.eat": "Nenet de nautile que manja",
	"subtitles.entity.baby_nautilus.hurt": "Nenet de nautile nafrat",
	"subtitles.entity.baby_nautilus.hurt_land": "Nenet de nautile nafrat",
	"subtitles.entity.baby_nautilus.swim": "Nenet de nautile que nada",
	"subtitles.entity.baby_pig.ambient": "Crit d'un porcelon",
	"subtitles.entity.baby_pig.death": "Porcelon que morís",
	"subtitles.entity.baby_pig.eat": "Porcelon que manja",
	"subtitles.entity.baby_pig.hurt": "Porcelon nafrat",
	"subtitles.entity.baby_wolf.ambient": "Jaupadís de lobaton",
	"subtitles.entity.baby_wolf.death": "Lobaton que morís",
	"subtitles.entity.baby_wolf.growl": "Lobaton que rona",
	"subtitles.entity.baby_wolf.hurt": "Lobaton nafrat",
	"subtitles.entity.baby_wolf.pant": "Lobaton que pantuga",
	"subtitles.entity.baby_wolf.whine": "Lobaton que gemís",
	...
	"subtitles.entity.bogged.ambient": "Enfagat que claqueja",
	"subtitles.entity.bogged.death": "Enfagat que morís",
	"subtitles.entity.bogged.hurt": "Enfagat nafrat",
	"subtitles.entity.breeze.charge": "Ventolet carga",
	"subtitles.entity.breeze.death": "Ventolet que morís",
	"subtitles.entity.breeze.deflect": "Ventolet desvia",
	"subtitles.entity.breeze.hurt": "Ventolet nafrat",
	"subtitles.entity.breeze.idle_air": "Ventolet que vòla",
	...
	"subtitles.entity.breeze.land": "Ventolet qu'aterrís",
	...
	"subtitles.entity.breeze.wind_burst": "Carga de vent que peta",
	"subtitles.entity.camel.ambient": "Dromadari que rena",
	"subtitles.entity.camel.dash": "Dromadari que carga",
	"subtitles.entity.camel.dash_ready": "Dromadari qu'a recobrat",
	"subtitles.entity.camel.death": "Dromadari que morís",
	"subtitles.entity.camel.eat": "Dromadari que manja",
	"subtitles.entity.camel.hurt": "Dromadari nafrat",
	"subtitles.entity.camel.saddle": "Sèla equipada",
	"subtitles.entity.camel.sit": "Dromadari que s'assèta",
	"subtitles.entity.camel.stand": "Dromadari que se lèva",
	"subtitles.entity.camel.step": "Dromadari que camina",
	"subtitles.entity.camel.step_sand": "Dromadari que trepeja la sabla",
	"subtitles.entity.camel_husk.ambient": "Dromadari momificat que rena",
	"subtitles.entity.camel_husk.dash": "Dromadari momificat que carga",
	"subtitles.entity.camel_husk.dash_ready": "Dromadari momificat qu'a recobrat",
	"subtitles.entity.camel_husk.death": "Dromadari momificat que morís",
	"subtitles.entity.camel_husk.eat": "Dromadari momificat que manja",
	"subtitles.entity.camel_husk.hurt": "Dromadari momificat nafrat",
	"subtitles.entity.camel_husk.saddle": "Sèla equipada",
	"subtitles.entity.camel_husk.sit": "Dromadari momificat que s'assèta",
	"subtitles.entity.camel_husk.stand": "Dromadari momificat que se lèva",
	"subtitles.entity.cat.ambient": "Cat que miaula",
	"subtitles.entity.cat.beg_for_food": "Cat que quista",
	"subtitles.entity.cat.death": "Cat morís",
	"subtitles.entity.cat.eat": "Cat que manja",
	"subtitles.entity.cat.hiss": "Cat siula",
	"subtitles.entity.cat.hurt": "Cat nafrat",
	"subtitles.entity.cat.purr": "Cat que ronroneja",
	...
	"subtitles.entity.cod.flop": "Merluça que sauteja",
	"subtitles.entity.cod.hurt": "Merluça nafrada",
	"subtitles.entity.copper_golem.death": "Golem de coire que morís",
	"subtitles.entity.copper_golem.hurt": "Golem de coire nafrat",
	"subtitles.entity.copper_golem.item_drop": "Golem de coire que plaça un objècte",
	"subtitles.entity.copper_golem.item_no_drop": "Golem de coire pòt pas plaçar l'objècte",
	"subtitles.entity.copper_golem.no_item_get": "Golem de coire que pren un objècte",
	"subtitles.entity.copper_golem.no_item_no_get": "Golem de coire pòt pas prene l'objècte",
	"subtitles.entity.copper_golem.spawn": "Golem de coire qu'apareis",
	"subtitles.entity.copper_golem.spin": "Golem de coire que vira lo cap",
	"subtitles.entity.copper_golem_become_statue": "Golem de coire que s'arroquís",
	"subtitles.entity.copper_golem_oxidized.death": "Golem de coire que morís",
	"subtitles.entity.copper_golem_oxidized.hurt": "Golem de coire nafrat",
	"subtitles.entity.copper_golem_oxidized.spin": "Golem de coire que vira lo cap",
	"subtitles.entity.copper_golem_weathered.death": "Golem de coire que morís",
	"subtitles.entity.copper_golem_weathered.hurt": "Golem de coire nafrat",
	"subtitles.entity.copper_golem_weathered.spin": "Golem de coire que vira lo cap",
	...
	"subtitles.entity.creaking.activate": "Cruisseire qu'obsèrva",
	"subtitles.entity.creaking.ambient": "Cruisseire que cruissís",
	"subtitles.entity.creaking.attack": "Cruisseire qu'ataca",
	"subtitles.entity.creaking.deactivate": "Cruisseire que s'apasima",
	"subtitles.entity.creaking.death": "Cruisseire que s'esfondra",
	"subtitles.entity.creaking.freeze": "Cruisseire que s'arresta",
	"subtitles.entity.creaking.spawn": "Cruisseire que se manifèsta",
	"subtitles.entity.creaking.sway": "Cruisseire atacat",
	"subtitles.entity.creaking.twitch": "Cruisseire que tremòla",
	"subtitles.entity.creaking.unfreeze": "Cruisseire que bolega",
	...
	"subtitles.entity.cushion.break": "Coissin trencat",
	"subtitles.entity.cushion.get_up": "Quicòm se lèva d'un coissin",
	"subtitles.entity.cushion.place": "Coissin plaçat",
	"subtitles.entity.cushion.sit": "Quicòm s'assèta sus un coissin",
	"subtitles.entity.dolphin.ambient": "Dalfin que carrinca",
	"subtitles.entity.dolphin.ambient_water": "Dalfin que fiula",
	...
	"subtitles.entity.donkey.angry": "Ase qu'endilha",
	"subtitles.entity.donkey.chest": "Còfre d'ase equipat",
	"subtitles.entity.donkey.death": "Ase morís",
	"subtitles.entity.donkey.eat": "Ase que manja",
	"subtitles.entity.donkey.hurt": "Ase nafrat",
	"subtitles.entity.donkey.jump": "Ase que sauta",
	"subtitles.entity.drowned.ambient": "Negat gargolha",
	"subtitles.entity.drowned.ambient_water": "Negat que gargolha",
	"subtitles.entity.drowned.death": "Negat morís",
	"subtitles.entity.drowned.hurt": "Negat nafrat",
	"subtitles.entity.drowned.shoot": "Negat que lança un trident",
	"subtitles.entity.drowned.step": "Negat que camina",
	"subtitles.entity.drowned.swim": "Negat que nada",
	...
	"subtitles.entity.ender_dragon.death": "Dragon que morís",
	"subtitles.entity.ender_dragon.flap": "Dragon qu'alateja",
	...
	"subtitles.entity.ender_eye.death": "Uèlh d'Ender que tomba",
	"subtitles.entity.ender_eye.launch": "Uèlh d'Ender lançat",
	...
	"subtitles.entity.enderman.scream": "Crit d'Enderòme",
	"subtitles.entity.enderman.stare": "Crit d'enderman",
	"subtitles.entity.enderman.teleport": "Enderman que se telepòrta",
	"subtitles.entity.endermite.ambient": "Formiguejadís d'endermita",
	"subtitles.entity.endermite.death": "Endermite que morís",
	"subtitles.entity.endermite.hurt": "Endermite nafrada",
	...
	"subtitles.entity.fish.swim": "Regiscle",
	"subtitles.entity.fishing_bobber.retrieve": "Flotador recuperat",
	"subtitles.entity.fishing_bobber.splash": "Regiscle de flotador",
	"subtitles.entity.fishing_bobber.throw": "Cana de pesca mandada",
	"subtitles.entity.fox.aggro": "Rainard s'enràbia",
	"subtitles.entity.fox.ambient": "Rainard que plipa",
	...
	"subtitles.entity.fox.sleep": "Rainard que ronca",
	"subtitles.entity.fox.sniff": "Rainard que nifla",
	...
	"subtitles.entity.generic.big_fall": "Quicòm es tombat",
	...
	"subtitles.entity.generic.wind_burst": "Carga de vent que peta",
	...
	"subtitles.entity.ghastling.ambient": "Chiu-chiu de Ghaston",
	"subtitles.entity.ghastling.death": "Ghaston que morís",
	"subtitles.entity.ghastling.hurt": "Ghaston nafrat",
	"subtitles.entity.ghastling.spawn": "Ghaston qu'apareis",
	"subtitles.entity.glow_item_frame.add_item": "Quadre lusent emplit",
	"subtitles.entity.glow_item_frame.break": "Quadre lusent trencat",
	"subtitles.entity.glow_item_frame.place": "Quadre lusent plaçat",
	"subtitles.entity.glow_item_frame.remove_item": "Quadre lusent vuejat",
	"subtitles.entity.glow_item_frame.rotate_item": "Clic sus un quadre lusent",
	...
	"subtitles.entity.goat.ambient": "Cabra que bèla",
	"subtitles.entity.goat.death": "Cabra morís",
	"subtitles.entity.goat.eat": "Cabra que manja",
	"subtitles.entity.goat.horn_break": "Còrn de cabra se trenca",
	"subtitles.entity.goat.hurt": "Cabra nafrada",
	"subtitles.entity.goat.long_jump": "Cabra que sauta",
	"subtitles.entity.goat.milk": "Molzuda d'una cabra",
	"subtitles.entity.goat.prepare_ram": "Cabra que se prepara",
	"subtitles.entity.goat.ram_impact": "Cabra que carga",
	"subtitles.entity.goat.screaming.ambient": "Cabra que brama",
	"subtitles.entity.goat.step": "Cabra que camina",
	...
	"subtitles.entity.happy_ghast.ambient": "Ghast urós que canturleja",
	"subtitles.entity.happy_ghast.death": "Ghast urós que morís",
	"subtitles.entity.happy_ghast.equip": "Arnesc equipat",
	"subtitles.entity.happy_ghast.harness_goggles_down": "Ghast urós qu'es prèst",
	"subtitles.entity.happy_ghast.harness_goggles_up": "Ghast urós que s'arrèsta",
	"subtitles.entity.happy_ghast.hurt": "Ghast urós nafrat",
	"subtitles.entity.happy_ghast.riding": "Ventada",
	"subtitles.entity.happy_ghast.unequip": "Arnesc quitat",
	"subtitles.entity.hoglin.ambient": "Hoglin que rena",
	"subtitles.entity.hoglin.angry": "Hoglin que rena furiosament",
	"subtitles.entity.hoglin.attack": "Hoglin ataca",
	"subtitles.entity.hoglin.converted_to_zombified": "Hoglin que se zòmbifica",
	"subtitles.entity.hoglin.death": "Hoglin morís",
	"subtitles.entity.hoglin.hurt": "Hoglin nafrat",
	"subtitles.entity.hoglin.retreat": "Hoglin que fugís",
	"subtitles.entity.hoglin.step": "Hoglin que camina",
	"subtitles.entity.horse.ambient": "Caval qu'endilha",
	"subtitles.entity.horse.angry": "Caval encanhat qu'endilha",
	"subtitles.entity.horse.armor": "Armadura per caval equipada",
	...
	"subtitles.entity.illusioner.cast_spell": "Illusionista qu'emmasca",
	"subtitles.entity.illusioner.death": "Illusionista morís",
	"subtitles.entity.illusioner.hurt": "Illusionista nafrat",
	"subtitles.entity.illusioner.mirror_move": "Illusionista que se desplaça",
	"subtitles.entity.illusioner.prepare_blindness": "Illusionista que prepara l'efièch de cecitat",
	"subtitles.entity.illusioner.prepare_mirror": "Illusionista qu'es en trin de se miralhar",
	...
	"subtitles.entity.item_frame.break": "Quadre trencat",
	...
	"subtitles.entity.leash_knot.break": "Estacada copada",
	"subtitles.entity.leash_knot.place": "Estacada ligada",
	...
	"subtitles.entity.llama.angry": "Lama que bèla furiosament",
	...
	"subtitles.entity.minecart.inside": "Clic-clac de vagonet",
	"subtitles.entity.minecart.inside_underwater": "Clic-clac de vagonet immergit",
	"subtitles.entity.minecart.riding": "Vagonet que rotla",
	"subtitles.entity.mooshroom.convert": "Mooshroom que se tresmuda",
	"subtitles.entity.mooshroom.eat": "Mooshroom que manja",
	"subtitles.entity.mooshroom.milk": "Molzuda d'una Mooshroom",
	"subtitles.entity.mooshroom.suspicious_milk": "Molzuda suspècta d'una Mooshroom",
	"subtitles.entity.mule.ambient": "Bram de mula",
	"subtitles.entity.mule.angry": "Mula qu'endilha",
	"subtitles.entity.mule.chest": "Còfre de mula equipat",
	"subtitles.entity.mule.death": "Mula morís",
	"subtitles.entity.mule.eat": "Mula que manja",
	"subtitles.entity.mule.hurt": "Mula nafrada",
	"subtitles.entity.mule.jump": "Mula que sauta",
	"subtitles.entity.nautilus.ambient": "Clacament de nautile",
	"subtitles.entity.nautilus.ambient_land": "Clacament de nautile",
	"subtitles.entity.nautilus.dash": "Nautile que se propulsa",
	"subtitles.entity.nautilus.dash_land": "Nautile que se propulsa",
	"subtitles.entity.nautilus.dash_ready": "Nautile qu'a recobrat",
	"subtitles.entity.nautilus.dash_ready_land": "Nautile qu'a recobrat",
	"subtitles.entity.nautilus.death": "Nautile que morís",
	"subtitles.entity.nautilus.death_land": "Nautile que morís",
	"subtitles.entity.nautilus.eat": "Nautile que manja",
	"subtitles.entity.nautilus.hurt": "Nautile nafrat",
	"subtitles.entity.nautilus.hurt_land": "Nautile nafrat",
	"subtitles.entity.nautilus.riding": "Nautile que fa de botiòlas",
	"subtitles.entity.nautilus.swim": "Nautile que nada",
	"subtitles.entity.painting.break": "Pintura despenjada",
	"subtitles.entity.painting.place": "Pintura plaçada",
	"subtitles.entity.panda.aggressive_ambient": "Panda que rena",
	"subtitles.entity.panda.ambient": "Panda pantuga",
	"subtitles.entity.panda.bite": "Panda mòrd",
	"subtitles.entity.panda.cant_breed": "Panda que bèla",
	"subtitles.entity.panda.death": "Panda morís",
	"subtitles.entity.panda.eat": "Panda que manja",
	"subtitles.entity.panda.hurt": "Panda nafrat",
	"subtitles.entity.panda.pre_sneeze": "Panda que va tossir",
	"subtitles.entity.panda.sneeze": "Panda que tossís",
	"subtitles.entity.panda.step": "Panda que camina",
	"subtitles.entity.panda.worried_ambient": "Panda que jangola",
	"subtitles.entity.parched.ambient": "Cracinada d'assecat",
	"subtitles.entity.parched.death": "Assecat que morís",
	"subtitles.entity.parched.hurt": "Assecat nafrat",
	...
	"subtitles.entity.parrot.imitate.bogged": "Papagai que claqueja",
	"subtitles.entity.parrot.imitate.breeze": "Papagai bronzina",
	"subtitles.entity.parrot.imitate.camel_husk": "Papagai que rena",
	"subtitles.entity.parrot.imitate.creaking": "Papagai que cruissís",
	...
	"subtitles.entity.parrot.imitate.ender_dragon": "Papagai que rugís",
	"subtitles.entity.parrot.imitate.endermite": "Papagai que formigueja",
	...
	"subtitles.entity.parrot.imitate.hoglin": "Papagai que rena",
	...
	"subtitles.entity.parrot.imitate.parched": "Cracinada de papagai",
	...
	"subtitles.entity.parrot.imitate.shulker": "Papagai qu'agacha",
	...
	"subtitles.entity.parrot.imitate.stray": "Papagai que claqueja",
	...
	"subtitles.entity.parrot.imitate.wither_skeleton": "Papagai que claqueja",
	"subtitles.entity.parrot.imitate.zoglin": "Papagai rena",
	"subtitles.entity.parrot.imitate.zombie": "Papagai rona",
	"subtitles.entity.parrot.imitate.zombie_horse": "Papagai que rona",
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Papagai que se gargarisa",
	...
	"subtitles.entity.phantom.swoop": "Fantauma que carga",
	"subtitles.entity.pig.ambient": "Crit d'un pòrc",
	"subtitles.entity.pig.death": "Pòrc morís",
	"subtitles.entity.pig.eat": "Pòrc que manja",
	...
	"subtitles.entity.piglin.converted_to_zombified": "Piglin que se zòmbifica",
	...
	"subtitles.entity.piglin.step": "Piglin que camina",
	...
	"subtitles.entity.piglin_brute.converted_to_zombified": "Piglin ferotge que se zòmbifica",
	"subtitles.entity.piglin_brute.death": "Piglin ferotge morís",
	"subtitles.entity.piglin_brute.hurt": "Piglin ferotge nafrat",
	"subtitles.entity.piglin_brute.step": "Piglin ferotge que camina",
	...
	"subtitles.entity.player.attack.knockback": "Ataca rebutanta",
	...
	"subtitles.entity.player.hurt_drown": "Jogaire que se nèga",
	"subtitles.entity.player.hurt_on_fire": "Jogaire que crèma",
	"subtitles.entity.player.levelup": "Jogaire que monta de nivèl",
	"subtitles.entity.player.teleport": "Jogaire que se telepòrta",
	"subtitles.entity.polar_bear.ambient": "Ors polar rona",
	"subtitles.entity.polar_bear.ambient_baby": "Orson polar que rena",
	...
	"subtitles.entity.puffer_fish.blow_out": "Peis glòbe que se confla",
	"subtitles.entity.puffer_fish.blow_up": "Peis glòbe que se desconfla",
	"subtitles.entity.puffer_fish.death": "Peis glòbe morís",
	"subtitles.entity.puffer_fish.flop": "Peis glòbe que sauteja",
	"subtitles.entity.puffer_fish.hurt": "Peis glòbe nafrat",
	"subtitles.entity.puffer_fish.sting": "Peis glòbe que pica",
	...
	"subtitles.entity.ravager.attack": "Devastator que mòrd",
	...
	"subtitles.entity.ravager.step": "Devastator que camina",
	"subtitles.entity.ravager.stunned": "Devastator estorbat",
	"subtitles.entity.salmon.death": "Saumon morís",
	"subtitles.entity.salmon.flop": "Saumon que sauteja",
	...
	"subtitles.entity.shulker.ambient": "Shulker qu'agacha",
	"subtitles.entity.shulker.close": "Shulker que se barra",
	"subtitles.entity.shulker.death": "Shulker que morís",
	"subtitles.entity.shulker.hurt": "Shulker nafrat",
	"subtitles.entity.shulker.open": "Shulker que se dobrís",
	"subtitles.entity.shulker.shoot": "Shulker qu'escopís",
	"subtitles.entity.shulker.teleport": "Shulker que se telepòrta",
	"subtitles.entity.shulker_bullet.hit": "Projectil de shulker qu'espeta",
	"subtitles.entity.shulker_bullet.hurt": "Projectil de shulker trencat",
	...
	"subtitles.entity.skeleton.converted_to_stray": "Esqueleta convertit en barrutlaire",
	...
	"subtitles.entity.skeleton_horse.jump_water": "Caval esqueleta que sauta",
	"subtitles.entity.skeleton_horse.swim": "Caval esqueleta que nada",
	...
	"subtitles.entity.small_sulfur_cube.death": "Cube de solpre pichon que morís",
	"subtitles.entity.small_sulfur_cube.eat": "Cube de solpre pichon qu'absorbís",
	"subtitles.entity.small_sulfur_cube.hurt": "Cube de solpre pichon nafrat",
	"subtitles.entity.small_sulfur_cube.jump": "Cube de solpre pichon que sauta",
	"subtitles.entity.sniffer.death": "Niflaire que morís",
	...
	"subtitles.entity.sniffer.idle": "Niflaire que rena",
	"subtitles.entity.sniffer.scenting": "Niflaire flaira",
	"subtitles.entity.sniffer.searching": "Niflaire que cèrca",
	...
	"subtitles.entity.strider.eat": "Arpentaire que manja",
	"subtitles.entity.strider.happy": "Arpentaire que laleja",
	"subtitles.entity.strider.hurt": "Arpentaire nafrat",
	"subtitles.entity.strider.idle": "Coac d'arpentaire",
	"subtitles.entity.strider.retreat": "Arpentaire que fugís",
	"subtitles.entity.sulfur_cube.absorb": "Cube de solpre plen",
	"subtitles.entity.sulfur_cube.bounce": "Cube de solpre que sauta",
	"subtitles.entity.sulfur_cube.death": "Cube de solpre que morís",
	"subtitles.entity.sulfur_cube.eject": "Blòc levat",
	"subtitles.entity.sulfur_cube.hit": "Cube de solpre tòcat",
	"subtitles.entity.sulfur_cube.hurt": "Cube de solpre nafrat",
	"subtitles.entity.sulfur_cube.jump": "Cube de solpre que sauta",
	"subtitles.entity.sulfur_cube.push": "Cube de solpre butat",
	"subtitles.entity.sulfur_cube.squish": "Cube de solpre que sauta",
	"subtitles.entity.tadpole.death": "Capgròs que morís",
	"subtitles.entity.tadpole.flop": "Capgròs que sauteja",
	"subtitles.entity.tadpole.grow_up": "Capgròs que creis",
	"subtitles.entity.tadpole.hurt": "Capgròs nafrat",
	"subtitles.entity.tnt.primed": "TNT amodat",
	"subtitles.entity.tropical_fish.death": "Peis tropical que morís",
	"subtitles.entity.tropical_fish.flop": "Peis tropical que sauteja",
	"subtitles.entity.tropical_fish.hurt": "Peis tropical nafrat",
	"subtitles.entity.turtle.ambient_land": "Tartuga que bresilha",
	"subtitles.entity.turtle.death": "Tartuga morís",
	"subtitles.entity.turtle.death_baby": "Nenet de tartuga que morís",
	"subtitles.entity.turtle.egg_break": "Uòu de tartuga se trenca",
	"subtitles.entity.turtle.egg_crack": "Uòu de tartuga que se fend",
	"subtitles.entity.turtle.egg_hatch": "Nenet de tartuga que pica l'uòu",
	"subtitles.entity.turtle.hurt": "Tartuga nafrada",
	"subtitles.entity.turtle.hurt_baby": "Nenet de tartuga nafrat",
	"subtitles.entity.turtle.lay_egg": "Tartuga que fa l'uòu",
	"subtitles.entity.turtle.shamble": "Tartuga que se trebala",
	"subtitles.entity.turtle.shamble_baby": "Nenet de tartuga que se trebala",
	"subtitles.entity.turtle.swim": "Tartuga que nada",
	...
	"subtitles.entity.villager.work_armorer": "Armadurièr que trabalha",
	...
	"subtitles.entity.villager.work_farmer": "Agricultor que trabalha",
	...
	"subtitles.entity.villager.work_toolsmith": "Faure d'aisinas que trabalha",
	"subtitles.entity.villager.work_weaponsmith": "Faure d'armas que trabalha",
	...
	"subtitles.entity.warden.angry": "Warden que s'encanha",
	"subtitles.entity.warden.attack_impact": "Warden que tusta",
	"subtitles.entity.warden.death": "Warden que morís",
	"subtitles.entity.warden.dig": "Warden que cava",
	"subtitles.entity.warden.emerge": "Warden que sortís de tèrra",
	"subtitles.entity.warden.heartbeat": "Baticòr de Warden",
	"subtitles.entity.warden.hurt": "Warden nafrat",
	"subtitles.entity.warden.listening": "Warden que percebèt",
	"subtitles.entity.warden.listening_angry": "Warden encanhat que percebèt",
	"subtitles.entity.warden.nearby_close": "Warden que s'apròcha",
	"subtitles.entity.warden.nearby_closer": "Warden qu'avança",
	"subtitles.entity.warden.nearby_closest": "Warden que se sarra de prèp",
	"subtitles.entity.warden.roar": "Warden rugís",
	"subtitles.entity.warden.sniff": "Warden que nifla",
	"subtitles.entity.warden.sonic_boom": "Bramadís de Warden",
	"subtitles.entity.warden.sonic_charge": "Warden que carga",
	"subtitles.entity.warden.step": "Warden que camina",
	"subtitles.entity.warden.tendril_clicks": "Verdilhas de Warden que respondon",
	"subtitles.entity.wind_charge.throw": "Carga de vent lançada",
	"subtitles.entity.wind_charge.wind_burst": "Carga de vent que peta",
	...
	"subtitles.entity.wolf.bark": "Japatge de lop",
	"subtitles.entity.wolf.death": "Lop morís",
	"subtitles.entity.wolf.growl": "Lop que rona",
	"subtitles.entity.wolf.hurt": "Lop nafrat",
	"subtitles.entity.wolf.pant": "Lop que pantuga",
	"subtitles.entity.wolf.shake": "Lop que s'esbrofa",
	"subtitles.entity.wolf.whine": "Lop que caïna",
	"subtitles.entity.zoglin.ambient": "Zoglin que rena",
	"subtitles.entity.zoglin.angry": "Zoglin que rona furiosament",
	...
	"subtitles.entity.zoglin.step": "Zoglin que camina",
	"subtitles.entity.zombie.ambient": "Zòmbi rona",
	"subtitles.entity.zombie.attack_wooden_door": "Pòrta que trembla",
	"subtitles.entity.zombie.break_wooden_door": "Pòrta trenca",
	"subtitles.entity.zombie.converted_to_drowned": "Zòmbi que se nega",
	"subtitles.entity.zombie.death": "Zòmbi morís",
	"subtitles.entity.zombie.destroy_egg": "Uòu de tartuga prautit",
	...
	"subtitles.entity.zombie_horse.angry": "Caval zòmbi qu'endilha",
	"subtitles.entity.zombie_horse.death": "Caval zòmbi que morís",
	"subtitles.entity.zombie_horse.eat": "Caval zòmbi que manja",
	"subtitles.entity.zombie_horse.hurt": "Caval zòmbi nafrat",
	"subtitles.entity.zombie_nautilus.ambient": "Gargolhs de nautile zòmbi",
	"subtitles.entity.zombie_nautilus.ambient_land": "Gargolhs de nautile zòmbi",
	"subtitles.entity.zombie_nautilus.dash": "Nautile zòmbi que se propulsa",
	"subtitles.entity.zombie_nautilus.dash_land": "Nautile zòmbi que se propulsa",
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautile zòmbi qu'a recobrat",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautile zòmbi qu'a recobrat",
	"subtitles.entity.zombie_nautilus.death": "Nautile zòmbi que morís",
	"subtitles.entity.zombie_nautilus.death_land": "Nautile zòmbi que morís",
	"subtitles.entity.zombie_nautilus.eat": "Nautile zòmbi que manja",
	"subtitles.entity.zombie_nautilus.hurt": "Nautile zòmbi nafrat",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautile zòmbi nafrat",
	"subtitles.entity.zombie_nautilus.swim": "Nautile zòmbi que nada",
	"subtitles.entity.zombie_villager.ambient": "Zòmbi vilatgés rona",
	"subtitles.entity.zombie_villager.converted": "Zòmbi vilatgés que vocifèra",
	"subtitles.entity.zombie_villager.cure": "Zòmbi vilatgés que s'agita",
	...
	"subtitles.entity.zombified_piglin.hurt": "Piglin zòmbificat nafrat",
	"subtitles.event.mob_effect.bad_omen": "Lo presagi pren fòrma",
	"subtitles.event.mob_effect.raid_omen": "Invasion que se sarra",
	"subtitles.event.mob_effect.trial_omen": "Espròva funèsta que se sarra",
	...
	"subtitles.item.armor.equip_copper": "Tindadís d'armadura en coire",
	...
	"subtitles.item.armor.equip_nautilus": "Armadura de nautile equipada",
	...
	"subtitles.item.armor.unequip_nautilus": "Armadura de nautile quitada",
	"subtitles.item.armor.unequip_wolf": "Armadura per lop quitada",
	"subtitles.item.axe.scrape": "Pigassa que desruca",
	"subtitles.item.axe.strip": "Pigassa que desruca",
	"subtitles.item.axe.wax_off": "Bresca raspada",
	"subtitles.item.bone_meal.use": "Polsa d'òs empegada",
	...
	"subtitles.item.brush.brushing.generic": "Brossatge",
	...
	"subtitles.item.bucket.fill_sulfur_cube": "Cube de solpre recuperat",
	...
	"subtitles.item.crossbow.charge": "Balèsta que se carga",
	"subtitles.item.crossbow.hit": "Sageta plantada",
	"subtitles.item.crossbow.load": "Balèsta cargada",
	"subtitles.item.crossbow.shoot": "Tir de balèsta",
	"subtitles.item.dye.use": "Tencha que tencha",
	"subtitles.item.elytra.flying": "Brusiment",
	"subtitles.item.firecharge.use": "Bola de fuòc lançada",
	"subtitles.item.flintandsteel.use": "Batifuòc emplegat",
	"subtitles.item.glow_ink_sac.use": "Sac de tencha lusent que taca",
	"subtitles.item.goat_horn.play": "Còrna de cabra que ressondís",
	"subtitles.item.golden_dandelion.unuse": "La creissença comença",
	"subtitles.item.golden_dandelion.use": "La creissença s'interrompèt",
	...
	"subtitles.item.horse_armor.unequip": "Armadura de caval quitada",
	"subtitles.item.ink_sac.use": "Sac de tencha que taca",
	"subtitles.item.lead.break": "Estacada copada",
	"subtitles.item.lead.tied": "Estaca ligada",
	"subtitles.item.lead.untied": "Estaca desligada",
	"subtitles.item.llama_carpet.unequip": "Moqueta quitada",
	"subtitles.item.lodestone_compass.lock": "Bossòla magnetizada fixada",
	"subtitles.item.mace.smash_air": "Maçament",
	"subtitles.item.mace.smash_ground": "Maçament",
	"subtitles.item.nautilus_saddle_equip": "Sèla equipada",
	"subtitles.item.nautilus_saddle_underwater_equip": "Sèla equipada",
	"subtitles.item.nether_wart.plant": "Cultura plantada",
	"subtitles.item.ominous_bottle.dispose": "Fiòla copada",
	"subtitles.item.saddle.unequip": "Sèla quitada",
	"subtitles.item.shears.shear": "Pinçamet de cisalhas",
	"subtitles.item.shears.snip": "Cisalhament",
	"subtitles.item.shield.block": "Parada de bloquièr",
	"subtitles.item.shovel.flatten": "Pala qu'aplatís",
	"subtitles.item.spear.attack": "Còp de lança",
	"subtitles.item.spear.hit": "Tust de lança",
	"subtitles.item.spear.lunge": "Estocada",
	"subtitles.item.spear.use": "Carga amb una lança",
	"subtitles.item.spear_wood.attack": "Còp de lança",
	"subtitles.item.spear_wood.hit": "Tust de lança",
	"subtitles.item.spear_wood.use": "Carga amb una lança",
	"subtitles.item.spyglass.stop_using": "Pòrtavista que se retracta",
	"subtitles.item.spyglass.use": "Pòrtavista que s'estend",
	"subtitles.item.totem.use": "Totèm activat",
	"subtitles.item.trident.hit": "Trident qu'empala",
	"subtitles.item.trident.hit_ground": "Trident que vibra",
	"subtitles.item.trident.return": "Trident que torna",
	"subtitles.item.trident.riptide": "Trident que propulsa",
	"subtitles.item.trident.throw": "Trident lançat",
	"subtitles.item.trident.thunder": "Tron de trident",
	"subtitles.item.underwater_saddle.equip": "Sèla equipada",
	...
	"symlink_warning.message.pack": "Cargar de paquets amb de ligams simbolics pòt presentar un risc se sabètz pas exactament çò que fasètz. Se vos plai, consultatz %s per ne saber mai.",
	...
	"symlink_warning.title": "Lo dossièr del mond conten de ligams simbolics",
	"symlink_warning.title.pack": "De paquet(s) que conten(on) de ligams simbolics apondut(s)",
	"symlink_warning.title.world": "Lo dossièr del mond conten de ligams simbolics",
	"team.collision.always": "Totjorn",
	"team.collision.never": "Jamai",
	"team.collision.pushOtherTeams": "Collisions amb las autras còlas",
	"team.collision.pushOwnTeam": "Collisions amb la sia pròpria còla",
	"team.notFound": "Còla desconeguda : %s",
	"team.visibility.always": "Totjorn",
	"team.visibility.hideForOtherTeams": "Amagar per las autras còlas",
	"team.visibility.hideForOwnTeam": "Amagar per la sia pròpria còla",
	"team.visibility.never": "Jamai",
	"telemetry.event.advancement_made.description": "Comprène lo contèxt de la realizacion d'un progrès pòt nos ajudar a melhorar la progression del jòc.",
	"telemetry.event.advancement_made.title": "Progrès realizat",
	"telemetry.event.game_load_times.description": "Aqueste eveniment pòt nos ajudar a comprène ont de melhoraments de performàncias al desmarratge son necessàrias en mesurant los temps d'execucion de cada fasa.",
	"telemetry.event.game_load_times.title": "Temps de cargament del jòc",
	"telemetry.event.graphics_capabilities.description": "Aqueste eveniment nos informa de las capacitats del periferic grafic emplegat per jogar al jòc.",
	"telemetry.event.graphics_capabilities.title": "Capacitats graficas",
	"telemetry.event.optional": "%s (facultatiu)",
	"telemetry.event.optional.disabled": "%s (facultatiu) - Desactivat",
	"telemetry.event.p2p_connection.description": "Aqueste eveniment nos ajuda a comprène la fiabilitat e las performàncias de las connexions \"egal a egal\" (P2P) entre los jogaires. Enregistra se la connexion a capitat o pas, lo tipe d'establiment de connectivitat interactiva (ICE, lo protocòl qu'emplegam per establir las connexions \"egal a egal\") aital que lo temps necessari per establir la connexion.",
	"telemetry.event.p2p_connection.title": "Connexion \"egal a egal\"",
	"telemetry.event.performance_metrics.description": "Conéisser lo perfil de performàncias de Minecraft nos ajuda a optimizar lo jòc per fòrça aparelhs e sistèmas d'espleitacion.\nLa version del jòc es enclausadas per nos ajudar a comparar los perfil de performàncias de las versions novèlas de Minecraft.",
	"telemetry.event.performance_metrics.title": "Mesuras de performàncias",
	"telemetry.event.required": "%s (requesit)",
	"telemetry.event.world_load_times.description": "Es important per nos de determinar lo temps que cal per rejónher un mond, e lo biais d'aquel temps evolua. Per exemple, se apondèm de foncionalitats o que fasèm de modificacions tecnicas importantas, avèm besonh de conéisser cossí càmbian los temps de cargament.",
	"telemetry.event.world_load_times.title": "Temps de cargament dels monds",
	"telemetry.event.world_loaded.description": "Saber cossí los jogaires jògan a Minecraft (quin mòde de jòc, se lo client o lo servidor es modificat, dins quina version) nos ajuda a melhorar los aspèctes qu'an lo mai d'importància pels jogaires.\nL'eveniment \"Mond cargat\" es associat al eveniment \"Mond descargat\" per calcular la durada totala d'una session de jòc.",
	"telemetry.event.world_loaded.title": "Mond cargat",
	"telemetry.event.world_unloaded.description": "Aqueste eveniment es associat al eveniment \"Mond cargat\" per calcular quant de temps dura una session de jòc completa.\nLa durada (en segondas e en cicles) es mesurada quand una session de jòc es acabada (al moment de tornar a menut principal, o de se desconnectar d'un servidor).",
	"telemetry.event.world_unloaded.title": "Mond descargat",
	"telemetry.property.advancement_game_time.title": "Temps de jòc (cicles)",
	"telemetry.property.advancement_id.title": "ID del progrès",
	"telemetry.property.backend_failure_message.title": "Messatge d'error a la creacion de l'API grafica",
	"telemetry.property.backend_failure_missing_capabilities.title": "Fracàs a la creacion de l'API grafica a causa d'una manca de capacitat",
	"telemetry.property.backend_failure_reason.title": "Rason del fracàs de la creacion del API grafica",
	"telemetry.property.backend_name.title": "Nom de l'API grafica",
	"telemetry.property.client_id.title": "ID del client",
	"telemetry.property.client_modded.title": "Client modificat",
	"telemetry.property.dedicated_memory_kb.title": "Memòria dedicada (ko)",
	"telemetry.property.event_timestamp_utc.title": "Ora d'enregistrament de la clau (UTC)",
	"telemetry.property.frame_rate_samples.title": "Escandilhatge de las imatges per segonda (FPS)",
	"telemetry.property.game_mode.title": "Mòde de jòc",
	"telemetry.property.game_version.title": "Version de jòc",
	"telemetry.property.launcher_name.title": "Nom del lançador",
	"telemetry.property.load_time_bootstrap_ms.title": "Temps de desmarratge (milisegondas)",
	"telemetry.property.load_time_loading_overlay_ms.title": "Temps dins l'ecran de cargament (en milisegondas)",
	"telemetry.property.load_time_pre_window_ms.title": "Temps abans l'obertura de la fenèstra (milisegondas)",
	"telemetry.property.load_time_total_time_ms.title": "Temps total de cargament (milisegondas)",
	"telemetry.property.minecraft_session_id.title": "ID de la session de Minecraft",
	"telemetry.property.new_world.title": "Mond nòu",
	"telemetry.property.number_of_samples.title": "Nombre d'escandilhatge",
	"telemetry.property.operating_system.title": "Sistèma d'espleitacion (OS)",
	"telemetry.property.opt_in.title": "Consentiment",
	"telemetry.property.p2p_connection_failure_stage.title": "Fasa de la mèuca",
	"telemetry.property.p2p_connection_ice_connect_time_ms.title": "Temps de connexion del establiment de connectivitat interactiva (ICE) (milisegondas)",
	"telemetry.property.p2p_connection_ice_path.title": "Camin del establiment de connectivitat interactiva (ICE)",
	"telemetry.property.p2p_connection_local_candidate_type.title": "Tipe de candidat local",
	"telemetry.property.p2p_connection_remote_candidate_type.title": "Tipe de candidat a distància",
	"telemetry.property.p2p_connection_signaling_time_ms.title": "Temps de connexion de la senhalizacion (milisegondas)",
	"telemetry.property.p2p_connection_successful.title": "Connexion capitada",
	"telemetry.property.p2p_connection_total_time_ms.title": "Temps de connexion total (milisegondas)",
	"telemetry.property.platform.title": "Platafòrma",
	"telemetry.property.realms_map_content.title": "Contengut de la carta de Realms (nom del mini-jòc)",
	"telemetry.property.render_distance.title": "Distància d'afichatge",
	"telemetry.property.render_time_samples.title": "Escandilhatges del temps de rendut",
	"telemetry.property.seconds_since_load.title": "Temps dempuèi lo cargament (segondas)",
	"telemetry.property.server_modded.title": "Servidor modificat",
	"telemetry.property.server_session_id.title": "ID de la session del servidor",
	"telemetry.property.server_type.title": "Tipe del servidor",
	"telemetry.property.ticks_since_load.title": "Temps dempuèi lo cargament (cicles)",
	"telemetry.property.used_memory_samples.title": "Memòria d'accès aleatòri (RAM) emplegada",
	"telemetry.property.user_id.title": "ID del utilizaire",
	"telemetry.property.world_load_time_ms.title": "Temps de cargament del mond (milisegondas)",
	"telemetry.property.world_session_id.title": "ID de la session del mond",
	"telemetry_info.button.give_feedback": "Donar una opinion",
	"telemetry_info.button.privacy_statement": "Declaracion de confidencialitat",
	"telemetry_info.button.show_data": "Espiar mas donadas",
	"telemetry_info.opt_in.description": "Accèpti lo mandadís de donadas de telemesura facultativas",
	"telemetry_info.property_title": "Donadas enclausadas",
	"telemetry_info.screen.description": "Collectar aquestas donadas nos ajuda a melhorar Minecraft en nos guidant dins de direccions pertinentas pels jogaires.\nPodètz tanben donar vòstre opinion per nos ajudar a melhorar lo jòc.",
	"telemetry_info.screen.title": "Collècta de donadas de telemesura",
	"test.error.block_property_mismatch": "Valor de la proprietat \"%s\" esperada : %s (valor recebuda : %s)",
	"test.error.block_property_missing": "La proprietat de blòc manca. Valor de la proprietat esperada : %s",
	"test.error.entity_property": "Fracàs del tèst de l'entitat \"%s\" : %s",
	"test.error.entity_property_details": "Fracàs del tèst de l'entitat \"%s\" : %s. (Valor esperada : %s, valor recebuda : %s)",
	"test.error.expected_block": "S'esperava lo blòc \"%s\" (recebut : \"%s\")",
	"test.error.expected_block_present": "S'esperava la preséncia del blòc \"%s\"",
	"test.error.expected_block_tag": "S'esperava lo blòc en #%s (valor recebuda : \"%s\")",
	"test.error.expected_container_contents": "Lo contenador deu conténer l'objècte \"%s\"",
	"test.error.expected_container_contents_single": "Lo contenador deu pas conténer qu'un objècte \"%s\"",
	"test.error.expected_empty_container": "Lo contenador deu èsser vuèg",
	"test.error.expected_entity": "Entitat \"%s\" esperada",
	"test.error.expected_entity_around": "Entitat \"%s\" esperada al entorn de %s, %s, %s",
	"test.error.expected_entity_count": "%s entitats del tipe \"%s\" esperadas (%s trobadas)",
	"test.error.expected_entity_data": "Donadas d'entitats esperadas : %s (valor recebuda : %s)",
	"test.error.expected_entity_data_predicate": "Las donadas de l'entitat correspondon pas per \"%s\"",
	"test.error.expected_entity_effect": "S'esperam que %s aja un efièch %s %s",
	"test.error.expected_entity_having": "L'inventari de l'entitat deuriá conténer l'objècte \"%s\"",
	"test.error.expected_entity_holding": "L'entitat deu téner l'objècte \"%s\"",
	"test.error.expected_entity_in_test": "Entitat \"%s\" esperada dins lo tèst",
	"test.error.expected_entity_not_touching": "S'esperava pas que l'entitat \"%s\" tòque %s, %s, %s (relativa : %s, %s, %s)",
	"test.error.expected_entity_touching": "S'esperava que l'entitat \"%s\" tòque %s, %s, %s (relativa : %s, %s, %s)",
	"test.error.expected_item": "Objècte de tipe \"%s\" esperat",
	"test.error.expected_items_count": "%s objèctes de tipe \"%s\" esperats (%s trobats)",
	"test.error.fail": "Condicions de fracàs complidas",
	"test.error.invalid_block_type": "Tipe de blòc inesperat trobat : %s",
	"test.error.missing_block_entity": "Manca una entitat de blòc",
	"test.error.not_a_block_item": "Lo blòc especificat pòt pas èsser un objècte",
	"test.error.position": "%s en %s, %s, %s (relativa : %s, %s, %s) al cicle %s",
	"test.error.sequence.condition_already_triggered": "Condicion ja activada al cicle %s",
	"test.error.sequence.condition_not_triggered": "Condicion pas activada",
	"test.error.sequence.invalid_tick": "Capitada dins un cicle pas valid : %s esperat(s)",
	"test.error.sequence.minimum_tick": "Capitada abans lo cicle esperar : s'esperava %s",
	"test.error.sequence.not_completed": "Lo tèst s'es estat acabat abans la fin de la sequéncia",
	"test.error.set_biome": "Fracàs a la definicion del biòme pel tèst",
	"test.error.spawn_failure": "Mèuca de la creacion de l'entitat \"%s\"",
	"test.error.state_not_equal": "Estat pas corrècte (estat esperat : %s, estat recebut : %s)",
	"test.error.structure.failure": "Mèuca del plaçament de l'estructura de tèst per \"%s\"",
	"test.error.tick": "%s en lo cicle %s",
	"test.error.ticking_without_structure": "Tèst de cicle fach abans lo plaçament de l'estructura",
	"test.error.timeout.no_result": "A pas capitat o fracassat pendent %s cicles",
	"test.error.timeout.no_sequences_finished": "Cap de sequéncia s'es acabat pendent %s cicles",
	"test.error.too_many_entities": "S'esperava de trobar pas qu'un \"%s\" al entorn de %s, %s, %s mas %s son estats trobats",
	"test.error.unexpected_block": "S'esperava pas lo blòc \"%s\"",
	"test.error.unexpected_entity": "S'esperava pas l'entitat \"%s\"",
	"test.error.unexpected_item": "S'esperava pas l'objècte de tipe \"%s\"",
	"test.error.unknown": "Error intèrna desconeguda : %s",
	"test.error.value_not_equal": "Valor %s esperada : %s (valor recebuda : %s)",
	"test.error.value_not_in_between": "Valor %s esperada entre %s e %s (valor recebuda : %s)",
	"test.error.wrong_block_entity": "Tipe d'entitat de blòc pas corrècte : %s",
	"test.player.coordinates": "Coordenadas del jogaire : [%s, %s, %s] dins la dimension %s",
	"test.run.coordinates": "Coordenadas de tèst : [%s, %s, %s] dins la dimension %s",
	"test_block.error.missing": "Lo blòc \"%s\" manca a l'estructura de tèst",
	"test_block.error.too_many": "Tròp de blòcs \"%s\"",
	"test_block.invalid_timeout": "Temps d'espèra pas valid (%s) - deu èsser un nombre positiu de cicles",
	"test_block.message": "Messatge :",
	"test_block.mode.accept": "Acceptar",
	"test_block.mode.fail": "Fracassar",
	"test_block.mode.log": "Enregistrar",
	"test_block.mode.start": "Desmarrar",
	"test_block.mode_info.accept": "Mòde acceptar - Acceptar la capitada (d'una part) d'un tèst",
	"test_block.mode_info.fail": "Mòde fracassar - Fracassar lo tèst",
	"test_block.mode_info.log": "Mòde enregistrar - Enregistrar un messatge",
	"test_block.mode_info.start": "Mòde desmarrar - Lo ponch de partença d'un tèst",
	"test_instance.action.reset": "Reïnicializar e cargar",
	"test_instance.action.run": "Cargar e executar",
	"test_instance.action.save": "Enregistrar l'estructura",
	"test_instance.description.batch": "Environament : %s",
	"test_instance.description.dimension": "Dimension: %s",
	"test_instance.description.failed": "Fracàs : %s",
	"test_instance.description.function": "Foncion : %s",
	"test_instance.description.invalid_id": "ID de tèst pas valid",
	"test_instance.description.no_test": "Aquel tèst existís pas",
	"test_instance.description.structure": "Estructura : %s",
	"test_instance.description.type": "Tipe : %s",
	"test_instance.type.block_based": "Tèst basat sus de blòcs",
	"test_instance.type.function": "Tèst de foncion integrada",
	"test_instance_block.entities": "Entitats :",
	"test_instance_block.error.no_test": "Impossible d'executar l'instància de tèst en %s, %s, %s pr'amor i a pas de tèst definit",
	"test_instance_block.error.no_test_structure": "Impossible d'executar l'instància de tèst en %s, %s, %s pr'amor i a pas d'estructura de tèst",
	"test_instance_block.error.unable_to_save": "Se pòt pas enregistrar lo modèl d'estructura de tèst per l'instància de tèst en %s, %s, %s",
	"test_instance_block.invalid": "[pas valid]",
	"test_instance_block.reset_success": "Reïnicializacion capitada pel tèst \"%s\"",
	"test_instance_block.rotation": "Rotacion :",
	"test_instance_block.size": "Talha de l'estructura de tèst",
	"test_instance_block.starting": "Desmarratge del tèst \"%s\"",
	"test_instance_block.test_id": "ID de l'instància de tèst",
	"title.32bit.deprecation": "Sistèma 32 bits detectat : poiriá vos empachar de jogar a l'avenidor pr'amor i auriá besonh d'un sistèma 64 bits!",
	"title.32bit.deprecation.realms": "Minecraft va exigir lèu un sistèma 64 bits, vos empacharà de jogar o d'emplegar Realms sus aquel aparelh. Deuriatz annular a la man cada abonament a Realms.",
	"title.32bit.deprecation.realms.check": "Pas pus mostrar aquel messatge",
	"title.32bit.deprecation.realms.header": "Sistèma 32 bits detectat",
	"title.credits": "Copyright Mojang AB. Pas distribuir!",
	"title.multiplayer.disabled": "Lo mòde multijogaires es desactivat. Se vos plai, verificatz los paramètres del vòstre compte Microsoft.",
	"title.multiplayer.disabled.banned.name": "Devètz cambiar lo vòstre nom per jogar en linha",
	"title.multiplayer.disabled.banned.permanent": "Vòstre compte es estat fòrabandit definitivament del jòc en linha",
	"title.multiplayer.disabled.banned.temporary": "Vòstre compte es estat fòrabandit temporàriament del jòc en linha",
	"title.multiplayer.lan": "Multijogaire (LAN)",
	"title.multiplayer.online": "Multijogaire (en linha)",
	...
	"trim_pattern.minecraft.ward": "Ondradura de las prigondors",
	"trim_pattern.minecraft.wayfinder": "Ondradura dels exploradors",
	...
	"tutorial.craft_planks.title": "Fabricatz de plancas",
	"tutorial.find_tree.description": "Tusta-o per obténer de la fusta",
	"tutorial.find_tree.title": "Trobatz un arbre",
	"tutorial.look.description": "Bolegatz vòstre mirga",
	"tutorial.look.title": "Agachatz a l'entorn de vos",
	"tutorial.move.description": "Sautatz amb %s",
	"tutorial.move.title": "Bolegatz amb %s, %s, %s e %s",
	"tutorial.open_inventory.description": "Picatz %s",
	"tutorial.open_inventory.title": "Dobrissètz vòstre inventari",
	"tutorial.punch_tree.description": "Mantenètz %s",
	"tutorial.punch_tree.title": "Copatz l'arbre",
	"tutorial.socialInteractions.description": "Picatz %s per obrir",
	"tutorial.socialInteractions.title": "Interaccions socialas",
	"upgrade.minecraft.netherite_upgrade": "Melhorament en netherita",
	"upgradeWorld.aborted.file_already_exists": "Lo dossièr del mond sembla ja conténer de fichièrs meses a jorn. Lo jòc pòt pas plan metre a jorn lo mond.",
	"upgradeWorld.aborted.message": "Pòt arribar se un autre programa a accedit al mond pendent l'actualizacion.\nTornatz amodar lo vòstre ordenador e, se lo problèma despareis pas, pensatz a senhalar lo bug.",
	"upgradeWorld.aborted.reportBug": "Senhalar un bug",
	"upgradeWorld.aborted.title": "Fracàs de l'actualizacion del mond",
	"upgradeWorld.canceled.message": "Vòstre mond demòra coma abans.",
	"upgradeWorld.canceled.title": "Actualizacion del mond anullada",
	"upgradeWorld.done": "Actualizacion del mond acabada",
	"upgradeWorld.failed_cleanup.message": "Aqueste mond es estat actualizat a la version actuala, ara, es dins la lista dels monds.\nAvèm encontrat de problèmas al netejar las donadas obsolètas. En consequéncia, lo nom del dossièr es estat modificat en \"%s\".",
	"upgradeWorld.failed_cleanup.title": "Actualizacion del mond capitada",
	"upgradeWorld.info.converted": "Actualizat : %s",
	"upgradeWorld.info.file_fix_stage": "Fasa : %s/%s",
	"upgradeWorld.info.scanning": "Analisi dels fichièrs...",
	"upgradeWorld.info.total": "Total : %s",
	"upgradeWorld.joinNow": "Volètz rejónher aqueste mond ja?",
	"upgradeWorld.progress.percentage": "%s %%",
	"upgradeWorld.progress.type.files": "Desplaçament dels fichièrs",
	"upgradeWorld.progress.type.legacy_structures": "Actualizacion de las ancianas estructuras",
	"upgradeWorld.progress.type.region": "Actualizacion de las regions",
	"upgradeWorld.symlink.message": "Lo mond causit contèn de ligam simbolics.\nLas etapas necessàrias per actualizar cap a la version actuala prenon pas en carga l'empleg de ligams simbolics. Per actualizar lo mond, cal ja resòlvre los ligams.",
	"upgradeWorld.symlink.title": "Impossible d'actualizar lo mond",
	"upgradeWorld.title": "Actualizacion dels fichièrs del mond",
}
