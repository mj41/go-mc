// Code generated by tools/gen_lang.go from 26.2/ast_es.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"accessibility.onboarding.accessibility.button.narration": "Configuración de l'accesibilidá",
	...
	"advMode.mode": "Mou",
	"advMode.mode.auto": "Repititivu",
	"advMode.mode.autoexec.bat": "Activu de contino",
	"advMode.mode.conditional": "Condicional",
	"advMode.mode.redstone": "Por impulsu",
	"advMode.mode.redstoneTriggered": "Precisa redstone",
	"advMode.mode.sequence": "En cadena",
	"advMode.mode.unconditional": "Incondicional",
	"advMode.notAllowed": "Has ser operador ya tar nel mou creativu",
	"advMode.notEnabled": "Los bloques de comandos nun tán activaos",
	"advMode.notEnabled.spawner": "Los bloques d'aprucir nun tán activaos",
	"advMode.previousOutput": "Salida anterior",
	"advMode.setCommand": "Configuración d'un comandu pal bloque",
	"advMode.setCommand.disabled": "Configuróse'l comandu «%s» mas los bloques de comandos siguen desactivaos",
	"advMode.setCommand.success": "Configuróse'l comandu «%s»",
	"advMode.trackOutput": "Rexistrar la salida",
	...
	"advancements.adventure.salvage_sherd.title": "Respetando los Restos",
	...
	"advancements.adventure.trim_with_any_armor_pattern.description": "Fai una armadura recortada nuna mesa de ferrería",
	...
	"advancements.husbandry.allay_deliver_cake_to_note_block.description": "Fai qu'un allay dexe cayer una tarta nun bloque de notes",
	...
	"advancements.husbandry.froglights.title": "¡Tamos xuntos nesto!",
	...
	"advancements.husbandry.safely_harvest_honey.description": "Usa una foguera pa catar miel d'un caxellu con una botella de cristal ensin enritar les abeyes",
	"advancements.husbandry.safely_harvest_honey.title": "¡Ye una gociada!",
	...
	"argument.anchor.invalid": "La posición d'anclaxe de la entidá «%s» nun ye válida",
	"argument.angle.incomplete": "El comandu ta incompletu (esperábase 1 ángulu)",
	"argument.angle.invalid": "L'ángulu nun ye válidu",
	"argument.block.id.invalid": "El tipu de bloque «%s» ye desconocíu",
	"argument.block.property.duplicate": "La propiedá «%s» del bloque «%s» namás se pue configurar una vegada",
	"argument.block.property.invalid": "El bloque «%s» nun acepta «%s» pa la propiedá «%s»",
	"argument.block.property.novalue": "Esperábase un valor pa la propiedá «%s» nel bloque «%s»",
	"argument.block.property.unclosed": "Esperábase'l caráuter «]» de les propiedaes d'estáu del bloque",
	...
	"argument.color.invalid": "La color «%s» ye desconocida",
	"argument.component.invalid": "Componente de chat non válidu: %s",
	"argument.criteria.invalid": "El criteriu «%s» ye desconocíu",
	"argument.dimension.invalid": "La dimensión «%s» ye desconocida",
	"argument.double.big": "El valor doble nun ha ser superior a %s mas yera %s",
	"argument.double.low": "El valor doble nun ha ser inferior a %s mas yera %s",
	"argument.entity.invalid": "El nome o l'UUID nun son válidos",
	...
	"argument.entity.options.gamemode.description": "Xugadores col mou de xuegu",
	...
	"argument.entity.options.limit.toosmall": "La llende ha ser pelo menos de 1",
	"argument.entity.options.mode.invalid": "El mou de xuegu «%s» ye desconocíu o nun ye válidu",
	"argument.entity.options.name.description": "Nome de la entidá",
	...
	"argument.entity.options.sort.description": "Ordena les entidaes",
	"argument.entity.options.sort.irreversible": "El tipu d'orde «%s» ye desconocíu o nun ye válidu",
	"argument.entity.options.tag.description": "Entidaes con una etiqueta",
	"argument.entity.options.team.description": "Entidaes nun equipu",
	"argument.entity.options.type.description": "Entidaes d'un tipu",
	"argument.entity.options.type.invalid": "El tipu d'entidá «%s» ye desconocíu o nun ye válidu",
	"argument.entity.options.unknown": "La opción «%s» ye desconocida",
	"argument.entity.options.unterminated": "Esperábase la fin de les opciones",
	"argument.entity.options.valueless": "Esperábase un valor pa la opción «%s»",
	...
	"argument.entity.selector.missing": "Falta'l tipu de selector",
	"argument.entity.selector.nearestEntity": "La entidá más averada",
	"argument.entity.selector.nearestPlayer": "El xugador más cercanu",
	"argument.entity.selector.not_allowed": "Nun se permite'l selector",
	"argument.entity.selector.randomPlayer": "Un xugador aleatoriu",
	"argument.entity.selector.self": "La entidá actual",
	"argument.entity.selector.unknown": "El tipu de selector «%s» ye desconocíu",
	"argument.entity.toomany": "Namás se permite una entidá mas el selector forníu permite más d'una",
	"argument.enum.invalid": "El valor «%s» nun ye válidu",
	"argument.float.big": "El valor flotante nun ha ser superior a %s mas yera %s",
	"argument.float.low": "El valor flotante nun ha ser inferior a %s mas yera %s",
	"argument.gamemode.invalid": "El mou de xuegu «%s» ye desconocíu",
	"argument.hexcolor.invalid": "El códigu de color n'hexadecimal «%s» nun ye válidu",
	"argument.id.invalid": "La ID nun ye válida",
	"argument.id.unknown": "La ID «%s» ye desconocida",
	"argument.integer.big": "El valor enteru nun ha ser superior a %s mas yera %s",
	"argument.integer.low": "El valor enteru nun ha ser inferior a %s mas yera %s",
	"argument.item.id.invalid": "L'oxetu «%s» ye desconocíu",
	"argument.item.tag.disallowed": "Equí nun se permiten les etiquetes, namás los oxetos",
	"argument.literal.incorrect": "Esperábase'l valor lliteral «%s»",
	"argument.long.big": "El valor llongu nun ha ser superior a %s mas yera %s",
	"argument.long.low": "El valor llongu nun ha ser inferior a %s mas yera %s",
	"argument.message.too_long": "El mensaxe de charra yera mui llongu (tien %s caráuteres ya supera'l máximu de %s)",
	"argument.nbt.array.invalid": "El tipu d'array «%s» nun ye válidu",
	"argument.nbt.array.mixed": "Nun se pue inxertar «%s» nel array «%s»",
	"argument.nbt.expected.compound": "Esperábase una etiqueta compuesta",
	"argument.nbt.expected.key": "Esperábase una clave",
	"argument.nbt.expected.value": "Esperábase un valor",
	"argument.nbt.list.mixed": "Nun se pue inxertar «%s» na llista «%s»",
	"argument.nbt.trailing": "Hai más datos de los esperaos",
	"argument.player.entities": "Esti comandu namás afeuta a xugadores mas el selector forníu inclúi entidaes",
	"argument.player.toomany": "Namás se permite un xugador mas el selector forníu permite más d'unu",
	...
	"argument.pos.mixed": "Nun se puen mecer les coordenaes del mundu ya les llocales (toes han usar el carauter ^ o nengún)",
	...
	"argument.range.empty": "Esperábase un valor o un intervalu d'ellos",
	"argument.range.ints": "Namás se permiten númberos enteros, non decimales",
	"argument.range.swapped": "El mínimu nun pue superar el máximu",
	"argument.resource.invalid_type": "L'elementu «%s» tien el tipu incorreutu «%s» (esperábase «%s»)",
	"argument.resource.not_found": "Nun se pue atopar l'elementu «%s» del tipu «%s»",
	"argument.resource_or_id.failed_to_parse": "L'análisis de la estructura «%s» falló",
	"argument.resource_or_id.invalid": "La ID o la etiqueta nun son válides",
	"argument.resource_or_id.no_such_element": "Nun se pue atopar l'elementu «%s» nel rexistru «%s»",
	"argument.resource_selector.not_found": "Nun hai nenguna coincidencia pal selector «%s» del tipu «%s»",
	"argument.resource_tag.invalid_type": "La etiqueta «%s» tien el tipu enquivocáu «%s» (esperábase «%s»)",
	"argument.resource_tag.not_found": "Nun se pue atopar la etiqueta «%s» del tipu «%s»",
	...
	"argument.style.invalid": "L'estilu «%s» nun ye válidu",
	"argument.swing_animation.invalid": "Unknown swing animation type: %s",
	"argument.time.invalid_tick_count": "El númberu de tics nun ha ser negativu",
	"argument.time.invalid_unit": "La unidá nun ye válida",
	"argument.time.tick_count_too_low": "El númberu de tics nun ha ser inferior a %s mas yera %s",
	"argument.uuid.invalid": "L'UUID nun ye válidu",
	"argument.waypoint.invalid": "La entidá seleicionada nun ye un puntu de referencia",
	"arguments.block.tag.unknown": "La etiqueta de bloque «%s» ye desconocida",
	"arguments.function.tag.unknown": "Etiqueta de función desconocida '%s'",
	"arguments.function.unknown": "La función «%s» ye desconocida",
	"arguments.item.component.expected": "Esperábase un componente d'oxetu",
	"arguments.item.component.malformed": "El componente «%s» ta mal formáu: %s",
	"arguments.item.component.repeated": "Repitióse'l componente d'oxetu «%s» mas namás se pue especificar un valor",
	"arguments.item.component.unknown": "El componente d'oxetu «%s» ye desconocíu",
	"arguments.item.malformed": "L'oxetu «%s» ta mal formáu",
	"arguments.item.overstacked": "«%s» namás pue apilase hasta %s",
	"arguments.item.predicate.malformed": "El predicáu «%s» ta mal formáu: %s",
	"arguments.item.predicate.unknown": "El predicáu d'oxetu «%s» ye desconocíu",
	"arguments.item.tag.unknown": "La etiqueta d'oxetu «%s» ye desconocida",
	...
	"attribute.name.air_drag_modifier": "Modificador de resistencia l'aire",
	...
	"attribute.name.waypoint_transmit_range": "Algame de tresmisión del puntu de ruta",
	...
	"biome.minecraft.dappled_forest": "Viesca d'álamos",
	...
	"biome.minecraft.old_growth_birch_forest": "Vieya viesca de bidul",
	"biome.minecraft.old_growth_pine_taiga": "Vieya taiga de pinu",
	"biome.minecraft.old_growth_spruce_taiga": "Vieya taiga d'abetu",
	...
	"block.minecraft.acacia_hanging_sign": "Cartelu colgante d'alcacia",
	...
	"block.minecraft.acacia_wall_hanging_sign": "Cartelu colgante d'alcacia na parede",
	...
	"block.minecraft.bamboo_fence_gate": "Portiella de bambú",
	"block.minecraft.bamboo_hanging_sign": "Cartelu colgante de bambú",
	"block.minecraft.bamboo_mosaic": "Mosaicu de bambú",
	"block.minecraft.bamboo_mosaic_slab": "Llábana de mosaicu de bambú",
	"block.minecraft.bamboo_mosaic_stairs": "Pasales de mosaicu de bambú",
	"block.minecraft.bamboo_planks": "Tables de bambú",
	...
	"block.minecraft.bamboo_slab": "Llábana de bambú",
	"block.minecraft.bamboo_stairs": "Pasales de bambú",
	"block.minecraft.bamboo_trapdoor": "Portiella de bambú",
	"block.minecraft.bamboo_wall_hanging_sign": "Cartelu colgante de bambú na parede",
	"block.minecraft.bamboo_wall_sign": "Cartelu de bambú na parede",
	...
	"block.minecraft.birch_hanging_sign": "Cartelu сolgante de bidul",
	...
	"block.minecraft.birch_wall_hanging_sign": "Cartelu colgante de bidul na parede",
	...
	"block.minecraft.black_wool_slab": "Llábana de llana prieto",
	"block.minecraft.black_wool_stairs": "Pasales de llana prieto",
	...
	"block.minecraft.blue_wool_slab": "Llábana de llana azul",
	"block.minecraft.blue_wool_stairs": "Pasales de llana azul",
	...
	"block.minecraft.brown_wool_slab": "Llábana de llana marrón",
	"block.minecraft.brown_wool_stairs": "Pasales de llana marrón",
	...
	"block.minecraft.cherry_button": "Botón de cerezu",
	"block.minecraft.cherry_door": "Puerta de cerezu",
	"block.minecraft.cherry_fence": "Valla de cerezu",
	"block.minecraft.cherry_fence_gate": "Portiella de cerezu",
	"block.minecraft.cherry_hanging_sign": "Cartelu colgante de cerezu",
	"block.minecraft.cherry_leaves": "Fueyes de cerezu",
	"block.minecraft.cherry_log": "Tueru de cerezu",
	"block.minecraft.cherry_planks": "Tables de cerezu",
	"block.minecraft.cherry_pressure_plate": "Placa de presión de cerezu",
	"block.minecraft.cherry_sapling": "Biltu de cerezu",
	"block.minecraft.cherry_shelf": "Estantería de cerezu",
	"block.minecraft.cherry_sign": "Cartelu de cerezu",
	"block.minecraft.cherry_slab": "Llábana de cerezu",
	"block.minecraft.cherry_stairs": "Pasales de cerezu",
	"block.minecraft.cherry_trapdoor": "Portiella de cerezu",
	"block.minecraft.cherry_wall_hanging_sign": "Cartelu colgante de cerezu na parede",
	"block.minecraft.cherry_wall_sign": "Cartelu de cerezu na parede",
	...
	"block.minecraft.chiseled_copper": "Cobre cincelao",
	...
	"block.minecraft.copper_grate": "Rexa de cobre",
	...
	"block.minecraft.copper_trapdoor": "Trapiella de cobre",
	"block.minecraft.copper_wall_torch": "Antorcha de cobre na parede",
	...
	"block.minecraft.crimson_hanging_sign": "Cartelu colgante carmesín",
	"block.minecraft.crimson_hyphae": "Hifas carmesines",
	...
	"block.minecraft.crimson_wall_hanging_sign": "Cartelu colgante carmesín na parede",
	"block.minecraft.crimson_wall_sign": "Cartelu carmesín na parede",
	...
	"block.minecraft.cyan_wool_slab": "Llábana de llana ciano",
	"block.minecraft.cyan_wool_stairs": "Pasales de llana ciano",
	...
	"block.minecraft.dark_oak_hanging_sign": "Cartelu colgante de carbayu escuro",
	...
	"block.minecraft.dark_oak_wall_hanging_sign": "Cartelu colgante de carbayu escuro",
	...
	"block.minecraft.exposed_copper_bulb": "Bombilla de cobre espuesto",
	...
	"block.minecraft.exposed_copper_door": "Puerta de cobre espuesto",
	"block.minecraft.exposed_copper_golem_statue": "Estatua de gólem de cobre espuesto",
	"block.minecraft.exposed_copper_grate": "Rexa de cobre espuesto",
	"block.minecraft.exposed_copper_lantern": "Llámpara de cobre espuesto",
	"block.minecraft.exposed_copper_trapdoor": "Trapiella de cobre espuesto",
	"block.minecraft.exposed_cut_copper": "Cobre cortao espuesto",
	"block.minecraft.exposed_cut_copper_slab": "Llábana de cobre cortao espuesto",
	"block.minecraft.exposed_cut_copper_stairs": "Pasales de cobre cortao espuesto",
	...
	"block.minecraft.gray_concrete_slab": "Llábana de formigón buxo",
	...
	"block.minecraft.gray_wool_slab": "Llábana de llana buxo",
	"block.minecraft.gray_wool_stairs": "Pasales de llana buxo",
	...
	"block.minecraft.green_wool_slab": "Llábana de llana verde",
	"block.minecraft.green_wool_stairs": "Pasales de llana verde",
	...
	"block.minecraft.jungle_hanging_sign": "Cartelu colgante de la xungla",
	...
	"block.minecraft.jungle_shelf": "Estantería de la xungla",
	...
	"block.minecraft.jungle_wall_hanging_sign": "Cartelu colgante de madera de la xungla na parede",
	...
	"block.minecraft.light_blue_wool_slab": "Llábana de llana azul claro",
	"block.minecraft.light_blue_wool_stairs": "Pasales de llana azul claro",
	...
	"block.minecraft.light_gray_wool_slab": "Llábana de llana buxo claro",
	"block.minecraft.light_gray_wool_stairs": "Pasales de llana buxo claro",
	...
	"block.minecraft.lime_wool_slab": "Llábana de llana llima",
	"block.minecraft.lime_wool_stairs": "Pasales de llana llima",
	...
	"block.minecraft.magenta_wool_slab": "Llábana de llana maxenta",
	"block.minecraft.magenta_wool_stairs": "Pasales de llana maxenta",
	...
	"block.minecraft.mangrove_fence_gate": "Portiella de mangle",
	"block.minecraft.mangrove_hanging_sign": "Cartelu colgante de mangle",
	"block.minecraft.mangrove_leaves": "Fueyes de mangle",
	"block.minecraft.mangrove_log": "Tueru de mangle",
	"block.minecraft.mangrove_planks": "Tables de mangle",
	"block.minecraft.mangrove_pressure_plate": "Placa de presión de mangle",
	"block.minecraft.mangrove_propagule": "Propágulu de mangle",
	"block.minecraft.mangrove_roots": "Raíces de mangle",
	"block.minecraft.mangrove_shelf": "Estantería de mangle",
	"block.minecraft.mangrove_sign": "Cartelu de mangle",
	"block.minecraft.mangrove_slab": "Llábana de mangle",
	"block.minecraft.mangrove_stairs": "Pasales de mangle",
	"block.minecraft.mangrove_trapdoor": "Trapiella de mangle",
	"block.minecraft.mangrove_wall_hanging_sign": "Cartelu colgante de mangle na parede",
	"block.minecraft.mangrove_wall_sign": "Cartelu de mangle na parede",
	...
	"block.minecraft.muddy_mangrove_roots": "Raigañu fangoso de mangle",
	...
	"block.minecraft.oak_hanging_sign": "Cartelu colgante de carbayu",
	...
	"block.minecraft.oak_wall_hanging_sign": "Cartelu colgante de carbayu na parede",
	...
	"block.minecraft.orange_poplar_leaves": "Fueyes de chopu naranxes",
	...
	"block.minecraft.orange_wool_slab": "Llábana de llana naranxa",
	"block.minecraft.orange_wool_stairs": "Pasales de llana naranxa",
	"block.minecraft.oxeye_daisy": "Catasol grande",
	"block.minecraft.oxidized_chiseled_copper": "Cobre cincelao ferruñoso",
	"block.minecraft.oxidized_copper": "Cobre oxidao",
	"block.minecraft.oxidized_copper_bars": "Barres de cobre ferruñoso",
	"block.minecraft.oxidized_copper_bulb": "Bombilla de cobre ferruñoso",
	...
	"block.minecraft.oxidized_copper_door": "Puerta de cobre ferruñoso",
	"block.minecraft.oxidized_copper_golem_statue": "Estatua de gólem de cobre ferruñoso",
	"block.minecraft.oxidized_copper_grate": "Rexa de cobre ferruñoso",
	"block.minecraft.oxidized_copper_lantern": "Llámpara de cobre ferruñoso",
	"block.minecraft.oxidized_copper_trapdoor": "Trapiella de cobre ferruñoso",
	...
	"block.minecraft.pale_oak_fence_gate": "Portiella de carbayu pálido",
	"block.minecraft.pale_oak_hanging_sign": "Cartelu de carbayu pálido na parede",
	...
	"block.minecraft.pale_oak_slab": "Llábana de carbayu pálido",
	"block.minecraft.pale_oak_stairs": "Pasales de carbayu pálido",
	"block.minecraft.pale_oak_trapdoor": "Trapiella de carbayu pálido",
	"block.minecraft.pale_oak_wall_hanging_sign": "Cartelu colgante de carbayu pálido na parede",
	"block.minecraft.pale_oak_wall_sign": "Cartelu de carbayu pálido na parede",
	"block.minecraft.pale_oak_wood": "Tueru de carbayu pálido",
	...
	"block.minecraft.pink_wool_slab": "Llábana de llana rosa",
	"block.minecraft.pink_wool_stairs": "Pasales de llana rosa",
	...
	"block.minecraft.poplar_button": "Botón de chopu",
	"block.minecraft.poplar_door": "Puerta de chopu",
	"block.minecraft.poplar_fence": "Valla de chopu",
	"block.minecraft.poplar_fence_gate": "Portiella de chopu",
	"block.minecraft.poplar_hanging_sign": "Cartelu colgante de chopu",
	"block.minecraft.poplar_leaves": "Fueyes de chopu",
	"block.minecraft.poplar_log": "Tueru de chopu",
	"block.minecraft.poplar_planks": "Tablones de chopu",
	"block.minecraft.poplar_pressure_plate": "Placa de presión de chopu",
	"block.minecraft.poplar_sapling": "Biltu de chopu",
	"block.minecraft.poplar_shelf": "Estantería de chopu",
	"block.minecraft.poplar_sign": "Cartelu de chopu",
	"block.minecraft.poplar_slab": "Llábana de chopu",
	"block.minecraft.poplar_stairs": "Pasales de chopu",
	"block.minecraft.poplar_trapdoor": "Trapiella de chopu",
	"block.minecraft.poplar_wall_hanging_sign": "Cartelu colgante de chopu na parede",
	"block.minecraft.poplar_wall_sign": "Cartelu de chopu na parede",
	"block.minecraft.poplar_wood": "Madera de chopu con corteza",
	...
	"block.minecraft.potted_cherry_sapling": "Tiestu con un biltu de cerezu",
	...
	"block.minecraft.potted_golden_dandelion": "Diente de lleón doráu en tiestu",
	...
	"block.minecraft.potted_mangrove_propagule": "Tiestu con un propágulu de mangle",
	...
	"block.minecraft.potted_poplar_sapling": "Tiestu con un biltu de chopu",
	...
	"block.minecraft.purple_wool_slab": "Llábana de llana morao",
	"block.minecraft.purple_wool_stairs": "Pasales de llana morao",
	...
	"block.minecraft.red_poplar_leaves": "Fueyes de chopu coloraes",
	...
	"block.minecraft.red_wool_slab": "Llábana de llana colorao",
	"block.minecraft.red_wool_stairs": "Pasales de llana colorao",
	...
	"block.minecraft.resin_brick_slab": "Llosa de lladriyos de resina",
	"block.minecraft.resin_brick_stairs": "Escaleres de lladriyos de resina",
	"block.minecraft.resin_brick_wall": "Muriu de lladriyos de resina",
	"block.minecraft.resin_bricks": "Lladriyos de resina",
	"block.minecraft.resin_clump": "Masa de resina",
	...
	"block.minecraft.short_dry_grass": "Yerba seco curtia",
	...
	"block.minecraft.spruce_shelf": "Estante d'abetu",
	...
	"block.minecraft.stripped_bamboo_block": "Bloque de bambú ensin corteza",
	...
	"block.minecraft.stripped_cherry_log": "Tueru de cerezu ensin corteza",
	"block.minecraft.stripped_cherry_wood": "Madera de cerru ensin corteza",
	"block.minecraft.stripped_crimson_hyphae": "Hifas carmesinas ensin corteza",
	...
	"block.minecraft.stripped_mangrove_log": "Tueru de mangle ensin corteza",
	"block.minecraft.stripped_mangrove_wood": "Madera de mangle ensin corteza",
	...
	"block.minecraft.stripped_pale_oak_log": "Tueru de carbayu pálido ensin corteza",
	"block.minecraft.stripped_pale_oak_wood": "Madera de carbayu pálido ensin corteza",
	"block.minecraft.stripped_poplar_log": "Tueru de chopu ensin corteza",
	"block.minecraft.stripped_poplar_wood": "Madera de tueru ensin corteza",
	...
	"block.minecraft.stripped_warped_hyphae": "Hifas distorsionaes ensin corteza",
	...
	"block.minecraft.test_instance_block": "Bloque d'instancia de prueba",
	...
	"block.minecraft.tuff_bricks": "Lladriyos de toba",
	...
	"block.minecraft.twisting_vines": "Enredaderes retorcigañaes",
	"block.minecraft.twisting_vines_plant": "Planta d'enredaderes retorcigañaes",
	...
	"block.minecraft.warped_hanging_sign": "Cartelu colgante distorsionáu",
	"block.minecraft.warped_hyphae": "Hifas torcíes",
	...
	"block.minecraft.warped_shelf": "Estantería distorsionada",
	...
	"block.minecraft.warped_wall_hanging_sign": "Cartelu colgante distorsionáu na pared",
	"block.minecraft.warped_wall_sign": "Cartelu distorsionáu na pared",
	...
	"block.minecraft.waxed_chiseled_copper": "Cobre cincelao con cera",
	"block.minecraft.waxed_copper_bars": "Barres de cobre con cera",
	"block.minecraft.waxed_copper_block": "Bloque de cobre enceráu",
	"block.minecraft.waxed_copper_bulb": "Bombilla de cobre con cera",
	"block.minecraft.waxed_copper_chain": "Cadena de cobre con cera",
	"block.minecraft.waxed_copper_chest": "Bagul de cobre con cera",
	"block.minecraft.waxed_copper_door": "Puerta de cobre con cera",
	"block.minecraft.waxed_copper_golem_statue": "Estatua de gólem de cobre encerada",
	"block.minecraft.waxed_copper_grate": "Rexa de cobre con cera",
	"block.minecraft.waxed_copper_lantern": "Llámpara de cobre con cera",
	"block.minecraft.waxed_copper_trapdoor": "Trapiella de cobre con cera",
	...
	"block.minecraft.waxed_exposed_chiseled_copper": "Cobre cincelao espuesto con cera",
	"block.minecraft.waxed_exposed_copper": "Cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_bars": "Barres de cobre espuestu con cera",
	"block.minecraft.waxed_exposed_copper_bulb": "Bombilla de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_chain": "Cadena de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_chest": "Bagul de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_door": "Puerta de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_golem_statue": "Estatua de gólem de cobre espuesta encerada",
	"block.minecraft.waxed_exposed_copper_grate": "Rexa de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_lantern": "Llámpara de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_copper_trapdoor": "Trapiella de cobre espuesto con cera",
	"block.minecraft.waxed_exposed_cut_copper": "Cobre espuesto cortao y con cera",
	"block.minecraft.waxed_exposed_cut_copper_slab": "Llábana de cobre cortao espuesto con cera",
	"block.minecraft.waxed_exposed_cut_copper_stairs": "Pasales de cobre cortao espuesto con cera",
	"block.minecraft.waxed_exposed_lightning_rod": "Pararrayos de cobre espuestu enceráu",
	"block.minecraft.waxed_lightning_rod": "Parrayos con cera",
	"block.minecraft.waxed_oxidized_chiseled_copper": "Cobre cincelao ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper": "Cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_bars": "Cadenes de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_bulb": "Bombilla de cobre ferruñoso con cera",
	...
	"block.minecraft.waxed_oxidized_copper_door": "Puerta de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_golem_statue": "Estatua de gólem de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_grate": "Rexa de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_lantern": "Llámpara de cobre ferruñoso con cera",
	"block.minecraft.waxed_oxidized_copper_trapdoor": "Trapiella de cobre ferruñoso encerao",
	"block.minecraft.waxed_oxidized_cut_copper": "Cobre cortao ferruñoso con cera",
	"block.minecraft.waxed_oxidized_cut_copper_slab": "Llábana de cobre cortao ferruñoso con cera",
	"block.minecraft.waxed_oxidized_cut_copper_stairs": "Pasales de cobre cortao ferruñoso con cera",
	"block.minecraft.waxed_oxidized_lightning_rod": "Pararrayos ferruñosu con cera",
	"block.minecraft.waxed_weathered_chiseled_copper": "Cobre cincelao corroyío con cera",
	"block.minecraft.waxed_weathered_copper": "Cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_bars": "Barres de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_bulb": "Bombilla de cobre corroyío con cera",
	...
	"block.minecraft.waxed_weathered_copper_door": "Puerta de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_golem_statue": "Estatua de gólem de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_grate": "Rexa de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_lantern": "Llámpara de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_copper_trapdoor": "Trapiella de cobre corroyío con cera",
	"block.minecraft.waxed_weathered_cut_copper": "Cobre cortao corroyío con cera",
	"block.minecraft.waxed_weathered_cut_copper_slab": "Llábana de cobre cortao corroyío con cera",
	"block.minecraft.waxed_weathered_cut_copper_stairs": "Pasales de cobre cortao corroyío con cera",
	"block.minecraft.waxed_weathered_lightning_rod": "Pararrayos corroyíu con cera",
	"block.minecraft.weathered_chiseled_copper": "Cobre cincelao con cera",
	"block.minecraft.weathered_copper": "Cobre corroyío",
	"block.minecraft.weathered_copper_bars": "Barres de cobre corroyío",
	"block.minecraft.weathered_copper_bulb": "Bombilla de cobre corroyío",
	"block.minecraft.weathered_copper_chain": "Cadena de cobre corroyío",
	"block.minecraft.weathered_copper_chest": "Bagul de cobre corroyío",
	"block.minecraft.weathered_copper_door": "Puerta de cobre corroyío",
	"block.minecraft.weathered_copper_golem_statue": "Estatua de gólem de cobre corroyío",
	"block.minecraft.weathered_copper_grate": "Rexa de cobre corroyío",
	"block.minecraft.weathered_copper_lantern": "Llámpara de cobre corroyío",
	"block.minecraft.weathered_copper_trapdoor": "Trapiella de cobre corroyío",
	...
	"block.minecraft.weathered_lightning_rod": "Pararrayos de cobre avieyáu",
	...
	"block.minecraft.white_wool_slab": "Llábana de llana blanco",
	"block.minecraft.white_wool_stairs": "Pasales de llana blanco",
	...
	"block.minecraft.yellow_poplar_leaves": "Fueyes de chopu marielles",
	...
	"block.minecraft.yellow_wool_slab": "Llábana de llana mariello",
	"block.minecraft.yellow_wool_stairs": "Pasales de llana mariello",
	...
	"book.edit.title": "Pantalla d'edición de llibru",
	...
	"book.page_button.next": "Páxina siguiente",
	"book.page_button.previous": "Páxina anterior",
	"book.sign.title": "Pantalla para roblar llibru",
	"book.sign.titlebox": "Títulu",
	"book.signButton": "Roblar",
	"book.view.title": "Pantalla de visualización de llibru",
	"build.spawn_protection": "%s ta so protección d'apaición",
	"build.tooHigh": "La llende d'altor pa la construcción ye %s",
	"build.tooLow": "L'altor mínimu de construcción ye %s",
	...
	"chat.queue.tooltip": "Fai clic para amosar el siguiente mensaxe",
	...
	"chat_restriction.chat_and_commands_disabled_by_options": "El chat ta acutáu na configuración del veceru.",
	"chat_restriction.chat_disabled_by_options": "El chat de xugadores ta acutáu na configuración del veceru.",
	"chat_restriction.chat_disabled_by_options.action": "Dir a la pantalla de configuración del chat",
	"chat_restriction.disabled_by_launcher": "El chat ta acutáu pol llanzador",
	"chat_restriction.disabled_by_profile": "El chat ta acutáu pola configuración del perfil.",
	"chat_restriction.disabled_by_profile.action": "Dir a la configuración del perfil",
	"chat_screen.commands_not_allowed": "Nun ta dexáu unviar comandos",
	"chat_screen.message": "Mensaxe a unviar: %s",
	"chat_screen.messages_not_allowed": "Nun ta dexáu unviar mensaxes de chat",
	"chat_screen.restricted": "El chat ta acutáu. Fai clic nesti mensaxe para llograr más información.",
	"chat_screen.restricted.narration": "El chat ta acutáu. Ve a la pantalla de Restricciones nes opciones del mundu.",
	...
	"command.compute.result.named.exact": "%s returned value %s",
	"command.compute.result.named.rounded": "%s returned value %s (rounded to %s)",
	"command.compute.result.unnamed.exact": "Number provider returned value %s",
	...
	"command.trailing_data": "Datos de siguimientu atopaos: %s",
	...
	"commands.attribute.base_value.reset.success": "El valor base del atributu %s para la entidá %s restablecer al valor predeterminado %s",
	"commands.attribute.base_value.set.success": "El valor base del atributu %s para la entidá %s establecer en %s",
	"commands.attribute.failed.entity": "%s nun ye una entidá válida para esti comandu",
	"commands.attribute.failed.modifier_already_present": "El modificador %s yá ta presente nel atributu %s de la entidá %s",
	"commands.attribute.failed.no_attribute": "La entidá «%s» nun tien nengún atributu «%s»",
	"commands.attribute.failed.no_modifier": "L'atributu %s de la entidá %s nun tien nengún modificador %s",
	"commands.attribute.modifier.add.success": "Amestóse'l modificador %s al atributu %s de la entidá %s",
	"commands.attribute.modifier.remove.success": "Esanicióse'l modificador %s del atributu %s de la entidá %s",
	...
	"commands.banip.info": "Esta prohibición afecta a %s xugador(ye): %s",
	...
	"commands.banlist.list": "Hai %s prohibición(ye):",
	...
	"commands.bossbar.get.players.some": "El xefe personalizáu %s tien %s xugador(ye) conectaos anguaño: %s",
	...
	"commands.bossbar.list.bars.some": "Hai %s barra(s) de xefe personalizada(s) activa(s): %s",
	...
	"commands.bossbar.set.players.success.some": "La barra de xefe personalizada %s agora tien %s xugador(ye): %s",
	...
	"commands.clear.success.multiple": "Esaniciáronse %s oxetu(s) de %s xugadores",
	"commands.clear.success.single": "Esaniciáronse %s oxetu(s) del xugador %s",
	"commands.clear.test.multiple": "Atopáronse %s oxetu(s) coincidente(s) en %s xugadores",
	"commands.clear.test.single": "Atopáronse %s oxetu(s) coincidente(s) nel xugador %s",
	"commands.clone.failed": "Nun se clonaron bloques",
	"commands.clone.overlap": "Les árees d'orixe y destín nun pueden superponerse",
	"commands.clone.success": "Clonáronse correchamente %s bloque(s)",
	"commands.clone.toobig": "Hai milenta bloques nel área especificáu (el maximu ye %s, el númberu especificáu foi %s)",
	"commands.damage.invulnerable": "L'oxetivu ye invulnerable al tipu de dañu especificáu",
	"commands.damage.success": "Aplicáronse %s de dañu a %s",
	...
	"commands.data.entity.invalid": "Non pueden modificar los datos del xugador",
	...
	"commands.data.get.multiple": "Esti argumentu acepta un únicu valor NBT",
	...
	"commands.data.modify.expected_list": "Esperábase una llista: llogróse %s",
	"commands.data.modify.expected_object": "Esperábase un oxetu: llogróse %s",
	"commands.data.modify.expected_value": "Esperábase un valor: llogróse %s",
	"commands.data.modify.invalid_index": "Índiz de llista non válidu: %s",
	"commands.data.modify.invalid_substring": "Índices de subcadena non válidos: %s a %s",
	...
	"commands.datapack.create.invalid_full_name": "Nome de paquete nuevu non válidu: '%s'",
	...
	"commands.datapack.enable.failed.no_flags": "El paquete de datos '%s' nun puede habilitase porque les marques riquíes nun tán activaes nesti mundu: %s!",
	"commands.datapack.list.available.none": "Nun hai más paquetes de datos disponibles",
	"commands.datapack.list.available.success": "Hai %s paquete(s) de datos disponible(s): %s",
	"commands.datapack.list.enabled.none": "Nun hai paquetes de datos disponibles",
	"commands.datapack.list.enabled.success": "Hai %s paquete(s) de datos habilitáu(s): %s",
	...
	"commands.debug.alreadyRunning": "El perfilador de ticks yá ta empecipiáu",
	"commands.debug.function.noRecursion": "Non puede rastrexase dende dientro d'una función",
	"commands.debug.function.noReturnRun": "El rastrexu nun puede usase con return",
	"commands.debug.function.success.multiple": "Rastrexáronse %s comandu(s) de %s funciones al arquivu de salida %s",
	"commands.debug.function.success.single": "Rastrexáronse %s comandu(s) de la función '%s' al arquivu de salida %s",
	"commands.debug.function.traceFailed": "Non pudo rastrexase la función",
	"commands.debug.notRunning": "El perfilador de ticks nun s'empecipió",
	"commands.debug.started": "Empecipióse'l perfiláu de ticks",
	"commands.debug.stopped": "Detúvose'l perfiláu de ticks tres %s segundu(s) y %s tick(s) (%s tick(s) per segundu)",
	...
	"commands.dialog.clear.multiple": "Cerróse'l diálogu para %s xugadores",
	"commands.dialog.clear.single": "Cerróse'l diálogu para %s",
	"commands.dialog.show.multiple": "Amosóse'l diálogu a %s xugadores",
	"commands.dialog.show.single": "Amosóse'l diálogu a %s",
	...
	"commands.drop.no_loot_table": "La entidá %s nun tien tabla de botín",
	"commands.drop.no_loot_table.block": "El bloque %s nun tien tabla de botín",
	"commands.drop.success.multiple": "Soltáronse %s oxetus",
	"commands.drop.success.multiple_with_table": "Soltáronse %s oxetus de la tabla de botín %s",
	"commands.drop.success.single": "Soltóse %s %s",
	"commands.drop.success.single_with_table": "Soltóse %s %s de la tabla de botín %s",
	...
	"commands.enchant.failed.entity": "%s nun ye una entidá válida para esti comandu",
	"commands.enchant.failed.incompatible": "%s nun sofita esi encantexu",
	"commands.enchant.failed.itemless": "%s nun lleva nengún oxetu",
	"commands.enchant.failed.level": "%s ye mayor que'l nivel máximu de %s dexáu por esi encantamientu",
	...
	"commands.execute.blocks.toobig": "Demasiaos bloques na área especificada (máximu %s, pero especificáronse %s)",
	"commands.execute.conditional.fail": "Falló la prueba",
	"commands.execute.conditional.fail_count": "Prueba fallida. Cantidá: %s",
	"commands.execute.conditional.pass": "Superóse la prueba",
	"commands.execute.conditional.pass_count": "Prueba superada. Cantidá: %s",
	"commands.execute.function.instantiationFailure": "Nun se pudo instanciar la función %s: %s",
	...
	"commands.fetchprofile.entity.success": "Perfil resueltu para la entidá %s: %s",
	"commands.fetchprofile.failed_to_serialize": "Nun se pudo serializar el perfil: %s",
	"commands.fetchprofile.give_item": "Dar oxetu",
	"commands.fetchprofile.id.failure": "Non pudo resolvese el perfil para'l DÍI %s",
	"commands.fetchprofile.id.success": "Perfil resueltu para'l DÍI %s: %s",
	"commands.fetchprofile.name.failure": "Non pudo resolvese el perfil para'l nome %s",
	"commands.fetchprofile.name.success": "Perfil resueltu para'l nome %s: %s",
	"commands.fetchprofile.no_profile": "La entidá %s nun tien perfil",
	"commands.fetchprofile.summon_mannequin": "Invocar maniquín",
	"commands.fill.failed": "Nun se rellenó nengún bloque",
	"commands.fill.success": "Rellenáronse correchamente %s bloque(s)",
	"commands.fill.toobig": "Demasiaos bloques na área especificada (máximu %s, pero especificáronse %s)",
	"commands.fillbiome.no_changes": "No biome entries were changed",
	"commands.fillbiome.success": "Biomas establecíos entre %s, %s, %s y %s, %s, %s",
	"commands.fillbiome.success.count": "%s entrada(s) de bioma entre %s, %s, %s y %s, %s, %s",
	"commands.fillbiome.toobig": "Demasiaos bloques nel volume especificáu (máximu %s, pero especificáronse %s)",
	...
	"commands.function.error.argument_not_compound": "Tipu d'argumentu non válidu: %s. Esperábase un Compound",
	"commands.function.error.missing_argument": "Falta l'argumentu %[2]s para la función %[1]s",
	"commands.function.error.missing_arguments": "Falten argumentos para la función %s",
	"commands.function.error.parse": "Al instanciar la macro %s, el Compound '%s' provocó l'erru: %s",
	"commands.function.instantiationFailure": "Nun se pudo instanciar la función %s: %s",
	"commands.function.result": "La función %s devolvió %s",
	"commands.function.scheduled.multiple": "Executando funciones %s",
	"commands.function.scheduled.no_functions": "Nun s'atoparon funciones col nome %s",
	"commands.function.scheduled.single": "Executando función %s",
	"commands.function.success.multiple": "Executáronse %s comandu(s) de %s funciones",
	"commands.function.success.multiple.result": "Executáronse %s funciones",
	"commands.function.success.single": "Executáronse %s comandu(s) de la función '%s'",
	"commands.function.success.single.result": "La función '%[2]s' devolvió %[1]s",
	...
	"commands.give.failed.toomanyitems": "Non pueden dase más de %s de %s",
	...
	"commands.item.target.no_changed.known_item": "Nengún oxetivu aceptó l'oxetu %s na ranura %s",
	"commands.item.target.no_changes": "Nengún oxetivu aceptó oxetos na ranura %s",
	...
	"commands.jfr.dump.failed": "Non pudo entornase la grabación JFR: %s",
	"commands.jfr.start.failed": "Non pudo empecipiase el perfiláu JFR",
	"commands.jfr.started": "Empecipióse'l perfiláu JFR",
	"commands.jfr.stopped": "Detúvose'l perfiláu JFR y entornóse en %s",
	"commands.kick.owner.failed": "Non puede espulsase al propietariu del servidor n'una partida LAN",
	"commands.kick.singleplayer.failed": "Non puede espulsase n'una partida individual ensin conexón",
	...
	"commands.locate.biome.success": "El bioma más cercanu %s ta en %s (%s bloques de distancia)",
	"commands.locate.poi.not_found": "Non pudo atopase un puntu d'interés del tipu \"%s\" a una distancia razonable",
	"commands.locate.poi.success": "El puntu d'interés más cercanu %s ta en %s (%s bloques de distancia)",
	"commands.locate.structure.invalid": "Nun esiste nenguna estructura del tipu \"%s\"",
	"commands.locate.structure.not_found": "Non pudo atopase una estructura del tipu \"%s\" barganal",
	...
	"commands.perf.alreadyRunning": "El perfilador de rendimientu yá ta empecipiáu",
	"commands.perf.notRunning": "El perfilador de rendimientu nun s'empecipió",
	...
	"commands.perf.started": "Empecipióse una sesión de perfiláu de rendimientu de 10 segundos (usa '/perf stop' para detenela antes)",
	"commands.perf.stopped": "Detúvose'l perfiláu de rendimientu tres %s segundu(s) y %s tick(s) (%s tick(s) per segundu)",
	"commands.place.feature.failed": "Non pudo asitiase la característica",
	"commands.place.feature.invalid": "Nun esiste nenguna característica del tipu \"%s\"",
	"commands.place.feature.success": "Colocóse «%s» en %s, %s, %s",
	"commands.place.feature.success.inline": "Placed feature at %s, %s, %s",
	"commands.place.jigsaw.failed": "Non pudo xenerase el jigsaw",
	"commands.place.jigsaw.invalid": "Nun esiste nengún grupu de plantiyes del tipu \"%s\"",
	"commands.place.jigsaw.success": "Jigsaw xeneráu en %s, %s, %s",
	"commands.place.structure.failed": "Errú al xenerar estructura",
	"commands.place.structure.invalid": "Nun esiste nenguna estructura del tipu \"%s\"",
	"commands.place.structure.success": "Estructura \"%s\" xenerada en %s, %s, %s",
	"commands.place.template.failed": "Non pudo asitiase la plantiya",
	"commands.place.template.invalid": "Nun hai nenguna plantía cola ID «%s»",
	"commands.place.template.success": "Plantiya \"%s\" cargada en %s, %s, %s",
	...
	"commands.profile_fetch.failed_to_serialize": "Nun se pudo serializar el perfil: %s",
	"commands.profile_fetch.give_item": "Dar oxetu",
	"commands.profile_fetch.id.failure": "Non pudo resolvese el perfil pal DÍI %s",
	"commands.profile_fetch.id.success": "Perfil resueltu pal DÍI %s: %s",
	"commands.profile_fetch.name.failure": "Non pudo resolvese el perfil para'l nome %s",
	"commands.profile_fetch.name.success": "Perfil resueltu para'l nome %s: %s",
	"commands.publish.alreadyPublished": "La partida multijugador yá ta agospiada nel puertu %s",
	"commands.publish.alreadyPublished.lan": "La partida local yá ta agospiada nel puertu %s",
	"commands.publish.alreadyPublished.online": "La partida en llínea yá ta agospiada",
	...
	"commands.publish.started.lan": "Partida local agospiada nel puertu %s",
	"commands.publish.started.online": "Partida en llínea agospiada",
	"commands.publish.success": "Agora la partida de dellos xugadores agóspiase nel puertu %s",
	"commands.random.error.range_too_large": "El rangu del valor aleatoriu ten de ser a lo más 2147483646",
	"commands.random.error.range_too_small": "El rangu del valor aleatoriu ten de ser siquier 2",
	"commands.random.reset.all.success": "Secuencia(s) aleatoria(s) %s restablecida(s)",
	"commands.random.reset.success": "Secuencia aleatoria restablecida: %s",
	"commands.random.roll": "%s llogró %s (de %s a %s)",
	...
	"commands.reload.failure": "Recargar falló; caltuviéronse los datos del xugador",
	"commands.reload.success": "¡Recargando!",
	"commands.ride.already_riding": "%s yá ta montando %s",
	"commands.ride.dismount.success": "%s dexó de montar %s",
	"commands.ride.mount.failure.cant_ride_players": "El xugadores nun pueden ser montaos",
	"commands.ride.mount.failure.generic": "%s nun pudo empezar a montar %s",
	"commands.ride.mount.failure.loop": "Non puede montase una entidá sobro sí mesma nin sobro nengún de los sos pasaxeros",
	"commands.ride.mount.failure.wrong_dimension": "Non puede montase una entidá n'otra dimensión",
	"commands.ride.mount.success": "%s empezó a montar %s",
	"commands.ride.not_riding": "%s nun ta montando nengún vehículu",
	"commands.rotate.success": "Se rotó %s",
	...
	"commands.schedule.cleared.success": "Esaniciáronse %s programación(ye) col DÍI %s",
	"commands.schedule.created.function": "Función programada \"%s\" en %s tick(s) a la de xuegu %s",
	"commands.schedule.created.tag": "Etiqueta programada \"%s\" en %s tick(s) a la de xuegu %s",
	"commands.schedule.macro": "Non puede programase una macro",
	...
	"commands.scoreboard.objectives.display.alreadyEmpty": "Nun se realizó nengún cambéu. Esa ranura de visualización yá ta vacida",
	"commands.scoreboard.objectives.display.alreadySet": "Nun se realizó nengún cambéu. Esa ranura de visualización yá amuesa ese oxetivu",
	...
	"commands.scoreboard.objectives.list.success": "Hai %s oxetivu(s): %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.disable": "Desactivóse l'actualización automática de la visualización para l'oxetivu %s",
	"commands.scoreboard.objectives.modify.displayAutoUpdate.enable": "Activóse l'actualización automática de la visualización para l'oxetivu %s",
	"commands.scoreboard.objectives.modify.displayname": "Camudó'l nome a amosar de %s a %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.clear": "Borróse'l formatu numbéricu predeterminado del oxetivu %s",
	"commands.scoreboard.objectives.modify.objectiveFormat.set": "Camudóse'l formatu numbéricu predeterminado del oxetivu %s",
	"commands.scoreboard.objectives.modify.rendertype": "Camudóse'l tipu de renderizado del oxetivu %s",
	...
	"commands.scoreboard.players.display.name.clear.success.multiple": "Borróse'l nome amosáu para %s entidaes en %s",
	"commands.scoreboard.players.display.name.clear.success.single": "Borróse'l nome amosáu para %s en %s",
	"commands.scoreboard.players.display.name.set.success.multiple": "Camudóse'l nome amosáu a %s para %s entidaes en %s",
	"commands.scoreboard.players.display.name.set.success.single": "Camudóse'l nome amosáu a %s para %s en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.multiple": "Borróse'l formatu numbéricu para %s entidaes en %s",
	"commands.scoreboard.players.display.numberFormat.clear.success.single": "Borróse'l formatu numbéricu para %s en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.multiple": "Camudóse'l formatu numbéricu para %s entidaes en %s",
	"commands.scoreboard.players.display.numberFormat.set.success.single": "Camudóse'l formatu numbéricu para %s en %s",
	"commands.scoreboard.players.enable.failed": "Nun camudó nada. Esi aicionador yá ta activáu",
	"commands.scoreboard.players.enable.invalid": "La habilitación solo funciona con oxetivos de tipu trigger",
	...
	"commands.scoreboard.players.get.null": "Non puede llograse el valor de %s para %s; nun s'estableció nengunu",
	...
	"commands.setidletimeout.success": "El tiempu d'inactividá del xugador agora ye de %s minutu(s)",
	"commands.setidletimeout.success.disabled": "El tiempu d'inactividá del xugador agora ta desactiváu",
	...
	"commands.setworldspawn.success.new": "Establecióse'l puntu d'apaición mundial en %s, %s, %s [%s, %s] en %s",
	"commands.spawnpoint.success.multiple": "Establecer el puntu de spawn en %s, %s, %s [%s] en %s pa %s xugadores",
	"commands.spawnpoint.success.multiple.new": "Establecióse'l puntu d'apaición en %s, %s, %s [%s, %s] en %s para %s xugadores",
	"commands.spawnpoint.success.single": "Establecer el puntu de spawn en %s, %s, %s [%s] en %s pa %s",
	"commands.spawnpoint.success.single.new": "Establecióse'l puntu d'apaición en %s, %s, %s [%s, %s] en %s para %s",
	"commands.spectate.cannot_spectate": "%s nun puede ser espectado",
	...
	"commands.spreadplayers.failed.entities": "Non pudieron esvalixase %s entidá(ye) alredor de %s, %s (demasiaes entidaes para l'espaciu; intenta esvalixales a un máximu de %s)",
	"commands.spreadplayers.failed.invalid.height": "Altor máximu inválida %s; esperábase una cimera al mínimu del mundu %s",
	"commands.spreadplayers.failed.teams": "Non pudieron esvalixase %s equipu(s) alredor de %s, %s (demasiaos equipos para l'espaciu; intenta esvalixalos a un máximu de %s)",
	"commands.spreadplayers.success.entities": "Esvalixáronse %s entidá(ye) alredor de %s, %s con una alloña promediu de %s bloque(s)",
	"commands.spreadplayers.success.teams": "Esvalixáronse %s equipu(s) alredor de %s, %s con una alloña promediu de %s bloque(s)",
	...
	"commands.stopwatch.already_exists": "El cronómetru '%s' yá esiste",
	"commands.stopwatch.create.success": "Creóse'l cronómetru '%s'",
	"commands.stopwatch.does_not_exist": "El cronómetru '%s' nun esiste",
	"commands.stopwatch.query": "El cronómetru '%s' tuvo n'execución mientres %ss",
	"commands.stopwatch.remove.success": "Esanicióse'l cronómetru '%s'",
	"commands.stopwatch.restart.success": "Reinicióse'l cronómetru '%s'",
	"commands.summon.failed": "Nun pue invocase a la entidá",
	"commands.summon.failed.peaceful": "Non pueden invocase bisarmes na dificultá Pacífica",
	...
	"commands.swing.failed.notliving": "Nun s'atoparon entidaes vives para banciar",
	"commands.swing.success.multiple": "Fíxose que %s entidaes banciaren los sos brazos",
	"commands.swing.success.single": "Fíxose que %s banciara un brazu",
	...
	"commands.team.empty.success": "Esaniciáronse %s miembru(s) del equipu %s",
	...
	"commands.team.list.members.success": "L'equipu %s tien %s miembru(s): %s",
	"commands.team.list.teams.empty": "Nun hai equipos",
	"commands.team.list.teams.success": "Hai %s equipu(s): %s",
	"commands.team.option.collisionRule.success": "Agora la regla de colisiones pal equipu %s ye «%s»",
	"commands.team.option.collisionRule.unchanged": "Nada camudó. La riegla de choque yá tien esi valor",
	"commands.team.option.color.clear.success": "Esanicióse el color del equipu %s",
	...
	"commands.team.option.prefix.success": "Prefixu del equipu establecíu en %s",
	...
	"commands.team.option.suffix.success": "Sufixu del equipu establecíu en %s",
	...
	"commands.teleport.invalidPosition": "Posición non válida para teletransporte",
	...
	"commands.test.batch.starting": "Empecipiando redolada %s del llote %s",
	"commands.test.clear.error.no_tests": "Nun s'atoparon pruebes para llimpiar",
	"commands.test.clear.success": "Llimpiáronse %s estructura(s)",
	"commands.test.coordinates": "%s, %s, %s",
	"commands.test.coordinates.copy": "Fai clic para copiar al portapapeles",
	"commands.test.create.success": "Configuración de prueba creada para la prueba %s",
	"commands.test.error.no_test_containing_pos": "Non pudo atopase una instancia de prueba que contenga %s, %s, %s",
	"commands.test.error.no_test_instances": "Nun s'atoparon instancies de prueba",
	"commands.test.error.non_existant_test": "Non pudo atopase la prueba %s",
	"commands.test.error.structure_not_found": "Non pudo atopase la estructura de prueba %s",
	"commands.test.error.test_instance_not_found": "Non pudo atopase la entidá de bloque d'instancia de prueba",
	"commands.test.error.test_instance_not_found.position": "Non pudo atopase la entidá de bloque d'instancia de prueba para la prueba en %s, %s, %s",
	"commands.test.error.too_large": "El tamañu de la estructura tien de ser inferior a %s bloques en cada exa",
	"commands.test.locate.done": "Allugamientu rematáu: atopáronse %s estructura(s)",
	"commands.test.locate.found": "Estructura atopada en: %s (distancia: %s)",
	"commands.test.locate.started": "Empecipióse la busca d'estructures de prueba. Esto puede tardar un momentu...",
	"commands.test.no_tests": "Nun hai pruebes para executar",
	"commands.test.relative_position": "Posición relativa a %s: %s",
	"commands.test.reset.error.no_tests": "Nun s'atoparon pruebes para restablecer",
	"commands.test.reset.success": "Restableciéronse %s estructura(s)",
	"commands.test.run.no_tests": "Nun s'atopó nenguna prueba",
	"commands.test.run.running": "Executando %s prueba(s)...",
	"commands.test.summary": "Prueba de xuegu completada. Executáronse %s prueba(s)",
	"commands.test.summary.all_required_passed": "Superáronse toles pruebes riquíes :)",
	"commands.test.summary.failed": "%s prueba(s) obligatoria(s) fallaron :(",
	"commands.test.summary.optional_failed": "%s prueba(s) opcional(ye) fallaron",
	"commands.tick.query.percentiles": "Percentiles: P50: %sms P95: %sms P99: %sms. Amuesa: %s",
	"commands.tick.query.rate.running": "Frecuencia de ticks oxetivu: %s per segundu.\nTiempu mediu por tick: %sms (oxetivu: %sms)",
	"commands.tick.query.rate.sprinting": "Frecuencia de ticks oxetivu: %s per segundu (ignorada, solo como referencia).\nTiempu mediu por tick: %sms",
	"commands.tick.rate.success": "Frecuencia de ticks oxetivu establecida en %s per segundu",
	"commands.tick.sprint.report": "Sprint completáu con %s ticks per segundu, o %s ms por tick",
	"commands.tick.sprint.stop.fail": "Nun hai nengún sprint de ticks en cursu",
	"commands.tick.sprint.stop.success": "Atayóse'l sprint de ticks actual",
	"commands.tick.status.frozen": "El xuegu ta conxeláu",
	"commands.tick.status.lagging": "El xuegu ta n'execución, pero nun puede caltener la frecuencia de ticks oxetivu",
	"commands.tick.status.running": "El xuegu ta executándose con normalidá",
	"commands.tick.status.sprinting": "El xuegu ta acelerando ticks",
	"commands.tick.step.fail": "Non puede avanzase - el xuegu primero tien de tar conxeláu",
	"commands.tick.step.stop.fail": "Nun hai nengún pasu de tick en cursu",
	"commands.tick.step.stop.success": "Atayóse'l pasu de tick actual",
	"commands.tick.step.success": "Avanzando %s tick(s)",
	"commands.time.no_default_clock": "Nun esiste un reló predeterminado na dimensión %s",
	"commands.time.no_time_marker_found": "El marcador de tiempu %s nun esiste para'l reló %s",
	"commands.time.pause": "Reló %s pausáu",
	...
	"commands.time.query.absolute": "El reló %s ta en %s tick(s)",
	"commands.time.query.gametime": "El tiempu del xuegu ye %s tick(s)",
	"commands.time.query.timeline": "La llínea temporal %s ta en %s tick(s)",
	"commands.time.query.timeline.repetitions": "La llínea temporal %s completó %s repetición(ye)",
	"commands.time.rate": "El reló %s va avanzar a %s vegaes la velocidá normal",
	"commands.time.rate.already_same": "Clock %s is already advancing at %sx normal rate",
	"commands.time.resume": "Reló %s vueltu a entamar",
	"commands.time.set": "Afitóse'l tiempu a %s",
	"commands.time.set.absolute": "Establecióse %s en %s tick(s)",
	...
	"commands.time.set.time_marker": "Establecióse %s nel marcador de tiempu %s",
	"commands.time.wrong_timeline_for_clock": "La llínea temporal %s nun ye válida para'l reló %s",
	...
	"commands.transfer.error.no_players": "Tienes De especificar siquier un xugador para tresferir",
	"commands.transfer.success.multiple": "Tresfiriendo %s xugadores a %s:%s",
	"commands.transfer.success.single": "Tresfiriendo %s a %s:%s",
	...
	"commands.unpublish.notPublished": "Nun hai nenguna partida multijugador publicada",
	"commands.unpublish.success": "La partida multijugador yá nun ta publicada",
	"commands.version.build_time": "build_time = %s",
	"commands.version.data": "data = %s",
	"commands.version.header": "Información de versión del servidor:",
	"commands.version.id": "díi = %s",
	"commands.version.name": "nome = %s",
	"commands.version.pack.data": "pack_data = %s",
	"commands.version.pack.resource": "pack_source = %s",
	"commands.version.protocol": "protocolu = %s (%s)",
	"commands.version.series": "serie = %s",
	"commands.version.stable.no": "estable = non",
	"commands.version.stable.yes": "estable = sí",
	"commands.waypoint.list.empty": "Nun hai puntos de ruta en %s",
	"commands.waypoint.list.success": "%s puntu(s) de ruta en %s: %s",
	"commands.waypoint.modify.color": "El color del puntu de ruta agora ye %s",
	"commands.waypoint.modify.color.reset": "Restablecer color del puntu de ruta",
	"commands.waypoint.modify.style": "Estilu del puntu de ruta camudáu",
	...
	"commands.whitelist.list": "Hai %s xugador(ye) na llista blanca: %s",
	...
	"commands.worldborder.damage.amount.failed": "Nada camudó. El dañu del cantu del mundu yá tien esi valor",
	"commands.worldborder.damage.amount.success": "Establecer el dañu del cantu del mundu en %s por bloque per segundu",
	"commands.worldborder.damage.buffer.failed": "Nada camudó. El marxe de dañu del cantu del mundu yá tien esa distancia",
	"commands.worldborder.damage.buffer.success": "Establecer el marxe de dañu del cantu del mundu en %s bloque(s)",
	"commands.worldborder.get": "El cantu del mundu tien anguaño un anchu de %s bloque(s)",
	"commands.worldborder.set.failed.big": "El berbesu del mundu nun pue tener más de %s bloques de llargor",
	"commands.worldborder.set.failed.far": "El cantu del mundu nun puede tar a más de %s bloques de distancia",
	...
	"commands.worldborder.set.immediate": "Establecer l'anchu del cantu del mundu en %s bloque(s)",
	"commands.worldborder.set.shrink": "Amenorgando'l cantu del mundu hasta %s bloque(s) d'anchu mientres %s segundu(s)",
	"commands.worldborder.warning.distance.failed": "Nada camudó. La distancia d'alvertencia del cantu del mundu yá tien esi valor",
	"commands.worldborder.warning.distance.success": "Establecer la distancia d'alvertencia del cantu del mundu en %s bloque(s)",
	"commands.worldborder.warning.time.failed": "Nada camudó. El tiempu d'alvertencia del cantu del mundu yá tien esi valor",
	"commands.worldborder.warning.time.success": "Establecer el tiempu d'alvertencia del cantu del mundu en %s segundu(s)",
	"compliance.playtime.greaterThan24Hours": "Tuvisti xugando mientres más de 24 hores",
	"compliance.playtime.hours": "Tuvisti xugando mientres %s hora(s)",
	"compliance.playtime.message": "El xuegu escesivu puede interferir cola vida diaria normal. Toca fierva urxentemente!",
	"component.profile.dynamic": "Dinámicu",
	...
	"connect.failed.transfer": "La conexón falló mientres la tresferencia al servidor",
	"connect.joining": "Xuniéndote al mundu…",
	"connect.negotiating": "Negociando…",
	"connect.p2p.establishing": "Estableciendo conexón...",
	"connect.p2p.failed.generic": "Non pudo conectase al xugador",
	"connect.p2p.failed.signaling": "Nun ye posible conectase agora mesmu. Inténtalo de nuevu más tarde.",
	"connect.p2p.failed.timeout": "La solicitú de conexón escosó'l tiempu d'espera",
	"connect.p2p.failed.unreachable": "El xugador nun ye accesible",
	"connect.reconfiging": "Reconfigurando...",
	"connect.reconfiguring": "Reconfigurando...",
	"connect.transferring": "Tresfiriendo a un nuevu servidor...",
	"container.barrel": "Barril",
	"container.beacon": "Baliza",
	"container.beehive.bees": "Abeyes: %s / %s",
	...
	"container.enchant.level.requirement": "Nivel riquíu: %s",
	...
	"container.upgrade": "Ameyorar equipu",
	"container.upgrade.error_tooltip": "Esti oxetu nun puede ameyorase d'esta manera",
	"container.upgrade.missing_template_tooltip": "Añedir plantiya de ferrería",
	...
	"dataPack.bundle.description": "Habilita l'oxetu esperimental Fardu",
	"dataPack.bundle.name": "Fardos",
	"dataPack.locator_bar.description": "Amuesa la dirección de otru xugadores en multijugador",
	...
	"dataPack.update_1_21.description": "Nueves característiques y conteníu para Minecraft 1.21",
	...
	"dataPack.winter_drop.description": "Nueves característiques y conteníu para l'actualización d'iviernu",
	"dataPack.winter_drop.name": "Actualización d'iviernu",
	...
	"death.attack.mace_smash": "%[1]s foi entartalláu por %[2]s",
	"death.attack.mace_smash.item": "%[1]s foi entartalláu por %[2]s usando %[3]s",
	...
	"death.attack.spear": "%[1]s foi travesáu por %[2]s",
	"death.attack.spear.item": "%[1]s foi travesáu por %[2]s usando %[3]s",
	...
	"death.attack.sulfurCubeHot": "%[1]s morrió porque non solo'l suelu ye lava",
	"death.attack.sulfurCubeHot.item": "%[2]s showed %[1]s that not just the floor is lava using %[3]s",
	"death.attack.sulfurCubeHot.player": "%[2]s demostrólu a %[1]s que non solo'l suelu ye lava",
	...
	"debug.copy_location.help": "F3 + C = Copiar allugamientu como comandu /tp, o caltener mientres 10 segundos para bloquiar el xuegu",
	"debug.copy_location.message": "Copióse l'allugamientu al cartafueyu",
	"debug.crash.message": "F3 + C ta primíu. Esto va bloquiar el xuegu nun siendo que se suelte.",
	"debug.crash.message.rebindable": "%s + %s ta primíu. Esto va bloquiar el xuegu nun siendo que se suelte.",
	...
	"debug.creative_spectator.help": "F3 + N = Camudar a la manera de xuegu anterior <-> espectador",
	"debug.dump_dynamic_textures": "Testures dinámiques guardaes en %s",
	"debug.dump_dynamic_textures.help": "F3 + S = Esportar testures dinámiques",
	"debug.entry.always": "Siempres",
	"debug.entry.currently.alwaysOn": "%s: Anguaño siempres",
	"debug.entry.currently.inF3": "%s: Anguaño solo en F3",
	"debug.entry.currently.inOverlay": "%s: Anguaño solo na superposición de depuración",
	"debug.entry.currently.never": "%s: Anguaño desactiváu",
	"debug.entry.f3": "En F3",
	"debug.entry.overlay": "Na superposición",
	"debug.gamemodes.error": "Non puede abrir el selector de manera de xuegu: nun tienes permisu",
	...
	"debug.options.category.text": "Testu de la pantalla de depuración",
	"debug.options.help": "F3 + F6 = Editar opciones de depuración",
	"debug.options.notAllowed.tooltip": "Non visible cuando la información de depuración ta amenorgada",
	"debug.options.profile.default": "Perfil predeterminado",
	"debug.options.profile.performance": "Perfil de rendimientu",
	"debug.options.search": "Buscar...",
	"debug.options.title": "Opciones de depuración",
	"debug.options.warning": "Estes opciones son solo para pruebes. Pueden ralentizar el to ordenador, bloquiar el xuegu o faer que la to mascota convertir n'una roca.",
	...
	"debug.profiling.help": "F3 + L = Empecipiar/detener perfiláu",
	"debug.profiling.start": "Perfilando mientres %s segundos. Usa F3 + L para detener antes",
	"debug.profiling.start.rebindable": "Perfilando mientres %s segundos. Usa %s + %s pa detener antes",
	"debug.profiling.stop": "Perfiláu rematáu. Resultancies guardaes en %s",
	...
	"debug.version.header": "Información de la versión del veceru:",
	"debug.version.help": "F3 + V = Información de la versión del veceru",
	...
	"disconnect.exceeded_packet_rate": "Espulsáu por entepasar la llende de tasa de paquetes",
	"disconnect.genericReason": "%s",
	"disconnect.ignoring_status_request": "Ignorando solicitú d'estáu",
	...
	"disconnect.loginFailedInfo.userBanned": "Tienes prohibíu xugar en llínea",
	"disconnect.lost": "Perdióse la conexón",
	"disconnect.packetError": "Erru de protocolu de rede",
	"disconnect.spam": "Echáronte por facer spam",
	"disconnect.timeout": "Escosó'l tiempu d'espera",
	"disconnect.transfer": "Tresferíu a otru servidor",
	"disconnect.unknownHost": "Agospiador desconocíu",
	"download.pack.failed": "Non pudieron descargase %s de %s paquete(s)",
	"download.pack.progress.bytes": "Progresu: %s (tamañu total desconocíu)",
	...
	"editGamerule.inGame.button": "Editar riegles del xuegu...",
	"editGamerule.inGame.disabled.hardcore.tooltip": "Non pueden camudase les riegles del xuegu nun mundu de manera estrema.",
	"editGamerule.inGame.disabled.tooltip": "Actualizar les riegles del xuegu rique permisos d'operador.",
	"editGamerule.inGame.discardChanges.message": "¿Seguru que quies refugar los cambeos pindios nes riegles del xuegu?",
	"editGamerule.inGame.discardChanges.title": "Cambeos nes riegles del xuegu",
	"editGamerule.inGame.downloadingGamerules": "Recuperando riegles del xuegu...",
	...
	"effect.minecraft.breath_of_the_nautilus": "Aliendu de nautilo",
	"effect.minecraft.conduit_power": "Poder del Conductu",
	...
	"effect.minecraft.infested": "Infestáu",
	...
	"effect.minecraft.oozing": "Rezumante",
	"effect.minecraft.poison": "Envelenamientu",
	"effect.minecraft.raid_omen": "Mal Presaxu d'Incursión",
	...
	"effect.minecraft.trial_omen": "Mal Presaxu de Prueba",
	"effect.minecraft.unluck": "Suerte mala",
	"effect.minecraft.water_breathing": "Aliendu acuáticu",
	"effect.minecraft.weakness": "Badea",
	"effect.minecraft.weaving": "Texíu",
	"effect.minecraft.wind_charged": "Carga de Vientu",
	"effect.minecraft.wither": "Marchitamiento",
	...
	"enchantment.minecraft.breach": "Perforación",
	"enchantment.minecraft.channeling": "Canalización",
	...
	"enchantment.minecraft.sweeping_edge": "Filu Barríu",
	"enchantment.minecraft.swift_sneak": "Sigilo Rápidu",
	...
	"entity.minecraft.bamboo_chest_raft": "Llancha de bambú con bagul",
	...
	"entity.minecraft.block_display": "Visualizador de Bloque",
	"entity.minecraft.boat": "Barca",
	"entity.minecraft.bogged": "Empantanado",
	"entity.minecraft.breeze": "Oral",
	"entity.minecraft.breeze_wind_charge": "Carga de Vientu",
	"entity.minecraft.camel": "Camellu",
	"entity.minecraft.camel_husk": "Camellu Zombi",
	"entity.minecraft.cat": "Gatu",
	"entity.minecraft.cave_spider": "Araña de cueva",
	"entity.minecraft.cherry_boat": "Barca de cerezu",
	"entity.minecraft.cherry_chest_boat": "Barca de cerezu con bagul",
	"entity.minecraft.chest_boat": "Barcu con Arca",
	"entity.minecraft.chest_minecart": "Vagoneta con Arca",
	...
	"entity.minecraft.creaking": "Cruxidor",
	"entity.minecraft.creaking_transient": "Cruxidor",
	"entity.minecraft.creeper": "Creeper",
	"entity.minecraft.cushion": "Cushion",
	"entity.minecraft.dark_oak_boat": "Barca de carbayu escuro",
	"entity.minecraft.dark_oak_chest_boat": "Barca de carbayu escuro con arca",
	...
	"entity.minecraft.experience_bottle": "Botella d'Encantamientu Refundiza",
	"entity.minecraft.experience_orb": "Bola d'esperiencia",
	"entity.minecraft.eye_of_ender": "Güeyu de Ender",
	"entity.minecraft.falling_block": "Bloque que cai",
	"entity.minecraft.falling_block_type": "%s en cayida",
	"entity.minecraft.fireball": "Bola de fueu",
	"entity.minecraft.firework_rocket": "Cohete de Fueos Artificiales",
	"entity.minecraft.fishing_bobber": "Flotador de Pesca",
	"entity.minecraft.fox": "Raposu",
	"entity.minecraft.frog": "Xaronca",
	"entity.minecraft.furnace_minecart": "Vagoneta con Fornu",
	"entity.minecraft.ghast": "Ghast",
	"entity.minecraft.giant": "Xigante",
	"entity.minecraft.glow_item_frame": "Marcu Brillosu",
	...
	"entity.minecraft.item_display": "Visualizador d'Oxetu",
	"entity.minecraft.item_frame": "Marcu",
	"entity.minecraft.jungle_boat": "Barca de madera de la xungla",
	"entity.minecraft.jungle_chest_boat": "Barca de madera de la xungla con bagul",
	...
	"entity.minecraft.lingering_potion": "Mestranzu Persistente",
	...
	"entity.minecraft.mangrove_chest_boat": "Barca de mangle ensin corteza",
	"entity.minecraft.mannequin": "Maniquín",
	...
	"entity.minecraft.oak_boat": "Barca de carbayu",
	"entity.minecraft.oak_chest_boat": "Barca de carbayu con bagul",
	...
	"entity.minecraft.pale_oak_boat": "Barca de carbayu pálido",
	"entity.minecraft.pale_oak_chest_boat": "Barca de carbayu pálido con bagul",
	"entity.minecraft.panda": "Panda",
	"entity.minecraft.parched": "Resecado",
	...
	"entity.minecraft.poplar_boat": "Barca de chopu",
	"entity.minecraft.poplar_chest_boat": "Barca de chopu con bagul",
	"entity.minecraft.potion": "Mestranzu",
	...
	"entity.minecraft.sniffer": "Olfateador",
	...
	"entity.minecraft.splash_potion": "Mestranzu Refundizu",
	"entity.minecraft.spruce_boat": "Barcu d'Abetu",
	"entity.minecraft.spruce_chest_boat": "Barcu d'Abetu con Arca",
	"entity.minecraft.squid": "Calamar",
	"entity.minecraft.stray": "Vagamundu",
	"entity.minecraft.strider": "Caminante",
	...
	"entity.minecraft.text_display": "Visualizador de Testu",
	...
	"entity.minecraft.tropical_fish.predefined.16": "Pargo Coloráu",
	...
	"entity.minecraft.tropical_fish.type.clayfish": "Pez Magre",
	"entity.minecraft.tropical_fish.type.dasher": "Dasher",
	"entity.minecraft.tropical_fish.type.flopper": "Dasher",
	...
	"filled_map.explorer_jungle": "Mapa d'esplorador de la xungla",
	"filled_map.explorer_swamp": "Mapa del Esplorador de Banzáu",
	...
	"filled_map.trial_chambers": "Mapa del Esplorador de Cámares de Prueba",
	"filled_map.unknown": "Mapa desconocíu",
	"filled_map.village_desert": "Mapa de L'Aldea del Desiertu",
	"filled_map.village_plains": "Mapa de L'Aldea d'Enllanaes",
	"filled_map.village_savanna": "Mapa de L'Aldea de Sabana",
	"filled_map.village_snowy": "Mapa de L'Aldea Nevada",
	"filled_map.village_taiga": "Mapa de L'Aldea de Taiga",
	...
	"gamerule.allowEnteringNetherUsingPortals": "Dexar Nether",
	"gamerule.allowEnteringNetherUsingPortals.description": "Controla si el xugadores pueden entrar al Nether.",
	"gamerule.allowFireTicksAwayFromPlayer": "Actualizar fueu llueñe de el xugadores",
	"gamerule.allowFireTicksAwayFromPlayer.description": "Controla si'l fueu y la lava tienen de siguir actualizándose a más de 8 chunks de cualquier xugador.",
	"gamerule.announceAdvancements": "Anunciar los avances",
	"gamerule.blockExplosionDropDecay": "Nes esplosiones por interacción de bloques, dellos bloques nun van soltar el so botín",
	"gamerule.blockExplosionDropDecay.description": "Dalgunos de los oxetos soltaos por bloques destruyíos por esplosiones causaes por interacciones de bloques perder na esplosión.",
	"gamerule.category.chat": "Chat",
	"gamerule.category.drops": "Oxetos soltaos",
	...
	"gamerule.commandBlockOutput": "Amosar salida de bloques de comandos",
	"gamerule.commandBlocksEnabled": "Habilitar bloques de comandos",
	"gamerule.commandModificationBlockLimit": "Llende de cambéu de bloques per comandu",
	"gamerule.commandModificationBlockLimit.description": "La cantidá de bloques que pueden modificar al empar con un solu comandu, como fill o clone.",
	"gamerule.disableElytraMovementCheck": "Desactivar comprobación de movimientu del elytra",
	"gamerule.disablePlayerMovementCheck": "Desactivar comprobación de movimientu del xugador",
	"gamerule.disableRaids": "Desactivar les invasiones",
	"gamerule.doDaylightCycle": "Avanzar el ciclu día-noche",
	"gamerule.doEntityDrops": "Soltar equipamientu d'entidaes",
	"gamerule.doEntityDrops.description": "Controla la cayida d'oxetos de vagonetas (incluyíos inventarios), marcos, barcos, etc.",
	...
	"gamerule.doLimitedCrafting.description": "Si ta activáu, el xugadores solo van poder fabricar recetes desbloquiaes.",
	"gamerule.doMobLoot": "Soltar botín de criatures",
	"gamerule.doMobLoot.description": "Controla la cayida de recursos de les criatures, incluyíos los orbes d'esperiencia.",
	"gamerule.doMobSpawning": "Aprucir creatures",
	"gamerule.doMobSpawning.description": "Delles entidaes pueden tener riegles independientes.",
	"gamerule.doPatrolSpawning": "Aprucir patrulles de saquiadores",
	"gamerule.doTileDrops": "Soltar bloques",
	"gamerule.doTileDrops.description": "Controla la cayida de recursos de los bloques, incluyíos los orbes d'esperiencia.",
	"gamerule.doTraderSpawning": "Crear vendedores errantes",
	"gamerule.doVinesSpread": "Espardimientu d'enredaderes",
	"gamerule.doVinesSpread.description": "Controla si'l bloque d'enredaderes arrobínase aleatoriamente a bloques axacentes. Nun afecta a otros tipos d'enredaderes, como Enredaderes Retorcigañaes o Enredaderes Lloramicadores.",
	...
	"gamerule.enderPearlsVanishOnDeath": "Les perlles de Ender refundiaes sumen al morrer",
	"gamerule.enderPearlsVanishOnDeath.description": "Controla si les perlles de Ender llanzaes por un xugador sumen cuando ese xugador muerre.",
	"gamerule.entitiesWithPassengersCanUsePortals": "Les entidaes con pasaxeros pueden usar portales",
	"gamerule.entitiesWithPassengersCanUsePortals.description": "Dexa que les entidaes con pasaxeros se teletransporten al traviés de portales del Nether, portales del End y puertes d'enllaz del End.",
	...
	"gamerule.globalSoundEvents": "Eventos de soníu globales",
	"gamerule.globalSoundEvents.description": "Cuando asoceden ciertos eventos del xuegu, como l'apaición d'un xefe, el soníu escúchase perdayuri.",
	"gamerule.keepInventory": "Caltener l'inventariu al morrer",
	"gamerule.lavaSourceConversion": "La lava convertir en roca fonte",
	"gamerule.lavaSourceConversion.description": "Cuando la lava que flúi ta arrodiada por lava fonte en dos llaos, convertir n'una fonte.",
	"gamerule.locatorBar": "Habilitar barra localizadora de xugadores",
	"gamerule.locatorBar.description": "Cuando ta habilitada, amuésase una barra en pantalla para indicar la dirección de el xugadores.",
	"gamerule.logAdminCommands": "Rexistrar comandos d'alministrador",
	"gamerule.maxCommandChainLength": "Llende de llargor de cadena de comandos",
	"gamerule.maxCommandChainLength.description": "Aplicar a cadenes de bloques de comandos y funciones.",
	"gamerule.maxCommandForkCount": "Llende de contestos de comandu",
	"gamerule.maxCommandForkCount.description": "Númberu máximu de contestos que pueden usase con comandos como 'execute as'.",
	"gamerule.maxEntityCramming": "Llende d'entidaes per bloque",
	"gamerule.minecartMaxSpeed": "Velocidá máxima de les vagonetas",
	"gamerule.minecartMaxSpeed.description": "Velocidá máxima predeterminada d'una vagoneta en tierra.",
	"gamerule.minecraft.elytra_movement_check": "Comprobación de movimientu con elytra",
	"gamerule.minecraft.fire_spread_radius_around_player": "Radio d'espardimientu del fueu",
	"gamerule.minecraft.fire_spread_radius_around_player.description": "El radiu en bloques alredor d'un xugador dientro del cual el fueu puede arrobinase",
	"gamerule.minecraft.player_movement_check": "Comprobación de movimientu del xugador",
	"gamerule.minecraft.raids": "Realizar incursiones",
	"gamerule.minecraft.universal_anger.description": "Los mobs neutrales enoxaos ataquen a cualquier xugador cercanu, non solo al que los enoxar. Funciona meyor si perdonar_xugadores_muertos ta desactiváu.",
	"gamerule.mobExplosionDropDecay": "N'esplosiones de criatures, dellos bloques nun van soltar el so botín",
	"gamerule.mobExplosionDropDecay.description": "Parte de los oxetos soltaos por bloques destruyíos n'esplosiones causaes por criatura perder na esplosión.",
	"gamerule.mobGriefing": "Dexar acciones destructives de criatures",
	"gamerule.naturalRegeneration": "Rexeneración de la salú",
	"gamerule.playersNetherPortalCreativeDelay": "Retrasu del portal del Nether para xugadores en manera creativa",
	"gamerule.playersNetherPortalCreativeDelay.description": "Tiempu (en ticks) qu'un xugador en manera creativa tien de permanecer nun portal del Nether antes de camudar de dimensión.",
	"gamerule.playersNetherPortalDefaultDelay": "Retrasu del portal del Nether pa xugadores fuera de la manera creativa",
	"gamerule.playersNetherPortalDefaultDelay.description": "Tiempu (en ticks) qu'un xugador fuera de la manera creativa tien de permanecer nun portal del Nether antes de camudar de dimensión.",
	"gamerule.playersSleepingPercentage": "Porcentaxe de xugadores dormiendo",
	...
	"gamerule.projectilesCanBreakBlocks.description": "Controla si los proyectiles d'impactu van destruyir bloques que pueden ser destruyíos por ellos.",
	"gamerule.pvp": "Habilitar PvP",
	"gamerule.pvp.description": "Controla si el xugadores pueden estropiar a otru xugadores.",
	"gamerule.randomTickSpeed": "Frecuencia de los tics al debalu",
	"gamerule.reducedDebugInfo": "Amenorgar información de depuración",
	"gamerule.reducedDebugInfo.description": "Llinda'l conteníu de la pantalla de depuración.",
	"gamerule.sendCommandFeedback": "Unviar retroalimentación de comandos",
	"gamerule.showDeathMessages": "Amosar los mensaxes de muerte",
	"gamerule.snowAccumulationHeight": "Altor d'acumuladura de nieve",
	"gamerule.snowAccumulationHeight.description": "Cuando nieva, fórmense capes de nieve nel suelu hasta esti númberu máximu de capes.",
	...
	"gamerule.spawnMonsters": "Xenerar bisarmes",
	"gamerule.spawnMonsters.description": "Controla si les bisarmes apaecen de forma natural.",
	...
	"gamerule.spawnerBlocksEnabled": "Habilitar bloques xeneradores",
	"gamerule.spectatorsGenerateChunks": "Los espectadores xeneren terrén",
	"gamerule.tntExplodes": "Dexar que la TNT actívese y esplote",
	"gamerule.tntExplosionDropDecay": "N'esplosiones de TNT, dellos bloques nun van soltar el so botín",
	"gamerule.tntExplosionDropDecay.description": "Parte de los oxetos soltaos por bloques destruyíos por esplosiones causaes por TNT perder na esplosión.",
	...
	"gamerule.waterSourceConversion": "L'agua convertir en fonte",
	"gamerule.waterSourceConversion.description": "Cuando l'agua que flúi ta arrodiada por fontes d'agua en dos llaos, convertir n'una fonte.",
	"generator.custom": "Personalizada",
	"generator.customized": "Personalizáu por DÍI",
	...
	"generator.minecraft.flat_all_dimensions": "Toles dimensiones planes",
	...
	"gui.abuseReport.attestation": "Al unviar esti informe, confirmes que la información proporcionada ye precisa y completa según el to lleal saber y entender.",
	"gui.abuseReport.comments": "Comentarios",
	"gui.abuseReport.describe": "Compartir detalles va ayudanos a tomar una decisión bien encontada.",
	"gui.abuseReport.discard.content": "Si sales, vas perder esti informe y los tos comentarios. ¿Seguru que quies salir?",
	"gui.abuseReport.discard.discard": "Salir y refugar informe",
	"gui.abuseReport.discard.draft": "Guardar borrador",
	"gui.abuseReport.discard.return": "Siguir editando",
	"gui.abuseReport.discard.title": "¿Refugar informe y comentarios?",
	"gui.abuseReport.draft.content": "¿Quies siguir cola edición del informe esistente o quies escartalu y crear otru?",
	"gui.abuseReport.draft.discard": "Refugar",
	"gui.abuseReport.draft.edit": "Siguir editando",
	"gui.abuseReport.draft.quittotitle.content": "¿Quies siguir editándolo o refugalo?",
	"gui.abuseReport.draft.quittotitle.title": "Tienes un borrador d'informe de chat que se va perder si sales",
	"gui.abuseReport.draft.title": "¿Editar borrador d'informe de chat?",
	"gui.abuseReport.error.title": "Problema al unviar el to informe",
	"gui.abuseReport.message": "¿Ónde reparasti'l comportamientu desaveniente? Esto va ayudanos a investigar el to casu.",
	"gui.abuseReport.more_comments": "Describe lo asocedío:",
	"gui.abuseReport.name.comment_box_label": "Describe por qué quies denunciar esti nome:",
	"gui.abuseReport.name.reporting": "Tas denunciando a: \"%s\".",
	"gui.abuseReport.name.title": "Denunciar nome de xugador desaveniente",
	"gui.abuseReport.observed_what": "¿Por qué tas denunciando esto?",
	"gui.abuseReport.read_info": "Más información sobro les denuncies",
	"gui.abuseReport.reason.alcohol_tobacco_drugs": "Drogues o alcohol",
	"gui.abuseReport.reason.alcohol_tobacco_drugs.description": "Daquién ta animando a otros a participar n'actividaes illegales rellacionaes con drogues o fomentando'l consumu d'alcohol por menores d'edá.",
	"gui.abuseReport.reason.child_sexual_exploitation_or_abuse": "Esplotación o abusu sexual infantil",
	...
	"gui.abuseReport.reason.defamation_impersonation_false_information": "Bilordiu",
	"gui.abuseReport.reason.defamation_impersonation_false_information.description": "Daquién ta estropiando la to reputación o la d'otra persona, por casu compartiendo información falsa col enfotu de esplotar o engañar a otros.",
	"gui.abuseReport.reason.description": "Descripción:",
	"gui.abuseReport.reason.false_reporting": "Denuncia falsa",
	"gui.abuseReport.reason.generic": "Quiero denuncialo",
	"gui.abuseReport.reason.generic.description": "Toi cafiante con él/ella. Fixo daqué que nun me gusta.",
	"gui.abuseReport.reason.harassment_or_bullying": "Acoso o intimidación",
	"gui.abuseReport.reason.harassment_or_bullying.description": "Daquién te ta avergoñando, atacando o amedranando a ti o a otra persona. Esto inclúi cuando daquién intenta contactate repetidamente ensin el to consentimientu o publica información personal quitada sobro ti o sobro otra persona ensin consentimientu (\"doxxing\").",
	"gui.abuseReport.reason.hate_speech": "Discursu d'odiu",
	"gui.abuseReport.reason.hate_speech.description": "Daquién ta atacándote a ti o a otru xugador por característiques de la so identidá, como relixón, raza o sexualidá.",
	"gui.abuseReport.reason.imminent_harm": "Amenaza de dañu a otros",
	"gui.abuseReport.reason.imminent_harm.description": "Daquién ta amenaciando con faer dañu a ti o a otra persona na vida real.",
	"gui.abuseReport.reason.narration": "%s: %s",
	"gui.abuseReport.reason.non_consensual_intimate_imagery": "Imaxes íntimes ensin consentimientu",
	"gui.abuseReport.reason.non_consensual_intimate_imagery.description": "Daquién ta falando, compartiendo o promoviendo imaxes privaes o íntimes.",
	"gui.abuseReport.reason.self_harm_or_suicide": "Autolesión o suicidiu",
	"gui.abuseReport.reason.self_harm_or_suicide.description": "Daquién ta amenaciando con faese dañu a sí mesmu na vida real o falando sobro faese dañu a sí mesmu na vida real.",
	"gui.abuseReport.reason.sexually_inappropriate": "Conteníu sexual desaveniente",
	"gui.abuseReport.reason.sexually_inappropriate.description": "Conteníu gráfico rellacionáu con actos sexuales, órganos sexuales o violencia sexual.",
	...
	"gui.abuseReport.reason.title": "Escoyer categoría de denuncia",
	"gui.abuseReport.report_sent_msg": "Recibimos correchamente la to denuncia. ¡Gracies!\n\nEl nuesu equipu revisar lo antes posible.",
	"gui.abuseReport.select_reason": "Escoyer categoría de denuncia",
	"gui.abuseReport.send": "Unviar denuncia",
	"gui.abuseReport.send.comment_too_long": "Por favor, encurtia'l comentariu",
	...
	"gui.abuseReport.send.http_error": "Producióse un erru HTTP inesperáu al unviar la to denuncia.",
	"gui.abuseReport.send.json_error": "Atopóse xuna carga útil malformada al unviar la to denuncia.",
	"gui.abuseReport.send.no_reason": "Escueye una categoría de denuncia",
	"gui.abuseReport.send.not_attested": "Llee'l testu anterior y marca el caxellu para poder unviar la denuncia",
	"gui.abuseReport.send.service_unavailable": "Non pudo aportase al serviciu de denuncies. Asegúrate de tar conectáu a Internet ya inténtalo de nuevu.",
	"gui.abuseReport.sending.title": "Unviando l'informe…",
	"gui.abuseReport.sent.title": "Denuncia unviada",
	"gui.abuseReport.skin.title": "Denunciar apariencia de xugador",
	"gui.abuseReport.title": "Denunciar xugador",
	"gui.abuseReport.type.chat": "Mensaxes de chat",
	"gui.abuseReport.type.name": "Nome de xugador",
	"gui.abuseReport.type.skin": "Apariencia de xugador",
	"gui.acknowledge": "Reconocer",
	"gui.advancements": "Progresos",
	"gui.all": "Too",
	"gui.back": "Atrás",
	"gui.banned.description": "%s\n\n%s\n\nMás información nel siguiente enllaz: %s",
	...
	"gui.banned.description.reason": "Recibimos una denuncia por comportamientu desaveniente de la to cuenta. Los nuesos moderadores revisaron el to casu y determinaron que se trata de %s, lo cual infringe les Normes de la Comunidá de Minecraft.",
	"gui.banned.description.reason_id": "Códigu: %s",
	"gui.banned.description.reason_id_message": "Códigu: %s - %s",
	"gui.banned.description.temporary": "Hasta %s, nun vas poder xugar en llínea nin xunite a Realms.",
	"gui.banned.description.temporary.duration": "La to cuenta foi suspendida temporalmente y va reactivase en %s.",
	...
	"gui.banned.name.description": "El to nome actual, \"%s\", infringe les Normes de la Comunidá. Puedes xugar nun solu xugador, pero tendrás de camudar el to nome para xugar en llínea.\n\nMás información o solicita una revisión del casu nel siguiente enllaz: %s",
	"gui.banned.name.title": "Nome ensin dexar en multijugador",
	"gui.banned.reason.defamation_impersonation_false_information": "Suplantación d'identidá o espardimientu d'información falsa para esplotar o engañar a otros",
	"gui.banned.reason.drugs": "Referencies a drogues illegales",
	"gui.banned.reason.extreme_violence_or_gore": "Representaciones de violencia estrema o gore na vida real",
	"gui.banned.reason.false_reporting": "Denuncies escesives, falses o inesactes",
	"gui.banned.reason.fraud": "Llogru o usu fraudulento de conteníu",
	"gui.banned.reason.generic_violation": "Infracción de les Normes de la Comunidá",
	"gui.banned.reason.harassment_or_bullying": "Llinguaxe abusivu gastáu de xeitu dirixíu y dañible",
	"gui.banned.reason.hate_speech": "Discursu d'odiu o discriminación",
	"gui.banned.reason.hate_terrorism_notorious_figure": "Referencies a grupos d'odiu, organizaciones terroristes o figures infames",
	"gui.banned.reason.imminent_harm_to_person_or_property": "Intención de causar dañu real a persones o propiedaes",
	"gui.banned.reason.nudity_or_pornography": "Amosar material obsceno o pornográficu",
	"gui.banned.reason.sexually_inappropriate": "Temes o conteníu de naturaleza sexual",
	"gui.banned.reason.spam_or_advertising": "Spam o publicidá",
	"gui.banned.skin.description": "La to apariencia actual infringe les Normes de la Comunidá. Entá puedes xugar usando una apariencia predeterminada o escoyer una nueva.\n\nMás información o solicita una revisión del casu nel siguiente enllaz: %s",
	"gui.banned.skin.title": "Apariencia ensin dexar",
	...
	"gui.chatReport.describe": "Compartir detalles va ayudanos a tomar una decisión bien encontada.",
	"gui.chatReport.discard.content": "Si sales, vas perder esta denuncia y los tos comentarios. ¿Seguru que quies salir?",
	"gui.chatReport.discard.discard": "Salir y refugar denuncia",
	"gui.chatReport.discard.draft": "Guardar borrador",
	"gui.chatReport.discard.return": "Siguir editando",
	"gui.chatReport.discard.title": "¿Refugar denuncia y comentarios?",
	...
	"gui.chatReport.draft.quittotitle.content": "¿Quies siguir editándola o refugala?",
	"gui.chatReport.draft.quittotitle.title": "Tienes un borrador de denuncia de chat que se va perder si sales",
	"gui.chatReport.draft.title": "¿Editar borrador de denuncia de chat?",
	"gui.chatReport.more_comments": "Describe lo asocedío:",
	"gui.chatReport.observed_what": "¿Por qué tas denunciando esto?",
	"gui.chatReport.read_info": "Más información sobro les denuncies",
	"gui.chatReport.report_sent_msg": "Recibimos correchamente la to denuncia. ¡Gracies!\n\nEl nuesu equipu revisar lo antes posible.",
	"gui.chatReport.select_chat": "Escoyer mensaxes de chat pa denunciar",
	"gui.chatReport.select_reason": "Escoyer categoría de denuncia",
	"gui.chatReport.selected_chat": "%s mensaxe(s) de chat escoyíu(s) pa denunciar",
	"gui.chatReport.send": "Unviar denuncia",
	"gui.chatReport.send.comments_too_long": "Por favor, encurtia'l comentariu",
	"gui.chatReport.send.no_reason": "Escueye xuna categoría de denuncia",
	"gui.chatReport.send.no_reported_messages": "Escueye siquier un mensaxe de chat pa denunciar",
	"gui.chatReport.send.too_many_messages": "Tas intentando incluyir demasiaos mensaxes na denuncia",
	"gui.chatReport.title": "Denunciar chat de xugador",
	"gui.chatSelection.context": "Los mensaxes qu'arrodien esta selección van incluyir p'apurrir contestu adicional",
	"gui.chatSelection.fold": "%s mensaxe(s) ocultu(s)",
	"gui.chatSelection.heading": "%s %s",
	"gui.chatSelection.join": "%s xunióse al chat",
	"gui.chatSelection.message.narrate": "%s dixo: %s a les %s",
	"gui.chatSelection.selected": "%s/%s mensaxe(s) escoyíos",
	"gui.chatSelection.title": "Escoyer mensaxes de chat pa denunciar",
	"gui.continue": "Siguir",
	"gui.copy_link_to_clipboard": "Copiar enllaz al portapapeles",
	"gui.days": "%s día(s)",
	"gui.done": "Fecho",
	"gui.down": "Abaxo",
	"gui.entity_tooltip.type": "Tipu: %s",
	"gui.experience.level": "%s",
	"gui.fileDropFailure.detail": "Refugar %s arquivos",
	"gui.fileDropFailure.title": "Non pudieron amestase los arquivos",
	...
	"gui.friends.cancel_request": "Atayar solicitú",
	"gui.friends.confirm_title": "Confirmar",
	"gui.friends.confirm_unfriend": "¿Seguru que quies esaniciar a esti xugador de la to llista d'amigos?",
	"gui.friends.copy_to_clipboard": "Copiar al portapapeles",
	"gui.friends.decline": "Refugar",
	"gui.friends.empty_nickname": "Introduz un nome de perfil válidu antes d'unviar una solicitú d'amistá",
	"gui.friends.empty_state": "Los amigos qu'amiestes van apaecer equí.\n\nXestiona la to seguridá en llínea cola to %s.",
	"gui.friends.empty_state.link": "Cuenta de Microsoft",
	"gui.friends.enter_nickname": "Introduz el nome del perfil",
	"gui.friends.error.connection_issue": "La llista d'amigos nun ta funcionando nesti momentu.\n\nComprueba la to conexón a Internet ya inténtalo de nuevu.",
	"gui.friends.error.failed.message": "Non puede unviase la to solicitú d'amistá nesti momentu",
	"gui.friends.error.forbidden.message": "Non pudo realizase esta acción d'amistá. Puede debese a la configuración de privacidá de la cuenta.",
	"gui.friends.error.generic": "Daqué salió mal con esta función, ¡non colos tos amigos!\n\nInténtalo de nuevu más tarde.",
	"gui.friends.error.rateLimited.message": "Tas realizando acciones de la llista d'amigos demasiáu rápidu. Espera un momentu ya inténtalo de nuevu.",
	"gui.friends.error.temporary_unavailable": "La llista d'amigos nun ta funcionando nesti momentu.\n\nInténtalo de nuevu más tarde.",
	"gui.friends.error.unauthorized": "Token non válidu proporcionáu. Reinicia'l xuegu y el launcher, y vuelve intentalo",
	"gui.friends.error.unavailable.message": "El serviciu de la llista d'amigos nun ta disponible anguaño. Comprueba la to conexón ya inténtalo de nuevu más tarde.",
	"gui.friends.error.upgrade_needed": "Actualiza'l xuegu para aportar a la to llista d'amigos.",
	"gui.friends.error.user_may_lack_active_profile": "Nun hai nengún xugador con esti nome de perfil",
	"gui.friends.join": "Xunise",
	"gui.friends.loading_friends": "Cargando llista d'amigos...",
	"gui.friends.loading_requests": "Cargando solicitúes...",
	"gui.friends.manage_account_footer": "Xestiona la to seguridá en llínea cola to %s",
	"gui.friends.multiplayer.invite": "Convidar",
	"gui.friends.multiplayer.invite_accept": "Aceptar",
	"gui.friends.multiplayer.invite_reject": "Refugar",
	"gui.friends.multiplayer.join_request": "Solicitar xunise",
	"gui.friends.multiplayer.join_request_accept": "Aceptar",
	"gui.friends.multiplayer.join_request_reject": "Refugar",
	"gui.friends.my_profile_name": "El mio nome de perfil: ",
	"gui.friends.my_profile_name.narration": "Copiar nome de perfil %s al portapapeles",
	"gui.friends.narration.button.accept": "Pulsia Intro para aceptar la solicitú d'amistá de %s",
	"gui.friends.narration.button.cancel_request": "Pulsia Intro para atayar la solicitú d'amistá a %s",
	"gui.friends.narration.button.decline": "Pulsia Intro para refugar la solicitú d'amistá de %s",
	"gui.friends.narration.button.unfriend": "Pulsia Intro para esaniciar a %s de la to llista d'amigos",
	"gui.friends.narration.entry.friend": "Amigu %s",
	"gui.friends.narration.entry.incoming": "Solicitú de amistad entrante de %s",
	"gui.friends.narration.entry.outgoing": "Solicitú d'amistá unviada a %s",
	"gui.friends.open": "Amigos",
	"gui.friends.open.narration": "Llista d'amigos",
	"gui.friends.open.tooltip": "Amigos",
	"gui.friends.pending.empty": "Nun hai solicitúes d'amistá pindies",
	"gui.friends.pending.received": "Recibíes",
	"gui.friends.pending.sent": "Unviaes",
	"gui.friends.presence.status.offline": "Desconectáu",
	"gui.friends.presence.status.online": "En llínea",
	"gui.friends.presence.status.playing_hosted_server": "En llínea (LAN)",
	"gui.friends.presence.status.playing_offline": "En llínea (Mundu)",
	"gui.friends.presence.status.playing_realms": "En llínea (Realm)",
	"gui.friends.presence.status.playing_server": "En llínea (Servidor)",
	"gui.friends.requests_count": "Solicitúes (%s)",
	"gui.friends.send_request": "Unviar solicitú d'amistá",
	"gui.friends.tab_friends": "Amigos",
	"gui.friends.toast.friend_added.message": "%s aceptó la to solicitú d'amistá",
	"gui.friends.toast.friend_invited.message": "%s foi convidáu a xunise al to mundu.",
	"gui.friends.toast.friend_removed.message": "%s foi esaniciáu de la to llista d'amigos",
	"gui.friends.toast.generic_error": "Producióse un erru inesperáu al actualizar la to llista d'amigos. Inténtalo de nuevu más tarde.",
	"gui.friends.toast.host_invite_expired.message": "La invitación por que %s xunir a esti mundu hai expirado.",
	"gui.friends.toast.invite_from_friend.message": "%s te convidó a xunite al so mundu. Abre la llista d'amigos pulsiando \"%s\" para xunite",
	"gui.friends.toast.join_invite_expired.message": "La invitación para xunite al mundu de %s hai expirado.",
	"gui.friends.toast.join_request.message": "%s quier xunise al to mundu. Abre la llista d'amigos con \"%s\" o dende'l menú del xuegu.",
	"gui.friends.toast.request_accepted.message": "Agora tu y %s sois amigos",
	"gui.friends.toast.request_received.message": "%s te unvió una solicitú d'amistá",
	"gui.friends.toast.request_sent.message": "Solicitú d'amistá unviada a %s",
	"gui.friends.toast.request_to_join_friend.message": "Solicitasti xunite al mundu de %s",
	"gui.friends.toast.requests_accepted_multiple.message": "%s aceptaron les tos solicitúes d'amistá",
	"gui.friends.toast.requests_received_multiple.message": "Recibisti %s solicitúes d'amistá",
	"gui.friends.unfriend": "Esaniciar amigu",
	"gui.friends.validation.already_friend": "%s yá ta na to llista d'amigos",
	"gui.friends.validation.already_incoming": "%s yá te unvió una solicitú d'amistá",
	"gui.friends.validation.already_outgoing": "Yá unviasti una solicitú d'amistá a %s",
	"gui.friends.validation.cannot_add_self": "Nun puedes unviate una solicitú d'amistá a ti mesmu",
	"gui.game_rule.search": "Buscar...",
	"gui.hours": "%s hora(s)",
	"gui.language.search": "Buscar...",
	"gui.loadingMinecraft": "Cargando Minecraft",
	"gui.minutes": "%s minutu(s)",
	"gui.multiLineEditBox.character_limit": "%s/%s",
	"gui.narrate.button": "Botón %s",
	"gui.narrate.editBox": "%s cuadru d'edición: %s",
	"gui.narrate.slider": "Eslizador %s",
	"gui.narrate.tab": "%s pestaña",
	"gui.no": "Non",
	"gui.none": "Nada",
	"gui.ok": "Aceptar",
	"gui.open_report_dir": "Abrir carpeta d'informes",
	"gui.packSelection.search": "Buscar...",
	"gui.privacy_link.message": "Abre esti enllaz para alministrar la to configuración de privacidá y seguridá en llínea.",
	"gui.privacy_link.title": "Los cambeos na configuración de Xbox pueden tardar un tiempu n'aplicase.\n\nSi nun s'actualicen, reinicia'l xuegu.",
	"gui.proceed": "Siguir",
	"gui.recipebook.moreRecipes": "Clic derechu pa más",
	"gui.recipebook.next_page": "Páxina siguiente",
	"gui.recipebook.page": "%s/%s",
	"gui.recipebook.previous_page": "Páxina anterior",
	...
	"gui.remove": "Esaniciar",
	"gui.report_to_server": "Denunciar al servidor",
	...
	"gui.socialInteractions.narration.hide": "Despintar mensaxes de %s",
	"gui.socialInteractions.narration.report": "Denunciar al xugador %s",
	"gui.socialInteractions.narration.show": "Amosar mensaxes de %s",
	...
	"gui.socialInteractions.status_blocked_offline": "Bloquiáu - Desconectáu",
	"gui.socialInteractions.status_hidden": "Ocultu",
	"gui.socialInteractions.status_hidden_offline": "Ocultu - Desconectáu",
	...
	"gui.socialInteractions.tooltip.hide": "Despintar mensaxes",
	"gui.socialInteractions.tooltip.report": "Denunciar xugador",
	"gui.socialInteractions.tooltip.report.chat_disabled_or_blocked": "Non puede denunciase a esti xugador porque'l chat ta evacuáu o bloquiáu",
	"gui.socialInteractions.tooltip.report.disabled": "El serviciu de denuncies nun ta disponible",
	"gui.socialInteractions.tooltip.report.no_messages": "Nun hai mensaxes denunciables del xugador %s",
	"gui.socialInteractions.tooltip.report.not_reportable": "Non puede denunciase a esti xugador porque los sos mensaxes de chat nun pueden verificase nesti servidor",
	"gui.socialInteractions.tooltip.show": "Amosar mensaxes",
	"gui.stats": "Estadístiques",
	"gui.stats.none_found": "Nun s'atoparon estadístiques.",
	"gui.toMenu": "Volver pa la llista de sirvidores",
	"gui.toRealms": "Volver a la llista de Realms",
	"gui.toTitle": "Volver pa la pantalla d'aniciu",
	"gui.toWorld": "Volver a la llista de mundos",
	"gui.togglable_slot": "Fai clic para desactivar la ranura",
	"gui.up": "Arriba",
	"gui.waitingForResponse.button.inactive": "Tras (%ss)",
	"gui.waitingForResponse.title": "Esperando al servidor",
	"gui.yes": "Sí",
	"hanging_sign.edit": "Editar mensaxe del cartelu colgante",
	"instrument.minecraft.admire_goat_horn": "Almirar",
	"instrument.minecraft.call_goat_horn": "Llamada",
	"instrument.minecraft.dream_goat_horn": "Suañu",
	"instrument.minecraft.feel_goat_horn": "Sentir",
	"instrument.minecraft.ponder_goat_horn": "Cavilgar",
	"instrument.minecraft.seek_goat_horn": "Buscar",
	"instrument.minecraft.sing_goat_horn": "Cantar",
	"instrument.minecraft.yearn_goat_horn": "Naguar por",
	"inventory.binSlot": "Destruyir oxetu",
	"inventory.hotbarInfo": "Guardar barra rápida con %[1]s + %[2]s",
	"inventory.hotbarSaved": "Barra rápida guardada (restaurar con %[1]s + %[2]s)",
	"item.canBreak": "Pue romper:",
	"item.canPlace": "Pue asitiase en:",
	"item.canUse.unknown": "Desconocíu",
	"item.color": "Color: %s",
	"item.components": "%s componente(s)",
	"item.disabled": "Oxetu evacuáu",
	...
	"item.minecraft.acacia_chest_boat": "Barca d'alcacia con bagul",
	"item.minecraft.allay_spawn_egg": "Güevu xenerador de Allay",
	"item.minecraft.amethyst_shard": "Cachu d'amatista",
	"item.minecraft.ancient_city_map": "Ancient City Map",
	"item.minecraft.angler_pottery_shard": "Fragmentu de cerámica Pescador",
	"item.minecraft.angler_pottery_sherd": "Tiestu de cerámica Pescador",
	"item.minecraft.apple": "Mazana",
	"item.minecraft.archer_pottery_shard": "Fragmentu de cerámica Arqueru",
	"item.minecraft.archer_pottery_sherd": "Tiestu de cerámica Arqueru",
	"item.minecraft.armadillo_scute": "Escudu d'Armadillu",
	"item.minecraft.armadillo_spawn_egg": "Güevu xenerador d'Armadíu",
	"item.minecraft.armor_stand": "Maniquín",
	"item.minecraft.arms_up_pottery_shard": "Fragmentu de cerámica Brazos Enriba",
	"item.minecraft.arms_up_pottery_sherd": "Tiestu de cerámica Brazos Enriba",
	...
	"item.minecraft.bamboo_chest_raft": "Llancha de bambú con bagul",
	"item.minecraft.bamboo_raft": "Llancha de bambú",
	...
	"item.minecraft.birch_chest_boat": "Barca de bidul con bagul",
	"item.minecraft.black_bundle": "Fardu negru",
	"item.minecraft.black_cushion": "Black Cushion",
	"item.minecraft.black_dye": "Tiñe prietu",
	"item.minecraft.black_harness": "Arnés negru",
	"item.minecraft.blade_pottery_shard": "Fragmentu de cerámica Espada",
	"item.minecraft.blade_pottery_sherd": "Tiestu de cerámica Espada",
	...
	"item.minecraft.blue_bundle": "Fardu azul",
	...
	"item.minecraft.bogged_spawn_egg": "Güevu xenerador de Bogged",
	"item.minecraft.bolt_armor_trim_smithing_template": "Plantiya de ferrería",
	"item.minecraft.bolt_armor_trim_smithing_template.new": "Plantiya de ferrería: Ribete Rescamplu",
	"item.minecraft.bone": "Güesu",
	"item.minecraft.bone_meal": "Fariña óseo",
	"item.minecraft.book": "Llibru",
	"item.minecraft.bordure_indented_banner_pattern": "Diseñu d'estandarte Bordura Dentada",
	"item.minecraft.bow": "Arcu",
	"item.minecraft.bowl": "Escudiella",
	"item.minecraft.bread": "Pan",
	"item.minecraft.breeze_rod": "Vara de Breeze",
	"item.minecraft.breeze_spawn_egg": "Güevu xenerador de Breeze",
	"item.minecraft.brewer_pottery_shard": "Fragmentu de cerámica Cerveceru",
	"item.minecraft.brewer_pottery_sherd": "Tiestu de cerámica Cerveceru",
	"item.minecraft.brewing_stand": "Soporte para mestranzos",
	"item.minecraft.brick": "Lladriyu",
	"item.minecraft.brown_bundle": "Fardu marrón",
	"item.minecraft.brown_cushion": "Brown Cushion",
	"item.minecraft.brown_dye": "Tiñe marrón",
	"item.minecraft.brown_egg": "Güevu marrón",
	...
	"item.minecraft.bundle.empty": "Vacíu",
	"item.minecraft.bundle.empty.description": "Puede contener una pila mista d'oxetos",
	"item.minecraft.bundle.full": "Llenu",
	...
	"item.minecraft.burn_pottery_shard": "Fragmentu de cerámica Quemadura",
	"item.minecraft.burn_pottery_sherd": "Tiestu de cerámica Quemadura",
	"item.minecraft.camel_husk_spawn_egg": "Güevu xenerador de Camellu Momificado",
	"item.minecraft.camel_spawn_egg": "Güevu xenerador de Camellu",
	...
	"item.minecraft.cauldron": "Calderu",
	...
	"item.minecraft.cherry_boat": "Barca de cerezu",
	"item.minecraft.cherry_chest_boat": "Barca de cerezu con bagul",
	...
	"item.minecraft.coast_armor_trim_smithing_template.new": "Plantiya de ferrería: Ribete Costeru",
	...
	"item.minecraft.copper_axe": "Hachu de cobre",
	"item.minecraft.copper_boots": "Botes de cobre",
	"item.minecraft.copper_chestplate": "Petu de cobre",
	"item.minecraft.copper_golem_spawn_egg": "Güevu qu'apruz un gólem de cobre",
	"item.minecraft.copper_helmet": "Cascu de cobre",
	"item.minecraft.copper_hoe": "Fesoria de cobre",
	"item.minecraft.copper_horse_armor": "Armadura caballuna de cobre",
	"item.minecraft.copper_ingot": "Llingote de cobre",
	"item.minecraft.copper_leggings": "Pantalones de cobre",
	"item.minecraft.copper_nautilus_armor": "Armadura de nautilu de cobre",
	"item.minecraft.copper_nugget": "Pebida de cobre",
	"item.minecraft.copper_pickaxe": "Picu de cobre",
	"item.minecraft.copper_shovel": "Pala de cobre",
	"item.minecraft.copper_spear": "Llanza de cobre",
	"item.minecraft.copper_sword": "Espada de cobre",
	"item.minecraft.cow_spawn_egg": "Güevu qu'apruz a una vaca",
	"item.minecraft.creaking_spawn_egg": "Güevu xenerador de Creaking",
	"item.minecraft.creeper_banner_pattern": "Patrón d'estandarte",
	"item.minecraft.creeper_banner_pattern.desc": "Dibuxu de creeper",
	"item.minecraft.creeper_banner_pattern.new": "Diseñu d'estandarte Carga de Creeper",
	...
	"item.minecraft.cyan_bundle": "Fardu cian",
	"item.minecraft.cyan_cushion": "Cyan Cushion",
	"item.minecraft.cyan_dye": "Tiñe cianu",
	"item.minecraft.cyan_harness": "Arnés cian",
	"item.minecraft.danger_pottery_shard": "Fragmentu de cerámica Peligru",
	"item.minecraft.danger_pottery_sherd": "Tiestu de cerámica Peligru",
	"item.minecraft.dark_oak_boat": "Barca de carbayu escuro",
	"item.minecraft.dark_oak_chest_boat": "Barca de carbayu escuro con bagul",
	"item.minecraft.debug_stick": "Palu de depuración",
	"item.minecraft.debug_stick.empty": "%s nun tien propiedaes",
	"item.minecraft.debug_stick.select": "escoyíu \"%s\" (%s)",
	...
	"item.minecraft.diamond_nautilus_armor": "Armadura Náutilo de diamante",
	"item.minecraft.diamond_pickaxe": "Picu de diamante",
	"item.minecraft.diamond_shovel": "Pala de diamante",
	"item.minecraft.diamond_spear": "Llanza de diamante",
	...
	"item.minecraft.dune_armor_trim_smithing_template": "Plantiya de ferrería",
	"item.minecraft.dune_armor_trim_smithing_template.new": "Plantiya de ferrería: Ribete de Dunes",
	...
	"item.minecraft.ender_dragon_spawn_egg": "Güevu xenerador de Dragón Ender",
	...
	"item.minecraft.explorer_pottery_shard": "Fragmentu de cerámica Esplorador",
	"item.minecraft.explorer_pottery_sherd": "Tiestu de cerámica Esplorador",
	"item.minecraft.eye_armor_trim_smithing_template": "Plantiya de ferrería: Ribete para Güeyu de Ender",
	"item.minecraft.eye_armor_trim_smithing_template.new": "Plantiya de ferrería de güeyu",
	"item.minecraft.feather": "Pluma",
	"item.minecraft.fermented_spider_eye": "Güeyu d'araña formentáu",
	"item.minecraft.field_masoned_banner_pattern": "Diseñu d'estandarte mampostería de campu",
	...
	"item.minecraft.flow_armor_trim_smithing_template": "Plantía de ferrería",
	"item.minecraft.flow_armor_trim_smithing_template.new": "Plantiya de ferrería de ribete de fluxu",
	"item.minecraft.flow_banner_pattern": "Diseñu d'estandarte",
	"item.minecraft.flow_banner_pattern.desc": "Fluxu",
	"item.minecraft.flow_banner_pattern.new": "Diseñu d'estandarte fluxu",
	"item.minecraft.flow_pottery_sherd": "Fragmentu de cerámica fluxu",
	"item.minecraft.flower_banner_pattern": "Diseñu d'estandarte",
	"item.minecraft.flower_banner_pattern.desc": "Dibuxu de flor",
	"item.minecraft.flower_banner_pattern.new": "Diseñu d'estandarte carga floral",
	"item.minecraft.flower_pot": "Tiestu",
	"item.minecraft.fox_spawn_egg": "Güevu qu'apruz a un raposu",
	"item.minecraft.friend_pottery_shard": "Fragmentu de cerámica amigu",
	"item.minecraft.friend_pottery_sherd": "Tiestu de cerámica amigu",
	"item.minecraft.frog_spawn_egg": "Güevu xenerador de xaronca",
	...
	"item.minecraft.globe_banner_pattern": "Diseñu d'estandarte",
	"item.minecraft.globe_banner_pattern.desc": "Planeta",
	"item.minecraft.globe_banner_pattern.new": "Diseñu d'estandarte Globu",
	"item.minecraft.glow_berries": "Bagues dulces rellumantes",
	"item.minecraft.glow_ink_sac": "Sacu de tinta rellumante",
	"item.minecraft.glow_item_frame": "Marcu brillosu",
	...
	"item.minecraft.guster_banner_pattern": "Diseñu d'estandarte",
	"item.minecraft.guster_banner_pattern.desc": "Rabasera",
	"item.minecraft.guster_banner_pattern.new": "Diseñu d'estandarte ráfaga",
	"item.minecraft.guster_pottery_sherd": "Fragmentu de cerámica rabasera",
	"item.minecraft.happy_ghast_spawn_egg": "Güevu xenerador de Happy Ghast",
	"item.minecraft.harness": "Arnés",
	"item.minecraft.heart_of_the_sea": "Corazón de la mar",
	"item.minecraft.heart_pottery_shard": "Fragmentu de cerámica corazón",
	"item.minecraft.heart_pottery_sherd": "Tiestu de cerámica corazón",
	"item.minecraft.heartbreak_pottery_shard": "Fragmentu de cerámica corazón rotu",
	"item.minecraft.heartbreak_pottery_sherd": "Tiestu de cerámica corazón rotu",
	...
	"item.minecraft.host_armor_trim_smithing_template": "Plantiya de ferrería",
	"item.minecraft.host_armor_trim_smithing_template.new": "Plantiya de ferrería de anfitrión",
	"item.minecraft.howl_pottery_shard": "Fragmentu de cerámica aullíu",
	"item.minecraft.howl_pottery_sherd": "Tiestu de cerámica aullíu",
	...
	"item.minecraft.iron_golem_spawn_egg": "Güevu xenerador de gólem de fierro",
	...
	"item.minecraft.iron_nautilus_armor": "Armadura de Náutilo de fierro",
	...
	"item.minecraft.iron_spear": "Llanza de fierro",
	...
	"item.minecraft.jungle_chest_boat": "Barca de madera de la xungla con bagul",
	"item.minecraft.jungle_explorer_map": "Jungle Explorer Map",
	...
	"item.minecraft.leather_horse_armor": "Armadura caballuna de cuero",
	"item.minecraft.leather_leggings": "Pantalones de cueru",
	"item.minecraft.light_blue_bundle": "Fardu azul claru",
	...
	"item.minecraft.light_gray_bundle": "Fardu gris claru",
	"item.minecraft.light_gray_cushion": "Light Gray Cushion",
	"item.minecraft.light_gray_dye": "Tiñe buxu claro",
	"item.minecraft.light_gray_harness": "Arnés gris claru",
	"item.minecraft.lime_bundle": "Fardu llima",
	"item.minecraft.lime_cushion": "Lime Cushion",
	"item.minecraft.lime_dye": "Tiñe llima",
	"item.minecraft.lime_harness": "Arnés llima",
	...
	"item.minecraft.lingering_potion.effect.infested": "Mestranzu persistente de Infestación",
	...
	"item.minecraft.lingering_potion.effect.oozing": "Mestranzu persistente de rezumamiento",
	...
	"item.minecraft.lingering_potion.effect.weaving": "Mestranzu persistente de texíu",
	"item.minecraft.lingering_potion.effect.wind_charged": "Mestranzu persistente de carga de vientu",
	...
	"item.minecraft.magenta_bundle": "Fardu magenta",
	...
	"item.minecraft.mangrove_chest_boat": "Barca de mangle con bagul",
	...
	"item.minecraft.miner_pottery_shard": "Fragmentu de cerámica mineru",
	"item.minecraft.miner_pottery_sherd": "Tiestu de cerámica mineru",
	"item.minecraft.mineshaft_map": "Mineshaft Map",
	"item.minecraft.mojang_banner_pattern": "Diseñu d'estandarte",
	"item.minecraft.mojang_banner_pattern.desc": "Llogotipu",
	"item.minecraft.mojang_banner_pattern.new": "Diseñu d'estandarte cuesa",
	"item.minecraft.mooshroom_spawn_egg": "Güevu qu'apruz a un mooshroom",
	"item.minecraft.mourner_pottery_shard": "Fragmentu de cerámica doliente",
	"item.minecraft.mourner_pottery_sherd": "Tiestu de cerámica doliente",
	...
	"item.minecraft.music_disc_bounce": "Discu de música",
	...
	"item.minecraft.music_disc_creator_music_box.desc": "Lena Raine - Creator (Caxa de música)",
	...
	"item.minecraft.nautilus_spawn_egg": "Güevu qu'apruz un nautilu",
	"item.minecraft.nether_brick": "Lladriyu del Nether",
	"item.minecraft.nether_star": "Estrella del Nether",
	"item.minecraft.nether_wart": "Fungu del Nether",
	...
	"item.minecraft.netherite_horse_armor": "Armadura caballuna de netherita",
	"item.minecraft.netherite_ingot": "Llingote de netherita",
	"item.minecraft.netherite_leggings": "Pantalones de netherita",
	"item.minecraft.netherite_nautilus_armor": "Armadura de nautilu de netherita",
	...
	"item.minecraft.netherite_spear": "Llancia de netherita",
	"item.minecraft.netherite_sword": "Espada de netherita",
	"item.minecraft.netherite_upgrade_smithing_template": "Plantía de ferrería",
	"item.minecraft.netherite_upgrade_smithing_template.new": "Meyora de netherita",
	"item.minecraft.oak_boat": "Barca de carbayu",
	"item.minecraft.oak_chest_boat": "Barca de carbayu con bagul",
	"item.minecraft.ocean_explorer_map": "Ocean Explorer Map",
	"item.minecraft.ocean_monument_map": "Ocean Monument Map",
	"item.minecraft.ocelot_spawn_egg": "Güevu qu'apruz a un ocelote",
	"item.minecraft.ominous_bottle": "Frascu siniestru",
	...
	"item.minecraft.pale_oak_boat": "Barca de carbayu pálido",
	"item.minecraft.pale_oak_chest_boat": "Barca de carbayu pálido con bagul",
	...
	"item.minecraft.poplar_boat": "Barca de chopu",
	"item.minecraft.poplar_chest_boat": "Barca de chopu con bagul",
	...
	"item.minecraft.raiser_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.rib_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.shaper_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.silence_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.snout_armor_trim_smithing_template": "Plantía de ferrería",
	"item.minecraft.snout_armor_trim_smithing_template.new": "Snout Armor Trim",
	"item.minecraft.snow_golem_spawn_egg": "Güevu qu'apruz un gólem de nieve",
	...
	"item.minecraft.spire_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.spruce_chest_boat": "Barca d'abetu con bagul",
	...
	"item.minecraft.swamp_explorer_map": "Swamp Explorer Map",
	...
	"item.minecraft.tide_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.trial_explorer_map": "Trial Explorer Map",
	...
	"item.minecraft.ward_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.wayfinder_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.wild_armor_trim_smithing_template": "Plantía de ferrería",
	...
	"item.minecraft.woodland_explorer_map": "Woodland Explorer Map",
	...
	"item.minecraft.zombie_nautilus_spawn_egg": "Güevu qu'apruz un nautilu zombi",
	...
	"item_modifier.unknown": "Modificador d'oxetu desconocíu: %s",
	...
	"key.keyboard.application": "Application",
	...
	"key.keyboard.lang1": "Language 1",
	"key.keyboard.lang2": "Language 2",
	"key.keyboard.lang3": "Language 3",
	"key.keyboard.lang4": "Language 4",
	"key.keyboard.lang5": "Language 5",
	"key.keyboard.lang6": "Language 6",
	"key.keyboard.lang7": "Language 7",
	"key.keyboard.lang8": "Language 8",
	"key.keyboard.lang9": "Language 9",
	...
	"mco.configure.world.region_preference": "Rexón preferida",
	"mco.configure.world.region_preference.title": "Seleición de rexón preferida",
	"mco.configure.world.renderDistance": "Render Distance Limit",
	"mco.configure.world.renderDistance.tooltip": "The maximum distance visible to Realm members. Higher values may impact performance.",
	...
	"mco.configure.world.simulationDistance.tooltip": "The range around players where the game loads and applies changes.",
	...
	"mco.pdp.friends.description": "Your invited friends can play in your Realm for free, anytime - even when you're not online. Play with up to 10 at once!",
	"mco.pdp.friends.title": "A better way to play together",
	"mco.pdp.minigames.description": "Explore the rotating library of minigames, adventure maps and more.",
	"mco.pdp.minigames.title": "Minigames - Free creator content",
	...
	"mco.pdp.private.title": "Personal server",
	"mco.pdp.private.worldSlots": "• Three world slots",
	"mco.pdp.trial.description": "Free 30-day trial!",
	"mco.pdp.trial.title": "Your own server, always online",
	"mco.pdp.tryForFree": "Try for free",
	...
	"mco.selectServer.freeTrial": "Free trial",
	...
	"mco.snapshot.subscription.info": "This is a Snapshot Realm that is paired with the subscription of your Realm '%s'. It will stay active for as long as its paired Realm is.",
	...
	"options.ctrlClickEmulatesRightClick.tooltip": "When enabled, Control + left-click is treated as a right-click. Only applies on macOS.",
	...
	"options.fullscreen.exclusive.mode.tooltip": "This setting only takes effect when Exclusive Fullscreen is enabled.",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "Some actions within a chunk will recompile the chunk immediately. This includes block placing and destroying.",
	...
	"options.quitShortcuts.tooltip": "Whether keyboard shortcuts can close the game. When off, Alt + F4 on Windows and Linux, and Cmd + Q on macOS, will no longer quit the game.",
	...
	"options.worldOptions.guest.force_game_mode.off.hardcore.tooltip": "Cannot change this setting in a hardcore world.",
	...
	"quickplay.error.invalid_identifier": "Could not find a world with the provided identifier",
	"quickplay.error.realm_connect": "Could not connect to this Realm",
	"quickplay.error.realm_permission": "Lacking permission to connect to this Realm",
	"quickplay.error.title": "Failed to Quick Play",
	"realms.configuration.region.australia_east": "Australia (Nueva Gales del Sur)",
	...
	"realms.configuration.region.central_us": "Estaos Xuníos (Iowa)",
	"realms.configuration.region.east_asia": "Ḥong Kong",
	"realms.configuration.region.east_us": "Estaos Xuníos (Virxinia)",
	"realms.configuration.region.east_us_2": "Estaos Xuníos (Carolina del Norte)",
	"realms.configuration.region.france_central": "Francia",
	"realms.configuration.region.japan_east": "Xapón oriental",
	"realms.configuration.region.japan_west": "Xapón occidental",
	"realms.configuration.region.korea_central": "Corea del Sur",
	"realms.configuration.region.mexico_central": "Mexico",
	"realms.configuration.region.north_central_us": "Estaos Xuníos (Illinois)",
	"realms.configuration.region.north_europe": "Irlanda",
	"realms.configuration.region.south_africa_north": "South Africa",
	"realms.configuration.region.south_central_us": "Estaos Xuníos (Texas)",
	"realms.configuration.region.southeast_asia": "Singapur",
	"realms.configuration.region.sweden_central": "Suecia",
	"realms.configuration.region.uae_north": "Emiratos Árabes Xuníos",
	"realms.configuration.region.uk_south": "Sur d'Inglaterra",
	"realms.configuration.region.west_central_us": "Estaos Xuníos (Utah)",
	"realms.configuration.region.west_europe": "Países Baxos",
	"realms.configuration.region.west_us": "Estaos Xuníos (California)",
	"realms.configuration.region.west_us_2": "Estaos Xuníos (Washington)",
	...
	"subtitles.block.barrel.close": "Barril que se zarra",
	...
	"subtitles.block.copper_bulb.turn_off": "Bombilla de cobre apágase",
	"subtitles.block.copper_bulb.turn_on": "Bombilla de cobre enciéndese",
	"subtitles.block.copper_chest.close": "Bagul que se zarra",
	"subtitles.block.copper_chest.open": "Bagul que s'abre",
	"subtitles.block.copper_trapdoor.close": "Trapiella que se zarra",
	"subtitles.block.copper_trapdoor.open": "Trapiella que s'abre",
	...
	"subtitles.block.growing_plant.crop": "Planta coyechada",
	...
	"subtitles.entity.baby_cat.ambient": "Gatín que miaga",
	"subtitles.entity.baby_cat.beg_for_food": "Gatín que pide",
	"subtitles.entity.baby_cat.death": "Gatín que muerre",
	"subtitles.entity.baby_cat.eat": "Gatín que come",
	"subtitles.entity.baby_cat.hiss": "Gatín que xibla",
	"subtitles.entity.baby_cat.hurt": "Gatín mancáu",
	"subtitles.entity.baby_cat.purr": "Gatín que runxe",
	"subtitles.entity.baby_chicken.ambient": "Pitín que pía",
	"subtitles.entity.baby_chicken.death": "Pitín que muerre",
	"subtitles.entity.baby_chicken.hurts": "Pitín mancáu",
	"subtitles.entity.baby_horse.ambient": "Potru que rincha",
	"subtitles.entity.baby_horse.angry": "Potru que rincha",
	"subtitles.entity.baby_horse.breathe": "Potru qu'alienda",
	"subtitles.entity.baby_horse.death": "Potru que muerre",
	"subtitles.entity.baby_horse.eat": "Potru que come",
	"subtitles.entity.baby_horse.hurt": "Potru mancáu",
	...
	"subtitles.entity.baby_nautilus.death": "Cría de nautilu que muerre",
	"subtitles.entity.baby_nautilus.death_land": "Cría de nautilu que muerre",
	"subtitles.entity.baby_nautilus.eat": "Cría de nautilu que come",
	"subtitles.entity.baby_nautilus.hurt": "Cría de nautilu mancada",
	"subtitles.entity.baby_nautilus.hurt_land": "Cría de nautilu mancada",
	"subtitles.entity.baby_nautilus.swim": "Cría de nautilu que nada",
	"subtitles.entity.baby_pig.ambient": "Oinc de bebé piglin",
	"subtitles.entity.baby_pig.death": "Gochín que muerre",
	"subtitles.entity.baby_pig.eat": "Gochín que come",
	"subtitles.entity.baby_pig.hurt": "Gochín mancáu",
	"subtitles.entity.baby_wolf.ambient": "Cachorru que lladra",
	"subtitles.entity.baby_wolf.death": "Cachorru que muerre",
	"subtitles.entity.baby_wolf.growl": "Cachorru qu'urnia",
	"subtitles.entity.baby_wolf.hurt": "Cachorru mancáu",
	"subtitles.entity.baby_wolf.pant": "Cachorru qu'aflana",
	"subtitles.entity.baby_wolf.whine": "Cachorru que gañe",
	...
	"subtitles.entity.copper_golem.death": "Gólem de cobre que muerre",
	"subtitles.entity.copper_golem.hurt": "Gólem de cobre mancáu",
	"subtitles.entity.copper_golem.item_drop": "Gólem de cobre colocando un oxetu",
	"subtitles.entity.copper_golem.item_no_drop": "Gólem de cobre nun puede colocar un oxetu",
	"subtitles.entity.copper_golem.no_item_get": "Gólem de cobre seleicionando un oxetu",
	"subtitles.entity.copper_golem.no_item_no_get": "Gólem de cobre nun puede garrar un oxetu",
	"subtitles.entity.copper_golem.spawn": "Gólem de cobre apaez",
	"subtitles.entity.copper_golem.spin": "Cabeza de gólem de cobre da vueltes",
	"subtitles.entity.copper_golem_become_statue": "Gólem de cobre petrificáu",
	"subtitles.entity.copper_golem_oxidized.death": "Gólem de cobre que muerre",
	"subtitles.entity.copper_golem_oxidized.hurt": "Gólem de cobre mancáu",
	"subtitles.entity.copper_golem_oxidized.spin": "Cabeza de gólem de cobre da vueltes",
	"subtitles.entity.copper_golem_weathered.death": "Gólem de cobre que muerre",
	"subtitles.entity.copper_golem_weathered.hurt": "Gólem de cobre mancáu",
	"subtitles.entity.copper_golem_weathered.spin": "Cabeza de gólem de cobre da vueltes",
	...
	"subtitles.entity.nautilus.dash_ready": "Nautilu recuperáu",
	"subtitles.entity.nautilus.dash_ready_land": "Nautilu recuperáu",
	"subtitles.entity.nautilus.death": "Nautilu que muerre",
	"subtitles.entity.nautilus.death_land": "Nautilu que muerre",
	"subtitles.entity.nautilus.eat": "Nautilu que come",
	"subtitles.entity.nautilus.hurt": "Nautilu mancáu",
	"subtitles.entity.nautilus.hurt_land": "Nautilu mancáu",
	"subtitles.entity.nautilus.riding": "Nautilus bubbles",
	"subtitles.entity.nautilus.swim": "Nautilu que nala",
	...
	"subtitles.entity.panda.ambient": "Panda qu'aflana",
	...
	"subtitles.entity.parrot.imitate.zombie_nautilus": "Loru que gargarexa",
	...
	"subtitles.entity.polar_bear.ambient_baby": "Marmullu de cría d'osu polar",
	...
	"subtitles.entity.snow_golem.hurt": "Gólem de nieve mancáu",
	...
	"subtitles.entity.turtle.death_baby": "Cría de tortuga que muerre",
	...
	"subtitles.entity.turtle.hurt_baby": "Cría de tortuga mancada",
	"subtitles.entity.turtle.lay_egg": "Tortuga que punxo un güevu",
	"subtitles.entity.turtle.shamble": "Turtle shambles",
	"subtitles.entity.turtle.shamble_baby": "Cría de tortuga que repta",
	...
	"subtitles.entity.wolf.pant": "Llobu qu'aflana",
	...
	"subtitles.entity.zombie_nautilus.ambient": "Nautilu zombi que babla",
	"subtitles.entity.zombie_nautilus.ambient_land": "Nautilu zombi que babla",
	...
	"subtitles.entity.zombie_nautilus.dash_ready": "Nautilu zombi recuperáu",
	"subtitles.entity.zombie_nautilus.dash_ready_land": "Nautilu zombi recuperáu",
	"subtitles.entity.zombie_nautilus.death": "Nautilu zombi que muerre",
	"subtitles.entity.zombie_nautilus.death_land": "Nautilu zombi que muerre",
	"subtitles.entity.zombie_nautilus.eat": "Nautilu zombi que come",
	"subtitles.entity.zombie_nautilus.hurt": "Nautilu zombi mancáu",
	"subtitles.entity.zombie_nautilus.hurt_land": "Nautilu zombi mancáu",
	...
	"subtitles.item.ominous_bottle.dispose": "Frascu frayáu",
	...
	"test_block.mode_info.log": "Mou rexistru - Rexistra un mensaxe",
	...
	"upgrade.minecraft.netherite_upgrade": "Meyora de netherita",
