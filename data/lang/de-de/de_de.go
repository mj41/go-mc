// Code generated by tools/gen_lang.go from 1.21.11/de_de.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"block.minecraft.golden_dandelion": "Goldlöwenzahn",
	...
	"block.minecraft.potted_golden_dandelion": "Eingetopfter Goldlöwenzahn",
	...
	"commands.time.no_time_marker_found": "Uhr %s hat keine Zeitmarke %s",
	"commands.time.pause": "Uhr %s wurde angehalten",
	"commands.time.query": "Die aktuelle Zeit ist %s",
	"commands.time.query.absolute": "Uhr %s ist bei %s Tick(s)",
	"commands.time.query.gametime": "Die Spielzeit beträgt %s Tick(s)",
	"commands.time.query.timeline": "Zeitachse %s ist bei %s Tick(s)",
	"commands.time.query.timeline.repetitions": "Zeitleiste %s wurde %s‐mal durchlaufen",
	"commands.time.resume": "Uhr %s fortgesetzt",
	"commands.time.set": "Zeit wurde auf %s gesetzt",
	"commands.time.set.absolute": "%s auf %s Tick(s) gesetzt",
	"commands.time.set.time_marker": "%s auf Zeitmarke %s gesetzt",
	"commands.time.wrong_timeline_for_clock": "Uhr %s unterstützt Zeitachse %s nicht",
	...
	"editGamerule.inGame.discardChanges.message": "Bist du sicher, dass du die ausstehenden Änderungen verwerfen möchtest?",
	...
	"mco.selectServer.popup": "Realms ist ein sicherer und einfacher Weg, Minecraft online mit bis zu zehn Freunden gleichzeitig zu spielen. Es bietet zahlreiche Minispiele und viele exklusive Welten! Nur der Besitzer des Realms muss zahlen.",
	...
	"options.textureFiltering.anisotropic.tooltip": "Eine Hardware-basierte Filtermethode, die sich aber auf die Leistung auswirkt und den Grafikspeicherbedarf erheblich erhöht. Wird möglicherweise nicht von allen Geräten unterstützt.",
	...
	"selectWorld.backupWarning.snapshot": "Diese Welt wurde zuletzt in der Version %s gespielt; du befindest dich auf Version %s. Bitte erstelle eine Sicherheitskopie für den Fall, dass die Welt beschädigt wird.",
	...
	"subtitles.item.golden_dandelion.use": "Goldlöwenzahn hält Alterung an",
	...
	"upgradeWorld.info.total": "Gesamt: %s",
