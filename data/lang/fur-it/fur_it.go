// Code generated by tools/gen_lang.go from 1.21.11/fur_it.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"gamerule.playersNetherPortalDefaultDelay.description": "Timp (in ticadis) che un zuiadôr, che nol è in modalitât creative, al à di restâ intun portâl pal Nether par cambiâ dimension.",
	...
	"selectWorld.backupWarning.snapshot": "La ultime volte che chest mont al è stât zuiât, al jere te version %s; tu tu sês te version %s. Fâs une copie di sigurece tal câs che tu ledis incuintri a problemis di coruzion dal mont.",
