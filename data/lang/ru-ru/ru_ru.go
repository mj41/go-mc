// Code generated by tools/gen_lang.go from 1.21.11/ru_ru.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"arguments.item.malformed": "Неверный элемент: «%s»",
	...
	"chat.disabled.invalid_command_signature": "Команда имеет несовместимые или отсутствующие подписи аргументов команды.",
	...
	"commands.datapack.create.io_failure": "Не удалось создать набор с именем «%s», проверьте журнал",
	...
	"commands.dialog.clear.single": "Убраны все диалоги у игрока %s",
	...
	"commands.tick.query.rate.sprinting": "Установленная частота тактов: %s в секунду (игнорируется, только для справки).\nСредняя длительность такта: %sмс",
	...
	"debug.options.category.text": "Текст на экране отладки",
	...
	"key.debug.focusPause": "Пауза при сворачивании",
	...
	"key.debug.overlay": "Экран отладки",
	...
	"key.toggleSpectatorShaderEffects": "Переключение эффектов шейдеров",
	...
	"mco.configure.world.spawn_toggle.message": "Выключение этой опции приведёт к удалению всех существующих сущностей этого типа",
	"mco.configure.world.spawn_toggle.message.npc": "Выключение этой опции приведёт к удалению всех существующих сущностей этого типа (например, крестьян)",
	...
	"mco.configure.world.title": "Параметры реалма:",
	...
	"mco.notification.transferSubscription.buttonText": "Перенести сейчас",
	...
	"multiplayer.status.cannot_resolve": "Не удалось определить название узла",
	...
	"options.graphics.preset.tooltip": "Адаптирует настройки графики к оптимальным значениям в соответствии с желаемым качеством.",
	"options.graphics.warning.accept": "Всё равно продолжить",
	"options.graphics.warning.cancel": "Отмена изменений",
	...
	"options.maxAnisotropy.tooltip": "Повышение выборки заметно улучшает чёткость текстур, значительно увеличивает расход видеопамяти и может повлиять на производительность. Затрагивает работу анизотропной фильтрации.",
	...
	"options.video.preferences.header": "Предпочтения",
	...
	"options.vignette.tooltip": "Малозаметная текстура, которая снижает яркость по краям экрана в тёмных местах и предупреждает о близости границы мира.",
	...
	"structure_block.size_failure": "Не удалось определить размеры конструкции. Добавьте углы с названием, соответствующим конструкции",
	...
	"subtitles.block.copper_bulb.turn_off": "Медная лампа выключилась",
	"subtitles.block.copper_bulb.turn_on": "Медная лампа включилась",
	...
	"test.error.expected_container_contents_single": "Контейнер должен содержать всего один %s",
	"test.error.expected_empty_container": "Контейнер должен быть пустым",
	"test.error.expected_entity": "Ожидался %s",
	"test.error.expected_entity_around": "Ожидался %s возле точки %s, %s, %s",
	...
	"test.error.sequence.invalid_tick": "Успех в недопустимом такте; ожидался в такте %s",
	...
	"test.error.unexpected_block": "Не ожидалось, что блок будет %s",
