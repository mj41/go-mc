// Code generated by tools/gen_lang.go from 1.21.11/be_by.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"block.minecraft.potted_golden_dandelion": "Залаты дзьмухавец у гаршчку",
	...
	"commands.fillbiome.toobig": "Зашмат блокаў у пазначанай вобласці (максімум %s, але пазначана %s)",
	...
	"commands.locate.poi.not_found": "Не атрымалася знайсці пункт інтарэсу тыпу «%s» на даступнай адлегласці",
	...
	"commands.setworldspawn.success.new": "Пункт адраджэння ў свеце прызначаны на %s, %s, %s [%s, %s] у %s",
	...
	"commands.time.query.timeline": "Расклад %s на %s такце",
	"commands.time.query.timeline.repetitions": "Колькасць паўтораў раскладу %s: %s",
	"commands.time.resume": "Гадзіннік %s узноўлены",
	"commands.time.set": "Час устаноўлены на %s",
	"commands.time.set.absolute": "Гадзіннік %s пераведзены на %s тактаў",
	...
	"mco.configure.world.restore.download.question.line1": "Свет будзе спампаваны і дададзены для адзіночнай гульні.",
	...
	"options.graphics.preset.tooltip": "Усталёўвае параметры «Якасць і прадукцыйнасць» на разумныя значэнні па змаўчанні, што адпавядаюць жаданай якасці.",
	...
	"subtitles.item.underwater_saddle.equip": "Сядло экіпіявана",
	...
	"test.error.state_not_equal": "Некарэктны стан. Чакалася %s: было %s",
