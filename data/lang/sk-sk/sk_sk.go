// Code generated by tools/gen_lang.go from 1.21.11/sk_sk.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"commands.fetchprofile.id.failure": "Nepodarilo sa rozlíšiť profil pre ID %s",
	"commands.fetchprofile.id.success": "Profil pre ID %s rozlíšený: %s",
	"commands.fetchprofile.name.failure": "Nepodarilo sa rozlíšiť profil pre meno %s",
	"commands.fetchprofile.name.success": "Profil pre meno %s rozlíšený: %s",
	...
	"commands.profile_fetch.id.failure": "Nepodarilo sa rozlíšiť profil pre ID %s",
	"commands.profile_fetch.id.success": "Profil pre ID %s rozlíšený: %s",
	"commands.profile_fetch.name.failure": "Nepodarilo sa rozlíšiť profil pre meno %s",
	"commands.profile_fetch.name.success": "Profil pre meno %s rozlíšený: %s",
	...
	"mco.configure.world.leave.question.line1": "Ak opustíš tento Realm, nebudeš ho vidieť, pokiaľ ťa niekto znova nepozve",
	...
	"mco.selectServer.popup": "Realms je bezpečný a jednoduchý spôsob, ako si užiť Minecraft svet online až s desiatimi hráčmi naraz. Podporuje množstvo minihier a vlastných svetov! Platí iba vlastník Realmu.",
	...
	"menu.custom_screen_info.disconnect": "Vlastná obrazovka zamietnutá",
	...
	"narration.slider.usage.focused.keyboard_cannot_change_value": "Stlačením klávesy enter začni meniť hodnotu posuvníka",
	...
	"options.textureFiltering.anisotropic.tooltip": "Hardvérová metóda filtrovania, ktorá má vplyv na výkon a významne ovplyvňuje využitie grafickej pamäte. Nemusí byť podporovaná na každom hardvéri.",
	...
	"upgradeWorld.symlink.title": "Nepodarilo sa aktualizovať súbory sveta",
