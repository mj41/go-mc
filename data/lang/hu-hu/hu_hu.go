// Code generated by tools/gen_lang.go from 1.21.11/hu_hu.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advancements.adventure.trim_with_all_exclusive_armor_patterns.title": "Divatdiktátor",
	...
	"advancements.husbandry.whole_pack.title": "Teljes a falka",
	...
	"argument.waypoint.invalid": "A kiválasztott entitás nem egy waypoint",
	...
	"attribute.name.block_interaction_range": "Blokk-interakciós hatótávolság",
	"attribute.name.burning_time": "égési idő",
	"attribute.name.camera_distance": "Kamera Távolság",
	"attribute.name.entity_interaction_range": "Entitás-interakciós hatótávolság",
	"attribute.name.explosion_knockback_resistance": "Robbantási hátralökéssel szembeni ellenállás",
	"attribute.name.fall_damage_multiplier": "Lehullási sebzés sokszorozó",
	...
	"attribute.name.generic.entity_interaction_range": "Entitás interakció hatótáv",
	...
	"attribute.name.generic.scale": "Mérték",
	"attribute.name.generic.step_height": "lépésmagasság",
	"attribute.name.generic.water_movement_efficiency": "Vízbéli mozgási hatékonyság",
	...
	"attribute.name.knockback_resistance": "Lökési helytállás",
	"attribute.name.luck": "Mázli",
	"attribute.name.max_absorption": "Maximális elnyelés",
	"attribute.name.max_health": "Maximális életerő",
	"attribute.name.mining_efficiency": "Bányászási hatékonyság",
	"attribute.name.movement_efficiency": "Mozgási hatékonyság",
	"attribute.name.movement_speed": "Gyorsaság",
	"attribute.name.oxygen_bonus": "Oxigén-bónusz",
	"attribute.name.player.block_break_speed": "Blokktörési gyorsaság",
	"attribute.name.player.block_interaction_range": "Blokk-interakciós hatótávolság",
	...
	"attribute.name.safe_fall_distance": "Veszélytelen lehullási távolság",
	"attribute.name.scale": "Mérték",
	...
	"attribute.name.submerged_mining_speed": "Elemrült ásási gyorsaság",
	...
	"attribute.name.waypoint_receive_range": "Waypoint Fogadási Távolság",
	"attribute.name.waypoint_transmit_range": "Waypoint Átviteli Távolság",
	...
	"block.minecraft.resin_brick_slab": "Gyantatégla féllap",
	...
	"block.minecraft.tuff_slab": "Tufa féllap",
	...
	"chat.validation_error": "Hiba a chat ellenőrzésekor",
	...
	"commands.damage.success": "%s sebzés okozva %s célpontnak",
	...
	"commands.datapack.create.io_failure": "Nem lehet létrehozni datapack-et \"%s\" néven, ellenőrizd le a naplókat",
	...
	"commands.waypoint.list.empty": "Nincsenek waypointok %s-nál/nél",
	"commands.waypoint.list.success": "%s waypoint %s: %s-nál/nél",
	"commands.waypoint.modify.color": "A waypoint színe mostantól %s",
	"commands.waypoint.modify.color.reset": "Waypoint szín visszaállítása",
	"commands.waypoint.modify.style": "Waypoint stílus megváltoztatva",
	...
	"dataPack.locator_bar.name": "Lokátor Csík",
	...
	"death.attack.fallingStalactite.player": "%[1]s-t felnyársalta egy leeső függőcseppkő, miközben vele harcolt: %[2]s",
	...
	"death.attack.mace_smash": "%[2]s összezúzta %[1]s játékost",
	"death.attack.mace_smash.item": "%[1]s játékost összezúzta %[2]s %[3]s tárggyal",
	...
	"death.attack.stalagmite.player": "%[1]s-t felnyársalta egy cseppkő, miközben vele harcolt: %[2]s",
	...
	"debug.options.category.renderer": "Debug Renderelők",
	...
	"debug.options.warning": "Ezek a beállítások csak Tesztelési okokból használhatóak. Lelassíthatják a számítógépedet, lefagyaszthatják a játékot és megehetik a templom falát húsvétkor.",
	...
	"entity.minecraft.camel_husk": "Eltevetett",
	...
	"entity.minecraft.creaking_transient": "Csikorgó",
	...
	"gamerule.playersNetherPortalCreativeDelay": "Nether-portál késleltetése kreatív módban",
	...
	"gamerule.playersNetherPortalDefaultDelay": "Nether-portál késleltetése nem kreatív módban",
	...
	"key.debug.switchGameMode": "Játékmódválasztó megnyitása",
	...
	"mco.errorMessage.realmsService.configurationError": "Váratlanul inaktív realms hely szerkesztése",
	...
	"mco.selectServer.popup": "A Realmsszel biztonságosan és egyszerűen használhatsz egy online Minecraft világot akár egyszerre tíz barátoddal is. Támogat sokféle minijátékot és egyedi világokat is! Csak a realm tulajdonosának kell fizetnie.",
	...
	"menu.custom_options": "Egyedi Opciók...",
	"menu.custom_options.title": "Egyedi Opciók",
	"menu.custom_options.tooltip": "Megjegyzés: Az egyedi opciók harmadik-fél szerveréről és/vagy tartalmától származnak.\nÓvatosan bánj velük!",
	"menu.custom_screen_info.button_narration": "Ezy egy egyedi oldal. További Infromáció.",
	"menu.custom_screen_info.contents": "Ennek az oldalnak a tartalmát egy harmadik-fél határozza meg és az oldal tartalmát és a pályákat nem birtokolja, nem tartja fenn és nem ellenőrzi a Mojang Studios vagy a Microsoft.\n\nÓvatossággal használd! Mindig vigyázz amikor linkeket nyitsz meg és soha ne add meg a személyes adataidat, beleértve a belépési adataidat.\n\nHa ez az oldal meggátol téged abban, hogy a szerveren játssz, akkor az alábbi gombbal visszatérhetsz a főmenübe.",
	...
	"menu.server_links": "Szerver linkek...",
	"menu.server_links.title": "Szerver linkek",
	...
	"pack.dropRejected.message": "A következő bejegyzések nem voltak érvényes csomagok, és nem másolták őket:\n %s",
	"pack.dropRejected.title": "Csomagmentes belépés",
	...
	"recipe.toast.title": "Új Recept(ek) Feloldva!",
	...
	"snbt.parser.expected_unquoted_string": "Egy érvényes, idézőjel nélküli karakterláncra szmítottunk",
	...
	"subtitles.entity.camel_husk.ambient": "Eltevetett morog",
	"subtitles.entity.camel_husk.dash": "Eltevetett ugrik",
	"subtitles.entity.camel_husk.dash_ready": "Eltevetett kipiheni magát",
	"subtitles.entity.camel_husk.death": "Élőhalott teve meghal",
	"subtitles.entity.camel_husk.eat": "Eltevetett eszik",
	"subtitles.entity.camel_husk.hurt": "Eltevetett sérül",
	"subtitles.entity.camel_husk.saddle": "Elvetevedett felnyergelése",
	"subtitles.entity.camel_husk.sit": "Eltevetett leül",
	"subtitles.entity.camel_husk.stand": "Eltevetett feláll",
	...
	"subtitles.entity.creaking.activate": "Csikorgó szegez",
	...
	"subtitles.entity.ghastling.hurt": "Ghastling sebződik",
	...
	"test.error.block_property_mismatch": "Elvárt tulajdonság ehhez: %s, %s volt de ezt kaptuk: %s",
	...
	"test.error.entity_property_details": "%s entitáns megbukott a kísérleten: %s, elvárt: %s, kapott:%s",
