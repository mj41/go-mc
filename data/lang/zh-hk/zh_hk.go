// Code generated by tools/gen_lang.go from 1.21.11/zh_hk.json; DO NOT EDIT.
...
var Map = map[string]string{
	...
	"advMode.mode.autoexec.bat": "保持開啟",
	...
	"advancements.adventure.under_lock_and_key.description": "用試煉鑰匙打開寶庫",
	...
	"advancements.end.find_end_city.description": "進去，又會發生什麼？",
	...
	"advancements.husbandry.balanced_diet.description": "吃遍所有可以吃的東西，就算它們對你的身體有害",
	...
	"chat.disabled.profile": "聊天功能受到帳户設定限制。再次按「%s」以獲得更多資訊。",
	...
	"chat.type.advancement.goal": "%s 達成了目標 %s",
	"chat.type.advancement.task": "%s 達成了進度 %s",
	...
	"chunk.toast.checkLog": "查看紀錄以取得詳細資訊",
	...
	"commands.bossbar.set.players.unchanged": "未作任何變更。玩家已經在此 Boss 狀態條中，無法加入或移除",
	...
	"commands.datapack.create.already_exists": "名為「%s」的包已存在",
	"commands.datapack.create.invalid_full_name": "無效新包名稱「%s」",
	"commands.datapack.create.invalid_name": "新包名稱「%s」中包含無效字元",
	"commands.datapack.create.io_failure": "無法建立名為「%s」的包，請檢查紀錄檔",
	"commands.datapack.create.metadata_encode_failure": "無法編碼包「%s」的元數據：%s",
	"commands.datapack.create.success": "已建立名為「%s」的空包",
	"commands.datapack.disable.failed": "數據包「%s」未啟用！",
	"commands.datapack.disable.failed.feature": "無法停用數據包 %s，因為其為已啟用功能的一部分！",
	"commands.datapack.enable.failed": "數據包「%s」已經啟用！",
	"commands.datapack.enable.failed.no_flags": "無法啟用數據包「%s」，因為所需功能未於此世界啟用：%s！",
	...
	"commands.locate.biome.not_found": "在合理距離內未發現「%s」類型的生物羣落",
	"commands.locate.biome.success": "最近的 %s 位於 %s（%s 個方塊遠）",
	"commands.locate.poi.not_found": "在合理距離內未發現「%s」類型的興趣點",
	"commands.locate.poi.success": "最近的 %s 位於 %s（%s 個方塊遠）",
	"commands.locate.structure.invalid": "並無類型為「%s」的結構",
	"commands.locate.structure.not_found": "附近未發現類型為「%s」的結構",
	"commands.locate.structure.success": "最近的 %s 位於 %s（%s 個方塊遠）",
	...
	"commands.place.template.invalid": "並無類型為「%s」的模板",
	...
	"commands.publish.started": "已於 %s 連接埠上開放本地遊戲",
	...
	"commands.save.saving": "儲存遊戲中（可能需要些時間！）",
	"commands.save.success": "遊戲已儲存",
	"commands.schedule.cleared.failure": "並無 ID 為 %s 的計劃",
	"commands.schedule.cleared.success": "已移除 ID 為 %[2]s 的 %[1]s 個計劃",
	...
	"commands.scoreboard.players.get.null": "無法獲得 %[2]s 的 %[1]s 數值，數值未設定",
	...
	"commands.team.add.duplicate": "已經存在使用此名稱的隊伍",
	...
	"commands.team.option.seeFriendlyInvisibles.alreadyEnabled": "未作任何變更。此隊伍已經可以發現隱身的隊友",
	"commands.team.option.seeFriendlyInvisibles.disabled": "隊伍 %s 不再可以發現隱身的隊友",
	"commands.team.option.seeFriendlyInvisibles.enabled": "隊伍 %s 已經可以發現隱身的隊友",
	...
	"datapackFailure.title": "你選擇的數據包有問題，導致無法載入世界。\n你可以嘗試僅載入原版數據包（「安全模式」），或者返回主畫面手動修復。",
	...
	"death.attack.hotFloor": "%[1]s 發現地板是熔巖",
	...
	"debug.options.warning": "此類選項僅供測試，其或會拖慢你的電腦執行速度，令你彈出遊戲，甚至導致世界末日。",
	...
	"demo.reminder": "試玩時間已經結束，請購買遊戲來繼續，或者重新開始一個新的世界！",
	...
	"gamerule.blockExplosionDropDecay": "方塊交互爆炸中，部分方塊不會跌落戰利品",
	...
	"gamerule.entitiesWithPassengersCanUsePortals.description": "允許被策騎的實體通過終界傳送門、地獄傳送門及終界折躍門傳送。",
	...
	"gamerule.playersNetherPortalCreativeDelay": "創造模式玩家的地獄傳送門等待時間",
	"gamerule.playersNetherPortalCreativeDelay.description": "創造模式下的玩家通過地獄傳送門前需要站在其中等待的時間（以刻為單位）。",
	"gamerule.playersNetherPortalDefaultDelay": "非創造模式玩家的地獄傳送門等待時間",
	"gamerule.playersNetherPortalDefaultDelay.description": "非創造模式下的玩家通過地獄傳送門前需要站在其中等待的時間（以刻為單位）。",
	"gamerule.playersSleepingPercentage": "睡覺百分比",
	...
	"gui.abuseReport.draft.content": "你想繼續編輯現有聊天舉報抑或放棄並創建新的舉報？",
	"gui.abuseReport.draft.discard": "放棄",
	"gui.abuseReport.draft.edit": "繼續編輯",
	"gui.abuseReport.draft.quittotitle.content": "你想繼續編輯或者放棄？",
	...
	"gui.abuseReport.reason.self_harm_or_suicide.description": "有人威脅將會在現實中傷害自己，或者正在談論現實生活中傷害自己的行為。",
	...
	"gui.banned.description.reason": "我們近日收到舉報稱你的帳户存在不良行為。審核員已審閲你的個案，認定其為「%s」並違反 Minecraft 社羣準則。",
	...
	"gui.banned.description.unknownreason": "我們近日收到舉報稱你的帳户存在不良行為。審核員已審閲你的個案，並認定其違反 Minecraft 社羣準則。",
	"gui.banned.name.description": "你現時使用的名稱（%s）違反社羣守則。你仍可遊玩單人遊戲，惟你須更改名稱方可遊玩線上遊戲。\n\n瀏覽以下連結以瞭解更多或提交個案覆核：%s",
	"gui.banned.name.title": "多人遊戲中不容許使用此名稱",
	...
	"gui.banned.skin.title": "此外觀不被容許使用",
	...
	"gui.chatReport.draft.content": "你想繼續編輯現有聊天舉報抑或捨棄並創建新的舉報？",
	"gui.chatReport.draft.discard": "捨棄",
	"gui.chatReport.draft.edit": "繼續編輯",
	"gui.chatReport.draft.quittotitle.content": "您想繼續編輯抑或捨棄？",
	...
	"gui.proceed": "繼續",
	"gui.recipebook.moreRecipes": "按右鍵以瞭解更多",
	...
	"gui.socialInteractions.tooltip.report.no_messages": "玩家 %s 不存在可以舉報的訊息",
	...
	"mco.account.privacy.info.button": "閲讀更多有關 GDPR 的資訊",
	"mco.account.privacy.information": "Mojang 正實施幾項政策以助保護兒童及其私隱，包括遵守《兒童線上私隱保護法》(COPPA) 和《通用數據保障條例》(GDPR)。\n\n你可能需先獲得父母同意，才能使用你的 Realms 帳户。",
	...
	"mco.compatibility.downgrade.description": "此世界最後於 %s 版本遊玩，而你目前遊玩 %s 版本。降低世界遊戲版本可能會導致存檔損壞，我們無法確定世界會否崩潰或可否載入。\n\n你的世界備份將會儲存到「世界備份」中，如有需要可以復原世界。",
	...
	"mco.compatibility.unverifiable.message": "無法驗證此世界上一次遊玩的版本。若升級或降級世界的版本，則會自動建立備份，並儲存於「世界備份」資料夾中。",
	"mco.compatibility.unverifiable.title": "無法驗證相容性",
	"mco.compatibility.upgrade": "升級",
	"mco.compatibility.upgrade.description": "此世界最後一次遊玩的版本為 %s，而你使用的版本為 %s。\n\n你的世界備份將會儲存到「世界備份」中，如有需要可以復原世界。",
	"mco.compatibility.upgrade.friend.description": "此世界最後一次遊玩的版本為 %s，而你使用的版本為 %s。\n\n該世界備份將會儲存到「世界備份」中。\n\n如有需要，Realm 擁有者可以復原世界。",
	...
	"mco.configure.world.buttons.region_preference": "選取地區⋯⋯",
	...
	"mco.configure.world.restore.download.question.line1": "下載後世界將加入到你的單人遊戲世界中。",
	...
	"mco.notification.transferSubscription.message": "Java Realms 訂閲將會轉移到 Microsoft Store。不要令你的訂閲到期！現在轉移，你可以免費獲取 30 日的 Realms。請在 minecraft.net 中的「個人檔案」頁面轉移你的訂閲。",
	...
	"mco.selectServer.popup": "Realms 可以同時提供最多 10 位好友安全又簡單地享受線上 Minecraft 世界。它支援許多小遊戲以及大量自訂世界！只有 Realm 的擁有者需要支付費用。",
	...
	"menu.custom_screen_info.contents": "此畫面中的內容由第三方伺服器及地圖掌握，其並非由 Mojang Studios 或 Microsoft 擁有、營運或監督。\n請小心操作！點擊連結時務必時刻保持謹慎，切勿透露個人資訊，包括登入賬户、密碼等。\n若此畫面阻止你繼續遊玩，可點擊下方按鍵中斷伺服器連線。",
	...
	"multiplayer.disconnect.duplicate_login": "你已經在其他位置登入",
	...
	"multiplayer.disconnect.invalid_public_key_signature.new": "個人資訊公鑰無效。\n請嘗試重新啟動遊戲。",
	...
	"multiplayer.disconnect.out_of_order_chat": "收到的聊天封包順序不正確。你的系統時間是否已變更？",
	...
	"multiplayer.disconnect.unsigned_chat": "收到缺少或含有無效簽署的聊天封包。",
	...
	"options.allowServerListing.tooltip": "伺服器可能會公開列出上線玩家的名單。\n關閉此選項後，你將不會出現於名單內。",
	"options.ao": "柔和光源",
	"options.ao.max": "最大值",
	"options.ao.min": "最小值",
	"options.ao.off": "關",
	...
	"options.graphics.fabulous.tooltip": "%s 畫質用影像着色器在不透明方塊與水後方繪製天氣、雲層及粒子。\n此選項或會嚴重影響流動裝置及 4K 設備的效能。",
	"options.graphics.fancy": "細緻",
	"options.graphics.fancy.tooltip": "「細緻」畫質平衡了多數電腦的遊戲效能與畫面品質。\n天氣、雲層同埋粒子可能不會在透明方塊與水的後面顯示。",
	...
	"options.inactivityFpsLimit.afk.tooltip": "當玩家超過一分鐘沒有進行操作時，FPS 會被限制為 30。再過九分鐘，進一步將其限制為 10。",
	...
	"options.prioritizeChunkUpdates.byPlayer.tooltip": "部分操作會導致所在區塊即時重新編譯，包括埋放置或破壞方塊。",
	...
	"options.screenEffectScale.tooltip": "嘔心效果和地獄傳送門扭曲影像的強度。\n若設定為較低數值，你的螢幕將會被綠色覆蓋，以取代嘔心效果。",
	...
	"options.vignette.tooltip": "此微弱紋理位於遊戲畫面周圍，用於減弱螢幕邊緣亮度及警示世界邊界。",
	"options.visible": "顯示",
	"options.vsync": "垂直同步",
	...
	"parsing.bool.invalid": "無效布爾值，應為「true」或「false」，惟出現「%s」",
	...
	"quickplay.error.realm_permission": "權限不足，無法連線到此 Realm",
	...
	"realms.configuration.region_preference.automatic_owner": "自動（取決於 Realms 擁有者網絡延遲）",
	...
	"selectWorld.backupQuestion.experimental": "不支援使用實驗性質設定的世界",
	...
	"selectWorld.incompatible.tooltip": "此世界於不相容的版本上創建，因此無法打開。",
	...
	"selectWorld.warning.deprecated.question": "部分功能已經淘汰，並將於未來失效。你確定要繼續？",
	"selectWorld.warning.deprecated.title": "警吿！設定使用已經淘汰的功能",
	...
	"sign.edit": "編輯指示牌訊息",
	"sleep.not_possible": "已經睡覺的玩家的數量未夠跳過夜晚",
	...
	"subtitles.entity.baby_cat.ambient": "幼年貓喵叫聲",
	...
	"subtitles.entity.cat.ambient": "貓喵叫聲",
	...
	"subtitles.entity.copper_golem_become_statue": "銅人變成雕像",
	...
	"symlink_warning.message": "繼續操作前請知悉，在包含符號連結的文件夾內載入世界可能會有風險。瀏覽 %s 以瞭解更多。",
	"symlink_warning.message.pack": "繼續操作前請知悉，載入包含符號連結的包可能會有風險。訪問 %s 以瞭解更多。",
	"symlink_warning.message.world": "繼續操作前請知悉，在包含符號連結的文件夾內載入世界可能會有風險。訪問 %s 以瞭解更多。",
	"symlink_warning.more_info": "更多資訊",
	"symlink_warning.title": "世界文件夾包含符號連結",
	"symlink_warning.title.pack": "所添加的包內含有符號連結",
	"symlink_warning.title.world": "世界文件夾內含有符號連結",
